...
-- CreateEnum
CREATE TYPE "BUSINESS_TYPE" AS ENUM ('TRANSFER', 'MERCHANT', 'BUSINESS', 'DISPATCHER');
...
-- CreateEnum
CREATE TYPE "VEHICLE_CLASS" AS ENUM ('SEDAN', 'CARAVAN', 'SUV', 'MINIVAN', 'VAN', 'MINIBUS', 'BUS', 'CARGO_VAN', 'PRIVATE_DRIVER');
