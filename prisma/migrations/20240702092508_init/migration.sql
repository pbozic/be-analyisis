...
-- CreateEnum
CREATE TYPE "BUSINESS_TYPE" AS ENUM ('TRANSFER', 'MERCHANT');
...
-- CreateEnum
CREATE TYPE "DOCUMENT_TYPE" AS ENUM ('NATIONAL_ID', 'PASSPORT', 'PROFILE_PICTURE', 'LOGO', 'BANNER', 'DRIVING_LICENSE', 'TAXI_LICENCE', 'PASSENGER_TRANSFER_LICENSE', 'BACKGROUND_CHECK_REPORT', 'VEHICLE_REGISTRATION', 'VEHICLE_INSURANCE', 'VEHICLE_TECHNICAL_INSPECTION', 'OPERATING_PERMIT', 'HACCP_CERTIFICATION', 'BUSINESS_LICENSE', 'MENU_ITEM_IMAGE');

-- CreateEnum
CREATE TYPE "TAXI_ORDER_STATUS" AS ENUM ('PENDING', 'TAXI_ACCEPTED', 'TAXI_REJECTED', 'TAXI_CANCELED', 'TAXI_WAITING', 'TAXI_DRIVING', 'TAXI_ARRIVED', 'TAXI_COMPLETED', 'CUSTOMER_CANCELLED');

-- CreateEnum
CREATE TYPE "DELIVERY_ORDER_STATUS" AS ENUM ('PENDING', 'DELIVERY_ACCEPTED', 'DELIVERY_REJECTED', 'DELIVERY_CANCELED', 'DELIVERY_PICKED_UP', 'DELIVERY_IN_DELIVERY', 'DELIVERY_DELAYED', 'DELIVERY_ARRIVED', 'DELIVERY_DELIVERED', 'DELIVERY_COMPLETED', 'CUSTOMER_CANCELLED', 'CUSTOMER_PAYMENT_FAILED', 'CUSTOMER_PAYMENT_SUCCESSFUL', 'CUSTOMER_PAYMENT_PENDING', 'MERCHANT_ACCEPTED', 'MERCHANT_REJECTED', 'MERCHANT_CANCELED', 'MERCHANT_PREPARING', 'MERCHANT_DELAYED', 'MERCHANT_READY_FOR_PICKUP', 'MERCHANT_REFUNDED', 'MERCHANT_HIGH_DEMAND');
