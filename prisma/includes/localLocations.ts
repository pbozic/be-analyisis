...
export type LocalLocationsWithIncludesPrisma = Prisma.local_locationsGetPayload<{
	include: typeof localLocationsDefaultInclude;
}>;
...
export type BusinessLocalLocationsWithIncludesPrisma = Prisma.business_local_locationsGetPayload<{
	include: typeof businessLocalLocationsDefaultInclude;
}>;
