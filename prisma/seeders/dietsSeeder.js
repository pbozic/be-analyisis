...
let languages = {
    ...
    de: {
        ...
        modalTitle: 'Info',
        modalDescription: "Wenn 'UND' ausgewählt ist, zeigen wir Ihnen nur Restaurants mit allen ausgewählten Ernährungsoptionen.\nWenn 'ODER' ausgewählt ist, zeigen wir Ihnen Restaurants mit einer der ausgewählten Ernährungsoptionen.",
    },
    en: {
        ...
        modalTitle: 'Info',
        modalDescription: "When 'AND' is selected, we will only show you the restaurants with all of the selected dietary options.\nWhen 'OR' is selected, we will show you the restaurants with any of the selected dietary options.",
    },
    es: {
        ...
        modalDescription: "Cuando se selecciona 'Y', te mostraremos solo los restaurantes con todas las opciones dietéticas seleccionadas.\nCuando se selecciona 'O', te mostraremos los restaurantes con cualquiera de las opciones dietéticas seleccionadas.",
    },
    fr: {
        ...
        modalTitle: 'Info',
        modalDescription: "Lorsque 'ET' est sélectionné, nous vous montrerons uniquement les restaurants avec toutes les options diététiques sélectionnées.\nLorsque 'OU' est sélectionné, nous vous montrerons les restaurants avec n'importe laquelle des options diététiques sélectionnées.",
    },
    it: {
        ...
        modalDescription: "Quando è selezionato 'E', ti mostreremo solo i ristoranti con tutte le opzioni dietetiche selezionate.\nQuando è selezionato 'O', ti mostreremo i ristoranti con qualsiasi delle opzioni dietetiche selezionate.",
    },
    ru: {
