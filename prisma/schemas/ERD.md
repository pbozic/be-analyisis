...
"files" {
  ...
  String business_logo_id FK,UK "nullable"
  String business_banner_id FK,UK "nullable"
...
"payment_intent_logs" {
  String payment_intent_logs_id PK
  String stripe_id UK
  DateTime(6) created_at
}
"payments" {
...
"files" |o--o| "menu_items" : menu_item
