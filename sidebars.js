						...
						items: [
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/business/businesses/busyness/get-api-business-businesses-busyness'],
							},
							{
								type: 'category',
								label: 'ids',
					...
					},
					{
						...
						items: [
							...
							'api/api/business/business_id/get-api-business-business_id',
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/business/business_id/reviews/get-api-business-business_id-reviews'],
							},
						],
					},
					{
						...
						items: [
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/business/delivery-address/add/post-api-business-delivery-address-add'],
							},
						...
						items: [
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/business/popular/business_id/patch-api-business-popular-business_id'],
							},
						],
					},
					{
			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						collapsible: true,
						collapsed: true,
						items: ['api/api/businessUsers/business_users_id/delete-api-businessUsers-business_users_id'],
					},
					{
						type: 'category',
						label: 'company-role',
						...
						items: [
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/deliveryDrivers/earnings/all/get-api-deliveryDrivers-earnings-all'],
							},
							{
								type: 'category',
								label: 'delivery_driver_id',
						...
						items: [
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/deliveryDrivers/user/user_id/get-api-deliveryDrivers-user-user_id'],
							},
						],
					},
				],
						...
						items: [
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/drivers/business/business_id/get-api-drivers-business-business_id'],
							},
						],
					},
					{
						...
						items: [
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/finances/business/business_id/get-api-finances-business-business_id'],
							},
						],
					},
					{
					...
					},
					{
						...
						items: [
							...
							},
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/menu/daily-meals-menu/create/post-api-menu-daily-meals-menu-create'],
							},
						],
					},
					{
					...
					},
					{
						...
						items: [
							...
							},
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/menu/menu-categories/menu_id/get-api-menu-menu-categories-menu_id'],
							},
							{
								type: 'category',
								label: 'order',
							...
							},
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/menu/menu-categories/remove/patch-api-menu-menu-categories-remove'],
							},
						],
					},
					{
						...
						items: [
							...
							},
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/menu/menu-items/menu_item_id/delete-api-menu-menu-items-menu_item_id'],
							},
							{
								type: 'category',
								label: 'order',
							...
							},
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/menu/menu-items/remove-order/patch-api-menu-menu-items-remove-order'],
							},
						],
					},
					{
					...
					},
					{
						...
						items: [
							...
							},
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/merchant/reservations/create/post-api-merchant-reservations-create'],
							},
							...
							},
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/merchant/reservations/status/patch-api-merchant-reservations-status'],
							},
							{
								type: 'category',
								label: 'table',
								...
								items: [
									{
										...
										collapsible: true,
										collapsed: true,
										items: ['api/api/promo/sections/type/type/get-api-promo-sections-type-type'],
									},
								],
							},
						],
								...
								items: [
									{
										...
										collapsible: true,
										collapsed: true,
										items: ['api/api/promo/word_buy/tier/tier/get-api-promo-word_buy-tier-tier'],
									},
								],
							},
							{
								...
								items: [
									{
										...
										collapsible: true,
										collapsed: true,
										items: ['api/api/promo/word_buy/word/word/get-api-promo-word_buy-word-word'],
									},
								],
							},
						],
					...
					},
					{
						...
						items: [
							...
							},
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/taxi/order/delivery_location/post-api-taxi-order-delivery_location'],
							},
							{
								type: 'category',
								label: 'order_id',
					...
					},
					{
						...
						items: [
							...
							},
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/users/me/ads-personalization/patch-api-users-me-ads-personalization'],
							},
							{
								type: 'category',
							...
							},
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/users/me/redeem-referral-code/post-api-users-me-redeem-referral-code'],
							},
							{
								type: 'category',
								label: 'referral',
						...
						items: [
							{
								...
								collapsible: true,
								collapsed: true,
								items: ['api/api/vehicles/business/businessId/get-api-vehicles-business-businessId'],
							},
						],
					},
					{
