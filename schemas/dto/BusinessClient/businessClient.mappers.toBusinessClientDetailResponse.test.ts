 ...
 *
 * Source: schemas/dto/BusinessClient/businessClient.mappers.ts:93
 * Generated: 2025-11-21T13:06:35.769Z
 */

import { describe, it, expect } from '@jest/globals';
import { toBusinessClientDetailResponse } from './businessClient.mappers.js';
import { BusinessClientDetailResponseSchema } from './businessClient.dto.js';
...
describe('BusinessClient Mapper - toBusinessClientDetailResponse', () => {
	it('should map Prisma data to DTO and validate against schema', () => {
		...
		if (!mockData) {
			console.warn('⚠️  Mock data for "businessclientdetail" not found');
