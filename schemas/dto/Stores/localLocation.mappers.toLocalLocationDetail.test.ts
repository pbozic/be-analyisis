...
import { toLocalLocationDetail } from './localLocation.mappers.js';
import { LocalLocationDetailSchema } from './localLocation.dto.js';
...
describe('Stores Mapper - toLocalLocationDetail', () => {
	it('should map Prisma data to DTO and validate against schema', () => {
		...
		const result = toLocalLocationDetail(mockData as unknown);
