...
export const OrderLobbyBaseSchema = z
	.object({
		...
		delivery_location: z.unknown().nullable().optional().describe('JSON delivery location data'),
...
export const OrderLobbyResponseSchema = OrderLobbyBaseSchema.extend({
	...
	// Note: order_lobby_items and order_lobby_users will be imported from their respective files
}).openapi({
