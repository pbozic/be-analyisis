...
export function toDailyMealSubscriptionResponse(row: DailyMealSubscriptionWithIncludesPrisma | any): DailyMealSubscriptionResponse {
    const r = row as any;
...
export function toDailyMealSubscriptionList(rows: (DailyMealSubscriptionWithIncludesPrisma | any)[]): DailyMealSubscriptionResponse[] {
