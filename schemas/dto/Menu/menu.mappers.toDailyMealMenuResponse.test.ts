...
import { toDailyMealMenuResponse } from './menu.mappers.js';
import { DailyMealMenuBaseSchema } from './menu.dto.js';
import { mockPrismaData } from '../../../tests/integration/mock-prisma.js';

describe('Menu Mapper - toDailyMealMenuResponse', () => {
	it('should map Prisma data to DTO and validate against schema', () => {
		// Get mock data
		const mockData = mockPrismaData.dailymealmenupayload;

		if (!mockData) {
			console.warn('⚠️  Mock data for "dailymealmenupayload" not found');
		...
		const result = toDailyMealMenuResponse(mockData as DailyMealMenuPayload);
