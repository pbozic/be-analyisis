...
import { toDailyMealCategoryPriceBase } from './dailyMealCategory.mappers.js';
import { DailyMealCategoryPriceBaseSchema } from './dailyMealCategory.js';
...
describe('DailyMealCategory Mapper - toDailyMealCategoryPriceBase', () => {
	it('should map Prisma data to DTO and validate against schema', () => {
		...
		const result = toDailyMealCategoryPriceBase(mockData as unknown);
