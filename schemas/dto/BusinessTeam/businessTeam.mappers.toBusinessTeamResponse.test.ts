 ...
 * Generated: 2025-11-21T13:06:35.770Z
 */

import { describe, it, expect } from '@jest/globals';
import { toBusinessTeamResponse } from './businessTeam.mappers.js';
import { BusinessTeamResponseSchema } from './businessTeam.dto.js';
import { mockPrismaData } from '../../../tests/integration/mock-prisma.js';

describe('BusinessTeam Mapper - toBusinessTeamResponse', () => {
	it('should map Prisma data to DTO and validate against schema', () => {
		// Get mock data
		const mockData = mockPrismaData.businessteamdefault;

		if (!mockData) {
			console.warn('⚠️  Mock data for "businessteamdefault" not found');
