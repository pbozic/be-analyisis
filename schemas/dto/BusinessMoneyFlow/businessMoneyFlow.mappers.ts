...
export function toBusinessMoneyFlowResponse(row: BusinessMoneyFlowWithBusinessPrisma | BusinessMoneyFlowDefaultPrisma): BusinessMoneyFlowResponse {
    const r = row as any;
...
export function toBusinessMoneyFlowsList(rows: Array<BusinessMoneyFlowWithBusinessPrisma | BusinessMoneyFlowDefaultPrisma>): BusinessMoneyFlowResponse[] {
