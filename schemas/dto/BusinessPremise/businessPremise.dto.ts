...
// Request schemas moved to businessPremise.validators.ts
...
export function registerSchemas(registry: OpenAPIRegistry) {
	...
	// Request schemas registered in businessPremise.validators.ts
...
export const registerBusinessPremiseSchemas = registerSchemas;
