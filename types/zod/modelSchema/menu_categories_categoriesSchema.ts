...
export type menu_categories_categoriesWithRelations = z.infer<typeof menu_categories_categoriesSchema> &
	menu_categories_categoriesRelations;

export const menu_categories_categoriesWithRelationsSchema: z.ZodType<menu_categories_categoriesWithRelations> =
	menu_categories_categoriesSchema.merge(
		z.object({
