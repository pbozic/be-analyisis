...
export type wallet_transfer_historyWithRelations = z.infer<typeof wallet_transfer_historySchema> & wallet_transfer_historyRelations

export const wallet_transfer_historyWithRelationsSchema: z.ZodType<wallet_transfer_historyWithRelations> = wallet_transfer_historySchema.merge(z.object({
