...
export type driver_municipalitiesWithRelations = z.infer<typeof driver_municipalitiesSchema> & driver_municipalitiesRelations

export const driver_municipalitiesWithRelationsSchema: z.ZodType<driver_municipalitiesWithRelations> = driver_municipalitiesSchema.merge(z.object({
