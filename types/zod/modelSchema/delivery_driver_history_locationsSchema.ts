...
export type delivery_driver_history_locationsWithRelations = Omit<z.infer<typeof delivery_driver_history_locationsSchema>, "location"> & {
  location?: JsonValueType | null;
} & delivery_driver_history_locationsRelations

export const delivery_driver_history_locationsWithRelationsSchema: z.ZodType<delivery_driver_history_locationsWithRelations> = delivery_driver_history_locationsSchema.merge(z.object({
