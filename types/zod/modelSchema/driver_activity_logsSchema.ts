...
export type driver_activity_logsWithRelations = z.infer<typeof driver_activity_logsSchema> &
	driver_activity_logsRelations;

export const driver_activity_logsWithRelationsSchema: z.ZodType<driver_activity_logsWithRelations> =
	driver_activity_logsSchema.merge(
		z.object({
