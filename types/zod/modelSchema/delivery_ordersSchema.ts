...
export type delivery_ordersWithRelations = Omit<z.infer<typeof delivery_ordersSchema>, "payment" | "estimates" | "details" | "courier_instructions" | "restaurant_message" | "scheduled" | "flags"> & {
...
export const delivery_ordersWithRelationsSchema: z.ZodType<delivery_ordersWithRelations> = delivery_ordersSchema.merge(z.object({
