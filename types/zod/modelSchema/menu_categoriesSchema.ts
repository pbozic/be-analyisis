...
export type menu_categoriesWithRelations = Omit<
	z.infer<typeof menu_categoriesSchema>,
	'names' | 'description' | 'menu_items_ordered'
> & {
...
export const menu_categoriesWithRelationsSchema: z.ZodType<menu_categoriesWithRelations> = menu_categoriesSchema.merge(
	z.object({
