...
export type delivery_driversWithRelations = Omit<
	z.infer<typeof delivery_driversSchema>,
	'working_hours' | 'location' | 'delivery_timeline' | 'scheduled_meals_route'
> & {
...
export const delivery_driversWithRelationsSchema: z.ZodType<delivery_driversWithRelations> =
	delivery_driversSchema.merge(
		z.object({
			...
			delivery_driver_history_locations: z
				.lazy(() => delivery_driver_history_locationsWithRelationsSchema)
				.array(),
