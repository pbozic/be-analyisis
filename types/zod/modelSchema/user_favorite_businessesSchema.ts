...
export type user_favorite_businessesWithRelations = z.infer<typeof user_favorite_businessesSchema> &
	user_favorite_businessesRelations;

export const user_favorite_businessesWithRelationsSchema: z.ZodType<user_favorite_businessesWithRelations> =
	user_favorite_businessesSchema.merge(
		z.object({
