...
export type daily_meals_subscriptionsWithRelations = z.infer<typeof daily_meals_subscriptionsSchema> & daily_meals_subscriptionsRelations

export const daily_meals_subscriptionsWithRelationsSchema: z.ZodType<daily_meals_subscriptionsWithRelations> = daily_meals_subscriptionsSchema.merge(z.object({
