...
export type taxi_ordersWithRelations = Omit<
	z.infer<typeof taxi_ordersSchema>,
	'delivery_location' | 'payment' | 'estimates' | 'preferences' | 'flags' | 'cargo_preferences'
> & {
...
export const taxi_ordersWithRelationsSchema: z.ZodType<taxi_ordersWithRelations> = taxi_ordersSchema.merge(
	z.object({
