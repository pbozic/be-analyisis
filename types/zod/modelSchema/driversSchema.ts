...
export type driversWithRelations = Omit<
	z.infer<typeof driversSchema>,
	'working_hours' | 'ride_requirements' | 'location' | 'delivery_timeline' | 'transfer_requirements'
> & {
...
export const driversWithRelationsSchema: z.ZodType<driversWithRelations> = driversSchema.merge(
	z.object({
