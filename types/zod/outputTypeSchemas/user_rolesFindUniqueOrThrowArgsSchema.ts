...
export const user_rolesFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.user_rolesFindUniqueOrThrowArgs> = z.object({
  select: user_rolesSelectSchema.optional(),
  include: user_rolesIncludeSchema.optional(),
  where: user_rolesWhereUniqueInputSchema,
}).strict() ;

export default user_rolesFindUniqueOrThrowArgsSchema;
