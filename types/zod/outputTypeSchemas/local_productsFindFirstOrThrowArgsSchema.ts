...
export const local_productsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.local_productsFindFirstOrThrowArgs> = z
	.object({
		...
		distinct: z
			.union([Local_productsScalarFieldEnumSchema, Local_productsScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();

export default local_productsFindFirstOrThrowArgsSchema;
