...
export const driver_municipalitiesFindFirstOrThrowArgsSchema: z.ZodType<Prisma.driver_municipalitiesFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ Driver_municipalitiesScalarFieldEnumSchema,Driver_municipalitiesScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default driver_municipalitiesFindFirstOrThrowArgsSchema;
