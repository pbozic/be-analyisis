...
export const user_addressGroupByArgsSchema: z.ZodType<Prisma.user_addressGroupByArgs> = z
	.object({
		where: user_addressWhereInputSchema.optional(),
		orderBy: z
			.union([
				user_addressOrderByWithAggregationInputSchema.array(),
				user_addressOrderByWithAggregationInputSchema,
			])
			.optional(),
