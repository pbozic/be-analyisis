...
export const allowancesGroupByArgsSchema: z.ZodType<Prisma.allowancesGroupByArgs> = z.object({
  where: allowancesWhereInputSchema.optional(),
  orderBy: z.union([ allowancesOrderByWithAggregationInputSchema.array(),allowancesOrderByWithAggregationInputSchema ]).optional(),
