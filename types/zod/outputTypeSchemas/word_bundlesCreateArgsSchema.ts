...
export const word_bundlesCreateArgsSchema: z.ZodType<Prisma.word_bundlesCreateArgs> = z.object({
  select: word_bundlesSelectSchema.optional(),
  include: word_bundlesIncludeSchema.optional(),
  data: z.union([ word_bundlesCreateInputSchema,word_bundlesUncheckedCreateInputSchema ]),
}).strict() ;

export default word_bundlesCreateArgsSchema;
