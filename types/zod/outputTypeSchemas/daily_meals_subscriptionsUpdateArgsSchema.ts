...
export const daily_meals_subscriptionsUpdateArgsSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpdateArgs> = z.object({
  select: daily_meals_subscriptionsSelectSchema.optional(),
  include: daily_meals_subscriptionsIncludeSchema.optional(),
  data: z.union([ daily_meals_subscriptionsUpdateInputSchema,daily_meals_subscriptionsUncheckedUpdateInputSchema ]),
  where: daily_meals_subscriptionsWhereUniqueInputSchema,
}).strict() ;

export default daily_meals_subscriptionsUpdateArgsSchema;
