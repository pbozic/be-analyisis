...
export const driver_activity_settingsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.driver_activity_settingsFindUniqueOrThrowArgs> = z.object({
  select: driver_activity_settingsSelectSchema.optional(),
  where: driver_activity_settingsWhereUniqueInputSchema,
}).strict() ;

export default driver_activity_settingsFindUniqueOrThrowArgsSchema;
