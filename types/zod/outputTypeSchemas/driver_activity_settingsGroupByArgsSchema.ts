...
export const driver_activity_settingsGroupByArgsSchema: z.ZodType<Prisma.driver_activity_settingsGroupByArgs> = z.object({
  where: driver_activity_settingsWhereInputSchema.optional(),
  orderBy: z.union([ driver_activity_settingsOrderByWithAggregationInputSchema.array(),driver_activity_settingsOrderByWithAggregationInputSchema ]).optional(),
