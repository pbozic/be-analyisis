...
export const daily_meals_subscriptionsGroupByArgsSchema: z.ZodType<Prisma.daily_meals_subscriptionsGroupByArgs> = z
	.object({
		where: daily_meals_subscriptionsWhereInputSchema.optional(),
		orderBy: z
			.union([
				daily_meals_subscriptionsOrderByWithAggregationInputSchema.array(),
				daily_meals_subscriptionsOrderByWithAggregationInputSchema,
			])
			.optional(),
