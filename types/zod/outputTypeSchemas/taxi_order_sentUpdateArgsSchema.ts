...
export const taxi_order_sentUpdateArgsSchema: z.ZodType<Prisma.taxi_order_sentUpdateArgs> = z.object({
  select: taxi_order_sentSelectSchema.optional(),
  include: taxi_order_sentIncludeSchema.optional(),
  data: z.union([ taxi_order_sentUpdateInputSchema,taxi_order_sentUncheckedUpdateInputSchema ]),
  where: taxi_order_sentWhereUniqueInputSchema,
}).strict() ;

export default taxi_order_sentUpdateArgsSchema;
