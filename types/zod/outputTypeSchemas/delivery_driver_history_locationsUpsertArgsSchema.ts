...
export const delivery_driver_history_locationsUpsertArgsSchema: z.ZodType<Prisma.delivery_driver_history_locationsUpsertArgs> = z.object({
  ...
  create: z.union([ delivery_driver_history_locationsCreateInputSchema,delivery_driver_history_locationsUncheckedCreateInputSchema ]),
  update: z.union([ delivery_driver_history_locationsUpdateInputSchema,delivery_driver_history_locationsUncheckedUpdateInputSchema ]),
}).strict() ;
