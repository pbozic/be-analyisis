...
export const daily_meals_subscriptionsUpsertArgsSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpsertArgs> = z
	.object({
		...
		create: z.union([
			daily_meals_subscriptionsCreateInputSchema,
			daily_meals_subscriptionsUncheckedCreateInputSchema,
		]),
		update: z.union([
			daily_meals_subscriptionsUpdateInputSchema,
			daily_meals_subscriptionsUncheckedUpdateInputSchema,
		]),
	})
	.strict();
