...
export const taxi_ordersGroupByArgsSchema: z.ZodType<Prisma.taxi_ordersGroupByArgs> = z
	.object({
		where: taxi_ordersWhereInputSchema.optional(),
		orderBy: z
			.union([taxi_ordersOrderByWithAggregationInputSchema.array(), taxi_ordersOrderByWithAggregationInputSchema])
			.optional(),
