...
export const user_favorite_businessesUpsertArgsSchema: z.ZodType<Prisma.user_favorite_businessesUpsertArgs> = z
	.object({
		...
		create: z.union([
			user_favorite_businessesCreateInputSchema,
			user_favorite_businessesUncheckedCreateInputSchema,
		]),
		update: z.union([
			user_favorite_businessesUpdateInputSchema,
			user_favorite_businessesUncheckedUpdateInputSchema,
		]),
	})
	.strict();
