...
export const taxi_ordersFindFirstOrThrowArgsSchema: z.ZodType<Prisma.taxi_ordersFindFirstOrThrowArgs> = z
	.object({
		...
		orderBy: z
			.union([taxi_ordersOrderByWithRelationInputSchema.array(), taxi_ordersOrderByWithRelationInputSchema])
			.optional(),
