...
export const taxi_ordersFindFirstOrThrowArgsSchema: z.ZodType<Prisma.taxi_ordersFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ Taxi_ordersScalarFieldEnumSchema,Taxi_ordersScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default taxi_ordersFindFirstOrThrowArgsSchema;
