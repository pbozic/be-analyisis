...
export const weather_dataGroupByArgsSchema: z.ZodType<Prisma.weather_dataGroupByArgs> = z
	.object({
		where: weather_dataWhereInputSchema.optional(),
		orderBy: z
			.union([
				weather_dataOrderByWithAggregationInputSchema.array(),
				weather_dataOrderByWithAggregationInputSchema,
			])
			.optional(),
