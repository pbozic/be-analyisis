...
export const weather_dataFindFirstOrThrowArgsSchema: z.ZodType<Prisma.weather_dataFindFirstOrThrowArgs> = z.object({
...
export default weather_dataFindFirstOrThrowArgsSchema;
