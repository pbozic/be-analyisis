...
export const driversFindFirstOrThrowArgsSchema: z.ZodType<Prisma.driversFindFirstOrThrowArgs> = z.object({
  select: driversSelectSchema.optional(),
  include: driversIncludeSchema.optional(),
  where: driversWhereInputSchema.optional(),
  orderBy: z.union([ driversOrderByWithRelationInputSchema.array(),driversOrderByWithRelationInputSchema ]).optional(),
  cursor: driversWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ DriversScalarFieldEnumSchema,DriversScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default driversFindFirstOrThrowArgsSchema;
