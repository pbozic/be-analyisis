...
export const local_pricesFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.local_pricesFindUniqueOrThrowArgs> = z.object({
...
export default local_pricesFindUniqueOrThrowArgsSchema;
