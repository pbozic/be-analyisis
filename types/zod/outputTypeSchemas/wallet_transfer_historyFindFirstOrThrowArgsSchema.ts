...
export const wallet_transfer_historyFindFirstOrThrowArgsSchema: z.ZodType<Prisma.wallet_transfer_historyFindFirstOrThrowArgs> =
	z
		.object({
			...
			distinct: z
				.union([
					Wallet_transfer_historyScalarFieldEnumSchema,
					Wallet_transfer_historyScalarFieldEnumSchema.array(),
				])
				.optional(),
		})
		.strict();
