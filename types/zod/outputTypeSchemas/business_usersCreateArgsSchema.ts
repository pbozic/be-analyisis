...
export const business_usersCreateArgsSchema: z.ZodType<Prisma.business_usersCreateArgs> = z.object({
  select: business_usersSelectSchema.optional(),
  include: business_usersIncludeSchema.optional(),
  data: z.union([ business_usersCreateInputSchema,business_usersUncheckedCreateInputSchema ]),
}).strict() ;

export default business_usersCreateArgsSchema;
