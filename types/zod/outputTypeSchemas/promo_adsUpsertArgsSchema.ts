...
import { promo_adsCreateInputSchema } from '../inputTypeSchemas/promo_adsCreateInputSchema'
import { promo_adsUncheckedCreateInputSchema } from '../inputTypeSchemas/promo_adsUncheckedCreateInputSchema'
import { promo_adsUpdateInputSchema } from '../inputTypeSchemas/promo_adsUpdateInputSchema'
import { promo_adsUncheckedUpdateInputSchema } from '../inputTypeSchemas/promo_adsUncheckedUpdateInputSchema'
...
export const promo_adsUpsertArgsSchema: z.ZodType<Prisma.promo_adsUpsertArgs> = z.object({
  select: promo_adsSelectSchema.optional(),
  include: promo_adsIncludeSchema.optional(),
  where: promo_adsWhereUniqueInputSchema,
  create: z.union([ promo_adsCreateInputSchema,promo_adsUncheckedCreateInputSchema ]),
  update: z.union([ promo_adsUpdateInputSchema,promo_adsUncheckedUpdateInputSchema ]),
}).strict() ;

export default promo_adsUpsertArgsSchema;
