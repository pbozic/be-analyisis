...
export const municipalitiesFindFirstOrThrowArgsSchema: z.ZodType<Prisma.municipalitiesFindFirstOrThrowArgs> = z
	.object({
		...
		orderBy: z
			.union([municipalitiesOrderByWithRelationInputSchema.array(), municipalitiesOrderByWithRelationInputSchema])
			.optional(),
		cursor: municipalitiesWhereUniqueInputSchema.optional(),
		take: z.number().optional(),
		skip: z.number().optional(),
		distinct: z
			.union([MunicipalitiesScalarFieldEnumSchema, MunicipalitiesScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();

export default municipalitiesFindFirstOrThrowArgsSchema;
