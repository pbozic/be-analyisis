...
export const municipalitiesFindFirstOrThrowArgsSchema: z.ZodType<Prisma.municipalitiesFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ MunicipalitiesScalarFieldEnumSchema,MunicipalitiesScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;
