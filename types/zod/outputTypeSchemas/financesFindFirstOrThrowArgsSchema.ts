...
export const financesFindFirstOrThrowArgsSchema: z.ZodType<Prisma.financesFindFirstOrThrowArgs> = z.object({
  select: financesSelectSchema.optional(),
  include: financesIncludeSchema.optional(),
  where: financesWhereInputSchema.optional(),
  orderBy: z.union([ financesOrderByWithRelationInputSchema.array(),financesOrderByWithRelationInputSchema ]).optional(),
...
export default financesFindFirstOrThrowArgsSchema;
