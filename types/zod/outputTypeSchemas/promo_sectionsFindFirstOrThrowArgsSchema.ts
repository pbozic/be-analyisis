...
export const promo_sectionsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.promo_sectionsFindFirstOrThrowArgs> = z
	.object({
		...
		orderBy: z
			.union([promo_sectionsOrderByWithRelationInputSchema.array(), promo_sectionsOrderByWithRelationInputSchema])
			.optional(),
		cursor: promo_sectionsWhereUniqueInputSchema.optional(),
		take: z.number().optional(),
		skip: z.number().optional(),
		distinct: z
			.union([Promo_sectionsScalarFieldEnumSchema, Promo_sectionsScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();

export default promo_sectionsFindFirstOrThrowArgsSchema;
