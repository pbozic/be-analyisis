...
export const business_usersCreateManyArgsSchema: z.ZodType<Prisma.business_usersCreateManyArgs> = z.object({
  data: z.union([ business_usersCreateManyInputSchema,business_usersCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default business_usersCreateManyArgsSchema;
