...
export const local_pricesGroupByArgsSchema: z.ZodType<Prisma.local_pricesGroupByArgs> = z.object({
  where: local_pricesWhereInputSchema.optional(),
  orderBy: z.union([ local_pricesOrderByWithAggregationInputSchema.array(),local_pricesOrderByWithAggregationInputSchema ]).optional(),
