...
export const delivery_order_sentUpdateArgsSchema: z.ZodType<Prisma.delivery_order_sentUpdateArgs> = z.object({
  select: delivery_order_sentSelectSchema.optional(),
  include: delivery_order_sentIncludeSchema.optional(),
  data: z.union([ delivery_order_sentUpdateInputSchema,delivery_order_sentUncheckedUpdateInputSchema ]),
  where: delivery_order_sentWhereUniqueInputSchema,
}).strict() ;

export default delivery_order_sentUpdateArgsSchema;
