...
export const referralsFindFirstArgsSchema: z.ZodType<Prisma.referralsFindFirstArgs> = z.object({
  select: referralsSelectSchema.optional(),
  include: referralsIncludeSchema.optional(),
  where: referralsWhereInputSchema.optional(),
  orderBy: z.union([ referralsOrderByWithRelationInputSchema.array(),referralsOrderByWithRelationInputSchema ]).optional(),
...
export default referralsFindFirstArgsSchema;
