...
export const word_bundlesUpdateArgsSchema: z.ZodType<Prisma.word_bundlesUpdateArgs> = z.object({
  select: word_bundlesSelectSchema.optional(),
  include: word_bundlesIncludeSchema.optional(),
  data: z.union([ word_bundlesUpdateInputSchema,word_bundlesUncheckedUpdateInputSchema ]),
  where: word_bundlesWhereUniqueInputSchema,
}).strict() ;

export default word_bundlesUpdateArgsSchema;
