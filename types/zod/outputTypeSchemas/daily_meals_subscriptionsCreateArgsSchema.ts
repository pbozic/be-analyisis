...
export const daily_meals_subscriptionsCreateArgsSchema: z.ZodType<Prisma.daily_meals_subscriptionsCreateArgs> = z.object({
  select: daily_meals_subscriptionsSelectSchema.optional(),
  include: daily_meals_subscriptionsIncludeSchema.optional(),
  data: z.union([ daily_meals_subscriptionsCreateInputSchema,daily_meals_subscriptionsUncheckedCreateInputSchema ]),
}).strict() ;

export default daily_meals_subscriptionsCreateArgsSchema;
