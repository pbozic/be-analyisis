...
export const reviewableUpsertArgsSchema: z.ZodType<Prisma.reviewableUpsertArgs> = z.object({
  select: reviewableSelectSchema.optional(),
  include: reviewableIncludeSchema.optional(),
  where: reviewableWhereUniqueInputSchema,
  create: z.union([ reviewableCreateInputSchema,reviewableUncheckedCreateInputSchema ]),
  update: z.union([ reviewableUpdateInputSchema,reviewableUncheckedUpdateInputSchema ]),
}).strict() ;

export default reviewableUpsertArgsSchema;
