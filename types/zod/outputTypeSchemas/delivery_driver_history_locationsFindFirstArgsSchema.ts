...
export const delivery_driver_history_locationsFindFirstArgsSchema: z.ZodType<Prisma.delivery_driver_history_locationsFindFirstArgs> = z.object({
  ...
  distinct: z.union([ Delivery_driver_history_locationsScalarFieldEnumSchema,Delivery_driver_history_locationsScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default delivery_driver_history_locationsFindFirstArgsSchema;
