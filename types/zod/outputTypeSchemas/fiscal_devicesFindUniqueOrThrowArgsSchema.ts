...
export const fiscal_devicesFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.fiscal_devicesFindUniqueOrThrowArgs> = z.object({
...
export default fiscal_devicesFindUniqueOrThrowArgsSchema;
