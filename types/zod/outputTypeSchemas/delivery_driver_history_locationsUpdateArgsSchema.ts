...
export const delivery_driver_history_locationsUpdateArgsSchema: z.ZodType<Prisma.delivery_driver_history_locationsUpdateArgs> = z.object({
  ...
  data: z.union([ delivery_driver_history_locationsUpdateInputSchema,delivery_driver_history_locationsUncheckedUpdateInputSchema ]),
  where: delivery_driver_history_locationsWhereUniqueInputSchema,
}).strict() ;

export default delivery_driver_history_locationsUpdateArgsSchema;
