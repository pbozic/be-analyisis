...
export const business_usersGroupByArgsSchema: z.ZodType<Prisma.business_usersGroupByArgs> = z.object({
  where: business_usersWhereInputSchema.optional(),
  orderBy: z.union([ business_usersOrderByWithAggregationInputSchema.array(),business_usersOrderByWithAggregationInputSchema ]).optional(),
