...
export const promo_ads_categoryUpdateManyArgsSchema: z.ZodType<Prisma.promo_ads_categoryUpdateManyArgs> = z
	.object({
		data: z.union([
			promo_ads_categoryUpdateManyMutationInputSchema,
			promo_ads_categoryUncheckedUpdateManyInputSchema,
		]),
