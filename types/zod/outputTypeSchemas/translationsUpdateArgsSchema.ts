...
export const translationsUpdateArgsSchema: z.ZodType<Prisma.translationsUpdateArgs> = z.object({
  select: translationsSelectSchema.optional(),
  include: translationsIncludeSchema.optional(),
  data: z.union([ translationsUpdateInputSchema,translationsUncheckedUpdateInputSchema ]),
  where: translationsWhereUniqueInputSchema,
}).strict() ;

export default translationsUpdateArgsSchema;
