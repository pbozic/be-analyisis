...
export const word_buyCreateArgsSchema: z.ZodType<Prisma.word_buyCreateArgs> = z.object({
  select: word_buySelectSchema.optional(),
  include: word_buyIncludeSchema.optional(),
  data: z.union([ word_buyCreateInputSchema,word_buyUncheckedCreateInputSchema ]),
}).strict() ;

export default word_buyCreateArgsSchema;
