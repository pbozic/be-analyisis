...
export const vehicle_driversFindFirstOrThrowArgsSchema: z.ZodType<Prisma.vehicle_driversFindFirstOrThrowArgs> = z
	.object({
		...
		distinct: z
			.union([Vehicle_driversScalarFieldEnumSchema, Vehicle_driversScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();

export default vehicle_driversFindFirstOrThrowArgsSchema;
