...
export const wordsGroupByArgsSchema: z.ZodType<Prisma.wordsGroupByArgs> = z
	.object({
		where: wordsWhereInputSchema.optional(),
		orderBy: z
			.union([wordsOrderByWithAggregationInputSchema.array(), wordsOrderByWithAggregationInputSchema])
			.optional(),
