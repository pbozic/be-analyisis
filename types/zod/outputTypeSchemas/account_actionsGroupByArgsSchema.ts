...
export const account_actionsGroupByArgsSchema: z.ZodType<Prisma.account_actionsGroupByArgs> = z
	.object({
		where: account_actionsWhereInputSchema.optional(),
		orderBy: z
			.union([
				account_actionsOrderByWithAggregationInputSchema.array(),
				account_actionsOrderByWithAggregationInputSchema,
			])
			.optional(),
