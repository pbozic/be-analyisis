...
export const translatableGroupByArgsSchema: z.ZodType<Prisma.translatableGroupByArgs> = z
	.object({
		where: translatableWhereInputSchema.optional(),
		orderBy: z
			.union([
				translatableOrderByWithAggregationInputSchema.array(),
				translatableOrderByWithAggregationInputSchema,
			])
			.optional(),
