...
import { order_lobby_itemsUpdateInputSchema } from '../inputTypeSchemas/order_lobby_itemsUpdateInputSchema'
import { order_lobby_itemsUncheckedUpdateInputSchema } from '../inputTypeSchemas/order_lobby_itemsUncheckedUpdateInputSchema'
...
export const order_lobby_itemsUpsertArgsSchema: z.ZodType<Prisma.order_lobby_itemsUpsertArgs> = z.object({
  ...
  create: z.union([ order_lobby_itemsCreateInputSchema,order_lobby_itemsUncheckedCreateInputSchema ]),
  update: z.union([ order_lobby_itemsUpdateInputSchema,order_lobby_itemsUncheckedUpdateInputSchema ]),
}).strict() ;

export default order_lobby_itemsUpsertArgsSchema;
