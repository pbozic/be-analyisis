...
export const promo_adsUpdateArgsSchema: z.ZodType<Prisma.promo_adsUpdateArgs> = z.object({
  select: promo_adsSelectSchema.optional(),
  include: promo_adsIncludeSchema.optional(),
  data: z.union([ promo_adsUpdateInputSchema,promo_adsUncheckedUpdateInputSchema ]),
  where: promo_adsWhereUniqueInputSchema,
}).strict() ;

export default promo_adsUpdateArgsSchema;
