...
export const cashbackFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.cashbackFindUniqueOrThrowArgs> = z.object({
  select: cashbackSelectSchema.optional(),
  include: cashbackIncludeSchema.optional(),
  where: cashbackWhereUniqueInputSchema,
}).strict() ;

export default cashbackFindUniqueOrThrowArgsSchema;
