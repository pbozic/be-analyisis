...
export const group_usersGroupByArgsSchema: z.ZodType<Prisma.group_usersGroupByArgs> = z.object({
  where: group_usersWhereInputSchema.optional(),
  orderBy: z.union([ group_usersOrderByWithAggregationInputSchema.array(),group_usersOrderByWithAggregationInputSchema ]).optional(),
