...
export const scoring_pointsCreateManyAndReturnArgsSchema: z.ZodType<Prisma.scoring_pointsCreateManyAndReturnArgs> = z.object({
  data: z.union([ scoring_pointsCreateManyInputSchema,scoring_pointsCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default scoring_pointsCreateManyAndReturnArgsSchema;
