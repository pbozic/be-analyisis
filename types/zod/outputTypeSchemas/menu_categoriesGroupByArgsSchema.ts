...
export const menu_categoriesGroupByArgsSchema: z.ZodType<Prisma.menu_categoriesGroupByArgs> = z
	.object({
		where: menu_categoriesWhereInputSchema.optional(),
		orderBy: z
			.union([
				menu_categoriesOrderByWithAggregationInputSchema.array(),
				menu_categoriesOrderByWithAggregationInputSchema,
			])
			.optional(),
