...
export const fiscal_devicesUpdateArgsSchema: z.ZodType<Prisma.fiscal_devicesUpdateArgs> = z.object({
  select: fiscal_devicesSelectSchema.optional(),
  include: fiscal_devicesIncludeSchema.optional(),
  data: z.union([ fiscal_devicesUpdateInputSchema,fiscal_devicesUncheckedUpdateInputSchema ]),
  where: fiscal_devicesWhereUniqueInputSchema,
}).strict() ;

export default fiscal_devicesUpdateArgsSchema;
