...
export const business_usersFindFirstArgsSchema: z.ZodType<Prisma.business_usersFindFirstArgs> = z
	.object({
		...
		orderBy: z
			.union([business_usersOrderByWithRelationInputSchema.array(), business_usersOrderByWithRelationInputSchema])
			.optional(),
		cursor: business_usersWhereUniqueInputSchema.optional(),
		take: z.number().optional(),
		skip: z.number().optional(),
		distinct: z
			.union([Business_usersScalarFieldEnumSchema, Business_usersScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();

export default business_usersFindFirstArgsSchema;
