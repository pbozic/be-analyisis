...
export const referralsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.referralsFindUniqueOrThrowArgs> = z.object({
  select: referralsSelectSchema.optional(),
  include: referralsIncludeSchema.optional(),
  where: referralsWhereUniqueInputSchema,
}).strict() ;

export default referralsFindUniqueOrThrowArgsSchema;
