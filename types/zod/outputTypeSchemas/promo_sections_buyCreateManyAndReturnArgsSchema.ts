...
export const promo_sections_buyCreateManyAndReturnArgsSchema: z.ZodType<Prisma.promo_sections_buyCreateManyAndReturnArgs> = z.object({
  data: z.union([ promo_sections_buyCreateManyInputSchema,promo_sections_buyCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default promo_sections_buyCreateManyAndReturnArgsSchema;
