...
export const allowancesUpdateArgsSchema: z.ZodType<Prisma.allowancesUpdateArgs> = z
	.object({
		select: allowancesSelectSchema.optional(),
		include: allowancesIncludeSchema.optional(),
		data: z.union([allowancesUpdateInputSchema, allowancesUncheckedUpdateInputSchema]),
		where: allowancesWhereUniqueInputSchema,
	})
	.strict();

export default allowancesUpdateArgsSchema;
