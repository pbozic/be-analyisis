...
export const business_teamsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.business_teamsFindFirstOrThrowArgs> = z
	.object({
		...
		orderBy: z
			.union([business_teamsOrderByWithRelationInputSchema.array(), business_teamsOrderByWithRelationInputSchema])
			.optional(),
		cursor: business_teamsWhereUniqueInputSchema.optional(),
		take: z.number().optional(),
		skip: z.number().optional(),
		distinct: z
			.union([Business_teamsScalarFieldEnumSchema, Business_teamsScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();

export default business_teamsFindFirstOrThrowArgsSchema;
