...
export const delivery_ordersUpdateArgsSchema: z.ZodType<Prisma.delivery_ordersUpdateArgs> = z.object({
  select: delivery_ordersSelectSchema.optional(),
  include: delivery_ordersIncludeSchema.optional(),
  data: z.union([ delivery_ordersUpdateInputSchema,delivery_ordersUncheckedUpdateInputSchema ]),
  where: delivery_ordersWhereUniqueInputSchema,
}).strict() ;

export default delivery_ordersUpdateArgsSchema;
