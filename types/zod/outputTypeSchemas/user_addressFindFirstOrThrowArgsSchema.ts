...
export const user_addressFindFirstOrThrowArgsSchema: z.ZodType<Prisma.user_addressFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ user_addressOrderByWithRelationInputSchema.array(),user_addressOrderByWithRelationInputSchema ]).optional(),
...
export default user_addressFindFirstOrThrowArgsSchema;
