...
export const order_lobby_itemsCreateManyAndReturnArgsSchema: z.ZodType<Prisma.order_lobby_itemsCreateManyAndReturnArgs> = z.object({
  data: z.union([ order_lobby_itemsCreateManyInputSchema,order_lobby_itemsCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default order_lobby_itemsCreateManyAndReturnArgsSchema;
