...
export const cashbackCreateManyAndReturnArgsSchema: z.ZodType<Prisma.cashbackCreateManyAndReturnArgs> = z.object({
  data: z.union([ cashbackCreateManyInputSchema,cashbackCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default cashbackCreateManyAndReturnArgsSchema;
