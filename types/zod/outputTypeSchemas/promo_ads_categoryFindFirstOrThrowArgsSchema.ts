...
export const promo_ads_categoryFindFirstOrThrowArgsSchema: z.ZodType<Prisma.promo_ads_categoryFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ promo_ads_categoryOrderByWithRelationInputSchema.array(),promo_ads_categoryOrderByWithRelationInputSchema ]).optional(),
  cursor: promo_ads_categoryWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ Promo_ads_categoryScalarFieldEnumSchema,Promo_ads_categoryScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default promo_ads_categoryFindFirstOrThrowArgsSchema;
