...
import { delivery_order_sentCreateInputSchema } from '../inputTypeSchemas/delivery_order_sentCreateInputSchema'
import { delivery_order_sentUncheckedCreateInputSchema } from '../inputTypeSchemas/delivery_order_sentUncheckedCreateInputSchema'
import { delivery_order_sentUpdateInputSchema } from '../inputTypeSchemas/delivery_order_sentUpdateInputSchema'
import { delivery_order_sentUncheckedUpdateInputSchema } from '../inputTypeSchemas/delivery_order_sentUncheckedUpdateInputSchema'
...
export const delivery_order_sentUpsertArgsSchema: z.ZodType<Prisma.delivery_order_sentUpsertArgs> = z.object({
  select: delivery_order_sentSelectSchema.optional(),
  include: delivery_order_sentIncludeSchema.optional(),
  where: delivery_order_sentWhereUniqueInputSchema,
  create: z.union([ delivery_order_sentCreateInputSchema,delivery_order_sentUncheckedCreateInputSchema ]),
  update: z.union([ delivery_order_sentUpdateInputSchema,delivery_order_sentUncheckedUpdateInputSchema ]),
}).strict() ;

export default delivery_order_sentUpsertArgsSchema;
