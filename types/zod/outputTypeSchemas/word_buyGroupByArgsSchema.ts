...
export const word_buyGroupByArgsSchema: z.ZodType<Prisma.word_buyGroupByArgs> = z.object({
  where: word_buyWhereInputSchema.optional(),
  orderBy: z.union([ word_buyOrderByWithAggregationInputSchema.array(),word_buyOrderByWithAggregationInputSchema ]).optional(),
