...
export const delivery_order_sentCreateArgsSchema: z.ZodType<Prisma.delivery_order_sentCreateArgs> = z.object({
  select: delivery_order_sentSelectSchema.optional(),
  include: delivery_order_sentIncludeSchema.optional(),
  data: z.union([ delivery_order_sentCreateInputSchema,delivery_order_sentUncheckedCreateInputSchema ]),
}).strict() ;

export default delivery_order_sentCreateArgsSchema;
