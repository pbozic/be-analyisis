...
export const driver_activity_settingsDeleteArgsSchema: z.ZodType<Prisma.driver_activity_settingsDeleteArgs> = z.object({
  select: driver_activity_settingsSelectSchema.optional(),
  where: driver_activity_settingsWhereUniqueInputSchema,
}).strict() ;

export default driver_activity_settingsDeleteArgsSchema;
