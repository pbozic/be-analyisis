...
export const promo_adsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.promo_adsFindUniqueOrThrowArgs> = z.object({
  select: promo_adsSelectSchema.optional(),
  include: promo_adsIncludeSchema.optional(),
  where: promo_adsWhereUniqueInputSchema,
}).strict() ;

export default promo_adsFindUniqueOrThrowArgsSchema;
