...
export const delivery_ordersSelectSchema: z.ZodType<Prisma.delivery_ordersSelect> = z.object({
...
export const delivery_ordersFindFirstOrThrowArgsSchema: z.ZodType<Prisma.delivery_ordersFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ delivery_ordersOrderByWithRelationInputSchema.array(),delivery_ordersOrderByWithRelationInputSchema ]).optional(),
  cursor: delivery_ordersWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ Delivery_ordersScalarFieldEnumSchema,Delivery_ordersScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default delivery_ordersFindFirstOrThrowArgsSchema;
