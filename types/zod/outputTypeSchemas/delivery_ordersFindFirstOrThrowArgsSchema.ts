...
export const delivery_ordersFindFirstOrThrowArgsSchema: z.ZodType<Prisma.delivery_ordersFindFirstOrThrowArgs> = z
	.object({
		...
		distinct: z
			.union([Delivery_ordersScalarFieldEnumSchema, Delivery_ordersScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();
