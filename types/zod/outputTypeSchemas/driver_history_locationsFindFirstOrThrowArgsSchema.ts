...
export const driver_history_locationsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.driver_history_locationsFindFirstOrThrowArgs> =
	z
		.object({
			...
			orderBy: z
				.union([
					driver_history_locationsOrderByWithRelationInputSchema.array(),
					driver_history_locationsOrderByWithRelationInputSchema,
				])
				.optional(),
			...
			distinct: z
				.union([
					Driver_history_locationsScalarFieldEnumSchema,
					Driver_history_locationsScalarFieldEnumSchema.array(),
				])
				.optional(),
		})
		.strict();

export default driver_history_locationsFindFirstOrThrowArgsSchema;
