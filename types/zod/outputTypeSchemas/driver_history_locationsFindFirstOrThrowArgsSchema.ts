...
export const driver_history_locationsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.driver_history_locationsFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ Driver_history_locationsScalarFieldEnumSchema,Driver_history_locationsScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;
