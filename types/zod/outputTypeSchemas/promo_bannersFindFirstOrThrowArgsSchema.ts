...
export const promo_bannersFindFirstOrThrowArgsSchema: z.ZodType<Prisma.promo_bannersFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ promo_bannersOrderByWithRelationInputSchema.array(),promo_bannersOrderByWithRelationInputSchema ]).optional(),
...
export default promo_bannersFindFirstOrThrowArgsSchema;
