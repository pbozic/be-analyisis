...
export const late_eventsCreateArgsSchema: z.ZodType<Prisma.late_eventsCreateArgs> = z.object({
  select: late_eventsSelectSchema.optional(),
  include: late_eventsIncludeSchema.optional(),
  data: z.union([ late_eventsCreateInputSchema,late_eventsUncheckedCreateInputSchema ]),
}).strict() ;

export default late_eventsCreateArgsSchema;
