...
export const local_productsGroupByArgsSchema: z.ZodType<Prisma.local_productsGroupByArgs> = z.object({
  where: local_productsWhereInputSchema.optional(),
  orderBy: z.union([ local_productsOrderByWithAggregationInputSchema.array(),local_productsOrderByWithAggregationInputSchema ]).optional(),
