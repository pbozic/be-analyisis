...
export const local_productsUpdateArgsSchema: z.ZodType<Prisma.local_productsUpdateArgs> = z.object({
  select: local_productsSelectSchema.optional(),
  include: local_productsIncludeSchema.optional(),
  data: z.union([ local_productsUpdateInputSchema,local_productsUncheckedUpdateInputSchema ]),
  where: local_productsWhereUniqueInputSchema,
}).strict() ;

export default local_productsUpdateArgsSchema;
