...
export const driver_municipalitiesDeleteArgsSchema: z.ZodType<Prisma.driver_municipalitiesDeleteArgs> = z.object({
...
export default driver_municipalitiesDeleteArgsSchema;
