...
export const taxi_order_sentGroupByArgsSchema: z.ZodType<Prisma.taxi_order_sentGroupByArgs> = z
	.object({
		where: taxi_order_sentWhereInputSchema.optional(),
		orderBy: z
			.union([
				taxi_order_sentOrderByWithAggregationInputSchema.array(),
				taxi_order_sentOrderByWithAggregationInputSchema,
			])
			.optional(),
