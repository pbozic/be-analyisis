...
export const wallet_transfer_historyGroupByArgsSchema: z.ZodType<Prisma.wallet_transfer_historyGroupByArgs> = z
	.object({
		where: wallet_transfer_historyWhereInputSchema.optional(),
		orderBy: z
			.union([
				wallet_transfer_historyOrderByWithAggregationInputSchema.array(),
				wallet_transfer_historyOrderByWithAggregationInputSchema,
			])
			.optional(),
