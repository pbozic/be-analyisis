...
export const taxi_ordersFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.taxi_ordersFindUniqueOrThrowArgs> = z.object({
  select: taxi_ordersSelectSchema.optional(),
  include: taxi_ordersIncludeSchema.optional(),
  where: taxi_ordersWhereUniqueInputSchema,
}).strict() ;

export default taxi_ordersFindUniqueOrThrowArgsSchema;
