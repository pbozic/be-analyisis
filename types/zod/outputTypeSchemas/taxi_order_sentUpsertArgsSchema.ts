...
import { taxi_order_sentCreateInputSchema } from '../inputTypeSchemas/taxi_order_sentCreateInputSchema'
import { taxi_order_sentUncheckedCreateInputSchema } from '../inputTypeSchemas/taxi_order_sentUncheckedCreateInputSchema'
import { taxi_order_sentUpdateInputSchema } from '../inputTypeSchemas/taxi_order_sentUpdateInputSchema'
import { taxi_order_sentUncheckedUpdateInputSchema } from '../inputTypeSchemas/taxi_order_sentUncheckedUpdateInputSchema'
...
export const taxi_order_sentUpsertArgsSchema: z.ZodType<Prisma.taxi_order_sentUpsertArgs> = z.object({
  ...
  create: z.union([ taxi_order_sentCreateInputSchema,taxi_order_sentUncheckedCreateInputSchema ]),
  update: z.union([ taxi_order_sentUpdateInputSchema,taxi_order_sentUncheckedUpdateInputSchema ]),
}).strict() ;

export default taxi_order_sentUpsertArgsSchema;
