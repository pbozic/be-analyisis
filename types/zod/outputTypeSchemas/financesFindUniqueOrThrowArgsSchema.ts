...
export const financesFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.financesFindUniqueOrThrowArgs> = z.object({
  select: financesSelectSchema.optional(),
  include: financesIncludeSchema.optional(),
  where: financesWhereUniqueInputSchema,
}).strict() ;

export default financesFindUniqueOrThrowArgsSchema;
