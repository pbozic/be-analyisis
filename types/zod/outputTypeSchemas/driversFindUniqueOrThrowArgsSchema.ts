...
export const driversFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.driversFindUniqueOrThrowArgs> = z.object({
  select: driversSelectSchema.optional(),
  include: driversIncludeSchema.optional(),
  where: driversWhereUniqueInputSchema,
}).strict() ;

export default driversFindUniqueOrThrowArgsSchema;
