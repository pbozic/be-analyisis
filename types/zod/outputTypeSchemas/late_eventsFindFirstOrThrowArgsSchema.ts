...
export const late_eventsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.late_eventsFindFirstOrThrowArgs> = z.object({
...
export default late_eventsFindFirstOrThrowArgsSchema;
