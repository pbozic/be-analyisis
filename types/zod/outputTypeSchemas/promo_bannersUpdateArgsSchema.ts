...
export const promo_bannersUpdateArgsSchema: z.ZodType<Prisma.promo_bannersUpdateArgs> = z.object({
  select: promo_bannersSelectSchema.optional(),
  include: promo_bannersIncludeSchema.optional(),
  data: z.union([ promo_bannersUpdateInputSchema,promo_bannersUncheckedUpdateInputSchema ]),
  where: promo_bannersWhereUniqueInputSchema,
}).strict() ;

export default promo_bannersUpdateArgsSchema;
