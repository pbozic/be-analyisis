...
export const wordsCreateArgsSchema: z.ZodType<Prisma.wordsCreateArgs> = z.object({
  select: wordsSelectSchema.optional(),
  include: wordsIncludeSchema.optional(),
  data: z.union([ wordsCreateInputSchema,wordsUncheckedCreateInputSchema ]),
}).strict() ;

export default wordsCreateArgsSchema;
