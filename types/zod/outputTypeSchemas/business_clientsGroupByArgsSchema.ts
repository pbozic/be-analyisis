...
export const business_clientsGroupByArgsSchema: z.ZodType<Prisma.business_clientsGroupByArgs> = z
	.object({
		where: business_clientsWhereInputSchema.optional(),
		orderBy: z
			.union([
				business_clientsOrderByWithAggregationInputSchema.array(),
				business_clientsOrderByWithAggregationInputSchema,
			])
			.optional(),
