...
export const promo_sectionsGroupByArgsSchema: z.ZodType<Prisma.promo_sectionsGroupByArgs> = z.object({
  where: promo_sectionsWhereInputSchema.optional(),
  orderBy: z.union([ promo_sectionsOrderByWithAggregationInputSchema.array(),promo_sectionsOrderByWithAggregationInputSchema ]).optional(),
