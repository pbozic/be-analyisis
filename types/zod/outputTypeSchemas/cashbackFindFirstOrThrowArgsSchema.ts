...
export const cashbackFindFirstOrThrowArgsSchema: z.ZodType<Prisma.cashbackFindFirstOrThrowArgs> = z.object({
  select: cashbackSelectSchema.optional(),
  include: cashbackIncludeSchema.optional(),
  where: cashbackWhereInputSchema.optional(),
  orderBy: z.union([ cashbackOrderByWithRelationInputSchema.array(),cashbackOrderByWithRelationInputSchema ]).optional(),
  cursor: cashbackWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ CashbackScalarFieldEnumSchema,CashbackScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default cashbackFindFirstOrThrowArgsSchema;
