...
import { promo_sections_buyCreateInputSchema } from '../inputTypeSchemas/promo_sections_buyCreateInputSchema'
import { promo_sections_buyUncheckedCreateInputSchema } from '../inputTypeSchemas/promo_sections_buyUncheckedCreateInputSchema'
...
export const promo_sections_buyUpsertArgsSchema: z.ZodType<Prisma.promo_sections_buyUpsertArgs> = z.object({
  ...
  create: z.union([ promo_sections_buyCreateInputSchema,promo_sections_buyUncheckedCreateInputSchema ]),
  update: z.union([ promo_sections_buyUpdateInputSchema,promo_sections_buyUncheckedUpdateInputSchema ]),
}).strict() ;

export default promo_sections_buyUpsertArgsSchema;
