...
export const group_usersUpdateArgsSchema: z.ZodType<Prisma.group_usersUpdateArgs> = z.object({
  select: group_usersSelectSchema.optional(),
  include: group_usersIncludeSchema.optional(),
  data: z.union([ group_usersUpdateInputSchema,group_usersUncheckedUpdateInputSchema ]),
  where: group_usersWhereUniqueInputSchema,
}).strict() ;

export default group_usersUpdateArgsSchema;
