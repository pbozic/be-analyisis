...
export const promo_sectionsUpdateArgsSchema: z.ZodType<Prisma.promo_sectionsUpdateArgs> = z.object({
  select: promo_sectionsSelectSchema.optional(),
  include: promo_sectionsIncludeSchema.optional(),
  data: z.union([ promo_sectionsUpdateInputSchema,promo_sectionsUncheckedUpdateInputSchema ]),
  where: promo_sectionsWhereUniqueInputSchema,
}).strict() ;

export default promo_sectionsUpdateArgsSchema;
