...
export const vehiclesFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.vehiclesFindUniqueOrThrowArgs> = z.object({
  select: vehiclesSelectSchema.optional(),
  include: vehiclesIncludeSchema.optional(),
  where: vehiclesWhereUniqueInputSchema,
}).strict() ;

export default vehiclesFindUniqueOrThrowArgsSchema;
