...
export const payment_intent_logsFindManyArgsSchema: z.ZodType<Prisma.payment_intent_logsFindManyArgs> = z.object({
...
export default payment_intent_logsFindManyArgsSchema;
