...
export const vehicle_driversGroupByArgsSchema: z.ZodType<Prisma.vehicle_driversGroupByArgs> = z
	.object({
		where: vehicle_driversWhereInputSchema.optional(),
		orderBy: z
			.union([
				vehicle_driversOrderByWithAggregationInputSchema.array(),
				vehicle_driversOrderByWithAggregationInputSchema,
			])
			.optional(),
