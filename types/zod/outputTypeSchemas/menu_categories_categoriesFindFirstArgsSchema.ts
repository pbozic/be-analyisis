...
export const menu_categories_categoriesFindFirstArgsSchema: z.ZodType<Prisma.menu_categories_categoriesFindFirstArgs> = z.object({
  ...
  distinct: z.union([ Menu_categories_categoriesScalarFieldEnumSchema,Menu_categories_categoriesScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default menu_categories_categoriesFindFirstArgsSchema;
