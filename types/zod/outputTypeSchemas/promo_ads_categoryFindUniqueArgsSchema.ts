...
export const promo_ads_categoryFindUniqueArgsSchema: z.ZodType<Prisma.promo_ads_categoryFindUniqueArgs> = z.object({
...
export default promo_ads_categoryFindUniqueArgsSchema;
