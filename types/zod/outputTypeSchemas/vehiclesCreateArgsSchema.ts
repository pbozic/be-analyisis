...
export const vehiclesCreateArgsSchema: z.ZodType<Prisma.vehiclesCreateArgs> = z.object({
  select: vehiclesSelectSchema.optional(),
  include: vehiclesIncludeSchema.optional(),
  data: z.union([ vehiclesCreateInputSchema,vehiclesUncheckedCreateInputSchema ]).optional(),
}).strict() ;

export default vehiclesCreateArgsSchema;
