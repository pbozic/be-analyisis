...
import { local_productsUpdateInputSchema } from '../inputTypeSchemas/local_productsUpdateInputSchema'
import { local_productsUncheckedUpdateInputSchema } from '../inputTypeSchemas/local_productsUncheckedUpdateInputSchema'
...
export const local_productsUpsertArgsSchema: z.ZodType<Prisma.local_productsUpsertArgs> = z.object({
  ...
  create: z.union([ local_productsCreateInputSchema,local_productsUncheckedCreateInputSchema ]),
  update: z.union([ local_productsUpdateInputSchema,local_productsUncheckedUpdateInputSchema ]),
}).strict() ;

export default local_productsUpsertArgsSchema;
