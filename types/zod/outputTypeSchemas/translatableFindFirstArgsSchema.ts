...
export const translatableFindFirstArgsSchema: z.ZodType<Prisma.translatableFindFirstArgs> = z
	.object({
		...
		orderBy: z
			.union([translatableOrderByWithRelationInputSchema.array(), translatableOrderByWithRelationInputSchema])
			.optional(),
...
export default translatableFindFirstArgsSchema;
