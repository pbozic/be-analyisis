...
export const flagsCreateArgsSchema: z.ZodType<Prisma.flagsCreateArgs> = z.object({
  select: flagsSelectSchema.optional(),
  include: flagsIncludeSchema.optional(),
  data: z.union([ flagsCreateInputSchema,flagsUncheckedCreateInputSchema ]),
}).strict() ;

export default flagsCreateArgsSchema;
