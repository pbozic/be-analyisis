...
export const wallet_transfer_historyFindFirstArgsSchema: z.ZodType<Prisma.wallet_transfer_historyFindFirstArgs> = z
	.object({
		...
		distinct: z
			.union([Wallet_transfer_historyScalarFieldEnumSchema, Wallet_transfer_historyScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();

export default wallet_transfer_historyFindFirstArgsSchema;
