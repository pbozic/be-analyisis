...
export const vehicle_specificationsUpdateManyArgsSchema: z.ZodType<Prisma.vehicle_specificationsUpdateManyArgs> = z
	.object({
		data: z.union([
			vehicle_specificationsUpdateManyMutationInputSchema,
			vehicle_specificationsUncheckedUpdateManyInputSchema,
		]),
