...
export const delivery_ordersGroupByArgsSchema: z.ZodType<Prisma.delivery_ordersGroupByArgs> = z
	.object({
		where: delivery_ordersWhereInputSchema.optional(),
		orderBy: z
			.union([
				delivery_ordersOrderByWithAggregationInputSchema.array(),
				delivery_ordersOrderByWithAggregationInputSchema,
			])
			.optional(),
