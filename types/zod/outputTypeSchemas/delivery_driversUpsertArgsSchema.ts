...
import { delivery_driversUpdateInputSchema } from '../inputTypeSchemas/delivery_driversUpdateInputSchema'
import { delivery_driversUncheckedUpdateInputSchema } from '../inputTypeSchemas/delivery_driversUncheckedUpdateInputSchema'
...
export const delivery_driversSelectSchema: z.ZodType<Prisma.delivery_driversSelect> = z.object({
  ...
  delivery_driver_history_locations: z.union([z.boolean(),z.lazy(() => delivery_driver_history_locationsFindManyArgsSchema)]).optional(),
...
export const delivery_driversUpsertArgsSchema: z.ZodType<Prisma.delivery_driversUpsertArgs> = z.object({
  select: delivery_driversSelectSchema.optional(),
  include: delivery_driversIncludeSchema.optional(),
  where: delivery_driversWhereUniqueInputSchema,
  create: z.union([ delivery_driversCreateInputSchema,delivery_driversUncheckedCreateInputSchema ]),
  update: z.union([ delivery_driversUpdateInputSchema,delivery_driversUncheckedUpdateInputSchema ]),
}).strict() ;

export default delivery_driversUpsertArgsSchema;
