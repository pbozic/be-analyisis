...
export const promo_sections_buyCreateArgsSchema: z.ZodType<Prisma.promo_sections_buyCreateArgs> = z.object({
  select: promo_sections_buySelectSchema.optional(),
  include: promo_sections_buyIncludeSchema.optional(),
  data: z.union([ promo_sections_buyCreateInputSchema,promo_sections_buyUncheckedCreateInputSchema ]),
}).strict() ;

export default promo_sections_buyCreateArgsSchema;
