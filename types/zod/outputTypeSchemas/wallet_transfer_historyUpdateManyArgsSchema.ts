...
export const wallet_transfer_historyUpdateManyArgsSchema: z.ZodType<Prisma.wallet_transfer_historyUpdateManyArgs> = z
	.object({
		data: z.union([
			wallet_transfer_historyUpdateManyMutationInputSchema,
			wallet_transfer_historyUncheckedUpdateManyInputSchema,
		]),
