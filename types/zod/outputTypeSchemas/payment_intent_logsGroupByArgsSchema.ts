...
export const payment_intent_logsGroupByArgsSchema: z.ZodType<Prisma.payment_intent_logsGroupByArgs> = z
	.object({
		where: payment_intent_logsWhereInputSchema.optional(),
		orderBy: z
			.union([
				payment_intent_logsOrderByWithAggregationInputSchema.array(),
				payment_intent_logsOrderByWithAggregationInputSchema,
			])
			.optional(),
