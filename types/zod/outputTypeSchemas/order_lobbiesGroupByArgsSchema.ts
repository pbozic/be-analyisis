...
export const order_lobbiesGroupByArgsSchema: z.ZodType<Prisma.order_lobbiesGroupByArgs> = z.object({
  where: order_lobbiesWhereInputSchema.optional(),
  orderBy: z.union([ order_lobbiesOrderByWithAggregationInputSchema.array(),order_lobbiesOrderByWithAggregationInputSchema ]).optional(),
