...
export const order_lobby_usersCreateArgsSchema: z.ZodType<Prisma.order_lobby_usersCreateArgs> = z
	.object({
		select: order_lobby_usersSelectSchema.optional(),
		include: order_lobby_usersIncludeSchema.optional(),
		data: z.union([order_lobby_usersCreateInputSchema, order_lobby_usersUncheckedCreateInputSchema]),
	})
	.strict();

export default order_lobby_usersCreateArgsSchema;
