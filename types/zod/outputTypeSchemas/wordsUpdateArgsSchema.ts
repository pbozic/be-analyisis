...
export const wordsUpdateArgsSchema: z.ZodType<Prisma.wordsUpdateArgs> = z.object({
  select: wordsSelectSchema.optional(),
  include: wordsIncludeSchema.optional(),
  data: z.union([ wordsUpdateInputSchema,wordsUncheckedUpdateInputSchema ]),
  where: wordsWhereUniqueInputSchema,
}).strict() ;

export default wordsUpdateArgsSchema;
