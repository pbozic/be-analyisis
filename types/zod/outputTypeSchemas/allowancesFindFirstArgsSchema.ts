...
export const allowancesFindFirstArgsSchema: z.ZodType<Prisma.allowancesFindFirstArgs> = z
	.object({
		select: allowancesSelectSchema.optional(),
		include: allowancesIncludeSchema.optional(),
		where: allowancesWhereInputSchema.optional(),
		orderBy: z
			.union([allowancesOrderByWithRelationInputSchema.array(), allowancesOrderByWithRelationInputSchema])
			.optional(),
...
export default allowancesFindFirstArgsSchema;
