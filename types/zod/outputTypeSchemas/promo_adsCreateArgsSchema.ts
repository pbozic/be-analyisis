...
export const promo_adsCreateArgsSchema: z.ZodType<Prisma.promo_adsCreateArgs> = z.object({
  select: promo_adsSelectSchema.optional(),
  include: promo_adsIncludeSchema.optional(),
  data: z.union([ promo_adsCreateInputSchema,promo_adsUncheckedCreateInputSchema ]),
}).strict() ;

export default promo_adsCreateArgsSchema;
