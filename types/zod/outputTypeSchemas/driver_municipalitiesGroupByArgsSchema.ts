...
export const driver_municipalitiesGroupByArgsSchema: z.ZodType<Prisma.driver_municipalitiesGroupByArgs> = z
	.object({
		where: driver_municipalitiesWhereInputSchema.optional(),
		orderBy: z
			.union([
				driver_municipalitiesOrderByWithAggregationInputSchema.array(),
				driver_municipalitiesOrderByWithAggregationInputSchema,
			])
			.optional(),
