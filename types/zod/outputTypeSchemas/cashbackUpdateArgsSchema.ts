...
export const cashbackUpdateArgsSchema: z.ZodType<Prisma.cashbackUpdateArgs> = z.object({
  select: cashbackSelectSchema.optional(),
  include: cashbackIncludeSchema.optional(),
  data: z.union([ cashbackUpdateInputSchema,cashbackUncheckedUpdateInputSchema ]),
  where: cashbackWhereUniqueInputSchema,
}).strict() ;

export default cashbackUpdateArgsSchema;
