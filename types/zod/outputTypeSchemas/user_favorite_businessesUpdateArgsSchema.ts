...
export const user_favorite_businessesUpdateArgsSchema: z.ZodType<Prisma.user_favorite_businessesUpdateArgs> = z.object({
  select: user_favorite_businessesSelectSchema.optional(),
  include: user_favorite_businessesIncludeSchema.optional(),
  data: z.union([ user_favorite_businessesUpdateInputSchema,user_favorite_businessesUncheckedUpdateInputSchema ]),
  where: user_favorite_businessesWhereUniqueInputSchema,
}).strict() ;

export default user_favorite_businessesUpdateArgsSchema;
