...
export const reviewableGroupByArgsSchema: z.ZodType<Prisma.reviewableGroupByArgs> = z
	.object({
		where: reviewableWhereInputSchema.optional(),
		orderBy: z
			.union([reviewableOrderByWithAggregationInputSchema.array(), reviewableOrderByWithAggregationInputSchema])
			.optional(),
