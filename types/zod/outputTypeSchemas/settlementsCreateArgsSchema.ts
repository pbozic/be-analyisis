...
export const settlementsCreateArgsSchema: z.ZodType<Prisma.settlementsCreateArgs> = z.object({
  select: settlementsSelectSchema.optional(),
  include: settlementsIncludeSchema.optional(),
  data: z.union([ settlementsCreateInputSchema,settlementsUncheckedCreateInputSchema ]),
}).strict() ;

export default settlementsCreateArgsSchema;
