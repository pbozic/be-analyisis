...
export const vehiclesUpdateArgsSchema: z.ZodType<Prisma.vehiclesUpdateArgs> = z.object({
  select: vehiclesSelectSchema.optional(),
  include: vehiclesIncludeSchema.optional(),
  data: z.union([ vehiclesUpdateInputSchema,vehiclesUncheckedUpdateInputSchema ]),
  where: vehiclesWhereUniqueInputSchema,
}).strict() ;

export default vehiclesUpdateArgsSchema;
