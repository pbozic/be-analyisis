...
import { taxi_ordersCreateInputSchema } from '../inputTypeSchemas/taxi_ordersCreateInputSchema'
import { taxi_ordersUncheckedCreateInputSchema } from '../inputTypeSchemas/taxi_ordersUncheckedCreateInputSchema'
...
export const taxi_ordersSelectSchema: z.ZodType<Prisma.taxi_ordersSelect> = z.object({
...
export const taxi_ordersUpsertArgsSchema: z.ZodType<Prisma.taxi_ordersUpsertArgs> = z.object({
  select: taxi_ordersSelectSchema.optional(),
  include: taxi_ordersIncludeSchema.optional(),
  where: taxi_ordersWhereUniqueInputSchema,
  create: z.union([ taxi_ordersCreateInputSchema,taxi_ordersUncheckedCreateInputSchema ]),
  update: z.union([ taxi_ordersUpdateInputSchema,taxi_ordersUncheckedUpdateInputSchema ]),
}).strict() ;

export default taxi_ordersUpsertArgsSchema;
