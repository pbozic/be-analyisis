...
export const business_teamsGroupByArgsSchema: z.ZodType<Prisma.business_teamsGroupByArgs> = z
	.object({
		where: business_teamsWhereInputSchema.optional(),
		orderBy: z
			.union([
				business_teamsOrderByWithAggregationInputSchema.array(),
				business_teamsOrderByWithAggregationInputSchema,
			])
			.optional(),
