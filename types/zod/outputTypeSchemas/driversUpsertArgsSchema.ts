...
import { driversUpdateInputSchema } from '../inputTypeSchemas/driversUpdateInputSchema'
import { driversUncheckedUpdateInputSchema } from '../inputTypeSchemas/driversUncheckedUpdateInputSchema'
...
export const driversSelectSchema: z.ZodType<Prisma.driversSelect> = z.object({
  ...
  received_delivery_orders: z.union([z.boolean(),z.lazy(() => delivery_order_sentFindManyArgsSchema)]).optional(),
  documents: z.union([z.boolean(),z.lazy(() => documentsFindManyArgsSchema)]).optional(),
  driver_history_locations: z.union([z.boolean(),z.lazy(() => driver_history_locationsFindManyArgsSchema)]).optional(),
...
export const driversUpsertArgsSchema: z.ZodType<Prisma.driversUpsertArgs> = z.object({
  select: driversSelectSchema.optional(),
  include: driversIncludeSchema.optional(),
  where: driversWhereUniqueInputSchema,
  create: z.union([ driversCreateInputSchema,driversUncheckedCreateInputSchema ]),
  update: z.union([ driversUpdateInputSchema,driversUncheckedUpdateInputSchema ]),
}).strict() ;

export default driversUpsertArgsSchema;
