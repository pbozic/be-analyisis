...
export const promo_sections_buyUpdateManyArgsSchema: z.ZodType<Prisma.promo_sections_buyUpdateManyArgs> = z.object({
  data: z.union([ promo_sections_buyUpdateManyMutationInputSchema,promo_sections_buyUncheckedUpdateManyInputSchema ]),
