...
export const promo_ads_categoryDeleteArgsSchema: z.ZodType<Prisma.promo_ads_categoryDeleteArgs> = z.object({
...
export default promo_ads_categoryDeleteArgsSchema;
