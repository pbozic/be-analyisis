...
import { allowancesUpdateInputSchema } from '../inputTypeSchemas/allowancesUpdateInputSchema';
import { allowancesUncheckedUpdateInputSchema } from '../inputTypeSchemas/allowancesUncheckedUpdateInputSchema';
...
export const allowancesSelectSchema: z.ZodType<Prisma.allowancesSelect> = z
	.object({
...
export const allowancesUpsertArgsSchema: z.ZodType<Prisma.allowancesUpsertArgs> = z
	.object({
		select: allowancesSelectSchema.optional(),
		include: allowancesIncludeSchema.optional(),
		where: allowancesWhereUniqueInputSchema,
		create: z.union([allowancesCreateInputSchema, allowancesUncheckedCreateInputSchema]),
		update: z.union([allowancesUpdateInputSchema, allowancesUncheckedUpdateInputSchema]),
	})
	.strict();

export default allowancesUpsertArgsSchema;
