...
export const driver_history_locationsCreateArgsSchema: z.ZodType<Prisma.driver_history_locationsCreateArgs> = z
	.object({
		select: driver_history_locationsSelectSchema.optional(),
		include: driver_history_locationsIncludeSchema.optional(),
		data: z.union([driver_history_locationsCreateInputSchema, driver_history_locationsUncheckedCreateInputSchema]),
	})
	.strict();

export default driver_history_locationsCreateArgsSchema;
