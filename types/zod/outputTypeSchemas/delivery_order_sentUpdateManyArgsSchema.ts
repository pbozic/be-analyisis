...
export const delivery_order_sentUpdateManyArgsSchema: z.ZodType<Prisma.delivery_order_sentUpdateManyArgs> = z.object({
  data: z.union([ delivery_order_sentUpdateManyMutationInputSchema,delivery_order_sentUncheckedUpdateManyInputSchema ]),
