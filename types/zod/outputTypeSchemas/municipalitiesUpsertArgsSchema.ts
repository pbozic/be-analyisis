...
import { municipalitiesCreateInputSchema } from '../inputTypeSchemas/municipalitiesCreateInputSchema'
import { municipalitiesUncheckedCreateInputSchema } from '../inputTypeSchemas/municipalitiesUncheckedCreateInputSchema'
...
export const municipalitiesUpsertArgsSchema: z.ZodType<Prisma.municipalitiesUpsertArgs> = z.object({
  ...
  create: z.union([ municipalitiesCreateInputSchema,municipalitiesUncheckedCreateInputSchema ]),
  update: z.union([ municipalitiesUpdateInputSchema,municipalitiesUncheckedUpdateInputSchema ]),
}).strict() ;

export default municipalitiesUpsertArgsSchema;
