...
export const promo_ads_categoryUpdateArgsSchema: z.ZodType<Prisma.promo_ads_categoryUpdateArgs> = z.object({
  select: promo_ads_categorySelectSchema.optional(),
  include: promo_ads_categoryIncludeSchema.optional(),
  data: z.union([ promo_ads_categoryUpdateInputSchema,promo_ads_categoryUncheckedUpdateInputSchema ]),
  where: promo_ads_categoryWhereUniqueInputSchema,
}).strict() ;

export default promo_ads_categoryUpdateArgsSchema;
