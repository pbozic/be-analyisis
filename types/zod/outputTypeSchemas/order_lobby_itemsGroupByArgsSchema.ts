...
export const order_lobby_itemsGroupByArgsSchema: z.ZodType<Prisma.order_lobby_itemsGroupByArgs> = z.object({
  where: order_lobby_itemsWhereInputSchema.optional(),
  orderBy: z.union([ order_lobby_itemsOrderByWithAggregationInputSchema.array(),order_lobby_itemsOrderByWithAggregationInputSchema ]).optional(),
