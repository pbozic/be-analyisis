...
export const wallet_fundsGroupByArgsSchema: z.ZodType<Prisma.wallet_fundsGroupByArgs> = z
	.object({
		where: wallet_fundsWhereInputSchema.optional(),
		orderBy: z
			.union([
				wallet_fundsOrderByWithAggregationInputSchema.array(),
				wallet_fundsOrderByWithAggregationInputSchema,
			])
			.optional(),
