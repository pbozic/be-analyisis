...
export const business_clientsFindUniqueArgsSchema: z.ZodType<Prisma.business_clientsFindUniqueArgs> = z.object({
...
export default business_clientsFindUniqueArgsSchema;
