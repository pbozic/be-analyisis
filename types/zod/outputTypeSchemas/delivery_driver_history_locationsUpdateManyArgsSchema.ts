...
export const delivery_driver_history_locationsUpdateManyArgsSchema: z.ZodType<Prisma.delivery_driver_history_locationsUpdateManyArgs> =
	z
		.object({
			data: z.union([
				delivery_driver_history_locationsUpdateManyMutationInputSchema,
				delivery_driver_history_locationsUncheckedUpdateManyInputSchema,
			]),
