...
export const vehicle_specificationsFindFirstArgsSchema: z.ZodType<Prisma.vehicle_specificationsFindFirstArgs> = z
	.object({
		...
		distinct: z
			.union([Vehicle_specificationsScalarFieldEnumSchema, Vehicle_specificationsScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();
