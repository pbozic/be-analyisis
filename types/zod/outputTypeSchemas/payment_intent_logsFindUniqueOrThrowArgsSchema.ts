...
export const payment_intent_logsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.payment_intent_logsFindUniqueOrThrowArgs> = z.object({
  select: payment_intent_logsSelectSchema.optional(),
  where: payment_intent_logsWhereUniqueInputSchema,
}).strict() ;

export default payment_intent_logsFindUniqueOrThrowArgsSchema;
