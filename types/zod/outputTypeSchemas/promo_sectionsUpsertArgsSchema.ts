...
import { promo_sectionsCreateInputSchema } from '../inputTypeSchemas/promo_sectionsCreateInputSchema'
import { promo_sectionsUncheckedCreateInputSchema } from '../inputTypeSchemas/promo_sectionsUncheckedCreateInputSchema'
import { promo_sectionsUpdateInputSchema } from '../inputTypeSchemas/promo_sectionsUpdateInputSchema'
import { promo_sectionsUncheckedUpdateInputSchema } from '../inputTypeSchemas/promo_sectionsUncheckedUpdateInputSchema'
...
export const promo_sectionsUpsertArgsSchema: z.ZodType<Prisma.promo_sectionsUpsertArgs> = z.object({
  ...
  create: z.union([ promo_sectionsCreateInputSchema,promo_sectionsUncheckedCreateInputSchema ]),
  update: z.union([ promo_sectionsUpdateInputSchema,promo_sectionsUncheckedUpdateInputSchema ]),
}).strict() ;

export default promo_sectionsUpsertArgsSchema;
