...
export const wallet_fundsUpsertArgsSchema: z.ZodType<Prisma.wallet_fundsUpsertArgs> = z.object({
  ...
  create: z.union([ wallet_fundsCreateInputSchema,wallet_fundsUncheckedCreateInputSchema ]),
  update: z.union([ wallet_fundsUpdateInputSchema,wallet_fundsUncheckedUpdateInputSchema ]),
}).strict() ;

export default wallet_fundsUpsertArgsSchema;
