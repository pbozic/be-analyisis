...
export const vehiclesFindFirstOrThrowArgsSchema: z.ZodType<Prisma.vehiclesFindFirstOrThrowArgs> = z.object({
...
export default vehiclesFindFirstOrThrowArgsSchema;
