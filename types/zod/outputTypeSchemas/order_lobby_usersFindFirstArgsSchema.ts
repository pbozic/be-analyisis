...
export const order_lobby_usersSelectSchema: z.ZodType<Prisma.order_lobby_usersSelect> = z
	.object({
...
export const order_lobby_usersFindFirstArgsSchema: z.ZodType<Prisma.order_lobby_usersFindFirstArgs> = z
	.object({
		...
		orderBy: z
			.union([
				order_lobby_usersOrderByWithRelationInputSchema.array(),
				order_lobby_usersOrderByWithRelationInputSchema,
			])
			.optional(),
		...
		distinct: z
			.union([Order_lobby_usersScalarFieldEnumSchema, Order_lobby_usersScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();

export default order_lobby_usersFindFirstArgsSchema;
