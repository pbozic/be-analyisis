...
export const delivery_order_sentCreateManyAndReturnArgsSchema: z.ZodType<Prisma.delivery_order_sentCreateManyAndReturnArgs> = z.object({
  data: z.union([ delivery_order_sentCreateManyInputSchema,delivery_order_sentCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default delivery_order_sentCreateManyAndReturnArgsSchema;
