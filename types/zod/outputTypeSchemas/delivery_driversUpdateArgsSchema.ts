...
export const delivery_driversUpdateArgsSchema: z.ZodType<Prisma.delivery_driversUpdateArgs> = z.object({
  select: delivery_driversSelectSchema.optional(),
  include: delivery_driversIncludeSchema.optional(),
  data: z.union([ delivery_driversUpdateInputSchema,delivery_driversUncheckedUpdateInputSchema ]),
  where: delivery_driversWhereUniqueInputSchema,
}).strict() ;

export default delivery_driversUpdateArgsSchema;
