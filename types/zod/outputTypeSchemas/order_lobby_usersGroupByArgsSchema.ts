...
export const order_lobby_usersGroupByArgsSchema: z.ZodType<Prisma.order_lobby_usersGroupByArgs> = z.object({
  where: order_lobby_usersWhereInputSchema.optional(),
  orderBy: z.union([ order_lobby_usersOrderByWithAggregationInputSchema.array(),order_lobby_usersOrderByWithAggregationInputSchema ]).optional(),
