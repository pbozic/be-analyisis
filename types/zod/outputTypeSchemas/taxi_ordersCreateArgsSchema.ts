...
export const taxi_ordersCreateArgsSchema: z.ZodType<Prisma.taxi_ordersCreateArgs> = z.object({
  select: taxi_ordersSelectSchema.optional(),
  include: taxi_ordersIncludeSchema.optional(),
  data: z.union([ taxi_ordersCreateInputSchema,taxi_ordersUncheckedCreateInputSchema ]),
}).strict() ;

export default taxi_ordersCreateArgsSchema;
