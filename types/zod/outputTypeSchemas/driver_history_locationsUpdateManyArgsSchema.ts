...
export const driver_history_locationsUpdateManyArgsSchema: z.ZodType<Prisma.driver_history_locationsUpdateManyArgs> = z
	.object({
		data: z.union([
			driver_history_locationsUpdateManyMutationInputSchema,
			driver_history_locationsUncheckedUpdateManyInputSchema,
		]),
