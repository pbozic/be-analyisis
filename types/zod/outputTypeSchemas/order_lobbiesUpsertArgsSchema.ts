...
import { order_lobbiesUpdateInputSchema } from '../inputTypeSchemas/order_lobbiesUpdateInputSchema'
import { order_lobbiesUncheckedUpdateInputSchema } from '../inputTypeSchemas/order_lobbiesUncheckedUpdateInputSchema'
...
export const order_lobbiesUpsertArgsSchema: z.ZodType<Prisma.order_lobbiesUpsertArgs> = z.object({
  select: order_lobbiesSelectSchema.optional(),
  include: order_lobbiesIncludeSchema.optional(),
  where: order_lobbiesWhereUniqueInputSchema,
  create: z.union([ order_lobbiesCreateInputSchema,order_lobbiesUncheckedCreateInputSchema ]),
  update: z.union([ order_lobbiesUpdateInputSchema,order_lobbiesUncheckedUpdateInputSchema ]),
}).strict() ;

export default order_lobbiesUpsertArgsSchema;
