...
export const order_lobbiesUpdateArgsSchema: z.ZodType<Prisma.order_lobbiesUpdateArgs> = z.object({
  select: order_lobbiesSelectSchema.optional(),
  include: order_lobbiesIncludeSchema.optional(),
  data: z.union([ order_lobbiesUpdateInputSchema,order_lobbiesUncheckedUpdateInputSchema ]),
  where: order_lobbiesWhereUniqueInputSchema,
}).strict() ;

export default order_lobbiesUpdateArgsSchema;
