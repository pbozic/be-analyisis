...
export const wallet_transfer_historyCreateArgsSchema: z.ZodType<Prisma.wallet_transfer_historyCreateArgs> = z.object({
  select: wallet_transfer_historySelectSchema.optional(),
  include: wallet_transfer_historyIncludeSchema.optional(),
  data: z.union([ wallet_transfer_historyCreateInputSchema,wallet_transfer_historyUncheckedCreateInputSchema ]),
}).strict() ;

export default wallet_transfer_historyCreateArgsSchema;
