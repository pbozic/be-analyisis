...
export const user_favorite_businessesUpdateManyArgsSchema: z.ZodType<Prisma.user_favorite_businessesUpdateManyArgs> = z
	.object({
		data: z.union([
			user_favorite_businessesUpdateManyMutationInputSchema,
			user_favorite_businessesUncheckedUpdateManyInputSchema,
		]),
