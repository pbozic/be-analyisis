...
export const cashbackGroupByArgsSchema: z.ZodType<Prisma.cashbackGroupByArgs> = z
	.object({
		where: cashbackWhereInputSchema.optional(),
		orderBy: z
			.union([cashbackOrderByWithAggregationInputSchema.array(), cashbackOrderByWithAggregationInputSchema])
			.optional(),
