...
export const vehicle_driversFindUniqueArgsSchema: z.ZodType<Prisma.vehicle_driversFindUniqueArgs> = z.object({
...
export default vehicle_driversFindUniqueArgsSchema;
