...
export const vehicle_specificationsUpdateArgsSchema: z.ZodType<Prisma.vehicle_specificationsUpdateArgs> = z.object({
  select: vehicle_specificationsSelectSchema.optional(),
  include: vehicle_specificationsIncludeSchema.optional(),
  data: z.union([ vehicle_specificationsUpdateInputSchema,vehicle_specificationsUncheckedUpdateInputSchema ]),
  where: vehicle_specificationsWhereUniqueInputSchema,
}).strict() ;

export default vehicle_specificationsUpdateArgsSchema;
