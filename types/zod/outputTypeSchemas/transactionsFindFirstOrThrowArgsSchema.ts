...
export const transactionsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.transactionsFindFirstOrThrowArgs> = z
	.object({
		...
		orderBy: z
			.union([transactionsOrderByWithRelationInputSchema.array(), transactionsOrderByWithRelationInputSchema])
			.optional(),
...
export default transactionsFindFirstOrThrowArgsSchema;
