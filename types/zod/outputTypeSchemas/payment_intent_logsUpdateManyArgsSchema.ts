...
export const payment_intent_logsUpdateManyArgsSchema: z.ZodType<Prisma.payment_intent_logsUpdateManyArgs> = z
	.object({
		data: z.union([
			payment_intent_logsUpdateManyMutationInputSchema,
			payment_intent_logsUncheckedUpdateManyInputSchema,
		]),
