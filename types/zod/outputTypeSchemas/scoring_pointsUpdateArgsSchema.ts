...
export const scoring_pointsUpdateArgsSchema: z.ZodType<Prisma.scoring_pointsUpdateArgs> = z.object({
  select: scoring_pointsSelectSchema.optional(),
  include: scoring_pointsIncludeSchema.optional(),
  data: z.union([ scoring_pointsUpdateInputSchema,scoring_pointsUncheckedUpdateInputSchema ]),
  where: scoring_pointsWhereUniqueInputSchema,
}).strict() ;

export default scoring_pointsUpdateArgsSchema;
