...
export const user_addressUpdateArgsSchema: z.ZodType<Prisma.user_addressUpdateArgs> = z.object({
  select: user_addressSelectSchema.optional(),
  include: user_addressIncludeSchema.optional(),
  data: z.union([ user_addressUpdateInputSchema,user_addressUncheckedUpdateInputSchema ]),
  where: user_addressWhereUniqueInputSchema,
}).strict() ;

export default user_addressUpdateArgsSchema;
