...
export const scoring_pointsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.scoring_pointsFindFirstOrThrowArgs> = z
	.object({
		...
		distinct: z
			.union([Scoring_pointsScalarFieldEnumSchema, Scoring_pointsScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();

export default scoring_pointsFindFirstOrThrowArgsSchema;
