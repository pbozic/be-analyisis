...
export const user_rolesGroupByArgsSchema: z.ZodType<Prisma.user_rolesGroupByArgs> = z.object({
  where: user_rolesWhereInputSchema.optional(),
  orderBy: z.union([ user_rolesOrderByWithAggregationInputSchema.array(),user_rolesOrderByWithAggregationInputSchema ]).optional(),
