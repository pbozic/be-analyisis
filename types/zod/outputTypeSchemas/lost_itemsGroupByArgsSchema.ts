...
export const lost_itemsGroupByArgsSchema: z.ZodType<Prisma.lost_itemsGroupByArgs> = z
	.object({
		where: lost_itemsWhereInputSchema.optional(),
		orderBy: z
			.union([lost_itemsOrderByWithAggregationInputSchema.array(), lost_itemsOrderByWithAggregationInputSchema])
			.optional(),
