...
export const referralsGroupByArgsSchema: z.ZodType<Prisma.referralsGroupByArgs> = z
	.object({
		where: referralsWhereInputSchema.optional(),
		orderBy: z
			.union([referralsOrderByWithAggregationInputSchema.array(), referralsOrderByWithAggregationInputSchema])
			.optional(),
