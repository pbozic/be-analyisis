...
export const word_bundlesGroupByArgsSchema: z.ZodType<Prisma.word_bundlesGroupByArgs> = z
	.object({
		where: word_bundlesWhereInputSchema.optional(),
		orderBy: z
			.union([
				word_bundlesOrderByWithAggregationInputSchema.array(),
				word_bundlesOrderByWithAggregationInputSchema,
			])
			.optional(),
