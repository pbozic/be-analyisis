...
export const daily_meals_subscriptionsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.daily_meals_subscriptionsFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ Daily_meals_subscriptionsScalarFieldEnumSchema,Daily_meals_subscriptionsScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default daily_meals_subscriptionsFindFirstOrThrowArgsSchema;
