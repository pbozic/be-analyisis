...
export const menu_categories_categoriesUpdateArgsSchema: z.ZodType<Prisma.menu_categories_categoriesUpdateArgs> = z.object({
  select: menu_categories_categoriesSelectSchema.optional(),
  include: menu_categories_categoriesIncludeSchema.optional(),
  data: z.union([ menu_categories_categoriesUpdateInputSchema,menu_categories_categoriesUncheckedUpdateInputSchema ]),
