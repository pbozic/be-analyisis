...
export const tokensGroupByArgsSchema: z.ZodType<Prisma.tokensGroupByArgs> = z
	.object({
		where: tokensWhereInputSchema.optional(),
		orderBy: z
			.union([tokensOrderByWithAggregationInputSchema.array(), tokensOrderByWithAggregationInputSchema])
			.optional(),
