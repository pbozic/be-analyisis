...
export const driver_activity_logsFindUniqueArgsSchema: z.ZodType<Prisma.driver_activity_logsFindUniqueArgs> = z.object({
...
export default driver_activity_logsFindUniqueArgsSchema;
