...
export const weather_dataCreateArgsSchema: z.ZodType<Prisma.weather_dataCreateArgs> = z.object({
  select: weather_dataSelectSchema.optional(),
  include: weather_dataIncludeSchema.optional(),
  data: z.union([ weather_dataCreateInputSchema,weather_dataUncheckedCreateInputSchema ]),
}).strict() ;

export default weather_dataCreateArgsSchema;
