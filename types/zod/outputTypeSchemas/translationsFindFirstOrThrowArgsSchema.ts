...
export const translationsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.translationsFindFirstOrThrowArgs> = z
	.object({
		...
		orderBy: z
			.union([translationsOrderByWithRelationInputSchema.array(), translationsOrderByWithRelationInputSchema])
			.optional(),
...
export default translationsFindFirstOrThrowArgsSchema;
