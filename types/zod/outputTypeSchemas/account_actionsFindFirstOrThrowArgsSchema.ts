...
export const account_actionsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.account_actionsFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ account_actionsOrderByWithRelationInputSchema.array(),account_actionsOrderByWithRelationInputSchema ]).optional(),
  cursor: account_actionsWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ Account_actionsScalarFieldEnumSchema,Account_actionsScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default account_actionsFindFirstOrThrowArgsSchema;
