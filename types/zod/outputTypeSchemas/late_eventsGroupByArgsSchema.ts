...
export const late_eventsGroupByArgsSchema: z.ZodType<Prisma.late_eventsGroupByArgs> = z
	.object({
		where: late_eventsWhereInputSchema.optional(),
		orderBy: z
			.union([late_eventsOrderByWithAggregationInputSchema.array(), late_eventsOrderByWithAggregationInputSchema])
			.optional(),
