...
export const business_usersUpdateArgsSchema: z.ZodType<Prisma.business_usersUpdateArgs> = z.object({
  select: business_usersSelectSchema.optional(),
  include: business_usersIncludeSchema.optional(),
  data: z.union([ business_usersUpdateInputSchema,business_usersUncheckedUpdateInputSchema ]),
  where: business_usersWhereUniqueInputSchema,
}).strict() ;

export default business_usersUpdateArgsSchema;
