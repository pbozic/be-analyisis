...
export const promo_sections_buyFindFirstOrThrowArgsSchema: z.ZodType<Prisma.promo_sections_buyFindFirstOrThrowArgs> = z
	.object({
		...
		orderBy: z
			.union([
				promo_sections_buyOrderByWithRelationInputSchema.array(),
				promo_sections_buyOrderByWithRelationInputSchema,
			])
			.optional(),
		...
		distinct: z
			.union([Promo_sections_buyScalarFieldEnumSchema, Promo_sections_buyScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();

export default promo_sections_buyFindFirstOrThrowArgsSchema;
