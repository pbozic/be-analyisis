...
export const reservationsGroupByArgsSchema: z.ZodType<Prisma.reservationsGroupByArgs> = z
	.object({
		where: reservationsWhereInputSchema.optional(),
		orderBy: z
			.union([
				reservationsOrderByWithAggregationInputSchema.array(),
				reservationsOrderByWithAggregationInputSchema,
			])
			.optional(),
