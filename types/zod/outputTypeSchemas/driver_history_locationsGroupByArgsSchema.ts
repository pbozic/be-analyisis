...
export const driver_history_locationsGroupByArgsSchema: z.ZodType<Prisma.driver_history_locationsGroupByArgs> = z
	.object({
		where: driver_history_locationsWhereInputSchema.optional(),
		orderBy: z
			.union([
				driver_history_locationsOrderByWithAggregationInputSchema.array(),
				driver_history_locationsOrderByWithAggregationInputSchema,
			])
			.optional(),
