...
export const translatableSelectSchema: z.ZodType<Prisma.translatableSelect> = z
	.object({
...
export const translatableUpsertArgsSchema: z.ZodType<Prisma.translatableUpsertArgs> = z
	.object({
		...
		create: z.union([translatableCreateInputSchema, translatableUncheckedCreateInputSchema]),
		update: z.union([translatableUpdateInputSchema, translatableUncheckedUpdateInputSchema]),
	})
	.strict();

export default translatableUpsertArgsSchema;
