...
export const wallet_fundsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.wallet_fundsFindFirstOrThrowArgs> = z
	.object({
		...
		orderBy: z
			.union([wallet_fundsOrderByWithRelationInputSchema.array(), wallet_fundsOrderByWithRelationInputSchema])
			.optional(),
...
export default wallet_fundsFindFirstOrThrowArgsSchema;
