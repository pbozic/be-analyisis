...
export const menu_categories_categoriesGroupByArgsSchema: z.ZodType<Prisma.menu_categories_categoriesGroupByArgs> = z
	.object({
		where: menu_categories_categoriesWhereInputSchema.optional(),
		orderBy: z
			.union([
				menu_categories_categoriesOrderByWithAggregationInputSchema.array(),
				menu_categories_categoriesOrderByWithAggregationInputSchema,
			])
			.optional(),
