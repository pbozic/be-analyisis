...
export const order_lobby_itemsUpdateManyArgsSchema: z.ZodType<Prisma.order_lobby_itemsUpdateManyArgs> = z.object({
  data: z.union([ order_lobby_itemsUpdateManyMutationInputSchema,order_lobby_itemsUncheckedUpdateManyInputSchema ]),
