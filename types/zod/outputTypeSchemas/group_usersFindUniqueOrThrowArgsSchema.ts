...
export const group_usersFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.group_usersFindUniqueOrThrowArgs> = z.object({
  select: group_usersSelectSchema.optional(),
  include: group_usersIncludeSchema.optional(),
  where: group_usersWhereUniqueInputSchema,
}).strict() ;

export default group_usersFindUniqueOrThrowArgsSchema;
