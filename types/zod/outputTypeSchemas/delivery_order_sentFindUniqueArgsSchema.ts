...
export const delivery_order_sentFindUniqueArgsSchema: z.ZodType<Prisma.delivery_order_sentFindUniqueArgs> = z.object({
...
export default delivery_order_sentFindUniqueArgsSchema;
