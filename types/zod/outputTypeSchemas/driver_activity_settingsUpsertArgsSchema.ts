...
export const driver_activity_settingsUpsertArgsSchema: z.ZodType<Prisma.driver_activity_settingsUpsertArgs> = z.object({
  select: driver_activity_settingsSelectSchema.optional(),
  where: driver_activity_settingsWhereUniqueInputSchema,
  create: z.union([ driver_activity_settingsCreateInputSchema,driver_activity_settingsUncheckedCreateInputSchema ]),
  update: z.union([ driver_activity_settingsUpdateInputSchema,driver_activity_settingsUncheckedUpdateInputSchema ]),
}).strict() ;
