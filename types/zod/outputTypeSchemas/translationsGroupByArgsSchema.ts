...
export const translationsGroupByArgsSchema: z.ZodType<Prisma.translationsGroupByArgs> = z
	.object({
		where: translationsWhereInputSchema.optional(),
		orderBy: z
			.union([
				translationsOrderByWithAggregationInputSchema.array(),
				translationsOrderByWithAggregationInputSchema,
			])
			.optional(),
