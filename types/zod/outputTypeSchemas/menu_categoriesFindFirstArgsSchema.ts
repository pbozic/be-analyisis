...
export const menu_categoriesFindFirstArgsSchema: z.ZodType<Prisma.menu_categoriesFindFirstArgs> = z
	.object({
		...
		orderBy: z
			.union([
				menu_categoriesOrderByWithRelationInputSchema.array(),
				menu_categoriesOrderByWithRelationInputSchema,
			])
			.optional(),
		...
		distinct: z
			.union([Menu_categoriesScalarFieldEnumSchema, Menu_categoriesScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();

export default menu_categoriesFindFirstArgsSchema;
