...
export const group_usersFindFirstArgsSchema: z.ZodType<Prisma.group_usersFindFirstArgs> = z.object({
  ...
  orderBy: z.union([ group_usersOrderByWithRelationInputSchema.array(),group_usersOrderByWithRelationInputSchema ]).optional(),
...
export default group_usersFindFirstArgsSchema;
