...
export const order_lobby_itemsUpdateArgsSchema: z.ZodType<Prisma.order_lobby_itemsUpdateArgs> = z.object({
  select: order_lobby_itemsSelectSchema.optional(),
  include: order_lobby_itemsIncludeSchema.optional(),
  data: z.union([ order_lobby_itemsUpdateInputSchema,order_lobby_itemsUncheckedUpdateInputSchema ]),
  where: order_lobby_itemsWhereUniqueInputSchema,
}).strict() ;

export default order_lobby_itemsUpdateArgsSchema;
