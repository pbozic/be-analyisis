...
export const promo_sectionsCreateArgsSchema: z.ZodType<Prisma.promo_sectionsCreateArgs> = z.object({
  select: promo_sectionsSelectSchema.optional(),
  include: promo_sectionsIncludeSchema.optional(),
  data: z.union([ promo_sectionsCreateInputSchema,promo_sectionsUncheckedCreateInputSchema ]),
}).strict() ;

export default promo_sectionsCreateArgsSchema;
