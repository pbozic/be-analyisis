...
export const wordsCreateManyAndReturnArgsSchema: z.ZodType<Prisma.wordsCreateManyAndReturnArgs> = z.object({
  data: z.union([ wordsCreateManyInputSchema,wordsCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default wordsCreateManyAndReturnArgsSchema;
