...
export const delivery_order_sentFindFirstOrThrowArgsSchema: z.ZodType<Prisma.delivery_order_sentFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ Delivery_order_sentScalarFieldEnumSchema,Delivery_order_sentScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default delivery_order_sentFindFirstOrThrowArgsSchema;
