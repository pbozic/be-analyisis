...
export const order_lobby_usersUpdateManyArgsSchema: z.ZodType<Prisma.order_lobby_usersUpdateManyArgs> = z
	.object({
		data: z.union([
			order_lobby_usersUpdateManyMutationInputSchema,
			order_lobby_usersUncheckedUpdateManyInputSchema,
		]),
