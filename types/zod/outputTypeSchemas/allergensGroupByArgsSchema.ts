...
export const allergensGroupByArgsSchema: z.ZodType<Prisma.allergensGroupByArgs> = z.object({
  where: allergensWhereInputSchema.optional(),
  orderBy: z.union([ allergensOrderByWithAggregationInputSchema.array(),allergensOrderByWithAggregationInputSchema ]).optional(),
