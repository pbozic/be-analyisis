...
export const lost_itemsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.lost_itemsFindUniqueOrThrowArgs> = z.object({
  select: lost_itemsSelectSchema.optional(),
  include: lost_itemsIncludeSchema.optional(),
  where: lost_itemsWhereUniqueInputSchema,
}).strict() ;

export default lost_itemsFindUniqueOrThrowArgsSchema;
