...
export const order_lobby_usersUpdateArgsSchema: z.ZodType<Prisma.order_lobby_usersUpdateArgs> = z
	.object({
		select: order_lobby_usersSelectSchema.optional(),
		include: order_lobby_usersIncludeSchema.optional(),
		data: z.union([order_lobby_usersUpdateInputSchema, order_lobby_usersUncheckedUpdateInputSchema]),
		where: order_lobby_usersWhereUniqueInputSchema,
	})
	.strict();

export default order_lobby_usersUpdateArgsSchema;
