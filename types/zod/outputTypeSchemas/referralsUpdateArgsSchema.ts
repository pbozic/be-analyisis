...
export const referralsUpdateArgsSchema: z.ZodType<Prisma.referralsUpdateArgs> = z.object({
  select: referralsSelectSchema.optional(),
  include: referralsIncludeSchema.optional(),
  data: z.union([ referralsUpdateInputSchema,referralsUncheckedUpdateInputSchema ]),
  where: referralsWhereUniqueInputSchema,
}).strict() ;

export default referralsUpdateArgsSchema;
