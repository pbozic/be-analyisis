...
import { group_usersUpdateInputSchema } from '../inputTypeSchemas/group_usersUpdateInputSchema'
import { group_usersUncheckedUpdateInputSchema } from '../inputTypeSchemas/group_usersUncheckedUpdateInputSchema'
...
export const group_usersUpsertArgsSchema: z.ZodType<Prisma.group_usersUpsertArgs> = z.object({
  select: group_usersSelectSchema.optional(),
  include: group_usersIncludeSchema.optional(),
  where: group_usersWhereUniqueInputSchema,
  create: z.union([ group_usersCreateInputSchema,group_usersUncheckedCreateInputSchema ]),
  update: z.union([ group_usersUpdateInputSchema,group_usersUncheckedUpdateInputSchema ]),
}).strict() ;

export default group_usersUpsertArgsSchema;
