...
export const allergensFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.allergensFindUniqueOrThrowArgs> = z.object({
  select: allergensSelectSchema.optional(),
  where: allergensWhereUniqueInputSchema,
}).strict() ;

export default allergensFindUniqueOrThrowArgsSchema;
