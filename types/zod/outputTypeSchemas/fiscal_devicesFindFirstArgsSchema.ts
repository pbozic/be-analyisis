...
export const fiscal_devicesFindFirstArgsSchema: z.ZodType<Prisma.fiscal_devicesFindFirstArgs> = z
	.object({
		...
		orderBy: z
			.union([fiscal_devicesOrderByWithRelationInputSchema.array(), fiscal_devicesOrderByWithRelationInputSchema])
			.optional(),
		cursor: fiscal_devicesWhereUniqueInputSchema.optional(),
		take: z.number().optional(),
		skip: z.number().optional(),
		distinct: z
			.union([Fiscal_devicesScalarFieldEnumSchema, Fiscal_devicesScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();

export default fiscal_devicesFindFirstArgsSchema;
