...
export const settlementsGroupByArgsSchema: z.ZodType<Prisma.settlementsGroupByArgs> = z.object({
  where: settlementsWhereInputSchema.optional(),
  orderBy: z.union([ settlementsOrderByWithAggregationInputSchema.array(),settlementsOrderByWithAggregationInputSchema ]).optional(),
