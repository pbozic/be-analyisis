...
export const driver_activity_logsDeleteArgsSchema: z.ZodType<Prisma.driver_activity_logsDeleteArgs> = z.object({
...
export default driver_activity_logsDeleteArgsSchema;
