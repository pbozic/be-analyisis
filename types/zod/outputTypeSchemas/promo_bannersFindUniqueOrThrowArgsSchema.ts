...
export const promo_bannersFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.promo_bannersFindUniqueOrThrowArgs> = z.object({
...
export default promo_bannersFindUniqueOrThrowArgsSchema;
