...
export const business_clientsCreateArgsSchema: z.ZodType<Prisma.business_clientsCreateArgs> = z.object({
  select: business_clientsSelectSchema.optional(),
  include: business_clientsIncludeSchema.optional(),
  data: z.union([ business_clientsCreateInputSchema,business_clientsUncheckedCreateInputSchema ]),
}).strict() ;

export default business_clientsCreateArgsSchema;
