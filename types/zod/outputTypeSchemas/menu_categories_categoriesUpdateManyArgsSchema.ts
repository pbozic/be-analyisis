...
export const menu_categories_categoriesUpdateManyArgsSchema: z.ZodType<Prisma.menu_categories_categoriesUpdateManyArgs> =
	z
		.object({
			data: z.union([
				menu_categories_categoriesUpdateManyMutationInputSchema,
				menu_categories_categoriesUncheckedUpdateManyInputSchema,
			]),
