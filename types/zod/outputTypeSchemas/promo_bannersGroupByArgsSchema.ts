...
export const promo_bannersGroupByArgsSchema: z.ZodType<Prisma.promo_bannersGroupByArgs> = z.object({
  where: promo_bannersWhereInputSchema.optional(),
  orderBy: z.union([ promo_bannersOrderByWithAggregationInputSchema.array(),promo_bannersOrderByWithAggregationInputSchema ]).optional(),
