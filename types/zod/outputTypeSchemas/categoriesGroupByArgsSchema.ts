...
export const categoriesGroupByArgsSchema: z.ZodType<Prisma.categoriesGroupByArgs> = z
	.object({
		where: categoriesWhereInputSchema.optional(),
		orderBy: z
			.union([categoriesOrderByWithAggregationInputSchema.array(), categoriesOrderByWithAggregationInputSchema])
			.optional(),
