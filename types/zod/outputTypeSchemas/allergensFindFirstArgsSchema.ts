...
export const allergensFindFirstArgsSchema: z.ZodType<Prisma.allergensFindFirstArgs> = z.object({
  select: allergensSelectSchema.optional(),
  where: allergensWhereInputSchema.optional(),
  orderBy: z.union([ allergensOrderByWithRelationInputSchema.array(),allergensOrderByWithRelationInputSchema ]).optional(),
...
export default allergensFindFirstArgsSchema;
