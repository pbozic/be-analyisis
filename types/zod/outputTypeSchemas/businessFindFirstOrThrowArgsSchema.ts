...
export const businessSelectSchema: z.ZodType<Prisma.businessSelect> = z
	.object({
...
export const businessFindFirstOrThrowArgsSchema: z.ZodType<Prisma.businessFindFirstOrThrowArgs> = z
	.object({
		select: businessSelectSchema.optional(),
		include: businessIncludeSchema.optional(),
		where: businessWhereInputSchema.optional(),
		orderBy: z
			.union([businessOrderByWithRelationInputSchema.array(), businessOrderByWithRelationInputSchema])
			.optional(),
...
export default businessFindFirstOrThrowArgsSchema;
