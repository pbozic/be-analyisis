...
export const late_eventsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.late_eventsFindUniqueOrThrowArgs> = z.object({
  select: late_eventsSelectSchema.optional(),
  include: late_eventsIncludeSchema.optional(),
  where: late_eventsWhereUniqueInputSchema,
}).strict() ;

export default late_eventsFindUniqueOrThrowArgsSchema;
