...
export const word_buyFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.word_buyFindUniqueOrThrowArgs> = z.object({
  select: word_buySelectSchema.optional(),
  include: word_buyIncludeSchema.optional(),
  where: word_buyWhereUniqueInputSchema,
}).strict() ;

export default word_buyFindUniqueOrThrowArgsSchema;
