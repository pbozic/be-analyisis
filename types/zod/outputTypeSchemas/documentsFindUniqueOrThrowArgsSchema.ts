...
export const documentsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.documentsFindUniqueOrThrowArgs> = z
	.object({
...
export default documentsFindUniqueOrThrowArgsSchema;
