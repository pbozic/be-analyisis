...
import { menu_categoriesUpdateInputSchema } from '../inputTypeSchemas/menu_categoriesUpdateInputSchema'
import { menu_categoriesUncheckedUpdateInputSchema } from '../inputTypeSchemas/menu_categoriesUncheckedUpdateInputSchema'
...
export const menu_categoriesUpsertArgsSchema: z.ZodType<Prisma.menu_categoriesUpsertArgs> = z.object({
  ...
  create: z.union([ menu_categoriesCreateInputSchema,menu_categoriesUncheckedCreateInputSchema ]),
  update: z.union([ menu_categoriesUpdateInputSchema,menu_categoriesUncheckedUpdateInputSchema ]),
}).strict() ;

export default menu_categoriesUpsertArgsSchema;
