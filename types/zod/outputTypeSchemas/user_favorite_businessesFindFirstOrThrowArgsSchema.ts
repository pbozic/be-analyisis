...
export const user_favorite_businessesFindFirstOrThrowArgsSchema: z.ZodType<Prisma.user_favorite_businessesFindFirstOrThrowArgs> =
	z
		.object({
			...
			orderBy: z
				.union([
					user_favorite_businessesOrderByWithRelationInputSchema.array(),
					user_favorite_businessesOrderByWithRelationInputSchema,
				])
				.optional(),
			...
			distinct: z
				.union([
					User_favorite_businessesScalarFieldEnumSchema,
					User_favorite_businessesScalarFieldEnumSchema.array(),
				])
				.optional(),
		})
		.strict();

export default user_favorite_businessesFindFirstOrThrowArgsSchema;
