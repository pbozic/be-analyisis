...
export const vehiclesGroupByArgsSchema: z.ZodType<Prisma.vehiclesGroupByArgs> = z.object({
  where: vehiclesWhereInputSchema.optional(),
  orderBy: z.union([ vehiclesOrderByWithAggregationInputSchema.array(),vehiclesOrderByWithAggregationInputSchema ]).optional(),
