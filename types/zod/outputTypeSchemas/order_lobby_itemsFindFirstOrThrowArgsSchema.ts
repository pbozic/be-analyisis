...
export const order_lobby_itemsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.order_lobby_itemsFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ order_lobby_itemsOrderByWithRelationInputSchema.array(),order_lobby_itemsOrderByWithRelationInputSchema ]).optional(),
  cursor: order_lobby_itemsWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ Order_lobby_itemsScalarFieldEnumSchema,Order_lobby_itemsScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default order_lobby_itemsFindFirstOrThrowArgsSchema;
