...
export const menu_itemsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.menu_itemsFindUniqueOrThrowArgs> = z.object({
  select: menu_itemsSelectSchema.optional(),
  include: menu_itemsIncludeSchema.optional(),
  where: menu_itemsWhereUniqueInputSchema,
}).strict() ;

export default menu_itemsFindUniqueOrThrowArgsSchema;
