...
export const driver_activity_logsUpdateManyArgsSchema: z.ZodType<Prisma.driver_activity_logsUpdateManyArgs> = z
	.object({
		data: z.union([
			driver_activity_logsUpdateManyMutationInputSchema,
			driver_activity_logsUncheckedUpdateManyInputSchema,
		]),
