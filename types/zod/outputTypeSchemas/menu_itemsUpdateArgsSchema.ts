...
export const menu_itemsUpdateArgsSchema: z.ZodType<Prisma.menu_itemsUpdateArgs> = z.object({
  select: menu_itemsSelectSchema.optional(),
  include: menu_itemsIncludeSchema.optional(),
  data: z.union([ menu_itemsUpdateInputSchema,menu_itemsUncheckedUpdateInputSchema ]),
  where: menu_itemsWhereUniqueInputSchema,
}).strict() ;

export default menu_itemsUpdateArgsSchema;
