...
export const vehicle_driversCreateManyArgsSchema: z.ZodType<Prisma.vehicle_driversCreateManyArgs> = z.object({
  data: z.union([ vehicle_driversCreateManyInputSchema,vehicle_driversCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default vehicle_driversCreateManyArgsSchema;
