...
export const fiscal_devicesGroupByArgsSchema: z.ZodType<Prisma.fiscal_devicesGroupByArgs> = z.object({
  where: fiscal_devicesWhereInputSchema.optional(),
  orderBy: z.union([ fiscal_devicesOrderByWithAggregationInputSchema.array(),fiscal_devicesOrderByWithAggregationInputSchema ]).optional(),
