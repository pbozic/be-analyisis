...
export const order_lobbiesCreateManyAndReturnArgsSchema: z.ZodType<Prisma.order_lobbiesCreateManyAndReturnArgs> = z.object({
  data: z.union([ order_lobbiesCreateManyInputSchema,order_lobbiesCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default order_lobbiesCreateManyAndReturnArgsSchema;
