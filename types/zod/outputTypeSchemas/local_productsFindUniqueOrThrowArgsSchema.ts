...
export const local_productsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.local_productsFindUniqueOrThrowArgs> = z.object({
...
export default local_productsFindUniqueOrThrowArgsSchema;
