...
export const driver_activity_settingsUpdateManyArgsSchema: z.ZodType<Prisma.driver_activity_settingsUpdateManyArgs> = z
	.object({
		data: z.union([
			driver_activity_settingsUpdateManyMutationInputSchema,
			driver_activity_settingsUncheckedUpdateManyInputSchema,
		]),
