...
export const promo_ads_categoryGroupByArgsSchema: z.ZodType<Prisma.promo_ads_categoryGroupByArgs> = z
	.object({
		where: promo_ads_categoryWhereInputSchema.optional(),
		orderBy: z
			.union([
				promo_ads_categoryOrderByWithAggregationInputSchema.array(),
				promo_ads_categoryOrderByWithAggregationInputSchema,
			])
			.optional(),
