...
export const driver_activity_settingsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.driver_activity_settingsFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ Driver_activity_settingsScalarFieldEnumSchema,Driver_activity_settingsScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default driver_activity_settingsFindFirstOrThrowArgsSchema;
