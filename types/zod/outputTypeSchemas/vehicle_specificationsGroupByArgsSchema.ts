...
export const vehicle_specificationsGroupByArgsSchema: z.ZodType<Prisma.vehicle_specificationsGroupByArgs> = z.object({
  where: vehicle_specificationsWhereInputSchema.optional(),
  orderBy: z.union([ vehicle_specificationsOrderByWithAggregationInputSchema.array(),vehicle_specificationsOrderByWithAggregationInputSchema ]).optional(),
