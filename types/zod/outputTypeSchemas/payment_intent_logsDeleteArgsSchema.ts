...
export const payment_intent_logsDeleteArgsSchema: z.ZodType<Prisma.payment_intent_logsDeleteArgs> = z.object({
  select: payment_intent_logsSelectSchema.optional(),
  where: payment_intent_logsWhereUniqueInputSchema,
}).strict() ;

export default payment_intent_logsDeleteArgsSchema;
