...
export const lost_itemsCreateArgsSchema: z.ZodType<Prisma.lost_itemsCreateArgs> = z.object({
  select: lost_itemsSelectSchema.optional(),
  include: lost_itemsIncludeSchema.optional(),
  data: z.union([ lost_itemsCreateInputSchema,lost_itemsUncheckedCreateInputSchema ]),
}).strict() ;

export default lost_itemsCreateArgsSchema;
