...
import { cashbackCreateInputSchema } from '../inputTypeSchemas/cashbackCreateInputSchema'
import { cashbackUncheckedCreateInputSchema } from '../inputTypeSchemas/cashbackUncheckedCreateInputSchema'
import { cashbackUpdateInputSchema } from '../inputTypeSchemas/cashbackUpdateInputSchema'
import { cashbackUncheckedUpdateInputSchema } from '../inputTypeSchemas/cashbackUncheckedUpdateInputSchema'
...
export const cashbackUpsertArgsSchema: z.ZodType<Prisma.cashbackUpsertArgs> = z.object({
  select: cashbackSelectSchema.optional(),
  include: cashbackIncludeSchema.optional(),
  where: cashbackWhereUniqueInputSchema,
  create: z.union([ cashbackCreateInputSchema,cashbackUncheckedCreateInputSchema ]),
  update: z.union([ cashbackUpdateInputSchema,cashbackUncheckedUpdateInputSchema ]),
}).strict() ;

export default cashbackUpsertArgsSchema;
