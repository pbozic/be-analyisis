...
export const reviewableFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.reviewableFindUniqueOrThrowArgs> = z.object({
  select: reviewableSelectSchema.optional(),
  include: reviewableIncludeSchema.optional(),
  where: reviewableWhereUniqueInputSchema,
}).strict() ;

export default reviewableFindUniqueOrThrowArgsSchema;
