...
export const delivery_driversFindFirstOrThrowArgsSchema: z.ZodType<Prisma.delivery_driversFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ Delivery_driversScalarFieldEnumSchema,Delivery_driversScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default delivery_driversFindFirstOrThrowArgsSchema;
