...
export const delivery_driversFindFirstOrThrowArgsSchema: z.ZodType<Prisma.delivery_driversFindFirstOrThrowArgs> = z
	.object({
		...
		orderBy: z
			.union([
				delivery_driversOrderByWithRelationInputSchema.array(),
				delivery_driversOrderByWithRelationInputSchema,
			])
			.optional(),
		...
		distinct: z
			.union([Delivery_driversScalarFieldEnumSchema, Delivery_driversScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();
