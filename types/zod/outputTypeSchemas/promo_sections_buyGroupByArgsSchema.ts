...
export const promo_sections_buyGroupByArgsSchema: z.ZodType<Prisma.promo_sections_buyGroupByArgs> = z
	.object({
		where: promo_sections_buyWhereInputSchema.optional(),
		orderBy: z
			.union([
				promo_sections_buyOrderByWithAggregationInputSchema.array(),
				promo_sections_buyOrderByWithAggregationInputSchema,
			])
			.optional(),
