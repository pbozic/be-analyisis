...
export const flagsGroupByArgsSchema: z.ZodType<Prisma.flagsGroupByArgs> = z
	.object({
		where: flagsWhereInputSchema.optional(),
		orderBy: z
			.union([flagsOrderByWithAggregationInputSchema.array(), flagsOrderByWithAggregationInputSchema])
			.optional(),
