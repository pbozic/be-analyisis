...
export const promo_adsGroupByArgsSchema: z.ZodType<Prisma.promo_adsGroupByArgs> = z.object({
  where: promo_adsWhereInputSchema.optional(),
  orderBy: z.union([ promo_adsOrderByWithAggregationInputSchema.array(),promo_adsOrderByWithAggregationInputSchema ]).optional(),
