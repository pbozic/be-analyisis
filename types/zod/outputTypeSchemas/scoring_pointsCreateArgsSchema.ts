...
export const scoring_pointsCreateArgsSchema: z.ZodType<Prisma.scoring_pointsCreateArgs> = z.object({
  select: scoring_pointsSelectSchema.optional(),
  include: scoring_pointsIncludeSchema.optional(),
  data: z.union([ scoring_pointsCreateInputSchema,scoring_pointsUncheckedCreateInputSchema ]),
}).strict() ;

export default scoring_pointsCreateArgsSchema;
