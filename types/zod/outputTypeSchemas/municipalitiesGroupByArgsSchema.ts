...
export const municipalitiesGroupByArgsSchema: z.ZodType<Prisma.municipalitiesGroupByArgs> = z
	.object({
		where: municipalitiesWhereInputSchema.optional(),
		orderBy: z
			.union([
				municipalitiesOrderByWithAggregationInputSchema.array(),
				municipalitiesOrderByWithAggregationInputSchema,
			])
			.optional(),
