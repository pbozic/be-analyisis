...
export const delivery_driver_history_locationsGroupByArgsSchema: z.ZodType<Prisma.delivery_driver_history_locationsGroupByArgs> =
	z
		.object({
			where: delivery_driver_history_locationsWhereInputSchema.optional(),
			orderBy: z
				.union([
					delivery_driver_history_locationsOrderByWithAggregationInputSchema.array(),
					delivery_driver_history_locationsOrderByWithAggregationInputSchema,
				])
				.optional(),
