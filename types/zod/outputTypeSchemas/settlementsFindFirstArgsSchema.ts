...
export const settlementsFindFirstArgsSchema: z.ZodType<Prisma.settlementsFindFirstArgs> = z.object({
  ...
  orderBy: z.union([ settlementsOrderByWithRelationInputSchema.array(),settlementsOrderByWithRelationInputSchema ]).optional(),
...
export default settlementsFindFirstArgsSchema;
