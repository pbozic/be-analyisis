...
export const financesGroupByArgsSchema: z.ZodType<Prisma.financesGroupByArgs> = z.object({
  where: financesWhereInputSchema.optional(),
  orderBy: z.union([ financesOrderByWithAggregationInputSchema.array(),financesOrderByWithAggregationInputSchema ]).optional(),
