...
export const scoring_pointsGroupByArgsSchema: z.ZodType<Prisma.scoring_pointsGroupByArgs> = z.object({
  where: scoring_pointsWhereInputSchema.optional(),
  orderBy: z.union([ scoring_pointsOrderByWithAggregationInputSchema.array(),scoring_pointsOrderByWithAggregationInputSchema ]).optional(),
