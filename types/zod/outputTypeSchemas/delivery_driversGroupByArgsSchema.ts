...
export const delivery_driversGroupByArgsSchema: z.ZodType<Prisma.delivery_driversGroupByArgs> = z
	.object({
		where: delivery_driversWhereInputSchema.optional(),
		orderBy: z
			.union([
				delivery_driversOrderByWithAggregationInputSchema.array(),
				delivery_driversOrderByWithAggregationInputSchema,
			])
			.optional(),
