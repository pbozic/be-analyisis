...
export const driversUpdateArgsSchema: z.ZodType<Prisma.driversUpdateArgs> = z.object({
  select: driversSelectSchema.optional(),
  include: driversIncludeSchema.optional(),
  data: z.union([ driversUpdateInputSchema,driversUncheckedUpdateInputSchema ]),
  where: driversWhereUniqueInputSchema,
}).strict() ;

export default driversUpdateArgsSchema;
