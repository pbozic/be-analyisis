...
export const delivery_driver_history_locationsCreateArgsSchema: z.ZodType<Prisma.delivery_driver_history_locationsCreateArgs> = z.object({
  ...
  data: z.union([ delivery_driver_history_locationsCreateInputSchema,delivery_driver_history_locationsUncheckedCreateInputSchema ]),
}).strict() ;

export default delivery_driver_history_locationsCreateArgsSchema;
