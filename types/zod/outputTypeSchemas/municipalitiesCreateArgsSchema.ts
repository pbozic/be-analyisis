...
export const municipalitiesCreateArgsSchema: z.ZodType<Prisma.municipalitiesCreateArgs> = z.object({
  select: municipalitiesSelectSchema.optional(),
  include: municipalitiesIncludeSchema.optional(),
  data: z.union([ municipalitiesCreateInputSchema,municipalitiesUncheckedCreateInputSchema ]),
}).strict() ;

export default municipalitiesCreateArgsSchema;
