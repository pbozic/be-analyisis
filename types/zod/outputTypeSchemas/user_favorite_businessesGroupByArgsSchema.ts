...
export const user_favorite_businessesGroupByArgsSchema: z.ZodType<Prisma.user_favorite_businessesGroupByArgs> = z
	.object({
		where: user_favorite_businessesWhereInputSchema.optional(),
		orderBy: z
			.union([
				user_favorite_businessesOrderByWithAggregationInputSchema.array(),
				user_favorite_businessesOrderByWithAggregationInputSchema,
			])
			.optional(),
