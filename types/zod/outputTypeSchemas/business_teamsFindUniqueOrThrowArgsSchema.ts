...
export const business_teamsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.business_teamsFindUniqueOrThrowArgs> = z.object({
...
export default business_teamsFindUniqueOrThrowArgsSchema;
