...
export const lost_itemsFindFirstArgsSchema: z.ZodType<Prisma.lost_itemsFindFirstArgs> = z.object({
  select: lost_itemsSelectSchema.optional(),
  include: lost_itemsIncludeSchema.optional(),
  where: lost_itemsWhereInputSchema.optional(),
  orderBy: z.union([ lost_itemsOrderByWithRelationInputSchema.array(),lost_itemsOrderByWithRelationInputSchema ]).optional(),
...
export default lost_itemsFindFirstArgsSchema;
