...
import { promo_ads_categoryUpdateInputSchema } from '../inputTypeSchemas/promo_ads_categoryUpdateInputSchema'
import { promo_ads_categoryUncheckedUpdateInputSchema } from '../inputTypeSchemas/promo_ads_categoryUncheckedUpdateInputSchema'
...
export const promo_ads_categoryUpsertArgsSchema: z.ZodType<Prisma.promo_ads_categoryUpsertArgs> = z.object({
  ...
  create: z.union([ promo_ads_categoryCreateInputSchema,promo_ads_categoryUncheckedCreateInputSchema ]),
  update: z.union([ promo_ads_categoryUpdateInputSchema,promo_ads_categoryUncheckedUpdateInputSchema ]),
}).strict() ;

export default promo_ads_categoryUpsertArgsSchema;
