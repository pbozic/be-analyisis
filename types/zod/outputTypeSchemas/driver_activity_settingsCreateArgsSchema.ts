...
export const driver_activity_settingsCreateArgsSchema: z.ZodType<Prisma.driver_activity_settingsCreateArgs> = z
	.object({
		select: driver_activity_settingsSelectSchema.optional(),
		data: z
			.union([driver_activity_settingsCreateInputSchema, driver_activity_settingsUncheckedCreateInputSchema])
			.optional(),
	})
	.strict();
