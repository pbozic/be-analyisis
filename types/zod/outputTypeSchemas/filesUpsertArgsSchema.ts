...
import { filesCreateInputSchema } from '../inputTypeSchemas/filesCreateInputSchema'
import { filesUncheckedCreateInputSchema } from '../inputTypeSchemas/filesUncheckedCreateInputSchema'
...
export const filesUpsertArgsSchema: z.ZodType<Prisma.filesUpsertArgs> = z.object({
  select: filesSelectSchema.optional(),
  include: filesIncludeSchema.optional(),
  where: filesWhereUniqueInputSchema,
  create: z.union([ filesCreateInputSchema,filesUncheckedCreateInputSchema ]),
  update: z.union([ filesUpdateInputSchema,filesUncheckedUpdateInputSchema ]),
}).strict() ;

export default filesUpsertArgsSchema;
