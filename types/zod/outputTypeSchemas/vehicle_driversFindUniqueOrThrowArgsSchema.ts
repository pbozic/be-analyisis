...
export const vehicle_driversFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.vehicle_driversFindUniqueOrThrowArgs> = z.object({
...
export default vehicle_driversFindUniqueOrThrowArgsSchema;
