...
export const taxi_order_sentFindUniqueArgsSchema: z.ZodType<Prisma.taxi_order_sentFindUniqueArgs> = z.object({
...
export default taxi_order_sentFindUniqueArgsSchema;
