...
export const driver_history_locationsUpdateArgsSchema: z.ZodType<Prisma.driver_history_locationsUpdateArgs> = z
	.object({
		select: driver_history_locationsSelectSchema.optional(),
		include: driver_history_locationsIncludeSchema.optional(),
		data: z.union([driver_history_locationsUpdateInputSchema, driver_history_locationsUncheckedUpdateInputSchema]),
		where: driver_history_locationsWhereUniqueInputSchema,
	})
	.strict();

export default driver_history_locationsUpdateArgsSchema;
