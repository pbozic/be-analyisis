...
export const driver_municipalitiesUpdateManyArgsSchema: z.ZodType<Prisma.driver_municipalitiesUpdateManyArgs> = z.object({
  data: z.union([ driver_municipalitiesUpdateManyMutationInputSchema,driver_municipalitiesUncheckedUpdateManyInputSchema ]),
