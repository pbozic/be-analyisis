...
export const menu_itemsCreateArgsSchema: z.ZodType<Prisma.menu_itemsCreateArgs> = z.object({
  select: menu_itemsSelectSchema.optional(),
  include: menu_itemsIncludeSchema.optional(),
  data: z.union([ menu_itemsCreateInputSchema,menu_itemsUncheckedCreateInputSchema ]),
}).strict() ;

export default menu_itemsCreateArgsSchema;
