...
export const payment_intent_logsFindFirstArgsSchema: z.ZodType<Prisma.payment_intent_logsFindFirstArgs> = z.object({
  select: payment_intent_logsSelectSchema.optional(),
  where: payment_intent_logsWhereInputSchema.optional(),
  orderBy: z.union([ payment_intent_logsOrderByWithRelationInputSchema.array(),payment_intent_logsOrderByWithRelationInputSchema ]).optional(),
  cursor: payment_intent_logsWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ Payment_intent_logsScalarFieldEnumSchema,Payment_intent_logsScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default payment_intent_logsFindFirstArgsSchema;
