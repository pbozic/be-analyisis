...
export const menu_itemsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.menu_itemsFindFirstOrThrowArgs> = z.object({
  select: menu_itemsSelectSchema.optional(),
  include: menu_itemsIncludeSchema.optional(),
  where: menu_itemsWhereInputSchema.optional(),
  orderBy: z.union([ menu_itemsOrderByWithRelationInputSchema.array(),menu_itemsOrderByWithRelationInputSchema ]).optional(),
  cursor: menu_itemsWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ Menu_itemsScalarFieldEnumSchema,Menu_itemsScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default menu_itemsFindFirstOrThrowArgsSchema;
