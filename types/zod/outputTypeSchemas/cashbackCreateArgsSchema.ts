...
export const cashbackCreateArgsSchema: z.ZodType<Prisma.cashbackCreateArgs> = z.object({
  select: cashbackSelectSchema.optional(),
  include: cashbackIncludeSchema.optional(),
  data: z.union([ cashbackCreateInputSchema,cashbackUncheckedCreateInputSchema ]),
}).strict() ;

export default cashbackCreateArgsSchema;
