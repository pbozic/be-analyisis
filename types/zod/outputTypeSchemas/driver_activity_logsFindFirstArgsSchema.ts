...
export const driver_activity_logsFindFirstArgsSchema: z.ZodType<Prisma.driver_activity_logsFindFirstArgs> = z.object({
  ...
  distinct: z.union([ Driver_activity_logsScalarFieldEnumSchema,Driver_activity_logsScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default driver_activity_logsFindFirstArgsSchema;
