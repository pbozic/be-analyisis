...
export const categoriesFindFirstOrThrowArgsSchema: z.ZodType<Prisma.categoriesFindFirstOrThrowArgs> = z
	.object({
...
export default categoriesFindFirstOrThrowArgsSchema;
