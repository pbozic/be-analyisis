...
export const daily_meals_subscriptionsUpdateManyArgsSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpdateManyArgs> =
	z
		.object({
			data: z.union([
				daily_meals_subscriptionsUpdateManyMutationInputSchema,
				daily_meals_subscriptionsUncheckedUpdateManyInputSchema,
			]),
