...
export const flag_historyGroupByArgsSchema: z.ZodType<Prisma.flag_historyGroupByArgs> = z.object({
  where: flag_historyWhereInputSchema.optional(),
  orderBy: z.union([ flag_historyOrderByWithAggregationInputSchema.array(),flag_historyOrderByWithAggregationInputSchema ]).optional(),
