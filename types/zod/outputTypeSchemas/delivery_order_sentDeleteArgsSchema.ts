...
export const delivery_order_sentDeleteArgsSchema: z.ZodType<Prisma.delivery_order_sentDeleteArgs> = z.object({
...
export default delivery_order_sentDeleteArgsSchema;
