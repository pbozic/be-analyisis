...
export const menu_itemsGroupByArgsSchema: z.ZodType<Prisma.menu_itemsGroupByArgs> = z.object({
  where: menu_itemsWhereInputSchema.optional(),
  orderBy: z.union([ menu_itemsOrderByWithAggregationInputSchema.array(),menu_itemsOrderByWithAggregationInputSchema ]).optional(),
