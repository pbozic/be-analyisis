...
export const scoring_pointsFindUniqueArgsSchema: z.ZodType<Prisma.scoring_pointsFindUniqueArgs> = z.object({
...
export default scoring_pointsFindUniqueArgsSchema;
