...
export const taxi_order_sentCreateArgsSchema: z.ZodType<Prisma.taxi_order_sentCreateArgs> = z.object({
  select: taxi_order_sentSelectSchema.optional(),
  include: taxi_order_sentIncludeSchema.optional(),
  data: z.union([ taxi_order_sentCreateInputSchema,taxi_order_sentUncheckedCreateInputSchema ]),
}).strict() ;

export default taxi_order_sentCreateArgsSchema;
