...
import { weather_dataCreateInputSchema } from '../inputTypeSchemas/weather_dataCreateInputSchema'
import { weather_dataUncheckedCreateInputSchema } from '../inputTypeSchemas/weather_dataUncheckedCreateInputSchema'
import { weather_dataUpdateInputSchema } from '../inputTypeSchemas/weather_dataUpdateInputSchema'
import { weather_dataUncheckedUpdateInputSchema } from '../inputTypeSchemas/weather_dataUncheckedUpdateInputSchema'
...
export const weather_dataSelectSchema: z.ZodType<Prisma.weather_dataSelect> = z.object({
...
export const weather_dataUpsertArgsSchema: z.ZodType<Prisma.weather_dataUpsertArgs> = z.object({
  ...
  create: z.union([ weather_dataCreateInputSchema,weather_dataUncheckedCreateInputSchema ]),
  update: z.union([ weather_dataUpdateInputSchema,weather_dataUncheckedUpdateInputSchema ]),
}).strict() ;

export default weather_dataUpsertArgsSchema;
