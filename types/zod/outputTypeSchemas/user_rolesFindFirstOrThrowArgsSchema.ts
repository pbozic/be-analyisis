...
export const user_rolesFindFirstOrThrowArgsSchema: z.ZodType<Prisma.user_rolesFindFirstOrThrowArgs> = z
	.object({
		select: user_rolesSelectSchema.optional(),
		include: user_rolesIncludeSchema.optional(),
		where: user_rolesWhereInputSchema.optional(),
		orderBy: z
			.union([user_rolesOrderByWithRelationInputSchema.array(), user_rolesOrderByWithRelationInputSchema])
			.optional(),
...
export default user_rolesFindFirstOrThrowArgsSchema;
