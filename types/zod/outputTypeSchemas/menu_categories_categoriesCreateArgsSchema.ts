...
export const menu_categories_categoriesCreateArgsSchema: z.ZodType<Prisma.menu_categories_categoriesCreateArgs> = z.object({
  select: menu_categories_categoriesSelectSchema.optional(),
  include: menu_categories_categoriesIncludeSchema.optional(),
  data: z.union([ menu_categories_categoriesCreateInputSchema,menu_categories_categoriesUncheckedCreateInputSchema ]),
}).strict() ;

export default menu_categories_categoriesCreateArgsSchema;
