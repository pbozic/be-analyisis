...
export const taxi_order_sentFindFirstArgsSchema: z.ZodType<Prisma.taxi_order_sentFindFirstArgs> = z
	.object({
		...
		orderBy: z
			.union([
				taxi_order_sentOrderByWithRelationInputSchema.array(),
				taxi_order_sentOrderByWithRelationInputSchema,
			])
			.optional(),
		...
		distinct: z
			.union([Taxi_order_sentScalarFieldEnumSchema, Taxi_order_sentScalarFieldEnumSchema.array()])
			.optional(),
	})
	.strict();

export default taxi_order_sentFindFirstArgsSchema;
