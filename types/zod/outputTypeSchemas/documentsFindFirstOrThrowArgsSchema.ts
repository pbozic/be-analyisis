...
export const documentsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.documentsFindFirstOrThrowArgs> = z
	.object({
		select: documentsSelectSchema.optional(),
		include: documentsIncludeSchema.optional(),
		where: documentsWhereInputSchema.optional(),
		orderBy: z
			.union([documentsOrderByWithRelationInputSchema.array(), documentsOrderByWithRelationInputSchema])
			.optional(),
...
export default documentsFindFirstOrThrowArgsSchema;
