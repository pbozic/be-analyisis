...
import { driver_history_locationsCreateInputSchema } from '../inputTypeSchemas/driver_history_locationsCreateInputSchema';
import { driver_history_locationsUncheckedCreateInputSchema } from '../inputTypeSchemas/driver_history_locationsUncheckedCreateInputSchema';
import { driver_history_locationsUpdateInputSchema } from '../inputTypeSchemas/driver_history_locationsUpdateInputSchema';
import { driver_history_locationsUncheckedUpdateInputSchema } from '../inputTypeSchemas/driver_history_locationsUncheckedUpdateInputSchema';
...
export const driver_history_locationsSelectSchema: z.ZodType<Prisma.driver_history_locationsSelect> = z
	.object({
...
export const driver_history_locationsUpsertArgsSchema: z.ZodType<Prisma.driver_history_locationsUpsertArgs> = z
	.object({
		...
		create: z.union([
			driver_history_locationsCreateInputSchema,
			driver_history_locationsUncheckedCreateInputSchema,
		]),
		update: z.union([
			driver_history_locationsUpdateInputSchema,
			driver_history_locationsUncheckedUpdateInputSchema,
		]),
	})
	.strict();

export default driver_history_locationsUpsertArgsSchema;
