...
export const driver_history_locationsUpsertArgsSchema: z.ZodType<Prisma.driver_history_locationsUpsertArgs> = z.object({
  ...
  create: z.union([ driver_history_locationsCreateInputSchema,driver_history_locationsUncheckedCreateInputSchema ]),
  update: z.union([ driver_history_locationsUpdateInputSchema,driver_history_locationsUncheckedUpdateInputSchema ]),
}).strict() ;
