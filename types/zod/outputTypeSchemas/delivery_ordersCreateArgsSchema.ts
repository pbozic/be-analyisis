...
export const delivery_ordersCreateArgsSchema: z.ZodType<Prisma.delivery_ordersCreateArgs> = z.object({
  select: delivery_ordersSelectSchema.optional(),
  include: delivery_ordersIncludeSchema.optional(),
  data: z.union([ delivery_ordersCreateInputSchema,delivery_ordersUncheckedCreateInputSchema ]),
}).strict() ;

export default delivery_ordersCreateArgsSchema;
