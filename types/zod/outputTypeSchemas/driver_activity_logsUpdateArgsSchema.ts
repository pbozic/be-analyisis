...
export const driver_activity_logsUpdateArgsSchema: z.ZodType<Prisma.driver_activity_logsUpdateArgs> = z.object({
  select: driver_activity_logsSelectSchema.optional(),
  include: driver_activity_logsIncludeSchema.optional(),
  data: z.union([ driver_activity_logsUpdateInputSchema,driver_activity_logsUncheckedUpdateInputSchema ]),
  where: driver_activity_logsWhereUniqueInputSchema,
}).strict() ;

export default driver_activity_logsUpdateArgsSchema;
