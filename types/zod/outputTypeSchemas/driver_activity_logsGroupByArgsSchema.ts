...
export const driver_activity_logsGroupByArgsSchema: z.ZodType<Prisma.driver_activity_logsGroupByArgs> = z.object({
  where: driver_activity_logsWhereInputSchema.optional(),
  orderBy: z.union([ driver_activity_logsOrderByWithAggregationInputSchema.array(),driver_activity_logsOrderByWithAggregationInputSchema ]).optional(),
