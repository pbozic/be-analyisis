...
export const municipalitiesFindUniqueArgsSchema: z.ZodType<Prisma.municipalitiesFindUniqueArgs> = z.object({
...
export default municipalitiesFindUniqueArgsSchema;
