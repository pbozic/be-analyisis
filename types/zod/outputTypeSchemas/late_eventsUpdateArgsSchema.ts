...
export const late_eventsUpdateArgsSchema: z.ZodType<Prisma.late_eventsUpdateArgs> = z.object({
  select: late_eventsSelectSchema.optional(),
  include: late_eventsIncludeSchema.optional(),
  data: z.union([ late_eventsUpdateInputSchema,late_eventsUncheckedUpdateInputSchema ]),
  where: late_eventsWhereUniqueInputSchema,
}).strict() ;

export default late_eventsUpdateArgsSchema;
