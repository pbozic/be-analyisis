...
export const delivery_order_sentGroupByArgsSchema: z.ZodType<Prisma.delivery_order_sentGroupByArgs> = z
	.object({
		where: delivery_order_sentWhereInputSchema.optional(),
		orderBy: z
			.union([
				delivery_order_sentOrderByWithAggregationInputSchema.array(),
				delivery_order_sentOrderByWithAggregationInputSchema,
			])
			.optional(),
