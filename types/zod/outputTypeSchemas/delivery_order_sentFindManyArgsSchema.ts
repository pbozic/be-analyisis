...
export const delivery_order_sentFindManyArgsSchema: z.ZodType<Prisma.delivery_order_sentFindManyArgs> = z.object({
...
export default delivery_order_sentFindManyArgsSchema;
