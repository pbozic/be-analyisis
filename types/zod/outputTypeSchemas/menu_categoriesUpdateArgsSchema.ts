...
export const menu_categoriesUpdateArgsSchema: z.ZodType<Prisma.menu_categoriesUpdateArgs> = z.object({
  select: menu_categoriesSelectSchema.optional(),
  include: menu_categoriesIncludeSchema.optional(),
  data: z.union([ menu_categoriesUpdateInputSchema,menu_categoriesUncheckedUpdateInputSchema ]),
  where: menu_categoriesWhereUniqueInputSchema,
}).strict() ;

export default menu_categoriesUpdateArgsSchema;
