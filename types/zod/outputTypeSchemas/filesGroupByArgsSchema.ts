...
export const filesGroupByArgsSchema: z.ZodType<Prisma.filesGroupByArgs> = z
	.object({
		where: filesWhereInputSchema.optional(),
		orderBy: z
			.union([filesOrderByWithAggregationInputSchema.array(), filesOrderByWithAggregationInputSchema])
			.optional(),
