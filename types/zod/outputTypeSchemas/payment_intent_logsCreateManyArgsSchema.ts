...
export const payment_intent_logsCreateManyArgsSchema: z.ZodType<Prisma.payment_intent_logsCreateManyArgs> = z.object({
  data: z.union([ payment_intent_logsCreateManyInputSchema,payment_intent_logsCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default payment_intent_logsCreateManyArgsSchema;
