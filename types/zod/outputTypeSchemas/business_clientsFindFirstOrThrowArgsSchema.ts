...
export const business_clientsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.business_clientsFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ business_clientsOrderByWithRelationInputSchema.array(),business_clientsOrderByWithRelationInputSchema ]).optional(),
  cursor: business_clientsWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ Business_clientsScalarFieldEnumSchema,Business_clientsScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default business_clientsFindFirstOrThrowArgsSchema;
