...
export const documentsGroupByArgsSchema: z.ZodType<Prisma.documentsGroupByArgs> = z
	.object({
		where: documentsWhereInputSchema.optional(),
		orderBy: z
			.union([documentsOrderByWithAggregationInputSchema.array(), documentsOrderByWithAggregationInputSchema])
			.optional(),
