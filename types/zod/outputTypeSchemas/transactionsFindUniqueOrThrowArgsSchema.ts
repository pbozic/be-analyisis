...
export const transactionsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.transactionsFindUniqueOrThrowArgs> = z
	.object({
...
export default transactionsFindUniqueOrThrowArgsSchema;
