...
export const driversGroupByArgsSchema: z.ZodType<Prisma.driversGroupByArgs> = z.object({
  where: driversWhereInputSchema.optional(),
  orderBy: z.union([ driversOrderByWithAggregationInputSchema.array(),driversOrderByWithAggregationInputSchema ]).optional(),
