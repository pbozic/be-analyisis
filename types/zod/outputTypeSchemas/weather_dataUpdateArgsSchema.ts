...
export const weather_dataUpdateArgsSchema: z.ZodType<Prisma.weather_dataUpdateArgs> = z.object({
  select: weather_dataSelectSchema.optional(),
  include: weather_dataIncludeSchema.optional(),
  data: z.union([ weather_dataUpdateInputSchema,weather_dataUncheckedUpdateInputSchema ]),
  where: weather_dataWhereUniqueInputSchema,
}).strict() ;

export default weather_dataUpdateArgsSchema;
