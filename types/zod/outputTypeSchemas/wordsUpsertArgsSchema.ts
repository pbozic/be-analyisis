...
import { wordsCreateInputSchema } from '../inputTypeSchemas/wordsCreateInputSchema'
import { wordsUncheckedCreateInputSchema } from '../inputTypeSchemas/wordsUncheckedCreateInputSchema'
import { wordsUpdateInputSchema } from '../inputTypeSchemas/wordsUpdateInputSchema'
import { wordsUncheckedUpdateInputSchema } from '../inputTypeSchemas/wordsUncheckedUpdateInputSchema'
...
export const wordsUpsertArgsSchema: z.ZodType<Prisma.wordsUpsertArgs> = z.object({
  select: wordsSelectSchema.optional(),
  include: wordsIncludeSchema.optional(),
  where: wordsWhereUniqueInputSchema,
  create: z.union([ wordsCreateInputSchema,wordsUncheckedCreateInputSchema ]),
  update: z.union([ wordsUpdateInputSchema,wordsUncheckedUpdateInputSchema ]),
}).strict() ;

export default wordsUpsertArgsSchema;
