...
export const promo_adsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.promo_adsFindFirstOrThrowArgs> = z.object({
  select: promo_adsSelectSchema.optional(),
  include: promo_adsIncludeSchema.optional(),
  where: promo_adsWhereInputSchema.optional(),
  orderBy: z.union([ promo_adsOrderByWithRelationInputSchema.array(),promo_adsOrderByWithRelationInputSchema ]).optional(),
...
export default promo_adsFindFirstOrThrowArgsSchema;
