...
export const late_eventsCreateWithoutBusinessesInputSchema: z.ZodType<Prisma.late_eventsCreateWithoutBusinessesInput> = z.object({
...
export default late_eventsCreateWithoutBusinessesInputSchema;
