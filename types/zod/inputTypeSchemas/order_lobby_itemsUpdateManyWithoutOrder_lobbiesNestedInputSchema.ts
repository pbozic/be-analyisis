...
export const order_lobby_itemsUpdateManyWithoutOrder_lobbiesNestedInputSchema: z.ZodType<Prisma.order_lobby_itemsUpdateManyWithoutOrder_lobbiesNestedInput> =
	z
		.object({
			create: z
				.union([
