...
export const order_lobby_itemsUpdateManyWithoutOrder_lobbiesNestedInputSchema: z.ZodType<Prisma.order_lobby_itemsUpdateManyWithoutOrder_lobbiesNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => order_lobby_itemsUpsertWithWhereUniqueWithoutOrder_lobbiesInputSchema),z.lazy(() => order_lobby_itemsUpsertWithWhereUniqueWithoutOrder_lobbiesInputSchema).array() ]).optional(),
  createMany: z.lazy(() => order_lobby_itemsCreateManyOrder_lobbiesInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => order_lobby_itemsWhereUniqueInputSchema),z.lazy(() => order_lobby_itemsWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => order_lobby_itemsWhereUniqueInputSchema),z.lazy(() => order_lobby_itemsWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => order_lobby_itemsWhereUniqueInputSchema),z.lazy(() => order_lobby_itemsWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => order_lobby_itemsUpdateWithWhereUniqueWithoutOrder_lobbiesInputSchema),z.lazy(() => order_lobby_itemsUpdateWithWhereUniqueWithoutOrder_lobbiesInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => order_lobby_itemsUpdateManyWithWhereWithoutOrder_lobbiesInputSchema),z.lazy(() => order_lobby_itemsUpdateManyWithWhereWithoutOrder_lobbiesInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => order_lobby_itemsScalarWhereInputSchema),z.lazy(() => order_lobby_itemsScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default order_lobby_itemsUpdateManyWithoutOrder_lobbiesNestedInputSchema;
