...
export const business_clientsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.business_clientsScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => business_clientsScalarWhereWithAggregatesInputSchema),
					z.lazy(() => business_clientsScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => business_clientsScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
