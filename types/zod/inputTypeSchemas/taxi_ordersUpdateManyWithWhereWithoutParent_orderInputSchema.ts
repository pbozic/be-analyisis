...
export const taxi_ordersUpdateManyWithWhereWithoutParent_orderInputSchema: z.ZodType<Prisma.taxi_ordersUpdateManyWithWhereWithoutParent_orderInput> = z.object({
  where: z.lazy(() => taxi_ordersScalarWhereInputSchema),
  data: z.union([ z.lazy(() => taxi_ordersUpdateManyMutationInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateManyWithoutParent_orderInputSchema) ]),
}).strict();
