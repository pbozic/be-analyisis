...
export const delivery_ordersUpsertWithoutScoring_pointsInputSchema: z.ZodType<Prisma.delivery_ordersUpsertWithoutScoring_pointsInput> = z.object({
  update: z.union([ z.lazy(() => delivery_ordersUpdateWithoutScoring_pointsInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutScoring_pointsInputSchema) ]),
