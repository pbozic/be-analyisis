...
export const municipalitiesUpdateOneWithoutWeather_dataNestedInputSchema: z.ZodType<Prisma.municipalitiesUpdateOneWithoutWeather_dataNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => municipalitiesUpdateToOneWithWhereWithoutWeather_dataInputSchema),z.lazy(() => municipalitiesUpdateWithoutWeather_dataInputSchema),z.lazy(() => municipalitiesUncheckedUpdateWithoutWeather_dataInputSchema) ]).optional(),
}).strict();
