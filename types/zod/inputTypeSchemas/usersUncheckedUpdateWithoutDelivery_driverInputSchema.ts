...
import { flag_historyUncheckedUpdateManyWithoutUserNestedInputSchema } from './flag_historyUncheckedUpdateManyWithoutUserNestedInputSchema';
...
export const usersUncheckedUpdateWithoutDelivery_driverInputSchema: z.ZodType<Prisma.usersUncheckedUpdateWithoutDelivery_driverInput> = z.object({
  ...
  business_teams_id: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  flag_changes: z.lazy(() => flag_historyUncheckedUpdateManyWithoutUserNestedInputSchema).optional(),
  ...
  order_lobby_users: z.lazy(() => order_lobby_usersUncheckedUpdateManyWithoutUsersNestedInputSchema).optional(),
  promo_section_buys: z.lazy(() => promo_sections_buyUncheckedUpdateManyWithoutBought_byNestedInputSchema).optional(),
  user_favorite_businesses: z.lazy(() => user_favorite_businessesUncheckedUpdateManyWithoutUsersNestedInputSchema).optional(),
  scoring_points: z.lazy(() => scoring_pointsUncheckedUpdateManyWithoutUsersNestedInputSchema).optional(),
  daily_meals_subscriptions: z.lazy(() => daily_meals_subscriptionsUncheckedUpdateManyWithoutUserNestedInputSchema).optional(),
  ...
  created_account_actions: z.lazy(() => account_actionsUncheckedUpdateManyWithoutAction_creatorNestedInputSchema).optional()
}).strict();

export default usersUncheckedUpdateWithoutDelivery_driverInputSchema;
