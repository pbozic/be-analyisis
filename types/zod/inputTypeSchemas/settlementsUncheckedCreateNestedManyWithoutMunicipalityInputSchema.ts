...
export const settlementsUncheckedCreateNestedManyWithoutMunicipalityInputSchema: z.ZodType<Prisma.settlementsUncheckedCreateNestedManyWithoutMunicipalityInput> =
	z
		.object({
			create: z
				.union([
