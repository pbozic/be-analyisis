...
export const scoring_pointsWhereInputSchema: z.ZodType<Prisma.scoring_pointsWhereInput> = z.object({
  AND: z.union([ z.lazy(() => scoring_pointsWhereInputSchema),z.lazy(() => scoring_pointsWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => scoring_pointsWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => scoring_pointsWhereInputSchema),z.lazy(() => scoring_pointsWhereInputSchema).array() ]).optional(),
  ...
  users: z.union([ z.lazy(() => UsersNullableRelationFilterSchema),z.lazy(() => usersWhereInputSchema) ]).optional().nullable(),
  businesses: z.union([ z.lazy(() => BusinessNullableRelationFilterSchema),z.lazy(() => businessWhereInputSchema) ]).optional().nullable(),
  ...
  taxi_orders: z.union([ z.lazy(() => Taxi_ordersNullableRelationFilterSchema),z.lazy(() => taxi_ordersWhereInputSchema) ]).optional().nullable(),
  late_events: z.lazy(() => Late_eventsListRelationFilterSchema).optional()
}).strict();

export default scoring_pointsWhereInputSchema;
