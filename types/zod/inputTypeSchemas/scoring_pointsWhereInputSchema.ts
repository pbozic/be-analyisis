...
export const scoring_pointsWhereInputSchema: z.ZodType<Prisma.scoring_pointsWhereInput> = z
	.object({
		AND: z
			.union([z.lazy(() => scoring_pointsWhereInputSchema), z.lazy(() => scoring_pointsWhereInputSchema).array()])
			.optional(),
		OR: z
		...
		reason: z
			.union([z.lazy(() => EnumSCORING_POINTS_REASONFilterSchema), z.lazy(() => SCORING_POINTS_REASONSchema)])
			.optional(),
		expiration_date: z
