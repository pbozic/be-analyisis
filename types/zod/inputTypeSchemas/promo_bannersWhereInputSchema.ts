...
export const promo_bannersWhereInputSchema: z.ZodType<Prisma.promo_bannersWhereInput> = z
	.object({
		AND: z
			.union([z.lazy(() => promo_bannersWhereInputSchema), z.lazy(() => promo_bannersWhereInputSchema).array()])
			.optional(),
		OR: z
		...
		promo_ads: z
			.union([z.lazy(() => Promo_adsNullableRelationFilterSchema), z.lazy(() => promo_adsWhereInputSchema)])
			.optional()
			.nullable(),
	})
	.strict();
