...
export const user_addressCreateNestedManyWithoutUsersInputSchema: z.ZodType<Prisma.user_addressCreateNestedManyWithoutUsersInput> = z.object({
...
export default user_addressCreateNestedManyWithoutUsersInputSchema;
