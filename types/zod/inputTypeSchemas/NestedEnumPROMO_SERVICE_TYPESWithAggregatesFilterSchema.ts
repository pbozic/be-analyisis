...
export const NestedEnumPROMO_SERVICE_TYPESWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumPROMO_SERVICE_TYPESWithAggregatesFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => PROMO_SERVICE_TYPESSchema),z.lazy(() => NestedEnumPROMO_SERVICE_TYPESWithAggregatesFilterSchema) ]).optional(),
...
export default NestedEnumPROMO_SERVICE_TYPESWithAggregatesFilterSchema;
