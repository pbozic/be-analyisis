...
export const vehiclesUncheckedCreateNestedOneWithoutVehicle_specificationInputSchema: z.ZodType<Prisma.vehiclesUncheckedCreateNestedOneWithoutVehicle_specificationInput> =
	z
		.object({
			create: z
				.union([
