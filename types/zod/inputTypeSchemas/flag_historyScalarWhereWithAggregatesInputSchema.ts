...
export const flag_historyScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.flag_historyScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => flag_historyScalarWhereWithAggregatesInputSchema),
					z.lazy(() => flag_historyScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => flag_historyScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
