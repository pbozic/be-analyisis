...
export const late_eventsUpsertWithWhereUniqueWithoutBusinessesInputSchema: z.ZodType<Prisma.late_eventsUpsertWithWhereUniqueWithoutBusinessesInput> = z.object({
  where: z.lazy(() => late_eventsWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => late_eventsUpdateWithoutBusinessesInputSchema),z.lazy(() => late_eventsUncheckedUpdateWithoutBusinessesInputSchema) ]),
