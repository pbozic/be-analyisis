...
export const wordsUpdateWithWhereUniqueWithoutTranslatableInputSchema: z.ZodType<Prisma.wordsUpdateWithWhereUniqueWithoutTranslatableInput> = z.object({
  where: z.lazy(() => wordsWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => wordsUpdateWithoutTranslatableInputSchema),z.lazy(() => wordsUncheckedUpdateWithoutTranslatableInputSchema) ]),
}).strict();
