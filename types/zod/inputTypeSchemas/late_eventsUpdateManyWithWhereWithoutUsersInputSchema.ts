...
export const late_eventsUpdateManyWithWhereWithoutUsersInputSchema: z.ZodType<Prisma.late_eventsUpdateManyWithWhereWithoutUsersInput> =
	z
		.object({
			where: z.lazy(() => late_eventsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => late_eventsUpdateManyMutationInputSchema),
				z.lazy(() => late_eventsUncheckedUpdateManyWithoutUsersInputSchema),
			]),
		})
		.strict();
