...
export const taxi_ordersCreateNestedManyWithoutBusinessInputSchema: z.ZodType<Prisma.taxi_ordersCreateNestedManyWithoutBusinessInput> =
	z
		.object({
			create: z
				.union([
...
export default taxi_ordersCreateNestedManyWithoutBusinessInputSchema;
