...
export const daily_meals_subscriptionsWhereUniqueInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsWhereUniqueInput> =
	z
		.object({
			...
			z
				.object({
					...
					business: z
						...
						.optional(),
					menu: z
						.union([z.lazy(() => MenusRelationFilterSchema), z.lazy(() => menusWhereInputSchema)])
						.optional(),
					address: z
