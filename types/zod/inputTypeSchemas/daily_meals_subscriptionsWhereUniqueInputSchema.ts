...
export const daily_meals_subscriptionsWhereUniqueInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsWhereUniqueInput> = z.object({
  daily_meals_subscriptions_id: z.string().uuid()
})
.and(z.object({
  daily_meals_subscriptions_id: z.string().uuid().optional(),
  AND: z.union([ z.lazy(() => daily_meals_subscriptionsWhereInputSchema),z.lazy(() => daily_meals_subscriptionsWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => daily_meals_subscriptionsWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => daily_meals_subscriptionsWhereInputSchema),z.lazy(() => daily_meals_subscriptionsWhereInputSchema).array() ]).optional(),
  ...
  address: z.union([ z.lazy(() => AddressesRelationFilterSchema),z.lazy(() => addressesWhereInputSchema) ]).optional(),
}).strict());

export default daily_meals_subscriptionsWhereUniqueInputSchema;
