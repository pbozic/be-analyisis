...
export const delivery_driversCreateNestedOneWithoutDelivery_driver_history_locationsInputSchema: z.ZodType<Prisma.delivery_driversCreateNestedOneWithoutDelivery_driver_history_locationsInput> =
	z
		.object({
			create: z
				.union([
