...
export const wordsUncheckedCreateNestedManyWithoutCategoryInputSchema: z.ZodType<Prisma.wordsUncheckedCreateNestedManyWithoutCategoryInput> =
	z
		.object({
			create: z
				.union([
...
export default wordsUncheckedCreateNestedManyWithoutCategoryInputSchema;
