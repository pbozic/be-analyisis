...
export const word_buyCreateNestedManyWithoutWordInputSchema: z.ZodType<Prisma.word_buyCreateNestedManyWithoutWordInput> = z.object({
...
export default word_buyCreateNestedManyWithoutWordInputSchema;
