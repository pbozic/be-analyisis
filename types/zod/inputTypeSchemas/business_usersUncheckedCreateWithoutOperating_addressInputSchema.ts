...
export const business_usersUncheckedCreateWithoutOperating_addressInputSchema: z.ZodType<Prisma.business_usersUncheckedCreateWithoutOperating_addressInput> =
	z
		.object({
