...
export const addressesUpdateToOneWithWhereWithoutBusinesses_delivery_addressInputSchema: z.ZodType<Prisma.addressesUpdateToOneWithWhereWithoutBusinesses_delivery_addressInput> = z.object({
  where: z.lazy(() => addressesWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => addressesUpdateWithoutBusinesses_delivery_addressInputSchema),z.lazy(() => addressesUncheckedUpdateWithoutBusinesses_delivery_addressInputSchema) ]),
}).strict();
