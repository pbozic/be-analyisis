...
export const business_usersUpdateManyWithWhereWithoutOperating_addressInputSchema: z.ZodType<Prisma.business_usersUpdateManyWithWhereWithoutOperating_addressInput> = z.object({
  where: z.lazy(() => business_usersScalarWhereInputSchema),
  data: z.union([ z.lazy(() => business_usersUpdateManyMutationInputSchema),z.lazy(() => business_usersUncheckedUpdateManyWithoutOperating_addressInputSchema) ]),
}).strict();
