...
export const taxi_ordersUpdateWithoutCashbackInputSchema: z.ZodType<Prisma.taxi_ordersUpdateWithoutCashbackInput> = z
	.object({
		...
		type: z
			...
			.optional(),
		subtype: z
			.union([z.lazy(() => ORDER_SUBTYPESchema), z.lazy(() => EnumORDER_SUBTYPEFieldUpdateOperationsInputSchema)])
			.optional(),
		...
		driver_history_locations: z
			...
			.optional(),
		wallet_transfer: z.lazy(() => wallet_transfer_historyUpdateManyWithoutTaxi_orderNestedInputSchema).optional(),
...
export default taxi_ordersUpdateWithoutCashbackInputSchema;
