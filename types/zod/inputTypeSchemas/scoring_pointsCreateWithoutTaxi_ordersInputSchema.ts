...
export const scoring_pointsCreateWithoutTaxi_ordersInputSchema: z.ZodType<Prisma.scoring_pointsCreateWithoutTaxi_ordersInput> = z.object({
...
export default scoring_pointsCreateWithoutTaxi_ordersInputSchema;
