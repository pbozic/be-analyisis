...
export const documentsUpdateWithWhereUniqueWithoutDelivery_driverInputSchema: z.ZodType<Prisma.documentsUpdateWithWhereUniqueWithoutDelivery_driverInput> = z.object({
  where: z.lazy(() => documentsWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => documentsUpdateWithoutDelivery_driverInputSchema),z.lazy(() => documentsUncheckedUpdateWithoutDelivery_driverInputSchema) ]),
}).strict();
