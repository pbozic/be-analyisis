...
export const user_favorite_businessesWhereUniqueInputSchema: z.ZodType<Prisma.user_favorite_businessesWhereUniqueInput> =
	z
		.union([
			z.object({
		...
		.and(
			z
				.object({
					...
					user_typed_favorite: z
						.lazy(() => user_favorite_businessesUser_typed_favoriteCompoundUniqueInputSchema)
						.optional(),
					AND: z
						.union([
