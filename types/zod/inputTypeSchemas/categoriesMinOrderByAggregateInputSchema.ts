...
export const categoriesMinOrderByAggregateInputSchema: z.ZodType<Prisma.categoriesMinOrderByAggregateInput> = z
	.object({
...
export default categoriesMinOrderByAggregateInputSchema;
