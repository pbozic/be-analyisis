...
export const user_rolesUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.user_rolesUpdateManyWithWhereWithoutUserInput> = z.object({
  where: z.lazy(() => user_rolesScalarWhereInputSchema),
  data: z.union([ z.lazy(() => user_rolesUpdateManyMutationInputSchema),z.lazy(() => user_rolesUncheckedUpdateManyWithoutUserInputSchema) ]),
}).strict();
