...
export const late_eventsUncheckedCreateNestedManyWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.late_eventsUncheckedCreateNestedManyWithoutDelivery_ordersInput> =
	z
		.object({
			create: z
				.union([
