...
export const promo_sections_buyUncheckedUpdateManyWithoutPromo_sectionNestedInputSchema: z.ZodType<Prisma.promo_sections_buyUncheckedUpdateManyWithoutPromo_sectionNestedInput> =
	z
		.object({
			create: z
				.union([
