...
export const menu_itemsUncheckedUpdateWithoutMenu_categoryInputSchema: z.ZodType<Prisma.menu_itemsUncheckedUpdateWithoutMenu_categoryInput> =
	z
		.object({
			...
			availability: z
				.union([z.lazy(() => menu_itemsUpdateavailabilityInputSchema), z.string().array()])
				.optional(),
