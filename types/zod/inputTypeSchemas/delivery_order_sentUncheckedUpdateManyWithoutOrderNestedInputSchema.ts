...
export const delivery_order_sentUncheckedUpdateManyWithoutOrderNestedInputSchema: z.ZodType<Prisma.delivery_order_sentUncheckedUpdateManyWithoutOrderNestedInput> =
	z
		.object({
			create: z
				.union([
