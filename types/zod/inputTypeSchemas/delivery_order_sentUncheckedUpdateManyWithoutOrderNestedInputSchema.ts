...
export const delivery_order_sentUncheckedUpdateManyWithoutOrderNestedInputSchema: z.ZodType<Prisma.delivery_order_sentUncheckedUpdateManyWithoutOrderNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => delivery_order_sentUpsertWithWhereUniqueWithoutOrderInputSchema),z.lazy(() => delivery_order_sentUpsertWithWhereUniqueWithoutOrderInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => delivery_order_sentUpdateWithWhereUniqueWithoutOrderInputSchema),z.lazy(() => delivery_order_sentUpdateWithWhereUniqueWithoutOrderInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => delivery_order_sentUpdateManyWithWhereWithoutOrderInputSchema),z.lazy(() => delivery_order_sentUpdateManyWithWhereWithoutOrderInputSchema).array() ]).optional(),
...
export default delivery_order_sentUncheckedUpdateManyWithoutOrderNestedInputSchema;
