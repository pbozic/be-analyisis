...
export const transactionsUncheckedCreateWithoutDelivery_orderInputSchema: z.ZodType<Prisma.transactionsUncheckedCreateWithoutDelivery_orderInput> = z.object({
...
export default transactionsUncheckedCreateWithoutDelivery_orderInputSchema;
