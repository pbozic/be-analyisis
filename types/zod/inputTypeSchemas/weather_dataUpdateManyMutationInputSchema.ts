...
export const weather_dataUpdateManyMutationInputSchema: z.ZodType<Prisma.weather_dataUpdateManyMutationInput> = z.object({
...
export default weather_dataUpdateManyMutationInputSchema;
