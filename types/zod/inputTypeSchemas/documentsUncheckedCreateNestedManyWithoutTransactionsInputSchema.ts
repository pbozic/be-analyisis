...
export const documentsUncheckedCreateNestedManyWithoutTransactionsInputSchema: z.ZodType<Prisma.documentsUncheckedCreateNestedManyWithoutTransactionsInput> =
	z
		.object({
			create: z
				.union([
