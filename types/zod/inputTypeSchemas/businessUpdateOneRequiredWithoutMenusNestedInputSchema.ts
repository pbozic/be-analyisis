...
export const businessUpdateOneRequiredWithoutMenusNestedInputSchema: z.ZodType<Prisma.businessUpdateOneRequiredWithoutMenusNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => businessUpdateToOneWithWhereWithoutMenusInputSchema),
