...
export const business_usersUncheckedCreateNestedManyWithoutBusinessInputSchema: z.ZodType<Prisma.business_usersUncheckedCreateNestedManyWithoutBusinessInput> =
	z
		.object({
			create: z
				.union([
