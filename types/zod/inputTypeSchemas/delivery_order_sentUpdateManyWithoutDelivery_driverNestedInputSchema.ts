...
export const delivery_order_sentUpdateManyWithoutDelivery_driverNestedInputSchema: z.ZodType<Prisma.delivery_order_sentUpdateManyWithoutDelivery_driverNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => delivery_order_sentUpsertWithWhereUniqueWithoutDelivery_driverInputSchema),
					z.lazy(() => delivery_order_sentUpsertWithWhereUniqueWithoutDelivery_driverInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => delivery_order_sentUpdateWithWhereUniqueWithoutDelivery_driverInputSchema),
					z.lazy(() => delivery_order_sentUpdateWithWhereUniqueWithoutDelivery_driverInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => delivery_order_sentUpdateManyWithWhereWithoutDelivery_driverInputSchema),
					z.lazy(() => delivery_order_sentUpdateManyWithWhereWithoutDelivery_driverInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default delivery_order_sentUpdateManyWithoutDelivery_driverNestedInputSchema;
