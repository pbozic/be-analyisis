...
export const documentsUpdateManyWithWhereWithoutLost_itemsInputSchema: z.ZodType<Prisma.documentsUpdateManyWithWhereWithoutLost_itemsInput> =
	z
		.object({
			where: z.lazy(() => documentsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => documentsUpdateManyMutationInputSchema),
				z.lazy(() => documentsUncheckedUpdateManyWithoutLost_itemsInputSchema),
			]),
		})
		.strict();
