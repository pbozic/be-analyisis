...
export const promo_adsWhereInputSchema: z.ZodType<Prisma.promo_adsWhereInput> = z.object({
  AND: z.union([ z.lazy(() => promo_adsWhereInputSchema),z.lazy(() => promo_adsWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => promo_adsWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => promo_adsWhereInputSchema),z.lazy(() => promo_adsWhereInputSchema).array() ]).optional(),
  ...
  code: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
  created_at: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  active_at: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  active_until: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
