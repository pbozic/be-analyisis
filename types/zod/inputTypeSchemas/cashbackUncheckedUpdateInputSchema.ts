...
export const cashbackUncheckedUpdateInputSchema: z.ZodType<Prisma.cashbackUncheckedUpdateInput> = z.object({
...
export default cashbackUncheckedUpdateInputSchema;
