...
export const businessUpdateWithWhereUniqueWithoutFiscal_deviceInputSchema: z.ZodType<Prisma.businessUpdateWithWhereUniqueWithoutFiscal_deviceInput> = z.object({
  where: z.lazy(() => businessWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => businessUpdateWithoutFiscal_deviceInputSchema),z.lazy(() => businessUncheckedUpdateWithoutFiscal_deviceInputSchema) ]),
}).strict();
