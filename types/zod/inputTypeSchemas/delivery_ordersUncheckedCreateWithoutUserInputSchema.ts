...
export const delivery_ordersUncheckedCreateWithoutUserInputSchema: z.ZodType<Prisma.delivery_ordersUncheckedCreateWithoutUserInput> = z.object({
...
export default delivery_ordersUncheckedCreateWithoutUserInputSchema;
