...
export const taxi_ordersUpsertWithoutDriver_history_locationsInputSchema: z.ZodType<Prisma.taxi_ordersUpsertWithoutDriver_history_locationsInput> = z.object({
  update: z.union([ z.lazy(() => taxi_ordersUpdateWithoutDriver_history_locationsInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateWithoutDriver_history_locationsInputSchema) ]),
