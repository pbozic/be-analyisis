...
export const taxi_ordersCreateManyDriverInputSchema: z.ZodType<Prisma.taxi_ordersCreateManyDriverInput> = z.object({
...
export default taxi_ordersCreateManyDriverInputSchema;
