...
export const driver_history_locationsCreateNestedManyWithoutDelivery_orderInputSchema: z.ZodType<Prisma.driver_history_locationsCreateNestedManyWithoutDelivery_orderInput> =
	z
		.object({
			create: z
				.union([
