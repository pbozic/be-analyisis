...
export const scoring_pointsUncheckedCreateNestedManyWithoutTaxi_ordersInputSchema: z.ZodType<Prisma.scoring_pointsUncheckedCreateNestedManyWithoutTaxi_ordersInput> =
	z
		.object({
			create: z
				.union([
