...
export const promo_sectionsUncheckedUpdateManyWithoutTranslatableInputSchema: z.ZodType<Prisma.promo_sectionsUncheckedUpdateManyWithoutTranslatableInput> =
	z
		.object({
			promo_sections_id: z
