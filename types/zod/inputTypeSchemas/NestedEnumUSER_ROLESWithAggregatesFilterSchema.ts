...
export const NestedEnumUSER_ROLESWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumUSER_ROLESWithAggregatesFilter> = z.object({
  equals: z.lazy(() => USER_ROLESSchema).optional(),
  in: z.lazy(() => USER_ROLESSchema).array().optional(),
  notIn: z.lazy(() => USER_ROLESSchema).array().optional(),
  not: z.union([ z.lazy(() => USER_ROLESSchema),z.lazy(() => NestedEnumUSER_ROLESWithAggregatesFilterSchema) ]).optional(),
