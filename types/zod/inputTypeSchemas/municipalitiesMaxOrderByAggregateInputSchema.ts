...
export const municipalitiesMaxOrderByAggregateInputSchema: z.ZodType<Prisma.municipalitiesMaxOrderByAggregateInput> = z.object({
...
export default municipalitiesMaxOrderByAggregateInputSchema;
