...
export const documentsUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.documentsUpdateManyWithWhereWithoutUserInput> =
	z
		.object({
			where: z.lazy(() => documentsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => documentsUpdateManyMutationInputSchema),
				z.lazy(() => documentsUncheckedUpdateManyWithoutUserInputSchema),
			]),
		})
		.strict();
