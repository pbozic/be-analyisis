...
export const businessUncheckedUpdateManyWithoutDelivery_addressNestedInputSchema: z.ZodType<Prisma.businessUncheckedUpdateManyWithoutDelivery_addressNestedInput> =
	z
		.object({
			create: z
				.union([
