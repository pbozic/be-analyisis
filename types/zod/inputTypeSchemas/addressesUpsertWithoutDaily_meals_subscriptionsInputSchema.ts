...
export const addressesUpsertWithoutDaily_meals_subscriptionsInputSchema: z.ZodType<Prisma.addressesUpsertWithoutDaily_meals_subscriptionsInput> = z.object({
  update: z.union([ z.lazy(() => addressesUpdateWithoutDaily_meals_subscriptionsInputSchema),z.lazy(() => addressesUncheckedUpdateWithoutDaily_meals_subscriptionsInputSchema) ]),
