...
export const menu_itemsMaxOrderByAggregateInputSchema: z.ZodType<Prisma.menu_itemsMaxOrderByAggregateInput> = z.object({
...
export default menu_itemsMaxOrderByAggregateInputSchema;
