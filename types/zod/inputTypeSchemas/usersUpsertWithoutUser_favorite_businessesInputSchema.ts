...
export const usersUpsertWithoutUser_favorite_businessesInputSchema: z.ZodType<Prisma.usersUpsertWithoutUser_favorite_businessesInput> = z.object({
  update: z.union([ z.lazy(() => usersUpdateWithoutUser_favorite_businessesInputSchema),z.lazy(() => usersUncheckedUpdateWithoutUser_favorite_businessesInputSchema) ]),
