...
export const businessUpdateManyWithoutReviewableNestedInputSchema: z.ZodType<Prisma.businessUpdateManyWithoutReviewableNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => businessUpsertWithWhereUniqueWithoutReviewableInputSchema),
					z.lazy(() => businessUpsertWithWhereUniqueWithoutReviewableInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => businessUpdateWithWhereUniqueWithoutReviewableInputSchema),
					z.lazy(() => businessUpdateWithWhereUniqueWithoutReviewableInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => businessUpdateManyWithWhereWithoutReviewableInputSchema),
					z.lazy(() => businessUpdateManyWithWhereWithoutReviewableInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default businessUpdateManyWithoutReviewableNestedInputSchema;
