...
export const user_favorite_businessesUpdateManyWithoutBusinessesNestedInputSchema: z.ZodType<Prisma.user_favorite_businessesUpdateManyWithoutBusinessesNestedInput> =
	z
		.object({
			create: z
				.union([
