...
export const driver_history_locationsUncheckedUpdateManyWithoutDriverNestedInputSchema: z.ZodType<Prisma.driver_history_locationsUncheckedUpdateManyWithoutDriverNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => driver_history_locationsUpsertWithWhereUniqueWithoutDriverInputSchema),
					z.lazy(() => driver_history_locationsUpsertWithWhereUniqueWithoutDriverInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => driver_history_locationsUpdateWithWhereUniqueWithoutDriverInputSchema),
					z.lazy(() => driver_history_locationsUpdateWithWhereUniqueWithoutDriverInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => driver_history_locationsUpdateManyWithWhereWithoutDriverInputSchema),
					z.lazy(() => driver_history_locationsUpdateManyWithWhereWithoutDriverInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default driver_history_locationsUncheckedUpdateManyWithoutDriverNestedInputSchema;
