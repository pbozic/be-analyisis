...
export const taxi_ordersUpdateWithoutHistoryInputSchema: z.ZodType<Prisma.taxi_ordersUpdateWithoutHistoryInput> = z
	.object({
...
export default taxi_ordersUpdateWithoutHistoryInputSchema;
