...
export const weather_dataUncheckedCreateWithoutSettlementInputSchema: z.ZodType<Prisma.weather_dataUncheckedCreateWithoutSettlementInput> = z.object({
  ...
  municipalities_id: z.string().optional().nullable()
}).strict();

export default weather_dataUncheckedCreateWithoutSettlementInputSchema;
