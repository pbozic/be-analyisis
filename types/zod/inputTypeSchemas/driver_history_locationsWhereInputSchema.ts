...
export const driver_history_locationsWhereInputSchema: z.ZodType<Prisma.driver_history_locationsWhereInput> = z
	.object({
		AND: z
			.union([
...
export default driver_history_locationsWhereInputSchema;
