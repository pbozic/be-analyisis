...
export const promo_sections_buyUpdateManyWithWhereWithoutBought_byInputSchema: z.ZodType<Prisma.promo_sections_buyUpdateManyWithWhereWithoutBought_byInput> = z.object({
  where: z.lazy(() => promo_sections_buyScalarWhereInputSchema),
  data: z.union([ z.lazy(() => promo_sections_buyUpdateManyMutationInputSchema),z.lazy(() => promo_sections_buyUncheckedUpdateManyWithoutBought_byInputSchema) ]),
}).strict();
