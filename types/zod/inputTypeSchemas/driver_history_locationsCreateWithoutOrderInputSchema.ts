...
export const driver_history_locationsCreateWithoutOrderInputSchema: z.ZodType<Prisma.driver_history_locationsCreateWithoutOrderInput> =
	z
		.object({
			...
			delivery_order: z
				.lazy(() => delivery_ordersCreateNestedOneWithoutDriver_history_locationsInputSchema)
				.optional(),
		})
		.strict();

export default driver_history_locationsCreateWithoutOrderInputSchema;
