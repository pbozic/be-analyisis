...
import { driver_history_locationsUncheckedUpdateManyWithoutDriverNestedInputSchema } from './driver_history_locationsUncheckedUpdateManyWithoutDriverNestedInputSchema';
...
export const driversUncheckedUpdateWithoutCurrent_vehicleInputSchema: z.ZodType<Prisma.driversUncheckedUpdateWithoutCurrent_vehicleInput> =
	z
		.object({
			...
			received_delivery_orders: z
				.lazy(() => delivery_order_sentUncheckedUpdateManyWithoutDriverNestedInputSchema)
				.optional(),
			documents: z.lazy(() => documentsUncheckedUpdateManyWithoutDriversNestedInputSchema).optional(),
			driver_history_locations: z
				.lazy(() => driver_history_locationsUncheckedUpdateManyWithoutDriverNestedInputSchema)
				.optional(),
			driver_municipalities: z
				.lazy(() => driver_municipalitiesUncheckedUpdateManyWithoutDriversNestedInputSchema)
				.optional(),
			activity_logs: z
				.lazy(() => driver_activity_logsUncheckedUpdateManyWithoutDriverNestedInputSchema)
				.optional(),
		})
		.strict();

export default driversUncheckedUpdateWithoutCurrent_vehicleInputSchema;
