...
export const daily_meals_subscriptionsUpdateManyWithWhereWithoutMenuInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpdateManyWithWhereWithoutMenuInput> =
	z
		.object({
			...
			data: z.union([
				...
				z.lazy(() => daily_meals_subscriptionsUncheckedUpdateManyWithoutMenuInputSchema),
			]),
		})
		.strict();
