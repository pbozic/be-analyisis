...
export const promo_bannersMinOrderByAggregateInputSchema: z.ZodType<Prisma.promo_bannersMinOrderByAggregateInput> = z.object({
...
export default promo_bannersMinOrderByAggregateInputSchema;
