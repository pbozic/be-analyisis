...
export const menusUncheckedCreateNestedManyWithoutBusinessInputSchema: z.ZodType<Prisma.menusUncheckedCreateNestedManyWithoutBusinessInput> = z.object({
...
export default menusUncheckedCreateNestedManyWithoutBusinessInputSchema;
