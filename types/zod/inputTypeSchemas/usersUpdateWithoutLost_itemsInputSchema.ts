...
export const usersUpdateWithoutLost_itemsInputSchema: z.ZodType<Prisma.usersUpdateWithoutLost_itemsInput> = z
	.object({
...
export default usersUpdateWithoutLost_itemsInputSchema;
