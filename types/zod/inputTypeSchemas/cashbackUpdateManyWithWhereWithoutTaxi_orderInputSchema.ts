...
export const cashbackUpdateManyWithWhereWithoutTaxi_orderInputSchema: z.ZodType<Prisma.cashbackUpdateManyWithWhereWithoutTaxi_orderInput> =
	z
		.object({
			where: z.lazy(() => cashbackScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => cashbackUpdateManyMutationInputSchema),
				z.lazy(() => cashbackUncheckedUpdateManyWithoutTaxi_orderInputSchema),
			]),
		})
		.strict();
