...
export const driversUpdateToOneWithWhereWithoutDriver_municipalitiesInputSchema: z.ZodType<Prisma.driversUpdateToOneWithWhereWithoutDriver_municipalitiesInput> = z.object({
  where: z.lazy(() => driversWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => driversUpdateWithoutDriver_municipalitiesInputSchema),z.lazy(() => driversUncheckedUpdateWithoutDriver_municipalitiesInputSchema) ]),
}).strict();
