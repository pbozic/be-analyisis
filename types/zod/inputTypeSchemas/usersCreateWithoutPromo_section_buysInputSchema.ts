...
import { taxi_ordersCreateNestedManyWithoutUserInputSchema } from './taxi_ordersCreateNestedManyWithoutUserInputSchema';
...
export const usersCreateWithoutPromo_section_buysInputSchema: z.ZodType<Prisma.usersCreateWithoutPromo_section_buysInput> =
	z
		.object({
			...
			orders: z.lazy(() => taxi_ordersCreateNestedManyWithoutUserInputSchema).optional(),
			...
			user_favorite_businesses: z
				.lazy(() => user_favorite_businessesCreateNestedManyWithoutUsersInputSchema)
				.optional(),
			scoring_points: z.lazy(() => scoring_pointsCreateNestedManyWithoutUsersInputSchema).optional(),
			daily_meals_subscriptions: z
				.lazy(() => daily_meals_subscriptionsCreateNestedManyWithoutUserInputSchema)
				.optional(),
			...
			created_account_actions: z
				.lazy(() => account_actionsCreateNestedManyWithoutAction_creatorInputSchema)
				.optional(),
		})
		.strict();

export default usersCreateWithoutPromo_section_buysInputSchema;
