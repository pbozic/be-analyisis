...
export const user_rolesScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.user_rolesScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => user_rolesScalarWhereWithAggregatesInputSchema),
					z.lazy(() => user_rolesScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => user_rolesScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
