...
export const transactionsUpdateManyWithWhereWithoutDelivery_orderInputSchema: z.ZodType<Prisma.transactionsUpdateManyWithWhereWithoutDelivery_orderInput> =
	z
		.object({
			where: z.lazy(() => transactionsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => transactionsUpdateManyMutationInputSchema),
				z.lazy(() => transactionsUncheckedUpdateManyWithoutDelivery_orderInputSchema),
			]),
		})
		.strict();
