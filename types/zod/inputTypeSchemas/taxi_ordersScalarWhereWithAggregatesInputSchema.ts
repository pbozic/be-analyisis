...
export const taxi_ordersScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.taxi_ordersScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => taxi_ordersScalarWhereWithAggregatesInputSchema),
					z.lazy(() => taxi_ordersScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => taxi_ordersScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
			...
			status: z
				.union([
					z.lazy(() => EnumTAXI_ORDER_STATUSWithAggregatesFilterSchema),
			...
			parent_order_id: z
				...
				.nullable(),
			type: z
				.union([z.lazy(() => EnumORDER_TYPEWithAggregatesFilterSchema), z.lazy(() => ORDER_TYPESchema)])
				.optional(),
			subtype: z
				.union([z.lazy(() => EnumORDER_SUBTYPEWithAggregatesFilterSchema), z.lazy(() => ORDER_SUBTYPESchema)])
				.optional(),
