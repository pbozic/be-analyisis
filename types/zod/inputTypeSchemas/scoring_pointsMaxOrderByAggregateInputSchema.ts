...
export const scoring_pointsMaxOrderByAggregateInputSchema: z.ZodType<Prisma.scoring_pointsMaxOrderByAggregateInput> = z.object({
...
export default scoring_pointsMaxOrderByAggregateInputSchema;
