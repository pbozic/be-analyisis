...
export const usersUpdateToOneWithWhereWithoutBusiness_usersInputSchema: z.ZodType<Prisma.usersUpdateToOneWithWhereWithoutBusiness_usersInput> = z.object({
  where: z.lazy(() => usersWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => usersUpdateWithoutBusiness_usersInputSchema),z.lazy(() => usersUncheckedUpdateWithoutBusiness_usersInputSchema) ]),
}).strict();
