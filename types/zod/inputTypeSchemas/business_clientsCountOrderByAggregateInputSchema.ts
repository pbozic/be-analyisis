...
export const business_clientsCountOrderByAggregateInputSchema: z.ZodType<Prisma.business_clientsCountOrderByAggregateInput> = z.object({
...
export default business_clientsCountOrderByAggregateInputSchema;
