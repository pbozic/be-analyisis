...
export const categoriesUncheckedUpdateManyWithoutIconNestedInputSchema: z.ZodType<Prisma.categoriesUncheckedUpdateManyWithoutIconNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => categoriesUpsertWithWhereUniqueWithoutIconInputSchema),z.lazy(() => categoriesUpsertWithWhereUniqueWithoutIconInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => categoriesUpdateWithWhereUniqueWithoutIconInputSchema),z.lazy(() => categoriesUpdateWithWhereUniqueWithoutIconInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => categoriesUpdateManyWithWhereWithoutIconInputSchema),z.lazy(() => categoriesUpdateManyWithWhereWithoutIconInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => categoriesScalarWhereInputSchema),z.lazy(() => categoriesScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default categoriesUncheckedUpdateManyWithoutIconNestedInputSchema;
