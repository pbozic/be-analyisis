...
export const delivery_ordersUpdateWithWhereUniqueWithoutBusinessInputSchema: z.ZodType<Prisma.delivery_ordersUpdateWithWhereUniqueWithoutBusinessInput> = z.object({
  where: z.lazy(() => delivery_ordersWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => delivery_ordersUpdateWithoutBusinessInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutBusinessInputSchema) ]),
}).strict();
