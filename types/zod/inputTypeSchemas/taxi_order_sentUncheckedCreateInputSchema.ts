...
export const taxi_order_sentUncheckedCreateInputSchema: z.ZodType<Prisma.taxi_order_sentUncheckedCreateInput> = z.object({
...
export default taxi_order_sentUncheckedCreateInputSchema;
