...
export const driver_activity_logsUpdateManyWithWhereWithoutDriverInputSchema: z.ZodType<Prisma.driver_activity_logsUpdateManyWithWhereWithoutDriverInput> =
	z
		.object({
			where: z.lazy(() => driver_activity_logsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => driver_activity_logsUpdateManyMutationInputSchema),
				z.lazy(() => driver_activity_logsUncheckedUpdateManyWithoutDriverInputSchema),
			]),
		})
		.strict();
