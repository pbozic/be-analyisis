...
export const driversUpdateToOneWithWhereWithoutActivity_logsInputSchema: z.ZodType<Prisma.driversUpdateToOneWithWhereWithoutActivity_logsInput> = z.object({
  where: z.lazy(() => driversWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => driversUpdateWithoutActivity_logsInputSchema),z.lazy(() => driversUncheckedUpdateWithoutActivity_logsInputSchema) ]),
}).strict();
