...
export const account_actionsCreateManyBusinessInputSchema: z.ZodType<Prisma.account_actionsCreateManyBusinessInput> = z.object({
...
export default account_actionsCreateManyBusinessInputSchema;
