...
export const settlementsWhereInputSchema: z.ZodType<Prisma.settlementsWhereInput> = z
	.object({
		AND: z
			.union([z.lazy(() => settlementsWhereInputSchema), z.lazy(() => settlementsWhereInputSchema).array()])
			.optional(),
		OR: z
			.lazy(() => settlementsWhereInputSchema)
			.array()
			.optional(),
		NOT: z
			.union([z.lazy(() => settlementsWhereInputSchema), z.lazy(() => settlementsWhereInputSchema).array()])
		...
		municipality: z
			.union([z.lazy(() => MunicipalitiesRelationFilterSchema), z.lazy(() => municipalitiesWhereInputSchema)])
			.optional(),
