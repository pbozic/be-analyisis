...
export const addressesMaxOrderByAggregateInputSchema: z.ZodType<Prisma.addressesMaxOrderByAggregateInput> = z
	.object({
...
export default addressesMaxOrderByAggregateInputSchema;
