...
export const business_clientsUpdateManyWithoutBusinessNestedInputSchema: z.ZodType<Prisma.business_clientsUpdateManyWithoutBusinessNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => business_clientsUpsertWithWhereUniqueWithoutBusinessInputSchema),
					z.lazy(() => business_clientsUpsertWithWhereUniqueWithoutBusinessInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => business_clientsUpdateWithWhereUniqueWithoutBusinessInputSchema),
					z.lazy(() => business_clientsUpdateWithWhereUniqueWithoutBusinessInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => business_clientsUpdateManyWithWhereWithoutBusinessInputSchema),
					z.lazy(() => business_clientsUpdateManyWithWhereWithoutBusinessInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default business_clientsUpdateManyWithoutBusinessNestedInputSchema;
