...
export const business_usersUpdateManyWithoutOperating_addressNestedInputSchema: z.ZodType<Prisma.business_usersUpdateManyWithoutOperating_addressNestedInput> =
	z
		.object({
			create: z
				.union([
