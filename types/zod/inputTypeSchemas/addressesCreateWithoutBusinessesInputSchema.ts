...
export const addressesCreateWithoutBusinessesInputSchema: z.ZodType<Prisma.addressesCreateWithoutBusinessesInput> = z
	.object({
...
export default addressesCreateWithoutBusinessesInputSchema;
