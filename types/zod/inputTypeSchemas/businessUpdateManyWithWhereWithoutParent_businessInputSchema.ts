...
export const businessUpdateManyWithWhereWithoutParent_businessInputSchema: z.ZodType<Prisma.businessUpdateManyWithWhereWithoutParent_businessInput> = z.object({
  where: z.lazy(() => businessScalarWhereInputSchema),
  data: z.union([ z.lazy(() => businessUpdateManyMutationInputSchema),z.lazy(() => businessUncheckedUpdateManyWithoutParent_businessInputSchema) ]),
}).strict();
