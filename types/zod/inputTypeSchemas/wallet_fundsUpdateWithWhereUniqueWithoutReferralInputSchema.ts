...
export const wallet_fundsUpdateWithWhereUniqueWithoutReferralInputSchema: z.ZodType<Prisma.wallet_fundsUpdateWithWhereUniqueWithoutReferralInput> =
	z
		.object({
			where: z.lazy(() => wallet_fundsWhereUniqueInputSchema),
			data: z.union([
				z.lazy(() => wallet_fundsUpdateWithoutReferralInputSchema),
				z.lazy(() => wallet_fundsUncheckedUpdateWithoutReferralInputSchema),
			]),
		})
		.strict();
