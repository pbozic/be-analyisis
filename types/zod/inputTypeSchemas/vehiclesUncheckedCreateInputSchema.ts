...
export const vehiclesUncheckedCreateInputSchema: z.ZodType<Prisma.vehiclesUncheckedCreateInput> = z.object({
...
export default vehiclesUncheckedCreateInputSchema;
