...
export const usersCreateWithoutLost_itemsInputSchema: z.ZodType<Prisma.usersCreateWithoutLost_itemsInput> = z
	.object({
...
export default usersCreateWithoutLost_itemsInputSchema;
