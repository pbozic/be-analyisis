...
export const delivery_ordersUpdateManyWithWhereWithoutDelivery_driverInputSchema: z.ZodType<Prisma.delivery_ordersUpdateManyWithWhereWithoutDelivery_driverInput> = z.object({
  where: z.lazy(() => delivery_ordersScalarWhereInputSchema),
  data: z.union([ z.lazy(() => delivery_ordersUpdateManyMutationInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateManyWithoutDelivery_driverInputSchema) ]),
}).strict();
