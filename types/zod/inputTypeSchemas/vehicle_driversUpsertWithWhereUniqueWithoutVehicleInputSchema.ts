...
export const vehicle_driversUpsertWithWhereUniqueWithoutVehicleInputSchema: z.ZodType<Prisma.vehicle_driversUpsertWithWhereUniqueWithoutVehicleInput> =
	z
		.object({
			where: z.lazy(() => vehicle_driversWhereUniqueInputSchema),
			update: z.union([
				z.lazy(() => vehicle_driversUpdateWithoutVehicleInputSchema),
				z.lazy(() => vehicle_driversUncheckedUpdateWithoutVehicleInputSchema),
			]),
			create: z.union([
