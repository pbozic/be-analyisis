...
export const categoriesUpdateOneRequiredWithoutPromo_ads_categoryNestedInputSchema: z.ZodType<Prisma.categoriesUpdateOneRequiredWithoutPromo_ads_categoryNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => categoriesUpdateToOneWithWhereWithoutPromo_ads_categoryInputSchema),z.lazy(() => categoriesUpdateWithoutPromo_ads_categoryInputSchema),z.lazy(() => categoriesUncheckedUpdateWithoutPromo_ads_categoryInputSchema) ]).optional(),
}).strict();
