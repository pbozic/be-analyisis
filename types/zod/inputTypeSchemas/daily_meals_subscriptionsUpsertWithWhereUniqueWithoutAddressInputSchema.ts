...
export const daily_meals_subscriptionsUpsertWithWhereUniqueWithoutAddressInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpsertWithWhereUniqueWithoutAddressInput> = z.object({
  where: z.lazy(() => daily_meals_subscriptionsWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => daily_meals_subscriptionsUpdateWithoutAddressInputSchema),z.lazy(() => daily_meals_subscriptionsUncheckedUpdateWithoutAddressInputSchema) ]),
