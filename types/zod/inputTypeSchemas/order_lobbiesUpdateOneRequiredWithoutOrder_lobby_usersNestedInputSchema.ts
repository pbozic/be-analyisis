...
export const order_lobbiesUpdateOneRequiredWithoutOrder_lobby_usersNestedInputSchema: z.ZodType<Prisma.order_lobbiesUpdateOneRequiredWithoutOrder_lobby_usersNestedInput> = z.object({
  create: z.union([ z.lazy(() => order_lobbiesCreateWithoutOrder_lobby_usersInputSchema),z.lazy(() => order_lobbiesUncheckedCreateWithoutOrder_lobby_usersInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => order_lobbiesUpdateToOneWithWhereWithoutOrder_lobby_usersInputSchema),z.lazy(() => order_lobbiesUpdateWithoutOrder_lobby_usersInputSchema),z.lazy(() => order_lobbiesUncheckedUpdateWithoutOrder_lobby_usersInputSchema) ]).optional(),
}).strict();
