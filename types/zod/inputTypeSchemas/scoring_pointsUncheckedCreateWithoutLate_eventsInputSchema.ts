...
export const scoring_pointsUncheckedCreateWithoutLate_eventsInputSchema: z.ZodType<Prisma.scoring_pointsUncheckedCreateWithoutLate_eventsInput> = z.object({
...
export default scoring_pointsUncheckedCreateWithoutLate_eventsInputSchema;
