...
export const categoriesUncheckedCreateWithoutWordsInputSchema: z.ZodType<Prisma.categoriesUncheckedCreateWithoutWordsInput> = z.object({
...
export default categoriesUncheckedCreateWithoutWordsInputSchema;
