...
export const transactionsUpdateManyWithWhereWithoutTaxi_orderInputSchema: z.ZodType<Prisma.transactionsUpdateManyWithWhereWithoutTaxi_orderInput> = z.object({
  where: z.lazy(() => transactionsScalarWhereInputSchema),
  data: z.union([ z.lazy(() => transactionsUpdateManyMutationInputSchema),z.lazy(() => transactionsUncheckedUpdateManyWithoutTaxi_orderInputSchema) ]),
}).strict();
