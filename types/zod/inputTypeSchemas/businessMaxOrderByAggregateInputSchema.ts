...
export const businessMaxOrderByAggregateInputSchema: z.ZodType<Prisma.businessMaxOrderByAggregateInput> = z
	.object({
...
export default businessMaxOrderByAggregateInputSchema;
