...
export const late_eventsUpdateManyWithoutTaxi_ordersNestedInputSchema: z.ZodType<Prisma.late_eventsUpdateManyWithoutTaxi_ordersNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => late_eventsUpsertWithWhereUniqueWithoutTaxi_ordersInputSchema),
					z.lazy(() => late_eventsUpsertWithWhereUniqueWithoutTaxi_ordersInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => late_eventsUpdateWithWhereUniqueWithoutTaxi_ordersInputSchema),
					z.lazy(() => late_eventsUpdateWithWhereUniqueWithoutTaxi_ordersInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => late_eventsUpdateManyWithWhereWithoutTaxi_ordersInputSchema),
					z.lazy(() => late_eventsUpdateManyWithWhereWithoutTaxi_ordersInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default late_eventsUpdateManyWithoutTaxi_ordersNestedInputSchema;
