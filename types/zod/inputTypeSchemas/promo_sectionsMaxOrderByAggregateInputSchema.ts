...
export const promo_sectionsMaxOrderByAggregateInputSchema: z.ZodType<Prisma.promo_sectionsMaxOrderByAggregateInput> = z.object({
...
export default promo_sectionsMaxOrderByAggregateInputSchema;
