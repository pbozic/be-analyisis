...
export const account_actionsCreateManyInputSchema: z.ZodType<Prisma.account_actionsCreateManyInput> = z.object({
...
export default account_actionsCreateManyInputSchema;
