...
export const late_eventsUpdateManyWithWhereWithoutScoring_pointsInputSchema: z.ZodType<Prisma.late_eventsUpdateManyWithWhereWithoutScoring_pointsInput> = z.object({
  where: z.lazy(() => late_eventsScalarWhereInputSchema),
  data: z.union([ z.lazy(() => late_eventsUpdateManyMutationInputSchema),z.lazy(() => late_eventsUncheckedUpdateManyWithoutScoring_pointsInputSchema) ]),
}).strict();
