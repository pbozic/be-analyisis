...
export const usersUpdateOneWithoutAccount_actionsNestedInputSchema: z.ZodType<Prisma.usersUpdateOneWithoutAccount_actionsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => usersUpdateToOneWithWhereWithoutAccount_actionsInputSchema),z.lazy(() => usersUpdateWithoutAccount_actionsInputSchema),z.lazy(() => usersUncheckedUpdateWithoutAccount_actionsInputSchema) ]).optional(),
}).strict();
