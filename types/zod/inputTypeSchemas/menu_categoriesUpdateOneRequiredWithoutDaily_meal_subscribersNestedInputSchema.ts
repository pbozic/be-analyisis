...
export const menu_categoriesUpdateOneRequiredWithoutDaily_meal_subscribersNestedInputSchema: z.ZodType<Prisma.menu_categoriesUpdateOneRequiredWithoutDaily_meal_subscribersNestedInput> = z.object({
  create: z.union([ z.lazy(() => menu_categoriesCreateWithoutDaily_meal_subscribersInputSchema),z.lazy(() => menu_categoriesUncheckedCreateWithoutDaily_meal_subscribersInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => menu_categoriesCreateOrConnectWithoutDaily_meal_subscribersInputSchema).optional(),
  ...
  update: z.union([ z.lazy(() => menu_categoriesUpdateToOneWithWhereWithoutDaily_meal_subscribersInputSchema),z.lazy(() => menu_categoriesUpdateWithoutDaily_meal_subscribersInputSchema),z.lazy(() => menu_categoriesUncheckedUpdateWithoutDaily_meal_subscribersInputSchema) ]).optional(),
}).strict();
