...
export const account_actionsUncheckedUpdateManyInputSchema: z.ZodType<Prisma.account_actionsUncheckedUpdateManyInput> = z.object({
...
export default account_actionsUncheckedUpdateManyInputSchema;
