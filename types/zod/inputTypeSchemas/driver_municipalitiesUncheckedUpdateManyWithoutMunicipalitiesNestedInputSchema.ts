...
export const driver_municipalitiesUncheckedUpdateManyWithoutMunicipalitiesNestedInputSchema: z.ZodType<Prisma.driver_municipalitiesUncheckedUpdateManyWithoutMunicipalitiesNestedInput> =
	z
		.object({
			create: z
				.union([
