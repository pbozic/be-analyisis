...
export const delivery_order_sentMaxOrderByAggregateInputSchema: z.ZodType<Prisma.delivery_order_sentMaxOrderByAggregateInput> = z.object({
...
export default delivery_order_sentMaxOrderByAggregateInputSchema;
