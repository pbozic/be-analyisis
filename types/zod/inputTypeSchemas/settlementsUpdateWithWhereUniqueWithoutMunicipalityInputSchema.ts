...
export const settlementsUpdateWithWhereUniqueWithoutMunicipalityInputSchema: z.ZodType<Prisma.settlementsUpdateWithWhereUniqueWithoutMunicipalityInput> = z.object({
  where: z.lazy(() => settlementsWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => settlementsUpdateWithoutMunicipalityInputSchema),z.lazy(() => settlementsUncheckedUpdateWithoutMunicipalityInputSchema) ]),
}).strict();
