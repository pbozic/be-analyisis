...
export const delivery_ordersCreateManyBusinessInputSchema: z.ZodType<Prisma.delivery_ordersCreateManyBusinessInput> = z.object({
...
export default delivery_ordersCreateManyBusinessInputSchema;
