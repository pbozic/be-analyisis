...
export const reviewableUpdateToOneWithWhereWithoutBusinessInputSchema: z.ZodType<Prisma.reviewableUpdateToOneWithWhereWithoutBusinessInput> = z.object({
  where: z.lazy(() => reviewableWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => reviewableUpdateWithoutBusinessInputSchema),z.lazy(() => reviewableUncheckedUpdateWithoutBusinessInputSchema) ]),
}).strict();
