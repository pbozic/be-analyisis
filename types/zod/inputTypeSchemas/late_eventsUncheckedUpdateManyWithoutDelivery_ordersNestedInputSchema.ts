...
export const late_eventsUncheckedUpdateManyWithoutDelivery_ordersNestedInputSchema: z.ZodType<Prisma.late_eventsUncheckedUpdateManyWithoutDelivery_ordersNestedInput> =
	z
		.object({
			create: z
				.union([
