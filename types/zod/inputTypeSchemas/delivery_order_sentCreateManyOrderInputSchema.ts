...
export const delivery_order_sentCreateManyOrderInputSchema: z.ZodType<Prisma.delivery_order_sentCreateManyOrderInput> = z.object({
...
export default delivery_order_sentCreateManyOrderInputSchema;
