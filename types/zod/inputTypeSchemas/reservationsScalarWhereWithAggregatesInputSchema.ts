...
export const reservationsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.reservationsScalarWhereWithAggregatesInput> = z.object({
  ...
  status: z.union([ z.lazy(() => EnumRESERVATION_STATUSWithAggregatesFilterSchema),z.lazy(() => RESERVATION_STATUSSchema) ]).optional(),
  table: z.union([ z.lazy(() => IntNullableWithAggregatesFilterSchema),z.number() ]).optional().nullable(),
}).strict();
