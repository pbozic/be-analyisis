...
export const order_lobbiesUncheckedUpdateWithoutOrder_lobby_usersInputSchema: z.ZodType<Prisma.order_lobbiesUncheckedUpdateWithoutOrder_lobby_usersInput> =
	z
		.object({
			order_lobbies_id: z
