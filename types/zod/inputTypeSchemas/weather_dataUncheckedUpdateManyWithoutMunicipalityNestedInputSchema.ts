...
export const weather_dataUncheckedUpdateManyWithoutMunicipalityNestedInputSchema: z.ZodType<Prisma.weather_dataUncheckedUpdateManyWithoutMunicipalityNestedInput> =
	z
		.object({
			create: z
				.union([
