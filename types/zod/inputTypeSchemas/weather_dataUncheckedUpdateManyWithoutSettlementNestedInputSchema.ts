...
export const weather_dataUncheckedUpdateManyWithoutSettlementNestedInputSchema: z.ZodType<Prisma.weather_dataUncheckedUpdateManyWithoutSettlementNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => weather_dataUpsertWithWhereUniqueWithoutSettlementInputSchema),
					z.lazy(() => weather_dataUpsertWithWhereUniqueWithoutSettlementInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => weather_dataUpdateWithWhereUniqueWithoutSettlementInputSchema),
					z.lazy(() => weather_dataUpdateWithWhereUniqueWithoutSettlementInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => weather_dataUpdateManyWithWhereWithoutSettlementInputSchema),
					z.lazy(() => weather_dataUpdateManyWithWhereWithoutSettlementInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default weather_dataUncheckedUpdateManyWithoutSettlementNestedInputSchema;
