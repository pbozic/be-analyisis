...
export const delivery_ordersUpdateOneWithoutOrder_lobbiesNestedInputSchema: z.ZodType<Prisma.delivery_ordersUpdateOneWithoutOrder_lobbiesNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => delivery_ordersUpdateToOneWithWhereWithoutOrder_lobbiesInputSchema),
