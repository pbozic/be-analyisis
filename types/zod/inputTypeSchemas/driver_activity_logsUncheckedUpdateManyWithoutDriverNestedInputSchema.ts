...
export const driver_activity_logsUncheckedUpdateManyWithoutDriverNestedInputSchema: z.ZodType<Prisma.driver_activity_logsUncheckedUpdateManyWithoutDriverNestedInput> =
	z
		.object({
			create: z
				.union([
					z.lazy(() => driver_activity_logsCreateWithoutDriverInputSchema),
					z.lazy(() => driver_activity_logsCreateWithoutDriverInputSchema).array(),
					z.lazy(() => driver_activity_logsUncheckedCreateWithoutDriverInputSchema),
					z.lazy(() => driver_activity_logsUncheckedCreateWithoutDriverInputSchema).array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					z.lazy(() => driver_activity_logsCreateOrConnectWithoutDriverInputSchema),
					z.lazy(() => driver_activity_logsCreateOrConnectWithoutDriverInputSchema).array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(() => driver_activity_logsUpsertWithWhereUniqueWithoutDriverInputSchema),
					z.lazy(() => driver_activity_logsUpsertWithWhereUniqueWithoutDriverInputSchema).array(),
				])
				.optional(),
			createMany: z.lazy(() => driver_activity_logsCreateManyDriverInputEnvelopeSchema).optional(),
			set: z
				.union([
					z.lazy(() => driver_activity_logsWhereUniqueInputSchema),
					z.lazy(() => driver_activity_logsWhereUniqueInputSchema).array(),
				])
				.optional(),
			disconnect: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => driver_activity_logsUpdateWithWhereUniqueWithoutDriverInputSchema),
					z.lazy(() => driver_activity_logsUpdateWithWhereUniqueWithoutDriverInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => driver_activity_logsUpdateManyWithWhereWithoutDriverInputSchema),
					z.lazy(() => driver_activity_logsUpdateManyWithWhereWithoutDriverInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
					z.lazy(() => driver_activity_logsScalarWhereInputSchema),
					z.lazy(() => driver_activity_logsScalarWhereInputSchema).array(),
				])
				.optional(),
		})
		.strict();

export default driver_activity_logsUncheckedUpdateManyWithoutDriverNestedInputSchema;
