...
export const delivery_driversCreateNestedManyWithoutDaily_meal_businessInputSchema: z.ZodType<Prisma.delivery_driversCreateNestedManyWithoutDaily_meal_businessInput> =
	z
		.object({
			create: z
				.union([
