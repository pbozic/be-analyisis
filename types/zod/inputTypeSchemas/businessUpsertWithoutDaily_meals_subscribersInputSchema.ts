...
export const businessUpsertWithoutDaily_meals_subscribersInputSchema: z.ZodType<Prisma.businessUpsertWithoutDaily_meals_subscribersInput> = z.object({
  update: z.union([ z.lazy(() => businessUpdateWithoutDaily_meals_subscribersInputSchema),z.lazy(() => businessUncheckedUpdateWithoutDaily_meals_subscribersInputSchema) ]),
