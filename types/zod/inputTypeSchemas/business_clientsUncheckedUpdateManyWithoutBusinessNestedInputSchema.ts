...
export const business_clientsUncheckedUpdateManyWithoutBusinessNestedInputSchema: z.ZodType<Prisma.business_clientsUncheckedUpdateManyWithoutBusinessNestedInput> =
	z
		.object({
			create: z
				.union([
