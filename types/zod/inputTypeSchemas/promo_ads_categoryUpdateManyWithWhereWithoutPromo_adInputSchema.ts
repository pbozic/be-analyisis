...
export const promo_ads_categoryUpdateManyWithWhereWithoutPromo_adInputSchema: z.ZodType<Prisma.promo_ads_categoryUpdateManyWithWhereWithoutPromo_adInput> = z.object({
  where: z.lazy(() => promo_ads_categoryScalarWhereInputSchema),
  data: z.union([ z.lazy(() => promo_ads_categoryUpdateManyMutationInputSchema),z.lazy(() => promo_ads_categoryUncheckedUpdateManyWithoutPromo_adInputSchema) ]),
}).strict();
