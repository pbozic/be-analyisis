...
export const usersUpdateOneRequiredWithoutTransactionsNestedInputSchema: z.ZodType<Prisma.usersUpdateOneRequiredWithoutTransactionsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => usersUpdateToOneWithWhereWithoutTransactionsInputSchema),
