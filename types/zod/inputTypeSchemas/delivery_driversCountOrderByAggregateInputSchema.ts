...
export const delivery_driversCountOrderByAggregateInputSchema: z.ZodType<Prisma.delivery_driversCountOrderByAggregateInput> = z.object({
  ...
  scheduled_meals_route: z.lazy(() => SortOrderSchema).optional(),
...
export default delivery_driversCountOrderByAggregateInputSchema;
