...
export const daily_meals_subscriptionsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => daily_meals_subscriptionsScalarWhereWithAggregatesInputSchema),
					z.lazy(() => daily_meals_subscriptionsScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => daily_meals_subscriptionsScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
