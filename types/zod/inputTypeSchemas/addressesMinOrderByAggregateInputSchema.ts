...
export const addressesMinOrderByAggregateInputSchema: z.ZodType<Prisma.addressesMinOrderByAggregateInput> = z
	.object({
...
export default addressesMinOrderByAggregateInputSchema;
