...
export const promo_adsMaxOrderByAggregateInputSchema: z.ZodType<Prisma.promo_adsMaxOrderByAggregateInput> = z.object({
...
export default promo_adsMaxOrderByAggregateInputSchema;
