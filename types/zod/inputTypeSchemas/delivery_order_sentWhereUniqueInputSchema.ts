...
export const delivery_order_sentWhereUniqueInputSchema: z.ZodType<Prisma.delivery_order_sentWhereUniqueInput> = z.union([
  z.object({
    delivery_order_sent_id: z.string().uuid(),
    delivery_order_sent_driver_unique: z.lazy(() => delivery_order_sentDelivery_order_sent_driver_uniqueCompoundUniqueInputSchema),
    delivery_order_sent_delivery_driver_unique: z.lazy(() => delivery_order_sentDelivery_order_sent_delivery_driver_uniqueCompoundUniqueInputSchema)
  }),
  z.object({
    delivery_order_sent_id: z.string().uuid(),
    delivery_order_sent_driver_unique: z.lazy(() => delivery_order_sentDelivery_order_sent_driver_uniqueCompoundUniqueInputSchema),
...
.and(z.object({
  ...
  delivery_order_sent_driver_unique: z.lazy(() => delivery_order_sentDelivery_order_sent_driver_uniqueCompoundUniqueInputSchema).optional(),
  delivery_order_sent_delivery_driver_unique: z.lazy(() => delivery_order_sentDelivery_order_sent_delivery_driver_uniqueCompoundUniqueInputSchema).optional(),
  AND: z.union([ z.lazy(() => delivery_order_sentWhereInputSchema),z.lazy(() => delivery_order_sentWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => delivery_order_sentWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => delivery_order_sentWhereInputSchema),z.lazy(() => delivery_order_sentWhereInputSchema).array() ]).optional(),
