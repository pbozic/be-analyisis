...
export const menu_categoriesUpdateOneWithoutMenu_itemsNestedInputSchema: z.ZodType<Prisma.menu_categoriesUpdateOneWithoutMenu_itemsNestedInput> = z.object({
  create: z.union([ z.lazy(() => menu_categoriesCreateWithoutMenu_itemsInputSchema),z.lazy(() => menu_categoriesUncheckedCreateWithoutMenu_itemsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => menu_categoriesUpdateToOneWithWhereWithoutMenu_itemsInputSchema),z.lazy(() => menu_categoriesUpdateWithoutMenu_itemsInputSchema),z.lazy(() => menu_categoriesUncheckedUpdateWithoutMenu_itemsInputSchema) ]).optional(),
}).strict();
