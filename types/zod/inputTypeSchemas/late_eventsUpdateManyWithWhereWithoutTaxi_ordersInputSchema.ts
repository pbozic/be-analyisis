...
export const late_eventsUpdateManyWithWhereWithoutTaxi_ordersInputSchema: z.ZodType<Prisma.late_eventsUpdateManyWithWhereWithoutTaxi_ordersInput> =
	z
		.object({
			where: z.lazy(() => late_eventsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => late_eventsUpdateManyMutationInputSchema),
				z.lazy(() => late_eventsUncheckedUpdateManyWithoutTaxi_ordersInputSchema),
			]),
		})
		.strict();
