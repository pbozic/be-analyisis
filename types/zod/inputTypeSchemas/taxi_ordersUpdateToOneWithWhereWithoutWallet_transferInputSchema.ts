...
export const taxi_ordersUpdateToOneWithWhereWithoutWallet_transferInputSchema: z.ZodType<Prisma.taxi_ordersUpdateToOneWithWhereWithoutWallet_transferInput> = z.object({
  where: z.lazy(() => taxi_ordersWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => taxi_ordersUpdateWithoutWallet_transferInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateWithoutWallet_transferInputSchema) ]),
}).strict();
