...
export const order_lobbiesUpdateOneRequiredWithoutOrder_lobby_itemsNestedInputSchema: z.ZodType<Prisma.order_lobbiesUpdateOneRequiredWithoutOrder_lobby_itemsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => order_lobbiesUpdateToOneWithWhereWithoutOrder_lobby_itemsInputSchema),
					z.lazy(() => order_lobbiesUpdateWithoutOrder_lobby_itemsInputSchema),
					z.lazy(() => order_lobbiesUncheckedUpdateWithoutOrder_lobby_itemsInputSchema),
				])
				.optional(),
		})
		.strict();
