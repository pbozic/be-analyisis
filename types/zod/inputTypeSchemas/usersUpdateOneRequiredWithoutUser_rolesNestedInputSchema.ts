...
export const usersUpdateOneRequiredWithoutUser_rolesNestedInputSchema: z.ZodType<Prisma.usersUpdateOneRequiredWithoutUser_rolesNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => usersUpdateToOneWithWhereWithoutUser_rolesInputSchema),
