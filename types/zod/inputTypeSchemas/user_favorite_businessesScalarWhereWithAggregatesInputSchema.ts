...
export const user_favorite_businessesScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.user_favorite_businessesScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => user_favorite_businessesScalarWhereWithAggregatesInputSchema),
					z.lazy(() => user_favorite_businessesScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => user_favorite_businessesScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
