...
export const account_actionsUncheckedCreateNestedManyWithoutAction_creatorInputSchema: z.ZodType<Prisma.account_actionsUncheckedCreateNestedManyWithoutAction_creatorInput> =
	z
		.object({
			create: z
				.union([
