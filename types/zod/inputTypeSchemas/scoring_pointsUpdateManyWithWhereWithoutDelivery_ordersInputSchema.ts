...
export const scoring_pointsUpdateManyWithWhereWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.scoring_pointsUpdateManyWithWhereWithoutDelivery_ordersInput> =
	z
		.object({
			where: z.lazy(() => scoring_pointsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => scoring_pointsUpdateManyMutationInputSchema),
				z.lazy(() => scoring_pointsUncheckedUpdateManyWithoutDelivery_ordersInputSchema),
			]),
		})
		.strict();
