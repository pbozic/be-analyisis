...
export const promo_sections_buyCreateNestedManyWithoutPromo_sectionInputSchema: z.ZodType<Prisma.promo_sections_buyCreateNestedManyWithoutPromo_sectionInput> =
	z
		.object({
			create: z
				.union([
