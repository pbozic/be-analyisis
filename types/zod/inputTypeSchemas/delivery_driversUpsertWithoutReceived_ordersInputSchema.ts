...
export const delivery_driversUpsertWithoutReceived_ordersInputSchema: z.ZodType<Prisma.delivery_driversUpsertWithoutReceived_ordersInput> = z.object({
  update: z.union([ z.lazy(() => delivery_driversUpdateWithoutReceived_ordersInputSchema),z.lazy(() => delivery_driversUncheckedUpdateWithoutReceived_ordersInputSchema) ]),
