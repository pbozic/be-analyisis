...
export const menusUncheckedUpdateManyWithoutBusinessNestedInputSchema: z.ZodType<Prisma.menusUncheckedUpdateManyWithoutBusinessNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => menusUpsertWithWhereUniqueWithoutBusinessInputSchema),z.lazy(() => menusUpsertWithWhereUniqueWithoutBusinessInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => menusUpdateWithWhereUniqueWithoutBusinessInputSchema),z.lazy(() => menusUpdateWithWhereUniqueWithoutBusinessInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => menusUpdateManyWithWhereWithoutBusinessInputSchema),z.lazy(() => menusUpdateManyWithWhereWithoutBusinessInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => menusScalarWhereInputSchema),z.lazy(() => menusScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default menusUncheckedUpdateManyWithoutBusinessNestedInputSchema;
