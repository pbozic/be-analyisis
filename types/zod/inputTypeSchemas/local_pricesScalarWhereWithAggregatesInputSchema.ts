...
export const local_pricesScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.local_pricesScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => local_pricesScalarWhereWithAggregatesInputSchema),
					z.lazy(() => local_pricesScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => local_pricesScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
