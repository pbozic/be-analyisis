...
export const categoriesUncheckedCreateWithoutTranslatableInputSchema: z.ZodType<Prisma.categoriesUncheckedCreateWithoutTranslatableInput> = z.object({
...
export default categoriesUncheckedCreateWithoutTranslatableInputSchema;
