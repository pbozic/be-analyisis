...
export const wallet_fundsUncheckedUpdateWithoutTransactionsInputSchema: z.ZodType<Prisma.wallet_fundsUncheckedUpdateWithoutTransactionsInput> = z.object({
  wallet_funds_id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  user_id: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  referral_id: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export default wallet_fundsUncheckedUpdateWithoutTransactionsInputSchema;
