...
export const usersUpdateToOneWithWhereWithoutReferrals_madeInputSchema: z.ZodType<Prisma.usersUpdateToOneWithWhereWithoutReferrals_madeInput> = z.object({
  where: z.lazy(() => usersWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => usersUpdateWithoutReferrals_madeInputSchema),z.lazy(() => usersUncheckedUpdateWithoutReferrals_madeInputSchema) ]),
}).strict();
