...
export const categoriesUpdateToOneWithWhereWithoutMenu_categoriesInputSchema: z.ZodType<Prisma.categoriesUpdateToOneWithWhereWithoutMenu_categoriesInput> = z.object({
  where: z.lazy(() => categoriesWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => categoriesUpdateWithoutMenu_categoriesInputSchema),z.lazy(() => categoriesUncheckedUpdateWithoutMenu_categoriesInputSchema) ]),
}).strict();
