...
export const user_addressWhereUniqueInputSchema: z.ZodType<Prisma.user_addressWhereUniqueInput> = z.object({
...
.and(z.object({
  ...
  AND: z.union([ z.lazy(() => user_addressWhereInputSchema),z.lazy(() => user_addressWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => user_addressWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => user_addressWhereInputSchema),z.lazy(() => user_addressWhereInputSchema).array() ]).optional(),
