...
export const menusCreateWithoutBusinessInputSchema: z.ZodType<Prisma.menusCreateWithoutBusinessInput> = z.object({
...
export default menusCreateWithoutBusinessInputSchema;
