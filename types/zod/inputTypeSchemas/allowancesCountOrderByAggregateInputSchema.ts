...
export const allowancesCountOrderByAggregateInputSchema: z.ZodType<Prisma.allowancesCountOrderByAggregateInput> = z.object({
...
export default allowancesCountOrderByAggregateInputSchema;
