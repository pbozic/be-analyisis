...
export const promo_sectionsUncheckedUpdateManyWithoutTranslatableNestedInputSchema: z.ZodType<Prisma.promo_sectionsUncheckedUpdateManyWithoutTranslatableNestedInput> =
	z
		.object({
			create: z
				.union([
