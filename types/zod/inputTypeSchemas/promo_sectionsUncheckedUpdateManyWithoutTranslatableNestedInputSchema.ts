...
export const promo_sectionsUncheckedUpdateManyWithoutTranslatableNestedInputSchema: z.ZodType<Prisma.promo_sectionsUncheckedUpdateManyWithoutTranslatableNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => promo_sectionsUpsertWithWhereUniqueWithoutTranslatableInputSchema),z.lazy(() => promo_sectionsUpsertWithWhereUniqueWithoutTranslatableInputSchema).array() ]).optional(),
  createMany: z.lazy(() => promo_sectionsCreateManyTranslatableInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => promo_sectionsWhereUniqueInputSchema),z.lazy(() => promo_sectionsWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => promo_sectionsWhereUniqueInputSchema),z.lazy(() => promo_sectionsWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => promo_sectionsWhereUniqueInputSchema),z.lazy(() => promo_sectionsWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => promo_sectionsWhereUniqueInputSchema),z.lazy(() => promo_sectionsWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => promo_sectionsUpdateWithWhereUniqueWithoutTranslatableInputSchema),z.lazy(() => promo_sectionsUpdateWithWhereUniqueWithoutTranslatableInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => promo_sectionsUpdateManyWithWhereWithoutTranslatableInputSchema),z.lazy(() => promo_sectionsUpdateManyWithWhereWithoutTranslatableInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => promo_sectionsScalarWhereInputSchema),z.lazy(() => promo_sectionsScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default promo_sectionsUncheckedUpdateManyWithoutTranslatableNestedInputSchema;
