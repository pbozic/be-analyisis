...
export const delivery_ordersCreateNestedOneWithoutDelivery_driver_history_locationsInputSchema: z.ZodType<Prisma.delivery_ordersCreateNestedOneWithoutDelivery_driver_history_locationsInput> =
	z
		.object({
			create: z
				.union([
