...
export const filesUpdateToOneWithWhereWithoutPromo_bannersInputSchema: z.ZodType<Prisma.filesUpdateToOneWithWhereWithoutPromo_bannersInput> = z.object({
  where: z.lazy(() => filesWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => filesUpdateWithoutPromo_bannersInputSchema),z.lazy(() => filesUncheckedUpdateWithoutPromo_bannersInputSchema) ]),
}).strict();
