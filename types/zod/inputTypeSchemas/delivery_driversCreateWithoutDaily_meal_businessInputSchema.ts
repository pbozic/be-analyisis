...
import { delivery_ordersCreateNestedManyWithoutDelivery_driverInputSchema } from './delivery_ordersCreateNestedManyWithoutDelivery_driverInputSchema';
...
export const delivery_driversCreateWithoutDaily_meal_businessInputSchema: z.ZodType<Prisma.delivery_driversCreateWithoutDaily_meal_businessInput> =
	z
		.object({
			...
			orders: z.lazy(() => delivery_ordersCreateNestedManyWithoutDelivery_driverInputSchema).optional(),
			received_orders: z
				.lazy(() => delivery_order_sentCreateNestedManyWithoutDelivery_driverInputSchema)
				.optional(),
			documents: z.lazy(() => documentsCreateNestedManyWithoutDelivery_driverInputSchema).optional(),
			delivery_driver_history_locations: z
				.lazy(() => delivery_driver_history_locationsCreateNestedManyWithoutDelivery_driverInputSchema)
				.optional(),
		})
		.strict();

export default delivery_driversCreateWithoutDaily_meal_businessInputSchema;
