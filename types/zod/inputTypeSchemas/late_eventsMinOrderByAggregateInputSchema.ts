...
export const late_eventsMinOrderByAggregateInputSchema: z.ZodType<Prisma.late_eventsMinOrderByAggregateInput> = z.object({
...
export default late_eventsMinOrderByAggregateInputSchema;
