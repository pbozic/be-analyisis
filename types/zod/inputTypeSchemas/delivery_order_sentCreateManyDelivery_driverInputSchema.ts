...
export const delivery_order_sentCreateManyDelivery_driverInputSchema: z.ZodType<Prisma.delivery_order_sentCreateManyDelivery_driverInput> = z.object({
...
export default delivery_order_sentCreateManyDelivery_driverInputSchema;
