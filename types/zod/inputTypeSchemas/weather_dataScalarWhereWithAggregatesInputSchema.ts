...
export const weather_dataScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.weather_dataScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => weather_dataScalarWhereWithAggregatesInputSchema),z.lazy(() => weather_dataScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => weather_dataScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => weather_dataScalarWhereWithAggregatesInputSchema),z.lazy(() => weather_dataScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  ...
  municipalities_id: z.union([ z.lazy(() => UuidNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  settlement_id: z.union([ z.lazy(() => UuidNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
}).strict();
