...
export const usersUncheckedUpdateWithoutDaily_meals_subscriptionsInputSchema: z.ZodType<Prisma.usersUncheckedUpdateWithoutDaily_meals_subscriptionsInput> =
	z
		.object({
