...
export const usersUpsertWithoutPromo_section_buysInputSchema: z.ZodType<Prisma.usersUpsertWithoutPromo_section_buysInput> = z.object({
  update: z.union([ z.lazy(() => usersUpdateWithoutPromo_section_buysInputSchema),z.lazy(() => usersUncheckedUpdateWithoutPromo_section_buysInputSchema) ]),
  create: z.union([ z.lazy(() => usersCreateWithoutPromo_section_buysInputSchema),z.lazy(() => usersUncheckedCreateWithoutPromo_section_buysInputSchema) ]),
