...
export const wordsUpdateManyWithWhereWithoutTranslatableInputSchema: z.ZodType<Prisma.wordsUpdateManyWithWhereWithoutTranslatableInput> =
	z
		.object({
			where: z.lazy(() => wordsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => wordsUpdateManyMutationInputSchema),
				z.lazy(() => wordsUncheckedUpdateManyWithoutTranslatableInputSchema),
			]),
		})
		.strict();
