...
export const promo_bannersUpdateManyWithWhereWithoutPromo_adsInputSchema: z.ZodType<Prisma.promo_bannersUpdateManyWithWhereWithoutPromo_adsInput> =
	z
		.object({
			where: z.lazy(() => promo_bannersScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => promo_bannersUpdateManyMutationInputSchema),
				z.lazy(() => promo_bannersUncheckedUpdateManyWithoutPromo_adsInputSchema),
			]),
		})
		.strict();
