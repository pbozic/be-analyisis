...
export const wordsUpdateOneRequiredWithoutSubscriptionsNestedInputSchema: z.ZodType<Prisma.wordsUpdateOneRequiredWithoutSubscriptionsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => wordsUpdateToOneWithWhereWithoutSubscriptionsInputSchema),
