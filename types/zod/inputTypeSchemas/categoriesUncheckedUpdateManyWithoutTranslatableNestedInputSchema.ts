...
export const categoriesUncheckedUpdateManyWithoutTranslatableNestedInputSchema: z.ZodType<Prisma.categoriesUncheckedUpdateManyWithoutTranslatableNestedInput> =
	z
		.object({
			create: z
				.union([
