...
export const business_usersUncheckedUpdateManyWithoutOperating_addressNestedInputSchema: z.ZodType<Prisma.business_usersUncheckedUpdateManyWithoutOperating_addressNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => business_usersUpsertWithWhereUniqueWithoutOperating_addressInputSchema),
					z.lazy(() => business_usersUpsertWithWhereUniqueWithoutOperating_addressInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => business_usersUpdateWithWhereUniqueWithoutOperating_addressInputSchema),
					z.lazy(() => business_usersUpdateWithWhereUniqueWithoutOperating_addressInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => business_usersUpdateManyWithWhereWithoutOperating_addressInputSchema),
					z.lazy(() => business_usersUpdateManyWithWhereWithoutOperating_addressInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default business_usersUncheckedUpdateManyWithoutOperating_addressNestedInputSchema;
