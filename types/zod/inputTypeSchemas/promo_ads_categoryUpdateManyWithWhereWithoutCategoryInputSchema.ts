...
export const promo_ads_categoryUpdateManyWithWhereWithoutCategoryInputSchema: z.ZodType<Prisma.promo_ads_categoryUpdateManyWithWhereWithoutCategoryInput> =
	z
		.object({
			where: z.lazy(() => promo_ads_categoryScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => promo_ads_categoryUpdateManyMutationInputSchema),
				z.lazy(() => promo_ads_categoryUncheckedUpdateManyWithoutCategoryInputSchema),
			]),
		})
		.strict();
