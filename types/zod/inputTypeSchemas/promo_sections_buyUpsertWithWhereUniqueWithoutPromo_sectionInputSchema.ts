...
export const promo_sections_buyUpsertWithWhereUniqueWithoutPromo_sectionInputSchema: z.ZodType<Prisma.promo_sections_buyUpsertWithWhereUniqueWithoutPromo_sectionInput> = z.object({
  where: z.lazy(() => promo_sections_buyWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => promo_sections_buyUpdateWithoutPromo_sectionInputSchema),z.lazy(() => promo_sections_buyUncheckedUpdateWithoutPromo_sectionInputSchema) ]),
  create: z.union([ z.lazy(() => promo_sections_buyCreateWithoutPromo_sectionInputSchema),z.lazy(() => promo_sections_buyUncheckedCreateWithoutPromo_sectionInputSchema) ]),
}).strict();
