...
export const local_pricesUpdateManyWithWhereWithoutProductInputSchema: z.ZodType<Prisma.local_pricesUpdateManyWithWhereWithoutProductInput> =
	z
		.object({
			where: z.lazy(() => local_pricesScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => local_pricesUpdateManyMutationInputSchema),
				z.lazy(() => local_pricesUncheckedUpdateManyWithoutProductInputSchema),
			]),
		})
		.strict();
