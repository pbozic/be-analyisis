...
export const promo_ads_categoryUpsertWithWhereUniqueWithoutPromo_adInputSchema: z.ZodType<Prisma.promo_ads_categoryUpsertWithWhereUniqueWithoutPromo_adInput> = z.object({
  where: z.lazy(() => promo_ads_categoryWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => promo_ads_categoryUpdateWithoutPromo_adInputSchema),z.lazy(() => promo_ads_categoryUncheckedUpdateWithoutPromo_adInputSchema) ]),
