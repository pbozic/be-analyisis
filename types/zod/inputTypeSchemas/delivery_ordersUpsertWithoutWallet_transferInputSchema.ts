...
export const delivery_ordersUpsertWithoutWallet_transferInputSchema: z.ZodType<Prisma.delivery_ordersUpsertWithoutWallet_transferInput> = z.object({
  update: z.union([ z.lazy(() => delivery_ordersUpdateWithoutWallet_transferInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutWallet_transferInputSchema) ]),
