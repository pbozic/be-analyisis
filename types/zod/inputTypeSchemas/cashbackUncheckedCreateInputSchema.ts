...
export const cashbackUncheckedCreateInputSchema: z.ZodType<Prisma.cashbackUncheckedCreateInput> = z.object({
...
export default cashbackUncheckedCreateInputSchema;
