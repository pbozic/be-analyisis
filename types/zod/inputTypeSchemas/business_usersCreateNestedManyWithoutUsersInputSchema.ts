...
export const business_usersCreateNestedManyWithoutUsersInputSchema: z.ZodType<Prisma.business_usersCreateNestedManyWithoutUsersInput> =
	z
		.object({
			create: z
				.union([
...
export default business_usersCreateNestedManyWithoutUsersInputSchema;
