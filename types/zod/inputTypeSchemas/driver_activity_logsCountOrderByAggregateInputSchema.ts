...
export const driver_activity_logsCountOrderByAggregateInputSchema: z.ZodType<Prisma.driver_activity_logsCountOrderByAggregateInput> = z.object({
...
export default driver_activity_logsCountOrderByAggregateInputSchema;
