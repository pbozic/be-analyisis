...
export const account_actionsUncheckedUpdateManyWithoutAction_creatorInputSchema: z.ZodType<Prisma.account_actionsUncheckedUpdateManyWithoutAction_creatorInput> =
	z
		.object({
			account_action_id: z
