...
export const categoriesUpdateManyWithoutTranslatableNestedInputSchema: z.ZodType<Prisma.categoriesUpdateManyWithoutTranslatableNestedInput> =
	z
		.object({
			create: z
				.union([
					z.lazy(() => categoriesCreateWithoutTranslatableInputSchema),
					z.lazy(() => categoriesCreateWithoutTranslatableInputSchema).array(),
					z.lazy(() => categoriesUncheckedCreateWithoutTranslatableInputSchema),
					z.lazy(() => categoriesUncheckedCreateWithoutTranslatableInputSchema).array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					z.lazy(() => categoriesCreateOrConnectWithoutTranslatableInputSchema),
					z.lazy(() => categoriesCreateOrConnectWithoutTranslatableInputSchema).array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(() => categoriesUpsertWithWhereUniqueWithoutTranslatableInputSchema),
					z.lazy(() => categoriesUpsertWithWhereUniqueWithoutTranslatableInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => categoriesUpdateWithWhereUniqueWithoutTranslatableInputSchema),
					z.lazy(() => categoriesUpdateWithWhereUniqueWithoutTranslatableInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => categoriesUpdateManyWithWhereWithoutTranslatableInputSchema),
					z.lazy(() => categoriesUpdateManyWithWhereWithoutTranslatableInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default categoriesUpdateManyWithoutTranslatableNestedInputSchema;
