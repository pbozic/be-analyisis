...
export const local_productsWhereUniqueInputSchema: z.ZodType<Prisma.local_productsWhereUniqueInput> = z.union([
  z.object({
...
.and(z.object({
  ...
  AND: z.union([ z.lazy(() => local_productsWhereInputSchema),z.lazy(() => local_productsWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => local_productsWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => local_productsWhereInputSchema),z.lazy(() => local_productsWhereInputSchema).array() ]).optional(),
