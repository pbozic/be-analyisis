...
export const addressesCreateOrConnectWithoutDaily_meals_subscriptionsInputSchema: z.ZodType<Prisma.addressesCreateOrConnectWithoutDaily_meals_subscriptionsInput> =
	z
		.object({
