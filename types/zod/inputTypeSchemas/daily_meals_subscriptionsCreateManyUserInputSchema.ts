...
export const daily_meals_subscriptionsCreateManyUserInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsCreateManyUserInput> = z.object({
...
export default daily_meals_subscriptionsCreateManyUserInputSchema;
