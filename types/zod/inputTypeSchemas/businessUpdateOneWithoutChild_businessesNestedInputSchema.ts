...
export const businessUpdateOneWithoutChild_businessesNestedInputSchema: z.ZodType<Prisma.businessUpdateOneWithoutChild_businessesNestedInput> = z.object({
  create: z.union([ z.lazy(() => businessCreateWithoutChild_businessesInputSchema),z.lazy(() => businessUncheckedCreateWithoutChild_businessesInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => businessUpdateToOneWithWhereWithoutChild_businessesInputSchema),z.lazy(() => businessUpdateWithoutChild_businessesInputSchema),z.lazy(() => businessUncheckedUpdateWithoutChild_businessesInputSchema) ]).optional(),
}).strict();
