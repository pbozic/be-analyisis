...
export const categoriesUpdateOneRequiredWithoutMenu_categoriesNestedInputSchema: z.ZodType<Prisma.categoriesUpdateOneRequiredWithoutMenu_categoriesNestedInput> = z.object({
  create: z.union([ z.lazy(() => categoriesCreateWithoutMenu_categoriesInputSchema),z.lazy(() => categoriesUncheckedCreateWithoutMenu_categoriesInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => categoriesUpdateToOneWithWhereWithoutMenu_categoriesInputSchema),z.lazy(() => categoriesUpdateWithoutMenu_categoriesInputSchema),z.lazy(() => categoriesUncheckedUpdateWithoutMenu_categoriesInputSchema) ]).optional(),
}).strict();
