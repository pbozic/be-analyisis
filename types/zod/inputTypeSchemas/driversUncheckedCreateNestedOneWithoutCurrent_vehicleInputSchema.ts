...
export const driversUncheckedCreateNestedOneWithoutCurrent_vehicleInputSchema: z.ZodType<Prisma.driversUncheckedCreateNestedOneWithoutCurrent_vehicleInput> =
	z
		.object({
			create: z
				.union([
