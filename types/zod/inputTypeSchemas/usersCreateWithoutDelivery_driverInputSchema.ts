...
export const usersCreateWithoutDelivery_driverInputSchema: z.ZodType<Prisma.usersCreateWithoutDelivery_driverInput> = z
	.object({
...
export default usersCreateWithoutDelivery_driverInputSchema;
