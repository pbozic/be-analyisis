...
export const delivery_ordersUpdateToOneWithWhereWithoutCashbackInputSchema: z.ZodType<Prisma.delivery_ordersUpdateToOneWithWhereWithoutCashbackInput> = z.object({
  where: z.lazy(() => delivery_ordersWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => delivery_ordersUpdateWithoutCashbackInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutCashbackInputSchema) ]),
}).strict();
