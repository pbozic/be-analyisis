...
export const businessUpdateOneRequiredWithoutBusiness_teamsNestedInputSchema: z.ZodType<Prisma.businessUpdateOneRequiredWithoutBusiness_teamsNestedInput> = z.object({
  create: z.union([ z.lazy(() => businessCreateWithoutBusiness_teamsInputSchema),z.lazy(() => businessUncheckedCreateWithoutBusiness_teamsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => businessUpdateToOneWithWhereWithoutBusiness_teamsInputSchema),z.lazy(() => businessUpdateWithoutBusiness_teamsInputSchema),z.lazy(() => businessUncheckedUpdateWithoutBusiness_teamsInputSchema) ]).optional(),
}).strict();
