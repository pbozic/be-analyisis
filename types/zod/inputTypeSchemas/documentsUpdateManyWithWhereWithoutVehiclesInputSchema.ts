...
export const documentsUpdateManyWithWhereWithoutVehiclesInputSchema: z.ZodType<Prisma.documentsUpdateManyWithWhereWithoutVehiclesInput> =
	z
		.object({
			where: z.lazy(() => documentsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => documentsUpdateManyMutationInputSchema),
				z.lazy(() => documentsUncheckedUpdateManyWithoutVehiclesInputSchema),
			]),
		})
		.strict();
