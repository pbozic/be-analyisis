...
export const reservationsUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.reservationsUpdateManyWithoutUserNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => reservationsUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => reservationsUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => reservationsUpdateWithWhereUniqueWithoutUserInputSchema),z.lazy(() => reservationsUpdateWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => reservationsUpdateManyWithWhereWithoutUserInputSchema),z.lazy(() => reservationsUpdateManyWithWhereWithoutUserInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => reservationsScalarWhereInputSchema),z.lazy(() => reservationsScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default reservationsUpdateManyWithoutUserNestedInputSchema;
