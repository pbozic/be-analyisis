...
export const word_buyUpdateWithWhereUniqueWithoutBusinessInputSchema: z.ZodType<Prisma.word_buyUpdateWithWhereUniqueWithoutBusinessInput> = z.object({
  where: z.lazy(() => word_buyWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => word_buyUpdateWithoutBusinessInputSchema),z.lazy(() => word_buyUncheckedUpdateWithoutBusinessInputSchema) ]),
}).strict();
