...
export const order_lobbiesUncheckedCreateInputSchema: z.ZodType<Prisma.order_lobbiesUncheckedCreateInput> = z
	.object({
...
export default order_lobbiesUncheckedCreateInputSchema;
