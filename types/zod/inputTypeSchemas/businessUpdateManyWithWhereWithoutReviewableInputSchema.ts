...
export const businessUpdateManyWithWhereWithoutReviewableInputSchema: z.ZodType<Prisma.businessUpdateManyWithWhereWithoutReviewableInput> =
	z
		.object({
			where: z.lazy(() => businessScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => businessUpdateManyMutationInputSchema),
				z.lazy(() => businessUncheckedUpdateManyWithoutReviewableInputSchema),
			]),
		})
		.strict();
