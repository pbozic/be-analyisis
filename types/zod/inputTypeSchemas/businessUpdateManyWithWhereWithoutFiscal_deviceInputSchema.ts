...
export const businessUpdateManyWithWhereWithoutFiscal_deviceInputSchema: z.ZodType<Prisma.businessUpdateManyWithWhereWithoutFiscal_deviceInput> =
	z
		.object({
			where: z.lazy(() => businessScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => businessUpdateManyMutationInputSchema),
				z.lazy(() => businessUncheckedUpdateManyWithoutFiscal_deviceInputSchema),
			]),
		})
		.strict();
