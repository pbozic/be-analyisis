...
export const taxi_ordersUpdateWithWhereUniqueWithoutBusiness_usersInputSchema: z.ZodType<Prisma.taxi_ordersUpdateWithWhereUniqueWithoutBusiness_usersInput> = z.object({
  where: z.lazy(() => taxi_ordersWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => taxi_ordersUpdateWithoutBusiness_usersInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateWithoutBusiness_usersInputSchema) ]),
}).strict();
