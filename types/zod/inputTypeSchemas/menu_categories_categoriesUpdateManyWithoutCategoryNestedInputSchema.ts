...
export const menu_categories_categoriesUpdateManyWithoutCategoryNestedInputSchema: z.ZodType<Prisma.menu_categories_categoriesUpdateManyWithoutCategoryNestedInput> =
	z
		.object({
			create: z
				.union([
