...
export const municipalitiesWhereInputSchema: z.ZodType<Prisma.municipalitiesWhereInput> = z
	.object({
		AND: z
			.union([z.lazy(() => municipalitiesWhereInputSchema), z.lazy(() => municipalitiesWhereInputSchema).array()])
			.optional(),
		OR: z
