...
export const driver_municipalitiesUncheckedCreateNestedManyWithoutDriversInputSchema: z.ZodType<Prisma.driver_municipalitiesUncheckedCreateNestedManyWithoutDriversInput> =
	z
		.object({
			create: z
				.union([
