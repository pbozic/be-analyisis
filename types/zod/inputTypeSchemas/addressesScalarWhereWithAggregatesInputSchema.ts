...
export const addressesScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.addressesScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => addressesScalarWhereWithAggregatesInputSchema),
					z.lazy(() => addressesScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => addressesScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
