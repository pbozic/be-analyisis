...
export const weather_dataScalarWhereInputSchema: z.ZodType<Prisma.weather_dataScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => weather_dataScalarWhereInputSchema),z.lazy(() => weather_dataScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => weather_dataScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => weather_dataScalarWhereInputSchema),z.lazy(() => weather_dataScalarWhereInputSchema).array() ]).optional(),
...
export default weather_dataScalarWhereInputSchema;
