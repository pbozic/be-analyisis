...
export const delivery_ordersMaxOrderByAggregateInputSchema: z.ZodType<Prisma.delivery_ordersMaxOrderByAggregateInput> = z.object({
...
export default delivery_ordersMaxOrderByAggregateInputSchema;
