...
export const daily_meals_subscriptionsUncheckedUpdateManyWithoutAddressNestedInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUncheckedUpdateManyWithoutAddressNestedInput> =
	z
		.object({
			create: z
				.union([
