...
export const daily_meals_subscriptionsUncheckedUpdateManyWithoutAddressNestedInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUncheckedUpdateManyWithoutAddressNestedInput> = z.object({
  create: z.union([ z.lazy(() => daily_meals_subscriptionsCreateWithoutAddressInputSchema),z.lazy(() => daily_meals_subscriptionsCreateWithoutAddressInputSchema).array(),z.lazy(() => daily_meals_subscriptionsUncheckedCreateWithoutAddressInputSchema),z.lazy(() => daily_meals_subscriptionsUncheckedCreateWithoutAddressInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => daily_meals_subscriptionsCreateOrConnectWithoutAddressInputSchema),z.lazy(() => daily_meals_subscriptionsCreateOrConnectWithoutAddressInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => daily_meals_subscriptionsUpsertWithWhereUniqueWithoutAddressInputSchema),z.lazy(() => daily_meals_subscriptionsUpsertWithWhereUniqueWithoutAddressInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => daily_meals_subscriptionsUpdateWithWhereUniqueWithoutAddressInputSchema),z.lazy(() => daily_meals_subscriptionsUpdateWithWhereUniqueWithoutAddressInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => daily_meals_subscriptionsUpdateManyWithWhereWithoutAddressInputSchema),z.lazy(() => daily_meals_subscriptionsUpdateManyWithWhereWithoutAddressInputSchema).array() ]).optional(),
...
export default daily_meals_subscriptionsUncheckedUpdateManyWithoutAddressNestedInputSchema;
