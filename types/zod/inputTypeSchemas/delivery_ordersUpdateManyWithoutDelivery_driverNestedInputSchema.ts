...
export const delivery_ordersUpdateManyWithoutDelivery_driverNestedInputSchema: z.ZodType<Prisma.delivery_ordersUpdateManyWithoutDelivery_driverNestedInput> =
	z
		.object({
			create: z
				.union([
