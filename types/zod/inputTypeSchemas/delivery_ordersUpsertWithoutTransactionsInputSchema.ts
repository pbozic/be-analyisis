...
export const delivery_ordersUpsertWithoutTransactionsInputSchema: z.ZodType<Prisma.delivery_ordersUpsertWithoutTransactionsInput> = z.object({
  update: z.union([ z.lazy(() => delivery_ordersUpdateWithoutTransactionsInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutTransactionsInputSchema) ]),
  create: z.union([ z.lazy(() => delivery_ordersCreateWithoutTransactionsInputSchema),z.lazy(() => delivery_ordersUncheckedCreateWithoutTransactionsInputSchema) ]),
