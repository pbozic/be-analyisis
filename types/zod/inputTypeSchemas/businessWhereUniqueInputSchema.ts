...
export const businessWhereUniqueInputSchema: z.ZodType<Prisma.businessWhereUniqueInput> = z
	.union([
		z.object({
	...
	.and(
		z
			.object({
				...
				reviewable: z
					.union([
						z.lazy(() => ReviewableNullableRelationFilterSchema),
						z.lazy(() => reviewableWhereInputSchema),
					])
					.optional()
					.nullable(),
