...
export const local_productsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.local_productsScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => local_productsScalarWhereWithAggregatesInputSchema),
					z.lazy(() => local_productsScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => local_productsScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
