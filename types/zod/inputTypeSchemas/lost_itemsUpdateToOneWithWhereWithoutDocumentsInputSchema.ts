...
export const lost_itemsUpdateToOneWithWhereWithoutDocumentsInputSchema: z.ZodType<Prisma.lost_itemsUpdateToOneWithWhereWithoutDocumentsInput> = z.object({
  where: z.lazy(() => lost_itemsWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => lost_itemsUpdateWithoutDocumentsInputSchema),z.lazy(() => lost_itemsUncheckedUpdateWithoutDocumentsInputSchema) ]),
}).strict();
