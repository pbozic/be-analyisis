...
export const reviewableUpdateOneRequiredWithoutReviewsNestedInputSchema: z.ZodType<Prisma.reviewableUpdateOneRequiredWithoutReviewsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => reviewableUpdateToOneWithWhereWithoutReviewsInputSchema),z.lazy(() => reviewableUpdateWithoutReviewsInputSchema),z.lazy(() => reviewableUncheckedUpdateWithoutReviewsInputSchema) ]).optional(),
}).strict();
