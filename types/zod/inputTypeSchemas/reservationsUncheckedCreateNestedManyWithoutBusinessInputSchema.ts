...
export const reservationsUncheckedCreateNestedManyWithoutBusinessInputSchema: z.ZodType<Prisma.reservationsUncheckedCreateNestedManyWithoutBusinessInput> =
	z
		.object({
			create: z
				.union([
