...
export const late_eventsUpsertWithWhereUniqueWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.late_eventsUpsertWithWhereUniqueWithoutDelivery_ordersInput> =
	z
		.object({
			where: z.lazy(() => late_eventsWhereUniqueInputSchema),
			update: z.union([
				z.lazy(() => late_eventsUpdateWithoutDelivery_ordersInputSchema),
				z.lazy(() => late_eventsUncheckedUpdateWithoutDelivery_ordersInputSchema),
			]),
			create: z.union([
