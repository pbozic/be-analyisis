...
export const delivery_order_sentUpdateManyWithoutDriverNestedInputSchema: z.ZodType<Prisma.delivery_order_sentUpdateManyWithoutDriverNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => delivery_order_sentUpsertWithWhereUniqueWithoutDriverInputSchema),
					z.lazy(() => delivery_order_sentUpsertWithWhereUniqueWithoutDriverInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => delivery_order_sentUpdateWithWhereUniqueWithoutDriverInputSchema),
					z.lazy(() => delivery_order_sentUpdateWithWhereUniqueWithoutDriverInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => delivery_order_sentUpdateManyWithWhereWithoutDriverInputSchema),
					z.lazy(() => delivery_order_sentUpdateManyWithWhereWithoutDriverInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default delivery_order_sentUpdateManyWithoutDriverNestedInputSchema;
