...
export const promo_sectionsUpsertWithoutPromo_section_buyInputSchema: z.ZodType<Prisma.promo_sectionsUpsertWithoutPromo_section_buyInput> = z.object({
  update: z.union([ z.lazy(() => promo_sectionsUpdateWithoutPromo_section_buyInputSchema),z.lazy(() => promo_sectionsUncheckedUpdateWithoutPromo_section_buyInputSchema) ]),
  create: z.union([ z.lazy(() => promo_sectionsCreateWithoutPromo_section_buyInputSchema),z.lazy(() => promo_sectionsUncheckedCreateWithoutPromo_section_buyInputSchema) ]),
