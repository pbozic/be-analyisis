...
export const promo_sections_buyUpsertWithWhereUniqueWithoutBusinessInputSchema: z.ZodType<Prisma.promo_sections_buyUpsertWithWhereUniqueWithoutBusinessInput> = z.object({
  where: z.lazy(() => promo_sections_buyWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => promo_sections_buyUpdateWithoutBusinessInputSchema),z.lazy(() => promo_sections_buyUncheckedUpdateWithoutBusinessInputSchema) ]),
