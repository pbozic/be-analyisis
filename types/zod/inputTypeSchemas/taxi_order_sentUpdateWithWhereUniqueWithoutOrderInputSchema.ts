...
export const taxi_order_sentUpdateWithWhereUniqueWithoutOrderInputSchema: z.ZodType<Prisma.taxi_order_sentUpdateWithWhereUniqueWithoutOrderInput> = z.object({
  where: z.lazy(() => taxi_order_sentWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => taxi_order_sentUpdateWithoutOrderInputSchema),z.lazy(() => taxi_order_sentUncheckedUpdateWithoutOrderInputSchema) ]),
}).strict();
