...
export const taxi_ordersUpsertWithWhereUniqueWithoutParent_orderInputSchema: z.ZodType<Prisma.taxi_ordersUpsertWithWhereUniqueWithoutParent_orderInput> = z.object({
  where: z.lazy(() => taxi_ordersWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => taxi_ordersUpdateWithoutParent_orderInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateWithoutParent_orderInputSchema) ]),
