...
export const business_teamsCreateWithoutBusinessInputSchema: z.ZodType<Prisma.business_teamsCreateWithoutBusinessInput> = z.object({
...
export default business_teamsCreateWithoutBusinessInputSchema;
