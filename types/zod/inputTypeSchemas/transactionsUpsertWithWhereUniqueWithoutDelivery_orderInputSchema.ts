...
export const transactionsUpsertWithWhereUniqueWithoutDelivery_orderInputSchema: z.ZodType<Prisma.transactionsUpsertWithWhereUniqueWithoutDelivery_orderInput> =
	z
		.object({
			where: z.lazy(() => transactionsWhereUniqueInputSchema),
			update: z.union([
				z.lazy(() => transactionsUpdateWithoutDelivery_orderInputSchema),
				z.lazy(() => transactionsUncheckedUpdateWithoutDelivery_orderInputSchema),
			]),
			create: z.union([
