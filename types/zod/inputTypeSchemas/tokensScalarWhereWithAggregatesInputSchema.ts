...
export const tokensScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.tokensScalarWhereWithAggregatesInput> = z
	.object({
		AND: z
			.union([
				z.lazy(() => tokensScalarWhereWithAggregatesInputSchema),
				z.lazy(() => tokensScalarWhereWithAggregatesInputSchema).array(),
			])
			.optional(),
		OR: z
			.lazy(() => tokensScalarWhereWithAggregatesInputSchema)
			.array()
			.optional(),
		NOT: z
			.union([
		...
		type: z
			.union([z.lazy(() => EnumTokenTypeWithAggregatesFilterSchema), z.lazy(() => TokenTypeSchema)])
			.optional(),
