...
export const user_addressUpdateWithWhereUniqueWithoutAddressInputSchema: z.ZodType<Prisma.user_addressUpdateWithWhereUniqueWithoutAddressInput> = z.object({
  where: z.lazy(() => user_addressWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => user_addressUpdateWithoutAddressInputSchema),z.lazy(() => user_addressUncheckedUpdateWithoutAddressInputSchema) ]),
}).strict();
