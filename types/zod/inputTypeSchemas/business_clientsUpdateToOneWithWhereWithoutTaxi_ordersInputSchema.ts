...
export const business_clientsUpdateToOneWithWhereWithoutTaxi_ordersInputSchema: z.ZodType<Prisma.business_clientsUpdateToOneWithWhereWithoutTaxi_ordersInput> = z.object({
  where: z.lazy(() => business_clientsWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => business_clientsUpdateWithoutTaxi_ordersInputSchema),z.lazy(() => business_clientsUncheckedUpdateWithoutTaxi_ordersInputSchema) ]),
}).strict();
