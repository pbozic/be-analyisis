...
export const flagsUpsertWithoutHistoryInputSchema: z.ZodType<Prisma.flagsUpsertWithoutHistoryInput> = z.object({
  update: z.union([ z.lazy(() => flagsUpdateWithoutHistoryInputSchema),z.lazy(() => flagsUncheckedUpdateWithoutHistoryInputSchema) ]),
  create: z.union([ z.lazy(() => flagsCreateWithoutHistoryInputSchema),z.lazy(() => flagsUncheckedCreateWithoutHistoryInputSchema) ]),
