...
export const promo_sections_buyMaxOrderByAggregateInputSchema: z.ZodType<Prisma.promo_sections_buyMaxOrderByAggregateInput> = z.object({
...
export default promo_sections_buyMaxOrderByAggregateInputSchema;
