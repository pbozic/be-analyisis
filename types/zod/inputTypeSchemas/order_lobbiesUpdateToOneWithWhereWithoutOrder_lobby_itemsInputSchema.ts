...
export const order_lobbiesUpdateToOneWithWhereWithoutOrder_lobby_itemsInputSchema: z.ZodType<Prisma.order_lobbiesUpdateToOneWithWhereWithoutOrder_lobby_itemsInput> =
	z
		.object({
