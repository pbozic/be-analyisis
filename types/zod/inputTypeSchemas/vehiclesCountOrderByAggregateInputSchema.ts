...
export const vehiclesCountOrderByAggregateInputSchema: z.ZodType<Prisma.vehiclesCountOrderByAggregateInput> = z.object({
...
export default vehiclesCountOrderByAggregateInputSchema;
