...
export const order_lobby_itemsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.order_lobby_itemsScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => order_lobby_itemsScalarWhereWithAggregatesInputSchema),z.lazy(() => order_lobby_itemsScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => order_lobby_itemsScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => order_lobby_itemsScalarWhereWithAggregatesInputSchema),z.lazy(() => order_lobby_itemsScalarWhereWithAggregatesInputSchema).array() ]).optional(),
