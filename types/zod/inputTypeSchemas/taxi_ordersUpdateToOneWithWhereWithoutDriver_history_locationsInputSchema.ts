...
export const taxi_ordersUpdateToOneWithWhereWithoutDriver_history_locationsInputSchema: z.ZodType<Prisma.taxi_ordersUpdateToOneWithWhereWithoutDriver_history_locationsInput> = z.object({
  where: z.lazy(() => taxi_ordersWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => taxi_ordersUpdateWithoutDriver_history_locationsInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateWithoutDriver_history_locationsInputSchema) ]),
}).strict();
