...
export const transactionsCountOrderByAggregateInputSchema: z.ZodType<Prisma.transactionsCountOrderByAggregateInput> = z
	.object({
...
export default transactionsCountOrderByAggregateInputSchema;
