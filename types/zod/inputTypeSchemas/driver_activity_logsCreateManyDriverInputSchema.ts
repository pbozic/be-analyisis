...
export const driver_activity_logsCreateManyDriverInputSchema: z.ZodType<Prisma.driver_activity_logsCreateManyDriverInput> = z.object({
...
export default driver_activity_logsCreateManyDriverInputSchema;
