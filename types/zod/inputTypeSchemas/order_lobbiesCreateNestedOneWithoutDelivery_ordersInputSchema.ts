...
export const order_lobbiesCreateNestedOneWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.order_lobbiesCreateNestedOneWithoutDelivery_ordersInput> = z.object({
...
export default order_lobbiesCreateNestedOneWithoutDelivery_ordersInputSchema;
