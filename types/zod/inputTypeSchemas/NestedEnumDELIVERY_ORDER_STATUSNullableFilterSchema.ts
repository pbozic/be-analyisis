...
export const NestedEnumDELIVERY_ORDER_STATUSNullableFilterSchema: z.ZodType<Prisma.NestedEnumDELIVERY_ORDER_STATUSNullableFilter> =
	z
		.object({
			equals: z
			...
			not: z
				.union([
					...
					z.lazy(() => NestedEnumDELIVERY_ORDER_STATUSNullableFilterSchema),
				])
				.optional()
				.nullable(),
		})
