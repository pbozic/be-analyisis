...
export const filesUpdateManyWithoutDocumentsNestedInputSchema: z.ZodType<Prisma.filesUpdateManyWithoutDocumentsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => filesUpsertWithWhereUniqueWithoutDocumentsInputSchema),
					z.lazy(() => filesUpsertWithWhereUniqueWithoutDocumentsInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => filesUpdateWithWhereUniqueWithoutDocumentsInputSchema),
					z.lazy(() => filesUpdateWithWhereUniqueWithoutDocumentsInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => filesUpdateManyWithWhereWithoutDocumentsInputSchema),
					z.lazy(() => filesUpdateManyWithWhereWithoutDocumentsInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([z.lazy(() => filesScalarWhereInputSchema), z.lazy(() => filesScalarWhereInputSchema).array()])
				.optional(),
		})
		.strict();

export default filesUpdateManyWithoutDocumentsNestedInputSchema;
