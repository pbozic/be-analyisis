...
export const businessUncheckedCreateWithoutBusiness_order_lobbiesInputSchema: z.ZodType<Prisma.businessUncheckedCreateWithoutBusiness_order_lobbiesInput> =
	z
		.object({
