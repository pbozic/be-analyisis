...
export const daily_meals_subscriptionsCreateNestedManyWithoutMenuInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsCreateNestedManyWithoutMenuInput> =
	z
		.object({
			create: z
				.union([
