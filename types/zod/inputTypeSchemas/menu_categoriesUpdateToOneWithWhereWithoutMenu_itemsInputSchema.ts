...
export const menu_categoriesUpdateToOneWithWhereWithoutMenu_itemsInputSchema: z.ZodType<Prisma.menu_categoriesUpdateToOneWithWhereWithoutMenu_itemsInput> = z.object({
  where: z.lazy(() => menu_categoriesWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => menu_categoriesUpdateWithoutMenu_itemsInputSchema),z.lazy(() => menu_categoriesUncheckedUpdateWithoutMenu_itemsInputSchema) ]),
}).strict();
