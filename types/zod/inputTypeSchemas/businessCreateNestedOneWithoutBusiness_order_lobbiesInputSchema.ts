...
export const businessCreateNestedOneWithoutBusiness_order_lobbiesInputSchema: z.ZodType<Prisma.businessCreateNestedOneWithoutBusiness_order_lobbiesInput> =
	z
		.object({
			create: z
				.union([
