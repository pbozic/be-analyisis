...
export const menu_itemsUncheckedUpdateManyWithoutMenu_categoryNestedInputSchema: z.ZodType<Prisma.menu_itemsUncheckedUpdateManyWithoutMenu_categoryNestedInput> =
	z
		.object({
			create: z
				.union([
