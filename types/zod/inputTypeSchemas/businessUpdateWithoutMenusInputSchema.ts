...
export const businessUpdateWithoutMenusInputSchema: z.ZodType<Prisma.businessUpdateWithoutMenusInput> = z.object({
...
export default businessUpdateWithoutMenusInputSchema;
