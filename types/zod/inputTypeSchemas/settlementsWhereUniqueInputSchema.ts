...
export const settlementsWhereUniqueInputSchema: z.ZodType<Prisma.settlementsWhereUniqueInput> = z
	.object({
			...
			.object({
				...
				AND: z
					.union([
						...
						z.lazy(() => settlementsWhereInputSchema).array(),
					])
					.optional(),
				OR: z
...
export default settlementsWhereUniqueInputSchema;
