...
export const flag_historyUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.flag_historyUncheckedUpdateManyWithoutUserNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => flag_historyUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => flag_historyUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => flag_historyUpdateWithWhereUniqueWithoutUserInputSchema),z.lazy(() => flag_historyUpdateWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => flag_historyUpdateManyWithWhereWithoutUserInputSchema),z.lazy(() => flag_historyUpdateManyWithWhereWithoutUserInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => flag_historyScalarWhereInputSchema),z.lazy(() => flag_historyScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default flag_historyUncheckedUpdateManyWithoutUserNestedInputSchema;
