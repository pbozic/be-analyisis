...
export const documentsUncheckedUpdateManyWithoutTransactionsNestedInputSchema: z.ZodType<Prisma.documentsUncheckedUpdateManyWithoutTransactionsNestedInput> =
	z
		.object({
			create: z
				.union([
