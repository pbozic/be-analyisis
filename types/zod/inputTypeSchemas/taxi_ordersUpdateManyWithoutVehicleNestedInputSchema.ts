...
export const taxi_ordersUpdateManyWithoutVehicleNestedInputSchema: z.ZodType<Prisma.taxi_ordersUpdateManyWithoutVehicleNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => taxi_ordersUpsertWithWhereUniqueWithoutVehicleInputSchema),
					z.lazy(() => taxi_ordersUpsertWithWhereUniqueWithoutVehicleInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => taxi_ordersUpdateWithWhereUniqueWithoutVehicleInputSchema),
					z.lazy(() => taxi_ordersUpdateWithWhereUniqueWithoutVehicleInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => taxi_ordersUpdateManyWithWhereWithoutVehicleInputSchema),
					z.lazy(() => taxi_ordersUpdateManyWithWhereWithoutVehicleInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default taxi_ordersUpdateManyWithoutVehicleNestedInputSchema;
