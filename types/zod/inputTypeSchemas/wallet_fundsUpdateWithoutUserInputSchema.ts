...
export const wallet_fundsUpdateWithoutUserInputSchema: z.ZodType<Prisma.wallet_fundsUpdateWithoutUserInput> = z.object({
...
export default wallet_fundsUpdateWithoutUserInputSchema;
