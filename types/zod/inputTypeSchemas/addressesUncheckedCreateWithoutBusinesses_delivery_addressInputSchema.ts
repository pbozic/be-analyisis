...
export const addressesUncheckedCreateWithoutBusinesses_delivery_addressInputSchema: z.ZodType<Prisma.addressesUncheckedCreateWithoutBusinesses_delivery_addressInput> =
	z
		.object({
