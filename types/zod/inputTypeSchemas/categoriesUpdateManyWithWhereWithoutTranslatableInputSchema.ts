...
export const categoriesUpdateManyWithWhereWithoutTranslatableInputSchema: z.ZodType<Prisma.categoriesUpdateManyWithWhereWithoutTranslatableInput> =
	z
		.object({
			where: z.lazy(() => categoriesScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => categoriesUpdateManyMutationInputSchema),
				z.lazy(() => categoriesUncheckedUpdateManyWithoutTranslatableInputSchema),
			]),
		})
		.strict();
