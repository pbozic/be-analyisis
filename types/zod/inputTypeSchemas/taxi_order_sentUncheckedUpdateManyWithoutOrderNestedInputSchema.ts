...
export const taxi_order_sentUncheckedUpdateManyWithoutOrderNestedInputSchema: z.ZodType<Prisma.taxi_order_sentUncheckedUpdateManyWithoutOrderNestedInput> =
	z
		.object({
			create: z
				.union([
