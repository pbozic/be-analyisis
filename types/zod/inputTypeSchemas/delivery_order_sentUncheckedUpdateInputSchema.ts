...
export const delivery_order_sentUncheckedUpdateInputSchema: z.ZodType<Prisma.delivery_order_sentUncheckedUpdateInput> = z.object({
...
export default delivery_order_sentUncheckedUpdateInputSchema;
