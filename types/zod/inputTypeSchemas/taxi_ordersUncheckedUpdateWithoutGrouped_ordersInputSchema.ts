...
export const taxi_ordersUncheckedUpdateWithoutGrouped_ordersInputSchema: z.ZodType<Prisma.taxi_ordersUncheckedUpdateWithoutGrouped_ordersInput> = z.object({
  order_id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  user_id: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  business_users_id: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  business_clients_id: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  parent_order_id: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  driver_history_locations: z.lazy(() => driver_history_locationsUncheckedUpdateManyWithoutOrderNestedInputSchema).optional(),
  wallet_transfer: z.lazy(() => wallet_transfer_historyUncheckedUpdateManyWithoutTaxi_orderNestedInputSchema).optional(),
  ...
  scoring_points: z.lazy(() => scoring_pointsUncheckedUpdateManyWithoutTaxi_ordersNestedInputSchema).optional(),
  late_events: z.lazy(() => late_eventsUncheckedUpdateManyWithoutTaxi_ordersNestedInputSchema).optional()
}).strict();

export default taxi_ordersUncheckedUpdateWithoutGrouped_ordersInputSchema;
