...
export const menu_categoriesUncheckedCreateWithoutMenu_itemsInputSchema: z.ZodType<Prisma.menu_categoriesUncheckedCreateWithoutMenu_itemsInput> =
	z
		.object({
			...
			categories: z
				.union([z.lazy(() => menu_categoriesCreatecategoriesInputSchema), z.string().array()])
				.optional(),
			...
			menu_categories_categories: z
				.lazy(() => menu_categories_categoriesUncheckedCreateNestedManyWithoutMenu_categoryInputSchema)
				.optional(),
			daily_meal_subscribers: z
				.lazy(() => daily_meals_subscriptionsUncheckedCreateNestedManyWithoutMenu_categoryInputSchema)
				.optional(),
		})
		.strict();

export default menu_categoriesUncheckedCreateWithoutMenu_itemsInputSchema;
