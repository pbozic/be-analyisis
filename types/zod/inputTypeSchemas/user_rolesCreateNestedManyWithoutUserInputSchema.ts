...
export const user_rolesCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.user_rolesCreateNestedManyWithoutUserInput> = z.object({
...
export default user_rolesCreateNestedManyWithoutUserInputSchema;
