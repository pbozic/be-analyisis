...
export const late_eventsUncheckedUpdateManyWithoutBusinessesNestedInputSchema: z.ZodType<Prisma.late_eventsUncheckedUpdateManyWithoutBusinessesNestedInput> =
	z
		.object({
			create: z
				.union([
