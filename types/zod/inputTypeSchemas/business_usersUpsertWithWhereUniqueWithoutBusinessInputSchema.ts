...
export const business_usersUpsertWithWhereUniqueWithoutBusinessInputSchema: z.ZodType<Prisma.business_usersUpsertWithWhereUniqueWithoutBusinessInput> = z.object({
  where: z.lazy(() => business_usersWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => business_usersUpdateWithoutBusinessInputSchema),z.lazy(() => business_usersUncheckedUpdateWithoutBusinessInputSchema) ]),
  create: z.union([ z.lazy(() => business_usersCreateWithoutBusinessInputSchema),z.lazy(() => business_usersUncheckedCreateWithoutBusinessInputSchema) ]),
}).strict();
