...
export const driver_municipalitiesUpdateManyWithoutDriversNestedInputSchema: z.ZodType<Prisma.driver_municipalitiesUpdateManyWithoutDriversNestedInput> =
	z
		.object({
			create: z
				.union([
					z.lazy(() => driver_municipalitiesCreateWithoutDriversInputSchema),
					z.lazy(() => driver_municipalitiesCreateWithoutDriversInputSchema).array(),
					z.lazy(() => driver_municipalitiesUncheckedCreateWithoutDriversInputSchema),
					z.lazy(() => driver_municipalitiesUncheckedCreateWithoutDriversInputSchema).array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					z.lazy(() => driver_municipalitiesCreateOrConnectWithoutDriversInputSchema),
					z.lazy(() => driver_municipalitiesCreateOrConnectWithoutDriversInputSchema).array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(() => driver_municipalitiesUpsertWithWhereUniqueWithoutDriversInputSchema),
					z.lazy(() => driver_municipalitiesUpsertWithWhereUniqueWithoutDriversInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => driver_municipalitiesUpdateWithWhereUniqueWithoutDriversInputSchema),
					z.lazy(() => driver_municipalitiesUpdateWithWhereUniqueWithoutDriversInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => driver_municipalitiesUpdateManyWithWhereWithoutDriversInputSchema),
					z.lazy(() => driver_municipalitiesUpdateManyWithWhereWithoutDriversInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
					z.lazy(() => driver_municipalitiesScalarWhereInputSchema),
					z.lazy(() => driver_municipalitiesScalarWhereInputSchema).array(),
				])
				.optional(),
		})
		.strict();

export default driver_municipalitiesUpdateManyWithoutDriversNestedInputSchema;
