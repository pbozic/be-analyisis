...
export const scoring_pointsUpdateManyWithWhereWithoutTaxi_ordersInputSchema: z.ZodType<Prisma.scoring_pointsUpdateManyWithWhereWithoutTaxi_ordersInput> =
	z
		.object({
			where: z.lazy(() => scoring_pointsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => scoring_pointsUpdateManyMutationInputSchema),
				z.lazy(() => scoring_pointsUncheckedUpdateManyWithoutTaxi_ordersInputSchema),
			]),
		})
		.strict();
