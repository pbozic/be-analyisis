...
export const delivery_ordersOrderByWithAggregationInputSchema: z.ZodType<Prisma.delivery_ordersOrderByWithAggregationInput> = z.object({
  ...
  courier_instructions: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
