...
export const wallet_transfer_historyUncheckedCreateNestedManyWithoutTaxi_orderInputSchema: z.ZodType<Prisma.wallet_transfer_historyUncheckedCreateNestedManyWithoutTaxi_orderInput> =
	z
		.object({
			create: z
				.union([
