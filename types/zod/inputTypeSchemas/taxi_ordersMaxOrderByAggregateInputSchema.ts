...
export const taxi_ordersMaxOrderByAggregateInputSchema: z.ZodType<Prisma.taxi_ordersMaxOrderByAggregateInput> = z.object({
...
export default taxi_ordersMaxOrderByAggregateInputSchema;
