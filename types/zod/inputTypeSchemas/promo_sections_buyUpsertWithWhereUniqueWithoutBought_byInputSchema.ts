...
export const promo_sections_buyUpsertWithWhereUniqueWithoutBought_byInputSchema: z.ZodType<Prisma.promo_sections_buyUpsertWithWhereUniqueWithoutBought_byInput> =
	z
		.object({
			where: z.lazy(() => promo_sections_buyWhereUniqueInputSchema),
			update: z.union([
				z.lazy(() => promo_sections_buyUpdateWithoutBought_byInputSchema),
				z.lazy(() => promo_sections_buyUncheckedUpdateWithoutBought_byInputSchema),
			]),
			create: z.union([
