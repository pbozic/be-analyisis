...
export const user_favorite_businessesScalarWhereInputSchema: z.ZodType<Prisma.user_favorite_businessesScalarWhereInput> =
	z
		.object({
			AND: z
				.union([
				...
				.optional(),
			OR: z
				.lazy(() => user_favorite_businessesScalarWhereInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
