...
export const order_lobbiesCountOrderByAggregateInputSchema: z.ZodType<Prisma.order_lobbiesCountOrderByAggregateInput> = z.object({
...
export default order_lobbiesCountOrderByAggregateInputSchema;
