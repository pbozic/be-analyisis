...
export const user_favorite_businessesUncheckedUpdateManyWithoutUsersNestedInputSchema: z.ZodType<Prisma.user_favorite_businessesUncheckedUpdateManyWithoutUsersNestedInput> = z.object({
  create: z.union([ z.lazy(() => user_favorite_businessesCreateWithoutUsersInputSchema),z.lazy(() => user_favorite_businessesCreateWithoutUsersInputSchema).array(),z.lazy(() => user_favorite_businessesUncheckedCreateWithoutUsersInputSchema),z.lazy(() => user_favorite_businessesUncheckedCreateWithoutUsersInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => user_favorite_businessesCreateOrConnectWithoutUsersInputSchema),z.lazy(() => user_favorite_businessesCreateOrConnectWithoutUsersInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => user_favorite_businessesUpsertWithWhereUniqueWithoutUsersInputSchema),z.lazy(() => user_favorite_businessesUpsertWithWhereUniqueWithoutUsersInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => user_favorite_businessesUpdateWithWhereUniqueWithoutUsersInputSchema),z.lazy(() => user_favorite_businessesUpdateWithWhereUniqueWithoutUsersInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => user_favorite_businessesUpdateManyWithWhereWithoutUsersInputSchema),z.lazy(() => user_favorite_businessesUpdateManyWithWhereWithoutUsersInputSchema).array() ]).optional(),
...
export default user_favorite_businessesUncheckedUpdateManyWithoutUsersNestedInputSchema;
