...
export const user_favorite_businessesUncheckedUpdateManyWithoutUsersNestedInputSchema: z.ZodType<Prisma.user_favorite_businessesUncheckedUpdateManyWithoutUsersNestedInput> =
	z
		.object({
			create: z
				.union([
