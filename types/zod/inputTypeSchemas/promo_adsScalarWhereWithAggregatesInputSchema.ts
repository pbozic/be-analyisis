...
export const promo_adsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.promo_adsScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => promo_adsScalarWhereWithAggregatesInputSchema),
					z.lazy(() => promo_adsScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => promo_adsScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
