...
export const settlementsMaxOrderByAggregateInputSchema: z.ZodType<Prisma.settlementsMaxOrderByAggregateInput> = z.object({
...
export default settlementsMaxOrderByAggregateInputSchema;
