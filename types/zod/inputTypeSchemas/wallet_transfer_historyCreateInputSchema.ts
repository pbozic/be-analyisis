...
export const wallet_transfer_historyCreateInputSchema: z.ZodType<Prisma.wallet_transfer_historyCreateInput> = z.object({
...
export default wallet_transfer_historyCreateInputSchema;
