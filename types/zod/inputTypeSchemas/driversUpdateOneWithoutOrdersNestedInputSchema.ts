...
export const driversUpdateOneWithoutOrdersNestedInputSchema: z.ZodType<Prisma.driversUpdateOneWithoutOrdersNestedInput> = z.object({
  create: z.union([ z.lazy(() => driversCreateWithoutOrdersInputSchema),z.lazy(() => driversUncheckedCreateWithoutOrdersInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => driversUpdateToOneWithWhereWithoutOrdersInputSchema),z.lazy(() => driversUpdateWithoutOrdersInputSchema),z.lazy(() => driversUncheckedUpdateWithoutOrdersInputSchema) ]).optional(),
}).strict();
