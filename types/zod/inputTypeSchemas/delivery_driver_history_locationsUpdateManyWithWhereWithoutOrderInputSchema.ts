...
export const delivery_driver_history_locationsUpdateManyWithWhereWithoutOrderInputSchema: z.ZodType<Prisma.delivery_driver_history_locationsUpdateManyWithWhereWithoutOrderInput> = z.object({
  where: z.lazy(() => delivery_driver_history_locationsScalarWhereInputSchema),
  data: z.union([ z.lazy(() => delivery_driver_history_locationsUpdateManyMutationInputSchema),z.lazy(() => delivery_driver_history_locationsUncheckedUpdateManyWithoutOrderInputSchema) ]),
}).strict();
