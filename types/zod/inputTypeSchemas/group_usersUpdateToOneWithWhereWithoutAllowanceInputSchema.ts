...
export const group_usersUpdateToOneWithWhereWithoutAllowanceInputSchema: z.ZodType<Prisma.group_usersUpdateToOneWithWhereWithoutAllowanceInput> = z.object({
  where: z.lazy(() => group_usersWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => group_usersUpdateWithoutAllowanceInputSchema),z.lazy(() => group_usersUncheckedUpdateWithoutAllowanceInputSchema) ]),
}).strict();
