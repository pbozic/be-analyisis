...
export const daily_meals_subscriptionsUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUncheckedUpdateManyWithoutUserNestedInput> =
	z
		.object({
			create: z
				.union([
