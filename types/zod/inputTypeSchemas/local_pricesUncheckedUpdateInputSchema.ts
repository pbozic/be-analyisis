...
export const local_pricesUncheckedUpdateInputSchema: z.ZodType<Prisma.local_pricesUncheckedUpdateInput> = z.object({
...
export default local_pricesUncheckedUpdateInputSchema;
