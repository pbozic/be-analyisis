...
export const delivery_ordersUpsertWithoutOrder_lobbiesInputSchema: z.ZodType<Prisma.delivery_ordersUpsertWithoutOrder_lobbiesInput> = z.object({
  update: z.union([ z.lazy(() => delivery_ordersUpdateWithoutOrder_lobbiesInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutOrder_lobbiesInputSchema) ]),
  create: z.union([ z.lazy(() => delivery_ordersCreateWithoutOrder_lobbiesInputSchema),z.lazy(() => delivery_ordersUncheckedCreateWithoutOrder_lobbiesInputSchema) ]),
