...
export const taxi_ordersCreateNestedManyWithoutDriverInputSchema: z.ZodType<Prisma.taxi_ordersCreateNestedManyWithoutDriverInput> = z.object({
...
export default taxi_ordersCreateNestedManyWithoutDriverInputSchema;
