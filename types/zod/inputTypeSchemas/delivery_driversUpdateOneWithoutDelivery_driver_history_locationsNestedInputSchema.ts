...
export const delivery_driversUpdateOneWithoutDelivery_driver_history_locationsNestedInputSchema: z.ZodType<Prisma.delivery_driversUpdateOneWithoutDelivery_driver_history_locationsNestedInput> =
	z
		.object({
			create: z
				.union([
				...
				.optional(),
			connectOrCreate: z
				.lazy(() => delivery_driversCreateOrConnectWithoutDelivery_driver_history_locationsInputSchema)
				.optional(),
			...
			update: z
				.union([
					z.lazy(
						() => delivery_driversUpdateToOneWithWhereWithoutDelivery_driver_history_locationsInputSchema
					),
