...
export const menu_categoriesScalarWhereInputSchema: z.ZodType<Prisma.menu_categoriesScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => menu_categoriesScalarWhereInputSchema),z.lazy(() => menu_categoriesScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => menu_categoriesScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => menu_categoriesScalarWhereInputSchema),z.lazy(() => menu_categoriesScalarWhereInputSchema).array() ]).optional(),
