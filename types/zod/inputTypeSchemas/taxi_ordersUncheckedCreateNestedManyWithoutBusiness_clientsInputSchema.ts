...
export const taxi_ordersUncheckedCreateNestedManyWithoutBusiness_clientsInputSchema: z.ZodType<Prisma.taxi_ordersUncheckedCreateNestedManyWithoutBusiness_clientsInput> =
	z
		.object({
			create: z
				.union([
...
export default taxi_ordersUncheckedCreateNestedManyWithoutBusiness_clientsInputSchema;
