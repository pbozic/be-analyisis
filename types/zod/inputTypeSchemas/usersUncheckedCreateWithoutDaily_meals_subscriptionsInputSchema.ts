...
export const usersUncheckedCreateWithoutDaily_meals_subscriptionsInputSchema: z.ZodType<Prisma.usersUncheckedCreateWithoutDaily_meals_subscriptionsInput> =
	z
		.object({
