...
export const group_usersScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.group_usersScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => group_usersScalarWhereWithAggregatesInputSchema),
					z.lazy(() => group_usersScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => group_usersScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
