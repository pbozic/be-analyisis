...
export const menu_categoriesUncheckedUpdateWithoutMenu_categories_categoriesInputSchema: z.ZodType<Prisma.menu_categoriesUncheckedUpdateWithoutMenu_categories_categoriesInput> =
	z
		.object({
			menu_category_id: z
