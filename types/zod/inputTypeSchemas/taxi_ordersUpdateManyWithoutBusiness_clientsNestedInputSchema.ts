...
export const taxi_ordersUpdateManyWithoutBusiness_clientsNestedInputSchema: z.ZodType<Prisma.taxi_ordersUpdateManyWithoutBusiness_clientsNestedInput> =
	z
		.object({
			create: z
				.union([
					z.lazy(() => taxi_ordersCreateWithoutBusiness_clientsInputSchema),
					z.lazy(() => taxi_ordersCreateWithoutBusiness_clientsInputSchema).array(),
					z.lazy(() => taxi_ordersUncheckedCreateWithoutBusiness_clientsInputSchema),
					z.lazy(() => taxi_ordersUncheckedCreateWithoutBusiness_clientsInputSchema).array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					z.lazy(() => taxi_ordersCreateOrConnectWithoutBusiness_clientsInputSchema),
					z.lazy(() => taxi_ordersCreateOrConnectWithoutBusiness_clientsInputSchema).array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(() => taxi_ordersUpsertWithWhereUniqueWithoutBusiness_clientsInputSchema),
					z.lazy(() => taxi_ordersUpsertWithWhereUniqueWithoutBusiness_clientsInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => taxi_ordersUpdateWithWhereUniqueWithoutBusiness_clientsInputSchema),
					z.lazy(() => taxi_ordersUpdateWithWhereUniqueWithoutBusiness_clientsInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => taxi_ordersUpdateManyWithWhereWithoutBusiness_clientsInputSchema),
					z.lazy(() => taxi_ordersUpdateManyWithWhereWithoutBusiness_clientsInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default taxi_ordersUpdateManyWithoutBusiness_clientsNestedInputSchema;
