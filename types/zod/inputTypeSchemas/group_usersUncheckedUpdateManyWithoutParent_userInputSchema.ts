...
export const group_usersUncheckedUpdateManyWithoutParent_userInputSchema: z.ZodType<Prisma.group_usersUncheckedUpdateManyWithoutParent_userInput> = z.object({
...
export default group_usersUncheckedUpdateManyWithoutParent_userInputSchema;
