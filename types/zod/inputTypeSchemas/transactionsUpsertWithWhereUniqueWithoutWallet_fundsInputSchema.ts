...
export const transactionsUpsertWithWhereUniqueWithoutWallet_fundsInputSchema: z.ZodType<Prisma.transactionsUpsertWithWhereUniqueWithoutWallet_fundsInput> =
	z
		.object({
			where: z.lazy(() => transactionsWhereUniqueInputSchema),
			update: z.union([
				z.lazy(() => transactionsUpdateWithoutWallet_fundsInputSchema),
				z.lazy(() => transactionsUncheckedUpdateWithoutWallet_fundsInputSchema),
			]),
			create: z.union([
