...
export const daily_meals_subscriptionsMinOrderByAggregateInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsMinOrderByAggregateInput> = z.object({
...
export default daily_meals_subscriptionsMinOrderByAggregateInputSchema;
