...
export const usersCreateWithoutTransactionsInputSchema: z.ZodType<Prisma.usersCreateWithoutTransactionsInput> = z
	.object({
...
export default usersCreateWithoutTransactionsInputSchema;
