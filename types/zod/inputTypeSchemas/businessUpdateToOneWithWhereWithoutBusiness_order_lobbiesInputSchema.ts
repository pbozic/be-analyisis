...
export const businessUpdateToOneWithWhereWithoutBusiness_order_lobbiesInputSchema: z.ZodType<Prisma.businessUpdateToOneWithWhereWithoutBusiness_order_lobbiesInput> = z.object({
  where: z.lazy(() => businessWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => businessUpdateWithoutBusiness_order_lobbiesInputSchema),z.lazy(() => businessUncheckedUpdateWithoutBusiness_order_lobbiesInputSchema) ]),
}).strict();
