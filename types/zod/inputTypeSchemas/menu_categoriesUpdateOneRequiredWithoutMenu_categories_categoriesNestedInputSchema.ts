...
export const menu_categoriesUpdateOneRequiredWithoutMenu_categories_categoriesNestedInputSchema: z.ZodType<Prisma.menu_categoriesUpdateOneRequiredWithoutMenu_categories_categoriesNestedInput> = z.object({
  create: z.union([ z.lazy(() => menu_categoriesCreateWithoutMenu_categories_categoriesInputSchema),z.lazy(() => menu_categoriesUncheckedCreateWithoutMenu_categories_categoriesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => menu_categoriesCreateOrConnectWithoutMenu_categories_categoriesInputSchema).optional(),
  ...
  update: z.union([ z.lazy(() => menu_categoriesUpdateToOneWithWhereWithoutMenu_categories_categoriesInputSchema),z.lazy(() => menu_categoriesUpdateWithoutMenu_categories_categoriesInputSchema),z.lazy(() => menu_categoriesUncheckedUpdateWithoutMenu_categories_categoriesInputSchema) ]).optional(),
}).strict();
