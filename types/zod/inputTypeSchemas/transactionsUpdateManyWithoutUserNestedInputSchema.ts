		...
		.object({
			...
			upsert: z
				.union([
					...
					z.lazy(() => transactionsUpsertWithWhereUniqueWithoutUserInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					...
					z.lazy(() => transactionsUpdateWithWhereUniqueWithoutUserInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => transactionsUpdateManyWithWhereWithoutUserInputSchema),
					z.lazy(() => transactionsUpdateManyWithWhereWithoutUserInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default transactionsUpdateManyWithoutUserNestedInputSchema;
