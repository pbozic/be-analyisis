...
export const addressesCreateWithoutBusiness_usersInputSchema: z.ZodType<Prisma.addressesCreateWithoutBusiness_usersInput> =
	z
		.object({
			...
			daily_meals_subscriptions: z
				.lazy(() => daily_meals_subscriptionsCreateNestedManyWithoutAddressInputSchema)
				.optional(),
		})
		.strict();

export default addressesCreateWithoutBusiness_usersInputSchema;
