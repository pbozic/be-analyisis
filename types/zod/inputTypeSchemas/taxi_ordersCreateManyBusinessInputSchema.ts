...
export const taxi_ordersCreateManyBusinessInputSchema: z.ZodType<Prisma.taxi_ordersCreateManyBusinessInput> = z.object({
...
export default taxi_ordersCreateManyBusinessInputSchema;
