...
export const driver_history_locationsUncheckedCreateNestedManyWithoutOrderInputSchema: z.ZodType<Prisma.driver_history_locationsUncheckedCreateNestedManyWithoutOrderInput> =
	z
		.object({
			create: z
				.union([
