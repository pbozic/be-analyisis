...
export const delivery_order_sentScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.delivery_order_sentScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => delivery_order_sentScalarWhereWithAggregatesInputSchema),
					z.lazy(() => delivery_order_sentScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => delivery_order_sentScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
