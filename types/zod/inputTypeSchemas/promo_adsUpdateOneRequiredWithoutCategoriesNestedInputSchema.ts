...
export const promo_adsUpdateOneRequiredWithoutCategoriesNestedInputSchema: z.ZodType<Prisma.promo_adsUpdateOneRequiredWithoutCategoriesNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => promo_adsUpdateToOneWithWhereWithoutCategoriesInputSchema),
