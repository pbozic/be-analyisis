...
export const wallet_transfer_historyUncheckedCreateNestedManyWithoutDelivery_orderInputSchema: z.ZodType<Prisma.wallet_transfer_historyUncheckedCreateNestedManyWithoutDelivery_orderInput> =
	z
		.object({
			create: z
				.union([
