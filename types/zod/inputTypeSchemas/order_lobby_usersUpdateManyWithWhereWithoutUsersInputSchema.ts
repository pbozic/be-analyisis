...
export const order_lobby_usersUpdateManyWithWhereWithoutUsersInputSchema: z.ZodType<Prisma.order_lobby_usersUpdateManyWithWhereWithoutUsersInput> = z.object({
  where: z.lazy(() => order_lobby_usersScalarWhereInputSchema),
  data: z.union([ z.lazy(() => order_lobby_usersUpdateManyMutationInputSchema),z.lazy(() => order_lobby_usersUncheckedUpdateManyWithoutUsersInputSchema) ]),
}).strict();
