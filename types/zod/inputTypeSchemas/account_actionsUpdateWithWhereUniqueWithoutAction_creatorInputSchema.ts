...
export const account_actionsUpdateWithWhereUniqueWithoutAction_creatorInputSchema: z.ZodType<Prisma.account_actionsUpdateWithWhereUniqueWithoutAction_creatorInput> =
	z
		.object({
			where: z.lazy(() => account_actionsWhereUniqueInputSchema),
			data: z.union([
				z.lazy(() => account_actionsUpdateWithoutAction_creatorInputSchema),
				z.lazy(() => account_actionsUncheckedUpdateWithoutAction_creatorInputSchema),
			]),
		})
		.strict();
