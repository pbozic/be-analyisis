...
export const addressesCreateNestedOneWithoutBusinesses_delivery_addressInputSchema: z.ZodType<Prisma.addressesCreateNestedOneWithoutBusinesses_delivery_addressInput> =
	z
		.object({
			create: z
				.union([
