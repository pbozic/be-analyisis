...
export const scoring_pointsUpdateManyWithoutBusinessesNestedInputSchema: z.ZodType<Prisma.scoring_pointsUpdateManyWithoutBusinessesNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => scoring_pointsUpsertWithWhereUniqueWithoutBusinessesInputSchema),z.lazy(() => scoring_pointsUpsertWithWhereUniqueWithoutBusinessesInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => scoring_pointsUpdateWithWhereUniqueWithoutBusinessesInputSchema),z.lazy(() => scoring_pointsUpdateWithWhereUniqueWithoutBusinessesInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => scoring_pointsUpdateManyWithWhereWithoutBusinessesInputSchema),z.lazy(() => scoring_pointsUpdateManyWithWhereWithoutBusinessesInputSchema).array() ]).optional(),
...
export default scoring_pointsUpdateManyWithoutBusinessesNestedInputSchema;
