...
export const vehiclesUncheckedUpdateManyWithoutDelivery_driverNestedInputSchema: z.ZodType<Prisma.vehiclesUncheckedUpdateManyWithoutDelivery_driverNestedInput> =
	z
		.object({
			create: z
				.union([
