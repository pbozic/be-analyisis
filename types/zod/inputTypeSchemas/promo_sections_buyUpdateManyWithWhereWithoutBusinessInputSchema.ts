...
export const promo_sections_buyUpdateManyWithWhereWithoutBusinessInputSchema: z.ZodType<Prisma.promo_sections_buyUpdateManyWithWhereWithoutBusinessInput> =
	z
		.object({
			where: z.lazy(() => promo_sections_buyScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => promo_sections_buyUpdateManyMutationInputSchema),
				z.lazy(() => promo_sections_buyUncheckedUpdateManyWithoutBusinessInputSchema),
			]),
		})
		.strict();
