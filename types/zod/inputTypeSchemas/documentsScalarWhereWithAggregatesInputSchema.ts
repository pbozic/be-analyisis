...
export const documentsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.documentsScalarWhereWithAggregatesInput> = z.object({
  ...
  document_type: z.union([ z.lazy(() => EnumDOCUMENT_TYPEWithAggregatesFilterSchema),z.lazy(() => DOCUMENT_TYPESchema) ]).optional(),
  ...
  issue_date: z.union([ z.lazy(() => DateTimeNullableWithAggregatesFilterSchema),z.coerce.date() ]).optional().nullable(),
  ...
  menu_item_id: z.union([ z.lazy(() => UuidNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  lost_item_id: z.union([ z.lazy(() => UuidNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  transaction_id: z.union([ z.lazy(() => UuidNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
}).strict();
