...
export const user_addressUncheckedUpdateInputSchema: z.ZodType<Prisma.user_addressUncheckedUpdateInput> = z.object({
...
export default user_addressUncheckedUpdateInputSchema;
