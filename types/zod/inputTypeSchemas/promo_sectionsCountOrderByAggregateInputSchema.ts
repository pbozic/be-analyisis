...
export const promo_sectionsCountOrderByAggregateInputSchema: z.ZodType<Prisma.promo_sectionsCountOrderByAggregateInput> = z.object({
  promo_sections_id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  tag: z.lazy(() => SortOrderSchema).optional(),
  active: z.lazy(() => SortOrderSchema).optional(),
  description: z.lazy(() => SortOrderSchema).optional(),
  prices: z.lazy(() => SortOrderSchema).optional(),
  limits: z.lazy(() => SortOrderSchema).optional(),
...
export default promo_sectionsCountOrderByAggregateInputSchema;
