...
export const wallet_fundsUncheckedUpdateManyWithoutReferralNestedInputSchema: z.ZodType<Prisma.wallet_fundsUncheckedUpdateManyWithoutReferralNestedInput> = z.object({
  create: z.union([ z.lazy(() => wallet_fundsCreateWithoutReferralInputSchema),z.lazy(() => wallet_fundsCreateWithoutReferralInputSchema).array(),z.lazy(() => wallet_fundsUncheckedCreateWithoutReferralInputSchema),z.lazy(() => wallet_fundsUncheckedCreateWithoutReferralInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => wallet_fundsCreateOrConnectWithoutReferralInputSchema),z.lazy(() => wallet_fundsCreateOrConnectWithoutReferralInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => wallet_fundsUpsertWithWhereUniqueWithoutReferralInputSchema),z.lazy(() => wallet_fundsUpsertWithWhereUniqueWithoutReferralInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => wallet_fundsUpdateWithWhereUniqueWithoutReferralInputSchema),z.lazy(() => wallet_fundsUpdateWithWhereUniqueWithoutReferralInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => wallet_fundsUpdateManyWithWhereWithoutReferralInputSchema),z.lazy(() => wallet_fundsUpdateManyWithWhereWithoutReferralInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => wallet_fundsScalarWhereInputSchema),z.lazy(() => wallet_fundsScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default wallet_fundsUncheckedUpdateManyWithoutReferralNestedInputSchema;
