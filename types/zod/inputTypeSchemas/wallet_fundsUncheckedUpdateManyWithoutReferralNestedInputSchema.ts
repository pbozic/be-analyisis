...
export const wallet_fundsUncheckedUpdateManyWithoutReferralNestedInputSchema: z.ZodType<Prisma.wallet_fundsUncheckedUpdateManyWithoutReferralNestedInput> =
	z
		.object({
			create: z
				.union([
