...
export const daily_meals_subscriptionsUpdateWithoutBusinessInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpdateWithoutBusinessInput> = z.object({
  daily_meals_subscriptions_id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  order_created: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  restaurant_comment: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  courier_comment: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  menu_category: z.lazy(() => menu_categoriesUpdateOneRequiredWithoutDaily_meal_subscribersNestedInputSchema).optional(),
...
export default daily_meals_subscriptionsUpdateWithoutBusinessInputSchema;
