...
export const wordsCountOrderByAggregateInputSchema: z.ZodType<Prisma.wordsCountOrderByAggregateInput> = z.object({
...
export default wordsCountOrderByAggregateInputSchema;
