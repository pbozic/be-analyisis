...
export const menu_itemsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.menu_itemsScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => menu_itemsScalarWhereWithAggregatesInputSchema),
					z.lazy(() => menu_itemsScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => menu_itemsScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
