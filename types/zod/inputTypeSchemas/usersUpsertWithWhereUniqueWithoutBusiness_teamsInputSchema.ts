...
export const usersUpsertWithWhereUniqueWithoutBusiness_teamsInputSchema: z.ZodType<Prisma.usersUpsertWithWhereUniqueWithoutBusiness_teamsInput> = z.object({
  where: z.lazy(() => usersWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => usersUpdateWithoutBusiness_teamsInputSchema),z.lazy(() => usersUncheckedUpdateWithoutBusiness_teamsInputSchema) ]),
  create: z.union([ z.lazy(() => usersCreateWithoutBusiness_teamsInputSchema),z.lazy(() => usersUncheckedCreateWithoutBusiness_teamsInputSchema) ]),
}).strict();
