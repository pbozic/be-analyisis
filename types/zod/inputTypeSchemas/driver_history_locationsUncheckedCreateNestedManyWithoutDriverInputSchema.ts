...
export const driver_history_locationsUncheckedCreateNestedManyWithoutDriverInputSchema: z.ZodType<Prisma.driver_history_locationsUncheckedCreateNestedManyWithoutDriverInput> =
	z
		.object({
			create: z
				.union([
