...
export const EnumCOMPANY_ROLEWithAggregatesFilterSchema: z.ZodType<Prisma.EnumCOMPANY_ROLEWithAggregatesFilter> = z
	.object({
		...
		notIn: z
			...
			.optional(),
		not: z
			.union([z.lazy(() => COMPANY_ROLESchema), z.lazy(() => NestedEnumCOMPANY_ROLEWithAggregatesFilterSchema)])
			.optional(),
