...
export const usersUpdateOneRequiredWithoutFlag_changesNestedInputSchema: z.ZodType<Prisma.usersUpdateOneRequiredWithoutFlag_changesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => usersUpdateToOneWithWhereWithoutFlag_changesInputSchema),z.lazy(() => usersUpdateWithoutFlag_changesInputSchema),z.lazy(() => usersUncheckedUpdateWithoutFlag_changesInputSchema) ]).optional(),
}).strict();
