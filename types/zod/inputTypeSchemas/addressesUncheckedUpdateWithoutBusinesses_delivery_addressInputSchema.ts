...
export const addressesUncheckedUpdateWithoutBusinesses_delivery_addressInputSchema: z.ZodType<Prisma.addressesUncheckedUpdateWithoutBusinesses_delivery_addressInput> =
	z
		.object({
