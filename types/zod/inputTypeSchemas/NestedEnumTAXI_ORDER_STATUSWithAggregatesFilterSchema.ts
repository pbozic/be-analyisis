...
export const NestedEnumTAXI_ORDER_STATUSWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumTAXI_ORDER_STATUSWithAggregatesFilter> = z.object({
  equals: z.lazy(() => TAXI_ORDER_STATUSSchema).optional(),
  in: z.lazy(() => TAXI_ORDER_STATUSSchema).array().optional(),
  notIn: z.lazy(() => TAXI_ORDER_STATUSSchema).array().optional(),
  not: z.union([ z.lazy(() => TAXI_ORDER_STATUSSchema),z.lazy(() => NestedEnumTAXI_ORDER_STATUSWithAggregatesFilterSchema) ]).optional(),
