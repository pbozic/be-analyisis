...
export const filesUpdateToOneWithWhereWithoutCategoriesInputSchema: z.ZodType<Prisma.filesUpdateToOneWithWhereWithoutCategoriesInput> = z.object({
  where: z.lazy(() => filesWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => filesUpdateWithoutCategoriesInputSchema),z.lazy(() => filesUncheckedUpdateWithoutCategoriesInputSchema) ]),
}).strict();
