...
import { promo_sections_buyCreateNestedManyWithoutPromo_sectionInputSchema } from './promo_sections_buyCreateNestedManyWithoutPromo_sectionInputSchema';

export const promo_sectionsCreateWithoutTranslatableInputSchema: z.ZodType<Prisma.promo_sectionsCreateWithoutTranslatableInput> = z.object({
  ...
  promo_section_buy: z.lazy(() => promo_sections_buyCreateNestedManyWithoutPromo_sectionInputSchema).optional()
}).strict();

export default promo_sectionsCreateWithoutTranslatableInputSchema;
