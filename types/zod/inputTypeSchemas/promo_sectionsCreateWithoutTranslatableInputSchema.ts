...
export const promo_sectionsCreateWithoutTranslatableInputSchema: z.ZodType<Prisma.promo_sectionsCreateWithoutTranslatableInput> =
	z
		.object({
			...
			promo_section_buy: z
				.lazy(() => promo_sections_buyCreateNestedManyWithoutPromo_sectionInputSchema)
				.optional(),
		})
		.strict();
