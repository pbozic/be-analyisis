...
export const taxi_ordersUncheckedUpdateManyWithoutBusinessNestedInputSchema: z.ZodType<Prisma.taxi_ordersUncheckedUpdateManyWithoutBusinessNestedInput> =
	z
		.object({
			create: z
				.union([
					z.lazy(() => taxi_ordersCreateWithoutBusinessInputSchema),
					z.lazy(() => taxi_ordersCreateWithoutBusinessInputSchema).array(),
					z.lazy(() => taxi_ordersUncheckedCreateWithoutBusinessInputSchema),
					z.lazy(() => taxi_ordersUncheckedCreateWithoutBusinessInputSchema).array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					z.lazy(() => taxi_ordersCreateOrConnectWithoutBusinessInputSchema),
					z.lazy(() => taxi_ordersCreateOrConnectWithoutBusinessInputSchema).array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(() => taxi_ordersUpsertWithWhereUniqueWithoutBusinessInputSchema),
					z.lazy(() => taxi_ordersUpsertWithWhereUniqueWithoutBusinessInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => taxi_ordersUpdateWithWhereUniqueWithoutBusinessInputSchema),
					z.lazy(() => taxi_ordersUpdateWithWhereUniqueWithoutBusinessInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => taxi_ordersUpdateManyWithWhereWithoutBusinessInputSchema),
					z.lazy(() => taxi_ordersUpdateManyWithWhereWithoutBusinessInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default taxi_ordersUncheckedUpdateManyWithoutBusinessNestedInputSchema;
