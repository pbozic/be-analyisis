...
export const word_buyUpdateManyWithWhereWithoutWordInputSchema: z.ZodType<Prisma.word_buyUpdateManyWithWhereWithoutWordInput> = z.object({
  where: z.lazy(() => word_buyScalarWhereInputSchema),
  data: z.union([ z.lazy(() => word_buyUpdateManyMutationInputSchema),z.lazy(() => word_buyUncheckedUpdateManyWithoutWordInputSchema) ]),
}).strict();
