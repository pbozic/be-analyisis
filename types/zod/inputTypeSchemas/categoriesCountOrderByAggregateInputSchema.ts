...
export const categoriesCountOrderByAggregateInputSchema: z.ZodType<Prisma.categoriesCountOrderByAggregateInput> = z
	.object({
...
export default categoriesCountOrderByAggregateInputSchema;
