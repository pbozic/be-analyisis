...
export const wordsUpsertWithWhereUniqueWithoutBundlesInputSchema: z.ZodType<Prisma.wordsUpsertWithWhereUniqueWithoutBundlesInput> = z.object({
  where: z.lazy(() => wordsWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => wordsUpdateWithoutBundlesInputSchema),z.lazy(() => wordsUncheckedUpdateWithoutBundlesInputSchema) ]),
