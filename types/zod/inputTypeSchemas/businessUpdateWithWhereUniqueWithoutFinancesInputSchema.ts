...
export const businessUpdateWithWhereUniqueWithoutFinancesInputSchema: z.ZodType<Prisma.businessUpdateWithWhereUniqueWithoutFinancesInput> = z.object({
  where: z.lazy(() => businessWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => businessUpdateWithoutFinancesInputSchema),z.lazy(() => businessUncheckedUpdateWithoutFinancesInputSchema) ]),
}).strict();
