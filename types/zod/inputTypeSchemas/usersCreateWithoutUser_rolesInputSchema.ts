...
export const usersCreateWithoutUser_rolesInputSchema: z.ZodType<Prisma.usersCreateWithoutUser_rolesInput> = z
	.object({
...
export default usersCreateWithoutUser_rolesInputSchema;
