...
export const menusUncheckedUpdateInputSchema: z.ZodType<Prisma.menusUncheckedUpdateInput> = z
	.object({
		...
		daily_meal_subscribers: z
			.lazy(() => daily_meals_subscriptionsUncheckedUpdateManyWithoutMenuNestedInputSchema)
			.optional(),
	})
	.strict();

export default menusUncheckedUpdateInputSchema;
