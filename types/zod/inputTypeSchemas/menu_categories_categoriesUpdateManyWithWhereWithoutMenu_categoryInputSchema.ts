...
export const menu_categories_categoriesUpdateManyWithWhereWithoutMenu_categoryInputSchema: z.ZodType<Prisma.menu_categories_categoriesUpdateManyWithWhereWithoutMenu_categoryInput> =
	z
		.object({
			where: z.lazy(() => menu_categories_categoriesScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => menu_categories_categoriesUpdateManyMutationInputSchema),
				z.lazy(() => menu_categories_categoriesUncheckedUpdateManyWithoutMenu_categoryInputSchema),
			]),
		})
		.strict();
