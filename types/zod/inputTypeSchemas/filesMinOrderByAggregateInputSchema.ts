...
export const filesMinOrderByAggregateInputSchema: z.ZodType<Prisma.filesMinOrderByAggregateInput> = z.object({
...
export default filesMinOrderByAggregateInputSchema;
