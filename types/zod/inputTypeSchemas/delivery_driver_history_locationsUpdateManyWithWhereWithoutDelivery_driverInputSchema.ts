...
export const delivery_driver_history_locationsUpdateManyWithWhereWithoutDelivery_driverInputSchema: z.ZodType<Prisma.delivery_driver_history_locationsUpdateManyWithWhereWithoutDelivery_driverInput> =
	z
		.object({
			...
			data: z.union([
				...
				z.lazy(() => delivery_driver_history_locationsUncheckedUpdateManyWithoutDelivery_driverInputSchema),
			]),
		})
		.strict();
