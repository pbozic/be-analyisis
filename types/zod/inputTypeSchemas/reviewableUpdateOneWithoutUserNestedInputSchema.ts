...
export const reviewableUpdateOneWithoutUserNestedInputSchema: z.ZodType<Prisma.reviewableUpdateOneWithoutUserNestedInput> = z.object({
  create: z.union([ z.lazy(() => reviewableCreateWithoutUserInputSchema),z.lazy(() => reviewableUncheckedCreateWithoutUserInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => reviewableUpdateToOneWithWhereWithoutUserInputSchema),z.lazy(() => reviewableUpdateWithoutUserInputSchema),z.lazy(() => reviewableUncheckedUpdateWithoutUserInputSchema) ]).optional(),
}).strict();
