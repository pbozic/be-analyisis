...
export const promo_sections_buyUpdateManyWithoutBought_byNestedInputSchema: z.ZodType<Prisma.promo_sections_buyUpdateManyWithoutBought_byNestedInput> =
	z
		.object({
			create: z
				.union([
					z.lazy(() => promo_sections_buyCreateWithoutBought_byInputSchema),
					z.lazy(() => promo_sections_buyCreateWithoutBought_byInputSchema).array(),
					z.lazy(() => promo_sections_buyUncheckedCreateWithoutBought_byInputSchema),
					z.lazy(() => promo_sections_buyUncheckedCreateWithoutBought_byInputSchema).array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					z.lazy(() => promo_sections_buyCreateOrConnectWithoutBought_byInputSchema),
					z.lazy(() => promo_sections_buyCreateOrConnectWithoutBought_byInputSchema).array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(() => promo_sections_buyUpsertWithWhereUniqueWithoutBought_byInputSchema),
					z.lazy(() => promo_sections_buyUpsertWithWhereUniqueWithoutBought_byInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => promo_sections_buyUpdateWithWhereUniqueWithoutBought_byInputSchema),
					z.lazy(() => promo_sections_buyUpdateWithWhereUniqueWithoutBought_byInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => promo_sections_buyUpdateManyWithWhereWithoutBought_byInputSchema),
					z.lazy(() => promo_sections_buyUpdateManyWithWhereWithoutBought_byInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default promo_sections_buyUpdateManyWithoutBought_byNestedInputSchema;
