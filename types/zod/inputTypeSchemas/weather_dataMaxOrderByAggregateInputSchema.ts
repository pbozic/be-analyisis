...
export const weather_dataMaxOrderByAggregateInputSchema: z.ZodType<Prisma.weather_dataMaxOrderByAggregateInput> = z.object({
...
export default weather_dataMaxOrderByAggregateInputSchema;
