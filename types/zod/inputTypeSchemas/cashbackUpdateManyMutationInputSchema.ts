...
export const cashbackUpdateManyMutationInputSchema: z.ZodType<Prisma.cashbackUpdateManyMutationInput> = z.object({
...
export default cashbackUpdateManyMutationInputSchema;
