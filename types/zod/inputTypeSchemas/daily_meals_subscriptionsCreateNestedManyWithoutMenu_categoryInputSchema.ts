...
export const daily_meals_subscriptionsCreateNestedManyWithoutMenu_categoryInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsCreateNestedManyWithoutMenu_categoryInput> =
	z
		.object({
			create: z
				.union([
