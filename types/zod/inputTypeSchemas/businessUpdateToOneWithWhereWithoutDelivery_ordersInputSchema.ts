...
export const businessUpdateToOneWithWhereWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.businessUpdateToOneWithWhereWithoutDelivery_ordersInput> = z.object({
  where: z.lazy(() => businessWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => businessUpdateWithoutDelivery_ordersInputSchema),z.lazy(() => businessUncheckedUpdateWithoutDelivery_ordersInputSchema) ]),
}).strict();
