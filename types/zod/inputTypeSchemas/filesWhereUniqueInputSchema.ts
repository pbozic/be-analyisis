...
export const filesWhereUniqueInputSchema: z.ZodType<Prisma.filesWhereUniqueInput> = z
	.object({
	...
	.and(
		z
			.object({
				...
				AND: z
					.union([z.lazy(() => filesWhereInputSchema), z.lazy(() => filesWhereInputSchema).array()])
					.optional(),
				OR: z
					.lazy(() => filesWhereInputSchema)
					.array()
					.optional(),
				NOT: z
					.union([z.lazy(() => filesWhereInputSchema), z.lazy(() => filesWhereInputSchema).array()])
				...
				documents: z
					.union([
						z.lazy(() => DocumentsNullableRelationFilterSchema),
...
export default filesWhereUniqueInputSchema;
