...
export const business_usersCreateWithoutBusinessInputSchema: z.ZodType<Prisma.business_usersCreateWithoutBusinessInput> = z.object({
...
export default business_usersCreateWithoutBusinessInputSchema;
