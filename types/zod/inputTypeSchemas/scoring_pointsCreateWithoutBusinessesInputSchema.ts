...
export const scoring_pointsCreateWithoutBusinessesInputSchema: z.ZodType<Prisma.scoring_pointsCreateWithoutBusinessesInput> = z.object({
...
export default scoring_pointsCreateWithoutBusinessesInputSchema;
