...
export const promo_sections_buyUncheckedUpdateInputSchema: z.ZodType<Prisma.promo_sections_buyUncheckedUpdateInput> = z.object({
...
export default promo_sections_buyUncheckedUpdateInputSchema;
