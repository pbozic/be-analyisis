...
export const delivery_driversUpdateToOneWithWhereWithoutDocumentsInputSchema: z.ZodType<Prisma.delivery_driversUpdateToOneWithWhereWithoutDocumentsInput> = z.object({
  where: z.lazy(() => delivery_driversWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => delivery_driversUpdateWithoutDocumentsInputSchema),z.lazy(() => delivery_driversUncheckedUpdateWithoutDocumentsInputSchema) ]),
}).strict();
