...
export const delivery_driver_history_locationsUpdateWithWhereUniqueWithoutOrderInputSchema: z.ZodType<Prisma.delivery_driver_history_locationsUpdateWithWhereUniqueWithoutOrderInput> = z.object({
  where: z.lazy(() => delivery_driver_history_locationsWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => delivery_driver_history_locationsUpdateWithoutOrderInputSchema),z.lazy(() => delivery_driver_history_locationsUncheckedUpdateWithoutOrderInputSchema) ]),
}).strict();
