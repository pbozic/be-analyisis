...
export const driversUpdateToOneWithWhereWithoutReceived_ordersInputSchema: z.ZodType<Prisma.driversUpdateToOneWithWhereWithoutReceived_ordersInput> = z.object({
  where: z.lazy(() => driversWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => driversUpdateWithoutReceived_ordersInputSchema),z.lazy(() => driversUncheckedUpdateWithoutReceived_ordersInputSchema) ]),
}).strict();
