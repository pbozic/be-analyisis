...
export const transactionsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.transactionsScalarWhereWithAggregatesInput> = z.object({
  ...
  type: z.union([ z.lazy(() => EnumTRANSACTION_TYPEWithAggregatesFilterSchema),z.lazy(() => TRANSACTION_TYPESchema) ]).optional(),
  ...
  wallet_fund_id: z.union([ z.lazy(() => UuidNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
}).strict();
