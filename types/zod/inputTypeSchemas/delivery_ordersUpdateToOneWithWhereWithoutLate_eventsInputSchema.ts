...
export const delivery_ordersUpdateToOneWithWhereWithoutLate_eventsInputSchema: z.ZodType<Prisma.delivery_ordersUpdateToOneWithWhereWithoutLate_eventsInput> = z.object({
  where: z.lazy(() => delivery_ordersWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => delivery_ordersUpdateWithoutLate_eventsInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutLate_eventsInputSchema) ]),
}).strict();
