...
export const menu_categoriesUpsertWithWhereUniqueWithoutMenuInputSchema: z.ZodType<Prisma.menu_categoriesUpsertWithWhereUniqueWithoutMenuInput> = z.object({
  where: z.lazy(() => menu_categoriesWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => menu_categoriesUpdateWithoutMenuInputSchema),z.lazy(() => menu_categoriesUncheckedUpdateWithoutMenuInputSchema) ]),
  create: z.union([ z.lazy(() => menu_categoriesCreateWithoutMenuInputSchema),z.lazy(() => menu_categoriesUncheckedCreateWithoutMenuInputSchema) ]),
}).strict();
