...
export const documentsUpsertWithWhereUniqueWithoutBusinessInputSchema: z.ZodType<Prisma.documentsUpsertWithWhereUniqueWithoutBusinessInput> =
	z
		.object({
			where: z.lazy(() => documentsWhereUniqueInputSchema),
			update: z.union([
				z.lazy(() => documentsUpdateWithoutBusinessInputSchema),
				z.lazy(() => documentsUncheckedUpdateWithoutBusinessInputSchema),
			]),
			create: z.union([
