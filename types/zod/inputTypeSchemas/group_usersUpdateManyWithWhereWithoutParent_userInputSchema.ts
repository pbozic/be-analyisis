...
export const group_usersUpdateManyWithWhereWithoutParent_userInputSchema: z.ZodType<Prisma.group_usersUpdateManyWithWhereWithoutParent_userInput> =
	z
		.object({
			where: z.lazy(() => group_usersScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => group_usersUpdateManyMutationInputSchema),
				z.lazy(() => group_usersUncheckedUpdateManyWithoutParent_userInputSchema),
			]),
		})
		.strict();
