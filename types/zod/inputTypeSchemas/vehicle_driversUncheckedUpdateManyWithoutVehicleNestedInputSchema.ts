...
export const vehicle_driversUncheckedUpdateManyWithoutVehicleNestedInputSchema: z.ZodType<Prisma.vehicle_driversUncheckedUpdateManyWithoutVehicleNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => vehicle_driversUpsertWithWhereUniqueWithoutVehicleInputSchema),
					z.lazy(() => vehicle_driversUpsertWithWhereUniqueWithoutVehicleInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => vehicle_driversUpdateWithWhereUniqueWithoutVehicleInputSchema),
					z.lazy(() => vehicle_driversUpdateWithWhereUniqueWithoutVehicleInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => vehicle_driversUpdateManyWithWhereWithoutVehicleInputSchema),
					z.lazy(() => vehicle_driversUpdateManyWithWhereWithoutVehicleInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default vehicle_driversUncheckedUpdateManyWithoutVehicleNestedInputSchema;
