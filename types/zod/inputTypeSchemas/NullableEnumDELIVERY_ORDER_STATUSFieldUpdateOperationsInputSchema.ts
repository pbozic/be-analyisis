...
export const NullableEnumDELIVERY_ORDER_STATUSFieldUpdateOperationsInputSchema: z.ZodType<Prisma.NullableEnumDELIVERY_ORDER_STATUSFieldUpdateOperationsInput> =
	z
		.object({
			set: z
