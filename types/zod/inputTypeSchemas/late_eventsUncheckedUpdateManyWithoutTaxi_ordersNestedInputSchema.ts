...
export const late_eventsUncheckedUpdateManyWithoutTaxi_ordersNestedInputSchema: z.ZodType<Prisma.late_eventsUncheckedUpdateManyWithoutTaxi_ordersNestedInput> =
	z
		.object({
			create: z
				.union([
