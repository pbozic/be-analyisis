...
export const reviewableUpdateToOneWithWhereWithoutUserInputSchema: z.ZodType<Prisma.reviewableUpdateToOneWithWhereWithoutUserInput> = z.object({
  where: z.lazy(() => reviewableWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => reviewableUpdateWithoutUserInputSchema),z.lazy(() => reviewableUncheckedUpdateWithoutUserInputSchema) ]),
}).strict();
