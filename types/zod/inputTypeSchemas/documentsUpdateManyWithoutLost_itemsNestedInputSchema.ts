...
export const documentsUpdateManyWithoutLost_itemsNestedInputSchema: z.ZodType<Prisma.documentsUpdateManyWithoutLost_itemsNestedInput> = z.object({
  create: z.union([ z.lazy(() => documentsCreateWithoutLost_itemsInputSchema),z.lazy(() => documentsCreateWithoutLost_itemsInputSchema).array(),z.lazy(() => documentsUncheckedCreateWithoutLost_itemsInputSchema),z.lazy(() => documentsUncheckedCreateWithoutLost_itemsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => documentsCreateOrConnectWithoutLost_itemsInputSchema),z.lazy(() => documentsCreateOrConnectWithoutLost_itemsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => documentsUpsertWithWhereUniqueWithoutLost_itemsInputSchema),z.lazy(() => documentsUpsertWithWhereUniqueWithoutLost_itemsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => documentsUpdateWithWhereUniqueWithoutLost_itemsInputSchema),z.lazy(() => documentsUpdateWithWhereUniqueWithoutLost_itemsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => documentsUpdateManyWithWhereWithoutLost_itemsInputSchema),z.lazy(() => documentsUpdateManyWithWhereWithoutLost_itemsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => documentsScalarWhereInputSchema),z.lazy(() => documentsScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default documentsUpdateManyWithoutLost_itemsNestedInputSchema;
