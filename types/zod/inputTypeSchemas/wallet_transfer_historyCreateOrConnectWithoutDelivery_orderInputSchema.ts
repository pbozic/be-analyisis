...
export const wallet_transfer_historyCreateOrConnectWithoutDelivery_orderInputSchema: z.ZodType<Prisma.wallet_transfer_historyCreateOrConnectWithoutDelivery_orderInput> =
	z
		.object({
