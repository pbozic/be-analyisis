...
export const delivery_ordersCreateNestedManyWithoutDriverInputSchema: z.ZodType<Prisma.delivery_ordersCreateNestedManyWithoutDriverInput> = z.object({
...
export default delivery_ordersCreateNestedManyWithoutDriverInputSchema;
