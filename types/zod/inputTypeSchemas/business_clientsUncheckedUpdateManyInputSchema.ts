...
export const business_clientsUncheckedUpdateManyInputSchema: z.ZodType<Prisma.business_clientsUncheckedUpdateManyInput> = z.object({
...
export default business_clientsUncheckedUpdateManyInputSchema;
