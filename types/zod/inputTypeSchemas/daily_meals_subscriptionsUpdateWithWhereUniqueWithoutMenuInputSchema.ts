...
export const daily_meals_subscriptionsUpdateWithWhereUniqueWithoutMenuInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpdateWithWhereUniqueWithoutMenuInput> =
	z
		.object({
			where: z.lazy(() => daily_meals_subscriptionsWhereUniqueInputSchema),
			data: z.union([
				z.lazy(() => daily_meals_subscriptionsUpdateWithoutMenuInputSchema),
				z.lazy(() => daily_meals_subscriptionsUncheckedUpdateWithoutMenuInputSchema),
			]),
		})
		.strict();
