...
export const scoring_pointsUncheckedCreateInputSchema: z.ZodType<Prisma.scoring_pointsUncheckedCreateInput> = z.object({
...
export default scoring_pointsUncheckedCreateInputSchema;
