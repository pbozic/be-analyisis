...
export const promo_ads_categoryWhereUniqueInputSchema: z.ZodType<Prisma.promo_ads_categoryWhereUniqueInput> = z.object({
  promo_ads_category_id: z.string().uuid()
})
.and(z.object({
  promo_ads_category_id: z.string().uuid().optional(),
  AND: z.union([ z.lazy(() => promo_ads_categoryWhereInputSchema),z.lazy(() => promo_ads_categoryWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => promo_ads_categoryWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => promo_ads_categoryWhereInputSchema),z.lazy(() => promo_ads_categoryWhereInputSchema).array() ]).optional(),
  ...
  promo_ad: z.union([ z.lazy(() => Promo_adsRelationFilterSchema),z.lazy(() => promo_adsWhereInputSchema) ]).optional(),
