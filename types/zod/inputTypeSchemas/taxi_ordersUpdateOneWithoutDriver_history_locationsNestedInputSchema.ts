...
export const taxi_ordersUpdateOneWithoutDriver_history_locationsNestedInputSchema: z.ZodType<Prisma.taxi_ordersUpdateOneWithoutDriver_history_locationsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => taxi_ordersUpdateToOneWithWhereWithoutDriver_history_locationsInputSchema),
