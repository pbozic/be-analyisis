...
export const delivery_driver_history_locationsUpdateManyWithoutDelivery_driverNestedInputSchema: z.ZodType<Prisma.delivery_driver_history_locationsUpdateManyWithoutDelivery_driverNestedInput> =
	z
		.object({
			create: z
				.union([
