...
export const scoring_pointsCreateWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.scoring_pointsCreateWithoutDelivery_ordersInput> = z.object({
...
export default scoring_pointsCreateWithoutDelivery_ordersInputSchema;
