...
export const driver_municipalitiesUpdateManyWithoutMunicipalitiesNestedInputSchema: z.ZodType<Prisma.driver_municipalitiesUpdateManyWithoutMunicipalitiesNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => driver_municipalitiesUpsertWithWhereUniqueWithoutMunicipalitiesInputSchema),
					z.lazy(() => driver_municipalitiesUpsertWithWhereUniqueWithoutMunicipalitiesInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => driver_municipalitiesUpdateWithWhereUniqueWithoutMunicipalitiesInputSchema),
					z.lazy(() => driver_municipalitiesUpdateWithWhereUniqueWithoutMunicipalitiesInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => driver_municipalitiesUpdateManyWithWhereWithoutMunicipalitiesInputSchema),
					z.lazy(() => driver_municipalitiesUpdateManyWithWhereWithoutMunicipalitiesInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default driver_municipalitiesUpdateManyWithoutMunicipalitiesNestedInputSchema;
