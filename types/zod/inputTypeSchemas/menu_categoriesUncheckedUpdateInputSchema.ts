...
export const menu_categoriesUncheckedUpdateInputSchema: z.ZodType<Prisma.menu_categoriesUncheckedUpdateInput> = z.object({
...
export default menu_categoriesUncheckedUpdateInputSchema;
