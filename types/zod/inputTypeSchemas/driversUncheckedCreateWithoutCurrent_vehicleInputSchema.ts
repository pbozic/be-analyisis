...
import { delivery_ordersUncheckedCreateNestedManyWithoutDriverInputSchema } from './delivery_ordersUncheckedCreateNestedManyWithoutDriverInputSchema';
...
export const driversUncheckedCreateWithoutCurrent_vehicleInputSchema: z.ZodType<Prisma.driversUncheckedCreateWithoutCurrent_vehicleInput> =
	z
		.object({
			...
			delivery_orders: z.lazy(() => delivery_ordersUncheckedCreateNestedManyWithoutDriverInputSchema).optional(),
			received_delivery_orders: z
				.lazy(() => delivery_order_sentUncheckedCreateNestedManyWithoutDriverInputSchema)
				.optional(),
			documents: z.lazy(() => documentsUncheckedCreateNestedManyWithoutDriversInputSchema).optional(),
			driver_history_locations: z
				.lazy(() => driver_history_locationsUncheckedCreateNestedManyWithoutDriverInputSchema)
				.optional(),
			driver_municipalities: z
				.lazy(() => driver_municipalitiesUncheckedCreateNestedManyWithoutDriversInputSchema)
				.optional(),
			activity_logs: z
				.lazy(() => driver_activity_logsUncheckedCreateNestedManyWithoutDriverInputSchema)
				.optional(),
		})
		.strict();

export default driversUncheckedCreateWithoutCurrent_vehicleInputSchema;
