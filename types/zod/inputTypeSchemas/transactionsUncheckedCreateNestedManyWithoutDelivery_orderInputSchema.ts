...
export const transactionsUncheckedCreateNestedManyWithoutDelivery_orderInputSchema: z.ZodType<Prisma.transactionsUncheckedCreateNestedManyWithoutDelivery_orderInput> =
	z
		.object({
			create: z
				.union([
