...
import { z } from 'zod';
import { categoriesTagCategory_typeCompoundUniqueInputSchema } from './categoriesTagCategory_typeCompoundUniqueInputSchema';
...
export const categoriesWhereUniqueInputSchema: z.ZodType<Prisma.categoriesWhereUniqueInput> = z
	.union([
		z.object({
			categories_id: z.string().uuid(),
			tag_category_type: z.lazy(() => categoriesTagCategory_typeCompoundUniqueInputSchema),
		}),
		z.object({
			categories_id: z.string().uuid(),
		}),
	...
	.and(
		z
			.object({
				...
				tag_category_type: z.lazy(() => categoriesTagCategory_typeCompoundUniqueInputSchema).optional(),
				AND: z
					.union([z.lazy(() => categoriesWhereInputSchema), z.lazy(() => categoriesWhereInputSchema).array()])
					.optional(),
				OR: z
				...
				deleted_at: z
					...
					.nullable(),
				icon: z
					.union([z.lazy(() => FilesNullableRelationFilterSchema), z.lazy(() => filesWhereInputSchema)])
					.optional()
					.nullable(),
...
export default categoriesWhereUniqueInputSchema;
