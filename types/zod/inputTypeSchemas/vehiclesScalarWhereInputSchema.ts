...
export const vehiclesScalarWhereInputSchema: z.ZodType<Prisma.vehiclesScalarWhereInput> = z
	.object({
		AND: z
			.union([z.lazy(() => vehiclesScalarWhereInputSchema), z.lazy(() => vehiclesScalarWhereInputSchema).array()])
			.optional(),
		OR: z
			.lazy(() => vehiclesScalarWhereInputSchema)
			.array()
			.optional(),
		NOT: z
			.union([z.lazy(() => vehiclesScalarWhereInputSchema), z.lazy(() => vehiclesScalarWhereInputSchema).array()])
