...
export const business_usersMaxOrderByAggregateInputSchema: z.ZodType<Prisma.business_usersMaxOrderByAggregateInput> = z.object({
...
export default business_usersMaxOrderByAggregateInputSchema;
