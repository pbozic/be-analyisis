...
export const NestedEnumCASHBACK_SOURCEFilterSchema: z.ZodType<Prisma.NestedEnumCASHBACK_SOURCEFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => CASHBACK_SOURCESchema),z.lazy(() => NestedEnumCASHBACK_SOURCEFilterSchema) ]).optional(),
}).strict();
