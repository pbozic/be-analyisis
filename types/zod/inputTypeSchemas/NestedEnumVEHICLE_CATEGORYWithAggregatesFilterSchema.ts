...
export const NestedEnumVEHICLE_CATEGORYWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumVEHICLE_CATEGORYWithAggregatesFilter> =
	z
		.object({
			...
			not: z
				.union([
					...
					z.lazy(() => NestedEnumVEHICLE_CATEGORYWithAggregatesFilterSchema),
				])
				.optional(),
...
export default NestedEnumVEHICLE_CATEGORYWithAggregatesFilterSchema;
