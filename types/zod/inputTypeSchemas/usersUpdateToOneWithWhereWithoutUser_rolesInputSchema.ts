...
export const usersUpdateToOneWithWhereWithoutUser_rolesInputSchema: z.ZodType<Prisma.usersUpdateToOneWithWhereWithoutUser_rolesInput> = z.object({
  where: z.lazy(() => usersWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => usersUpdateWithoutUser_rolesInputSchema),z.lazy(() => usersUncheckedUpdateWithoutUser_rolesInputSchema) ]),
}).strict();
