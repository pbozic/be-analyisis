...
export const vehiclesUpdateToOneWithWhereWithoutCurrent_driverInputSchema: z.ZodType<Prisma.vehiclesUpdateToOneWithWhereWithoutCurrent_driverInput> = z.object({
  where: z.lazy(() => vehiclesWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => vehiclesUpdateWithoutCurrent_driverInputSchema),z.lazy(() => vehiclesUncheckedUpdateWithoutCurrent_driverInputSchema) ]),
}).strict();
