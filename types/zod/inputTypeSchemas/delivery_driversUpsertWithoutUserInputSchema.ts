...
export const delivery_driversUpsertWithoutUserInputSchema: z.ZodType<Prisma.delivery_driversUpsertWithoutUserInput> = z.object({
  update: z.union([ z.lazy(() => delivery_driversUpdateWithoutUserInputSchema),z.lazy(() => delivery_driversUncheckedUpdateWithoutUserInputSchema) ]),
  create: z.union([ z.lazy(() => delivery_driversCreateWithoutUserInputSchema),z.lazy(() => delivery_driversUncheckedCreateWithoutUserInputSchema) ]),
