...
export const driver_history_locationsWhereUniqueInputSchema: z.ZodType<Prisma.driver_history_locationsWhereUniqueInput> =
	z
		.object({
		...
		.and(
			z
				.object({
					...
					AND: z
						.union([
							z.lazy(() => driver_history_locationsWhereInputSchema),
							z.lazy(() => driver_history_locationsWhereInputSchema).array(),
						])
						.optional(),
					OR: z
						.lazy(() => driver_history_locationsWhereInputSchema)
						.array()
						.optional(),
					NOT: z
						.union([
					...
					driver: z
						.union([
							z.lazy(() => DriversNullableRelationFilterSchema),
							z.lazy(() => driversWhereInputSchema),
						])
						.optional()
						.nullable(),
					order: z
