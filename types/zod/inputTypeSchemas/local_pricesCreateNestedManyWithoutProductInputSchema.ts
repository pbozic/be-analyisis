...
export const local_pricesCreateNestedManyWithoutProductInputSchema: z.ZodType<Prisma.local_pricesCreateNestedManyWithoutProductInput> = z.object({
...
export default local_pricesCreateNestedManyWithoutProductInputSchema;
