...
export const taxi_order_sentUpdateManyWithWhereWithoutDriverInputSchema: z.ZodType<Prisma.taxi_order_sentUpdateManyWithWhereWithoutDriverInput> = z.object({
  where: z.lazy(() => taxi_order_sentScalarWhereInputSchema),
  data: z.union([ z.lazy(() => taxi_order_sentUpdateManyMutationInputSchema),z.lazy(() => taxi_order_sentUncheckedUpdateManyWithoutDriverInputSchema) ]),
}).strict();
