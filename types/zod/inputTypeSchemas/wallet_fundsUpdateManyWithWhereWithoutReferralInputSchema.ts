...
export const wallet_fundsUpdateManyWithWhereWithoutReferralInputSchema: z.ZodType<Prisma.wallet_fundsUpdateManyWithWhereWithoutReferralInput> = z.object({
  where: z.lazy(() => wallet_fundsScalarWhereInputSchema),
  data: z.union([ z.lazy(() => wallet_fundsUpdateManyMutationInputSchema),z.lazy(() => wallet_fundsUncheckedUpdateManyWithoutReferralInputSchema) ]),
}).strict();
