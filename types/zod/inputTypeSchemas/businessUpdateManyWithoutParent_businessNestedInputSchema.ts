...
export const businessUpdateManyWithoutParent_businessNestedInputSchema: z.ZodType<Prisma.businessUpdateManyWithoutParent_businessNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => businessUpsertWithWhereUniqueWithoutParent_businessInputSchema),z.lazy(() => businessUpsertWithWhereUniqueWithoutParent_businessInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => businessUpdateWithWhereUniqueWithoutParent_businessInputSchema),z.lazy(() => businessUpdateWithWhereUniqueWithoutParent_businessInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => businessUpdateManyWithWhereWithoutParent_businessInputSchema),z.lazy(() => businessUpdateManyWithWhereWithoutParent_businessInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => businessScalarWhereInputSchema),z.lazy(() => businessScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default businessUpdateManyWithoutParent_businessNestedInputSchema;
