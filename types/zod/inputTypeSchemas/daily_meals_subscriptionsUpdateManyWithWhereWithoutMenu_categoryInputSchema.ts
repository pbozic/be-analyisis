...
export const daily_meals_subscriptionsUpdateManyWithWhereWithoutMenu_categoryInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpdateManyWithWhereWithoutMenu_categoryInput> = z.object({
  where: z.lazy(() => daily_meals_subscriptionsScalarWhereInputSchema),
  data: z.union([ z.lazy(() => daily_meals_subscriptionsUpdateManyMutationInputSchema),z.lazy(() => daily_meals_subscriptionsUncheckedUpdateManyWithoutMenu_categoryInputSchema) ]),
}).strict();
