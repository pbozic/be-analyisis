...
export const referralsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.referralsScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => referralsScalarWhereWithAggregatesInputSchema),z.lazy(() => referralsScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => referralsScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => referralsScalarWhereWithAggregatesInputSchema),z.lazy(() => referralsScalarWhereWithAggregatesInputSchema).array() ]).optional(),
