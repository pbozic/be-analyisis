...
export const allowancesMaxOrderByAggregateInputSchema: z.ZodType<Prisma.allowancesMaxOrderByAggregateInput> = z.object({
...
export default allowancesMaxOrderByAggregateInputSchema;
