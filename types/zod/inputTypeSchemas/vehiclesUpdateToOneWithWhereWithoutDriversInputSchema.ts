...
export const vehiclesUpdateToOneWithWhereWithoutDriversInputSchema: z.ZodType<Prisma.vehiclesUpdateToOneWithWhereWithoutDriversInput> = z.object({
  where: z.lazy(() => vehiclesWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => vehiclesUpdateWithoutDriversInputSchema),z.lazy(() => vehiclesUncheckedUpdateWithoutDriversInputSchema) ]),
}).strict();
