...
export const referralsMinOrderByAggregateInputSchema: z.ZodType<Prisma.referralsMinOrderByAggregateInput> = z.object({
...
export default referralsMinOrderByAggregateInputSchema;
