...
export const businessUncheckedUpdateManyWithoutAddressNestedInputSchema: z.ZodType<Prisma.businessUncheckedUpdateManyWithoutAddressNestedInput> = z.object({
  create: z.union([ z.lazy(() => businessCreateWithoutAddressInputSchema),z.lazy(() => businessCreateWithoutAddressInputSchema).array(),z.lazy(() => businessUncheckedCreateWithoutAddressInputSchema),z.lazy(() => businessUncheckedCreateWithoutAddressInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => businessCreateOrConnectWithoutAddressInputSchema),z.lazy(() => businessCreateOrConnectWithoutAddressInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => businessUpsertWithWhereUniqueWithoutAddressInputSchema),z.lazy(() => businessUpsertWithWhereUniqueWithoutAddressInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => businessUpdateWithWhereUniqueWithoutAddressInputSchema),z.lazy(() => businessUpdateWithWhereUniqueWithoutAddressInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => businessUpdateManyWithWhereWithoutAddressInputSchema),z.lazy(() => businessUpdateManyWithWhereWithoutAddressInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => businessScalarWhereInputSchema),z.lazy(() => businessScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default businessUncheckedUpdateManyWithoutAddressNestedInputSchema;
