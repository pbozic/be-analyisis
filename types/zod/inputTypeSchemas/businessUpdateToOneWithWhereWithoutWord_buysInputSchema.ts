...
export const businessUpdateToOneWithWhereWithoutWord_buysInputSchema: z.ZodType<Prisma.businessUpdateToOneWithWhereWithoutWord_buysInput> = z.object({
  where: z.lazy(() => businessWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => businessUpdateWithoutWord_buysInputSchema),z.lazy(() => businessUncheckedUpdateWithoutWord_buysInputSchema) ]),
}).strict();
