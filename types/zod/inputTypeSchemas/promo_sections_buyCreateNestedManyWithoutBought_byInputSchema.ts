...
export const promo_sections_buyCreateNestedManyWithoutBought_byInputSchema: z.ZodType<Prisma.promo_sections_buyCreateNestedManyWithoutBought_byInput> =
	z
		.object({
			create: z
				.union([
...
export default promo_sections_buyCreateNestedManyWithoutBought_byInputSchema;
