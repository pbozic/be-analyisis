...
export const delivery_order_sentUpdateWithWhereUniqueWithoutDriverInputSchema: z.ZodType<Prisma.delivery_order_sentUpdateWithWhereUniqueWithoutDriverInput> = z.object({
  where: z.lazy(() => delivery_order_sentWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => delivery_order_sentUpdateWithoutDriverInputSchema),z.lazy(() => delivery_order_sentUncheckedUpdateWithoutDriverInputSchema) ]),
}).strict();
