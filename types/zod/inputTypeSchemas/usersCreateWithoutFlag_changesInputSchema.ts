...
export const usersCreateWithoutFlag_changesInputSchema: z.ZodType<Prisma.usersCreateWithoutFlag_changesInput> = z
	.object({
...
export default usersCreateWithoutFlag_changesInputSchema;
