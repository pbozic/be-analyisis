...
export const taxi_ordersUpdateToOneWithWhereWithoutCashbackInputSchema: z.ZodType<Prisma.taxi_ordersUpdateToOneWithWhereWithoutCashbackInput> = z.object({
  where: z.lazy(() => taxi_ordersWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => taxi_ordersUpdateWithoutCashbackInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateWithoutCashbackInputSchema) ]),
}).strict();
