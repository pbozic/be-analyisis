...
export const business_usersUpdateToOneWithWhereWithoutTaxi_ordersInputSchema: z.ZodType<Prisma.business_usersUpdateToOneWithWhereWithoutTaxi_ordersInput> = z.object({
  where: z.lazy(() => business_usersWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => business_usersUpdateWithoutTaxi_ordersInputSchema),z.lazy(() => business_usersUncheckedUpdateWithoutTaxi_ordersInputSchema) ]),
}).strict();
