...
export const municipalitiesUncheckedCreateInputSchema: z.ZodType<Prisma.municipalitiesUncheckedCreateInput> = z.object({
...
export default municipalitiesUncheckedCreateInputSchema;
