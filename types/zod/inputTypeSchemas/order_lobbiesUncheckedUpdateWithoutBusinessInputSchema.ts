...
export const order_lobbiesUncheckedUpdateWithoutBusinessInputSchema: z.ZodType<Prisma.order_lobbiesUncheckedUpdateWithoutBusinessInput> = z.object({
  ...
  delivery_orders_id: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  created_at: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updated_at: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  order_lobby_items: z.lazy(() => order_lobby_itemsUncheckedUpdateManyWithoutOrder_lobbiesNestedInputSchema).optional(),
  order_lobby_users: z.lazy(() => order_lobby_usersUncheckedUpdateManyWithoutOrder_lobbiesNestedInputSchema).optional()
}).strict();

export default order_lobbiesUncheckedUpdateWithoutBusinessInputSchema;
