...
export const addressesUpdateWithoutDaily_meals_subscriptionsInputSchema: z.ZodType<Prisma.addressesUpdateWithoutDaily_meals_subscriptionsInput> =
	z
		.object({
			...
			businesses_delivery_address: z
				.lazy(() => businessUpdateManyWithoutDelivery_addressNestedInputSchema)
				.optional(),
			business_users: z.lazy(() => business_usersUpdateManyWithoutOperating_addressNestedInputSchema).optional(),
		})
		.strict();

export default addressesUpdateWithoutDaily_meals_subscriptionsInputSchema;
