...
export const businessUncheckedUpdateWithoutUser_favorite_businessesInputSchema: z.ZodType<Prisma.businessUncheckedUpdateWithoutUser_favorite_businessesInput> =
	z
		.object({
			...
			child_businesses: z
				.lazy(() => businessUncheckedUpdateManyWithoutParent_businessNestedInputSchema)
				.optional(),
