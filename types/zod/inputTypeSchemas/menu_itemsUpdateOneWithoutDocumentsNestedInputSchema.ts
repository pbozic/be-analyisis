...
export const menu_itemsUpdateOneWithoutDocumentsNestedInputSchema: z.ZodType<Prisma.menu_itemsUpdateOneWithoutDocumentsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => menu_itemsUpdateToOneWithWhereWithoutDocumentsInputSchema),
