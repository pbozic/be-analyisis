...
export const scoring_pointsUpdateManyWithoutTaxi_ordersNestedInputSchema: z.ZodType<Prisma.scoring_pointsUpdateManyWithoutTaxi_ordersNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => scoring_pointsUpsertWithWhereUniqueWithoutTaxi_ordersInputSchema),z.lazy(() => scoring_pointsUpsertWithWhereUniqueWithoutTaxi_ordersInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => scoring_pointsUpdateWithWhereUniqueWithoutTaxi_ordersInputSchema),z.lazy(() => scoring_pointsUpdateWithWhereUniqueWithoutTaxi_ordersInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => scoring_pointsUpdateManyWithWhereWithoutTaxi_ordersInputSchema),z.lazy(() => scoring_pointsUpdateManyWithWhereWithoutTaxi_ordersInputSchema).array() ]).optional(),
...
export default scoring_pointsUpdateManyWithoutTaxi_ordersNestedInputSchema;
