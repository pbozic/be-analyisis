...
export const order_lobby_usersUpsertWithWhereUniqueWithoutOrder_lobbiesInputSchema: z.ZodType<Prisma.order_lobby_usersUpsertWithWhereUniqueWithoutOrder_lobbiesInput> = z.object({
  where: z.lazy(() => order_lobby_usersWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => order_lobby_usersUpdateWithoutOrder_lobbiesInputSchema),z.lazy(() => order_lobby_usersUncheckedUpdateWithoutOrder_lobbiesInputSchema) ]),
