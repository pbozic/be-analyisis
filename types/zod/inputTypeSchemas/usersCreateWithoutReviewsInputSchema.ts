...
export const usersCreateWithoutReviewsInputSchema: z.ZodType<Prisma.usersCreateWithoutReviewsInput> = z
	.object({
...
export default usersCreateWithoutReviewsInputSchema;
