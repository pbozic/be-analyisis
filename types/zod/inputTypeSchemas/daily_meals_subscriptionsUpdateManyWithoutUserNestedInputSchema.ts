...
export const daily_meals_subscriptionsUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpdateManyWithoutUserNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => daily_meals_subscriptionsUpsertWithWhereUniqueWithoutUserInputSchema),
					z.lazy(() => daily_meals_subscriptionsUpsertWithWhereUniqueWithoutUserInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => daily_meals_subscriptionsUpdateWithWhereUniqueWithoutUserInputSchema),
					z.lazy(() => daily_meals_subscriptionsUpdateWithWhereUniqueWithoutUserInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => daily_meals_subscriptionsUpdateManyWithWhereWithoutUserInputSchema),
					z.lazy(() => daily_meals_subscriptionsUpdateManyWithWhereWithoutUserInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default daily_meals_subscriptionsUpdateManyWithoutUserNestedInputSchema;
