...
export const businessUncheckedCreateWithoutUser_favorite_businessesInputSchema: z.ZodType<Prisma.businessUncheckedCreateWithoutUser_favorite_businessesInput> =
	z
		.object({
