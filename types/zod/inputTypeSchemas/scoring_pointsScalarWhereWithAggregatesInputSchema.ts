...
export const scoring_pointsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.scoring_pointsScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => scoring_pointsScalarWhereWithAggregatesInputSchema),z.lazy(() => scoring_pointsScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => scoring_pointsScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => scoring_pointsScalarWhereWithAggregatesInputSchema),z.lazy(() => scoring_pointsScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  ...
  reason: z.union([ z.lazy(() => EnumSCORING_POINTS_REASONWithAggregatesFilterSchema),z.lazy(() => SCORING_POINTS_REASONSchema) ]).optional(),
