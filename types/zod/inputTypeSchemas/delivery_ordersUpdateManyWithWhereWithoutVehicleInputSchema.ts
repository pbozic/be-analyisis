...
export const delivery_ordersUpdateManyWithWhereWithoutVehicleInputSchema: z.ZodType<Prisma.delivery_ordersUpdateManyWithWhereWithoutVehicleInput> =
	z
		.object({
			where: z.lazy(() => delivery_ordersScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => delivery_ordersUpdateManyMutationInputSchema),
				z.lazy(() => delivery_ordersUncheckedUpdateManyWithoutVehicleInputSchema),
			]),
		})
		.strict();
