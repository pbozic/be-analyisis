...
export const transactionsUpdateManyWithoutDelivery_orderNestedInputSchema: z.ZodType<Prisma.transactionsUpdateManyWithoutDelivery_orderNestedInput> =
	z
		.object({
			create: z
				.union([
					z.lazy(() => transactionsCreateWithoutDelivery_orderInputSchema),
					z.lazy(() => transactionsCreateWithoutDelivery_orderInputSchema).array(),
					z.lazy(() => transactionsUncheckedCreateWithoutDelivery_orderInputSchema),
					z.lazy(() => transactionsUncheckedCreateWithoutDelivery_orderInputSchema).array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					z.lazy(() => transactionsCreateOrConnectWithoutDelivery_orderInputSchema),
					z.lazy(() => transactionsCreateOrConnectWithoutDelivery_orderInputSchema).array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(() => transactionsUpsertWithWhereUniqueWithoutDelivery_orderInputSchema),
					z.lazy(() => transactionsUpsertWithWhereUniqueWithoutDelivery_orderInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => transactionsUpdateWithWhereUniqueWithoutDelivery_orderInputSchema),
					z.lazy(() => transactionsUpdateWithWhereUniqueWithoutDelivery_orderInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => transactionsUpdateManyWithWhereWithoutDelivery_orderInputSchema),
					z.lazy(() => transactionsUpdateManyWithWhereWithoutDelivery_orderInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default transactionsUpdateManyWithoutDelivery_orderNestedInputSchema;
