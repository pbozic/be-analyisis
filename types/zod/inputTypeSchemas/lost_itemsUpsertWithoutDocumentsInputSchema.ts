...
export const lost_itemsUpsertWithoutDocumentsInputSchema: z.ZodType<Prisma.lost_itemsUpsertWithoutDocumentsInput> = z.object({
  update: z.union([ z.lazy(() => lost_itemsUpdateWithoutDocumentsInputSchema),z.lazy(() => lost_itemsUncheckedUpdateWithoutDocumentsInputSchema) ]),
  create: z.union([ z.lazy(() => lost_itemsCreateWithoutDocumentsInputSchema),z.lazy(() => lost_itemsUncheckedCreateWithoutDocumentsInputSchema) ]),
