...
export const reviewsWhereInputSchema: z.ZodType<Prisma.reviewsWhereInput> = z.object({
  ...
  reviewable: z.union([ z.lazy(() => ReviewableRelationFilterSchema),z.lazy(() => reviewableWhereInputSchema) ]).optional(),
