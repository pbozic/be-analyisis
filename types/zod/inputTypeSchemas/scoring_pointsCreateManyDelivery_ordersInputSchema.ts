...
export const scoring_pointsCreateManyDelivery_ordersInputSchema: z.ZodType<Prisma.scoring_pointsCreateManyDelivery_ordersInput> = z.object({
...
export default scoring_pointsCreateManyDelivery_ordersInputSchema;
