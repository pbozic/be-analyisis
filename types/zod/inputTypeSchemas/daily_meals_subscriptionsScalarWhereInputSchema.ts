...
export const daily_meals_subscriptionsScalarWhereInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsScalarWhereInput> =
	z
		.object({
			AND: z
				.union([
				...
				.optional(),
			OR: z
				.lazy(() => daily_meals_subscriptionsScalarWhereInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
