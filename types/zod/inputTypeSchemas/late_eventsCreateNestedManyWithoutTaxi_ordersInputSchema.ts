...
export const late_eventsCreateNestedManyWithoutTaxi_ordersInputSchema: z.ZodType<Prisma.late_eventsCreateNestedManyWithoutTaxi_ordersInput> = z.object({
...
export default late_eventsCreateNestedManyWithoutTaxi_ordersInputSchema;
