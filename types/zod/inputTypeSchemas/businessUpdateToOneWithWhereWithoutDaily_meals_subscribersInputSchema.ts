...
export const businessUpdateToOneWithWhereWithoutDaily_meals_subscribersInputSchema: z.ZodType<Prisma.businessUpdateToOneWithWhereWithoutDaily_meals_subscribersInput> = z.object({
  where: z.lazy(() => businessWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => businessUpdateWithoutDaily_meals_subscribersInputSchema),z.lazy(() => businessUncheckedUpdateWithoutDaily_meals_subscribersInputSchema) ]),
}).strict();
