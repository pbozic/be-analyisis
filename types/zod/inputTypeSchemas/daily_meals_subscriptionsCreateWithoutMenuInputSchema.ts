...
export const daily_meals_subscriptionsCreateWithoutMenuInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsCreateWithoutMenuInput> = z.object({
...
export default daily_meals_subscriptionsCreateWithoutMenuInputSchema;
