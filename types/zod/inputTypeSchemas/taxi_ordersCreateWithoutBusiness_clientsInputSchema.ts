...
import { taxi_ordersCreateNestedOneWithoutGrouped_ordersInputSchema } from './taxi_ordersCreateNestedOneWithoutGrouped_ordersInputSchema';
...
export const taxi_ordersCreateWithoutBusiness_clientsInputSchema: z.ZodType<Prisma.taxi_ordersCreateWithoutBusiness_clientsInput> = z.object({
  ...
  parent_order: z.lazy(() => taxi_ordersCreateNestedOneWithoutGrouped_ordersInputSchema).optional(),
  grouped_orders: z.lazy(() => taxi_ordersCreateNestedManyWithoutParent_orderInputSchema).optional(),
  driver_history_locations: z.lazy(() => driver_history_locationsCreateNestedManyWithoutOrderInputSchema).optional(),
  wallet_transfer: z.lazy(() => wallet_transfer_historyCreateNestedManyWithoutTaxi_orderInputSchema).optional(),
...
export default taxi_ordersCreateWithoutBusiness_clientsInputSchema;
