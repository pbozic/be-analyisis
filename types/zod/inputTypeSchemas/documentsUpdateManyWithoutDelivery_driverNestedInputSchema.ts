...
export const documentsUpdateManyWithoutDelivery_driverNestedInputSchema: z.ZodType<Prisma.documentsUpdateManyWithoutDelivery_driverNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => documentsUpsertWithWhereUniqueWithoutDelivery_driverInputSchema),
					z.lazy(() => documentsUpsertWithWhereUniqueWithoutDelivery_driverInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => documentsUpdateWithWhereUniqueWithoutDelivery_driverInputSchema),
					z.lazy(() => documentsUpdateWithWhereUniqueWithoutDelivery_driverInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => documentsUpdateManyWithWhereWithoutDelivery_driverInputSchema),
					z.lazy(() => documentsUpdateManyWithWhereWithoutDelivery_driverInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default documentsUpdateManyWithoutDelivery_driverNestedInputSchema;
