...
export const delivery_ordersCreateNestedManyWithoutDelivery_driverInputSchema: z.ZodType<Prisma.delivery_ordersCreateNestedManyWithoutDelivery_driverInput> =
	z
		.object({
			create: z
				.union([
