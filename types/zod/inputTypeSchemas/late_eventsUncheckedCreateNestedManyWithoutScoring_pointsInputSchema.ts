...
export const late_eventsUncheckedCreateNestedManyWithoutScoring_pointsInputSchema: z.ZodType<Prisma.late_eventsUncheckedCreateNestedManyWithoutScoring_pointsInput> =
	z
		.object({
			create: z
				.union([
