...
export const promo_sectionsCreateManyTranslatableInputSchema: z.ZodType<Prisma.promo_sectionsCreateManyTranslatableInput> = z.object({
...
export default promo_sectionsCreateManyTranslatableInputSchema;
