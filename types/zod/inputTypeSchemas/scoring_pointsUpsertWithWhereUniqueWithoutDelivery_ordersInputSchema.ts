...
export const scoring_pointsUpsertWithWhereUniqueWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.scoring_pointsUpsertWithWhereUniqueWithoutDelivery_ordersInput> =
	z
		.object({
			where: z.lazy(() => scoring_pointsWhereUniqueInputSchema),
			update: z.union([
				z.lazy(() => scoring_pointsUpdateWithoutDelivery_ordersInputSchema),
				z.lazy(() => scoring_pointsUncheckedUpdateWithoutDelivery_ordersInputSchema),
			]),
			create: z.union([
