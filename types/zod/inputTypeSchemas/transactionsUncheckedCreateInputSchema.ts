...
export const transactionsUncheckedCreateInputSchema: z.ZodType<Prisma.transactionsUncheckedCreateInput> = z
	.object({
...
export default transactionsUncheckedCreateInputSchema;
