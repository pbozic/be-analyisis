...
export const delivery_ordersUpdateToOneWithWhereWithoutTransactionsInputSchema: z.ZodType<Prisma.delivery_ordersUpdateToOneWithWhereWithoutTransactionsInput> =
	z
		.object({
