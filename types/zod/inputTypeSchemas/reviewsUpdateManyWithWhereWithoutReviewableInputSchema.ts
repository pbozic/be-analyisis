...
export const reviewsUpdateManyWithWhereWithoutReviewableInputSchema: z.ZodType<Prisma.reviewsUpdateManyWithWhereWithoutReviewableInput> = z.object({
  where: z.lazy(() => reviewsScalarWhereInputSchema),
  data: z.union([ z.lazy(() => reviewsUpdateManyMutationInputSchema),z.lazy(() => reviewsUncheckedUpdateManyWithoutReviewableInputSchema) ]),
}).strict();
