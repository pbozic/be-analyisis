...
export const daily_meals_subscriptionsUncheckedUpdateManyWithoutBusinessNestedInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUncheckedUpdateManyWithoutBusinessNestedInput> =
	z
		.object({
			create: z
				.union([
