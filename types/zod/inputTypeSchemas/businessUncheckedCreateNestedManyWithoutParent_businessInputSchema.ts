...
export const businessUncheckedCreateNestedManyWithoutParent_businessInputSchema: z.ZodType<Prisma.businessUncheckedCreateNestedManyWithoutParent_businessInput> =
	z
		.object({
			create: z
				.union([
