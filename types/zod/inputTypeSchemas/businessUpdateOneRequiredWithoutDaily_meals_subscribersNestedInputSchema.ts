...
export const businessUpdateOneRequiredWithoutDaily_meals_subscribersNestedInputSchema: z.ZodType<Prisma.businessUpdateOneRequiredWithoutDaily_meals_subscribersNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => businessUpdateToOneWithWhereWithoutDaily_meals_subscribersInputSchema),
