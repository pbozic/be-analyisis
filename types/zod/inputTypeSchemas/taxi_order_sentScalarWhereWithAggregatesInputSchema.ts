...
export const taxi_order_sentScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.taxi_order_sentScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => taxi_order_sentScalarWhereWithAggregatesInputSchema),z.lazy(() => taxi_order_sentScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => taxi_order_sentScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => taxi_order_sentScalarWhereWithAggregatesInputSchema),z.lazy(() => taxi_order_sentScalarWhereWithAggregatesInputSchema).array() ]).optional(),
