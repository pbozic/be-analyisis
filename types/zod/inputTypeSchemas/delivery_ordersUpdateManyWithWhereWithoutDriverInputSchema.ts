...
export const delivery_ordersUpdateManyWithWhereWithoutDriverInputSchema: z.ZodType<Prisma.delivery_ordersUpdateManyWithWhereWithoutDriverInput> =
	z
		.object({
			where: z.lazy(() => delivery_ordersScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => delivery_ordersUpdateManyMutationInputSchema),
				z.lazy(() => delivery_ordersUncheckedUpdateManyWithoutDriverInputSchema),
			]),
		})
		.strict();
