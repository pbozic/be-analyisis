...
export const business_clientsWhereUniqueInputSchema: z.ZodType<Prisma.business_clientsWhereUniqueInput> = z.union([
  z.object({
...
.and(z.object({
  ...
  uniqueBusinessClient: z.lazy(() => business_clientsUniqueBusinessClientCompoundUniqueInputSchema).optional(),
