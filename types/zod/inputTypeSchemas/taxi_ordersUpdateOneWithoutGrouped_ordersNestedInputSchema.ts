...
export const taxi_ordersUpdateOneWithoutGrouped_ordersNestedInputSchema: z.ZodType<Prisma.taxi_ordersUpdateOneWithoutGrouped_ordersNestedInput> = z.object({
  create: z.union([ z.lazy(() => taxi_ordersCreateWithoutGrouped_ordersInputSchema),z.lazy(() => taxi_ordersUncheckedCreateWithoutGrouped_ordersInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => taxi_ordersUpdateToOneWithWhereWithoutGrouped_ordersInputSchema),z.lazy(() => taxi_ordersUpdateWithoutGrouped_ordersInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateWithoutGrouped_ordersInputSchema) ]).optional(),
}).strict();
