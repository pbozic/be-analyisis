...
export const business_usersCreateWithoutUsersInputSchema: z.ZodType<Prisma.business_usersCreateWithoutUsersInput> = z.object({
...
export default business_usersCreateWithoutUsersInputSchema;
