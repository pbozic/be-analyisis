...
export const late_eventsUpdateManyWithoutScoring_pointsNestedInputSchema: z.ZodType<Prisma.late_eventsUpdateManyWithoutScoring_pointsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => late_eventsUpsertWithWhereUniqueWithoutScoring_pointsInputSchema),z.lazy(() => late_eventsUpsertWithWhereUniqueWithoutScoring_pointsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => late_eventsUpdateWithWhereUniqueWithoutScoring_pointsInputSchema),z.lazy(() => late_eventsUpdateWithWhereUniqueWithoutScoring_pointsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => late_eventsUpdateManyWithWhereWithoutScoring_pointsInputSchema),z.lazy(() => late_eventsUpdateManyWithWhereWithoutScoring_pointsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => late_eventsScalarWhereInputSchema),z.lazy(() => late_eventsScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default late_eventsUpdateManyWithoutScoring_pointsNestedInputSchema;
