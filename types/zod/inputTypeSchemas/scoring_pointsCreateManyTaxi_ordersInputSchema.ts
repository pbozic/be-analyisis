...
export const scoring_pointsCreateManyTaxi_ordersInputSchema: z.ZodType<Prisma.scoring_pointsCreateManyTaxi_ordersInput> = z.object({
...
export default scoring_pointsCreateManyTaxi_ordersInputSchema;
