...
export const promo_sections_buyUncheckedCreateInputSchema: z.ZodType<Prisma.promo_sections_buyUncheckedCreateInput> = z.object({
...
export default promo_sections_buyUncheckedCreateInputSchema;
