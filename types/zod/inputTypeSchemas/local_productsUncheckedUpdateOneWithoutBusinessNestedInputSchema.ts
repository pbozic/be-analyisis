...
export const local_productsUncheckedUpdateOneWithoutBusinessNestedInputSchema: z.ZodType<Prisma.local_productsUncheckedUpdateOneWithoutBusinessNestedInput> =
	z
		.object({
			create: z
				.union([
