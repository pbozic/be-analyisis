...
export const account_actionsUncheckedCreateWithoutUserInputSchema: z.ZodType<Prisma.account_actionsUncheckedCreateWithoutUserInput> = z.object({
...
export default account_actionsUncheckedCreateWithoutUserInputSchema;
