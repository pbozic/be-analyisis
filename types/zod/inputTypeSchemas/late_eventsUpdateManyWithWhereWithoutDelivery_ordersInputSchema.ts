...
export const late_eventsUpdateManyWithWhereWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.late_eventsUpdateManyWithWhereWithoutDelivery_ordersInput> =
	z
		.object({
			where: z.lazy(() => late_eventsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => late_eventsUpdateManyMutationInputSchema),
				z.lazy(() => late_eventsUncheckedUpdateManyWithoutDelivery_ordersInputSchema),
			]),
		})
		.strict();
