...
export const account_actionsUpdateManyWithWhereWithoutBusinessInputSchema: z.ZodType<Prisma.account_actionsUpdateManyWithWhereWithoutBusinessInput> =
	z
		.object({
			where: z.lazy(() => account_actionsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => account_actionsUpdateManyMutationInputSchema),
				z.lazy(() => account_actionsUncheckedUpdateManyWithoutBusinessInputSchema),
			]),
		})
		.strict();
