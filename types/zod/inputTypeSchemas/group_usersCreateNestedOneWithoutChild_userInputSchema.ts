...
export const group_usersCreateNestedOneWithoutChild_userInputSchema: z.ZodType<Prisma.group_usersCreateNestedOneWithoutChild_userInput> = z.object({
...
export default group_usersCreateNestedOneWithoutChild_userInputSchema;
