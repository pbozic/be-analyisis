...
export const word_buyUpsertWithWhereUniqueWithoutBusinessInputSchema: z.ZodType<Prisma.word_buyUpsertWithWhereUniqueWithoutBusinessInput> = z.object({
  where: z.lazy(() => word_buyWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => word_buyUpdateWithoutBusinessInputSchema),z.lazy(() => word_buyUncheckedUpdateWithoutBusinessInputSchema) ]),
  create: z.union([ z.lazy(() => word_buyCreateWithoutBusinessInputSchema),z.lazy(() => word_buyUncheckedCreateWithoutBusinessInputSchema) ]),
}).strict();
