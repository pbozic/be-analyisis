...
export const vehicle_specificationsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.vehicle_specificationsScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => vehicle_specificationsScalarWhereWithAggregatesInputSchema),
					z.lazy(() => vehicle_specificationsScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => vehicle_specificationsScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
			...
			class: z
				.union([z.lazy(() => EnumVEHICLE_CLASSWithAggregatesFilterSchema), z.lazy(() => VEHICLE_CLASSSchema)])
				.optional(),
			category: z
				.union([
					z.lazy(() => EnumVEHICLE_CATEGORYWithAggregatesFilterSchema),
