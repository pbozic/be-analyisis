...
export const lost_itemsUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.lost_itemsUpdateManyWithoutUserNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => lost_itemsUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => lost_itemsUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  createMany: z.lazy(() => lost_itemsCreateManyUserInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => lost_itemsWhereUniqueInputSchema),z.lazy(() => lost_itemsWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => lost_itemsWhereUniqueInputSchema),z.lazy(() => lost_itemsWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => lost_itemsWhereUniqueInputSchema),z.lazy(() => lost_itemsWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => lost_itemsWhereUniqueInputSchema),z.lazy(() => lost_itemsWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => lost_itemsUpdateWithWhereUniqueWithoutUserInputSchema),z.lazy(() => lost_itemsUpdateWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => lost_itemsUpdateManyWithWhereWithoutUserInputSchema),z.lazy(() => lost_itemsUpdateManyWithWhereWithoutUserInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => lost_itemsScalarWhereInputSchema),z.lazy(() => lost_itemsScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default lost_itemsUpdateManyWithoutUserNestedInputSchema;
