...
export const late_eventsUpdateWithWhereUniqueWithoutTaxi_ordersInputSchema: z.ZodType<Prisma.late_eventsUpdateWithWhereUniqueWithoutTaxi_ordersInput> = z.object({
  where: z.lazy(() => late_eventsWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => late_eventsUpdateWithoutTaxi_ordersInputSchema),z.lazy(() => late_eventsUncheckedUpdateWithoutTaxi_ordersInputSchema) ]),
}).strict();
