...
export const usersCreateNestedOneWithoutDaily_meals_subscriptionsInputSchema: z.ZodType<Prisma.usersCreateNestedOneWithoutDaily_meals_subscriptionsInput> =
	z
		.object({
			create: z
				.union([
