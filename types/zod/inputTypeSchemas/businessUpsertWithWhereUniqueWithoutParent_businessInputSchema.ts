...
export const businessUpsertWithWhereUniqueWithoutParent_businessInputSchema: z.ZodType<Prisma.businessUpsertWithWhereUniqueWithoutParent_businessInput> = z.object({
  where: z.lazy(() => businessWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => businessUpdateWithoutParent_businessInputSchema),z.lazy(() => businessUncheckedUpdateWithoutParent_businessInputSchema) ]),
