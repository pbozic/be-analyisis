...
export const translationsUpdateManyWithoutTranslatableNestedInputSchema: z.ZodType<Prisma.translationsUpdateManyWithoutTranslatableNestedInput> =
	z
		.object({
			create: z
				.union([
					z.lazy(() => translationsCreateWithoutTranslatableInputSchema),
					z.lazy(() => translationsCreateWithoutTranslatableInputSchema).array(),
					z.lazy(() => translationsUncheckedCreateWithoutTranslatableInputSchema),
					z.lazy(() => translationsUncheckedCreateWithoutTranslatableInputSchema).array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					z.lazy(() => translationsCreateOrConnectWithoutTranslatableInputSchema),
					z.lazy(() => translationsCreateOrConnectWithoutTranslatableInputSchema).array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(() => translationsUpsertWithWhereUniqueWithoutTranslatableInputSchema),
					z.lazy(() => translationsUpsertWithWhereUniqueWithoutTranslatableInputSchema).array(),
				])
				.optional(),
			createMany: z.lazy(() => translationsCreateManyTranslatableInputEnvelopeSchema).optional(),
			set: z
				.union([
					z.lazy(() => translationsWhereUniqueInputSchema),
					z.lazy(() => translationsWhereUniqueInputSchema).array(),
				])
				.optional(),
			disconnect: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => translationsUpdateWithWhereUniqueWithoutTranslatableInputSchema),
					z.lazy(() => translationsUpdateWithWhereUniqueWithoutTranslatableInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => translationsUpdateManyWithWhereWithoutTranslatableInputSchema),
					z.lazy(() => translationsUpdateManyWithWhereWithoutTranslatableInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default translationsUpdateManyWithoutTranslatableNestedInputSchema;
