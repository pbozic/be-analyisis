...
export const scoring_pointsCreateManyBusinessesInputSchema: z.ZodType<Prisma.scoring_pointsCreateManyBusinessesInput> = z.object({
...
export default scoring_pointsCreateManyBusinessesInputSchema;
