...
export const account_actionsUncheckedUpdateManyWithoutBusinessNestedInputSchema: z.ZodType<Prisma.account_actionsUncheckedUpdateManyWithoutBusinessNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => account_actionsUpsertWithWhereUniqueWithoutBusinessInputSchema),
					z.lazy(() => account_actionsUpsertWithWhereUniqueWithoutBusinessInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => account_actionsUpdateWithWhereUniqueWithoutBusinessInputSchema),
					z.lazy(() => account_actionsUpdateWithWhereUniqueWithoutBusinessInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => account_actionsUpdateManyWithWhereWithoutBusinessInputSchema),
					z.lazy(() => account_actionsUpdateManyWithWhereWithoutBusinessInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default account_actionsUncheckedUpdateManyWithoutBusinessNestedInputSchema;
