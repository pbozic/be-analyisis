...
export const usersUpdateOneWithoutDriverNestedInputSchema: z.ZodType<Prisma.usersUpdateOneWithoutDriverNestedInput> = z
	.object({
		create: z
			.union([
		...
		update: z
			.union([
				z.lazy(() => usersUpdateToOneWithWhereWithoutDriverInputSchema),
