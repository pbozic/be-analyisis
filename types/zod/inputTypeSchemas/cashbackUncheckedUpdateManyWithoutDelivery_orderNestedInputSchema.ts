...
export const cashbackUncheckedUpdateManyWithoutDelivery_orderNestedInputSchema: z.ZodType<Prisma.cashbackUncheckedUpdateManyWithoutDelivery_orderNestedInput> =
	z
		.object({
			create: z
				.union([
