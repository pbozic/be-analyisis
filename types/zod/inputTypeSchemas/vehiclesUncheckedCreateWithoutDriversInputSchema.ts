...
export const vehiclesUncheckedCreateWithoutDriversInputSchema: z.ZodType<Prisma.vehiclesUncheckedCreateWithoutDriversInput> = z.object({
...
export default vehiclesUncheckedCreateWithoutDriversInputSchema;
