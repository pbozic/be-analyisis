...
export const promo_bannersMaxOrderByAggregateInputSchema: z.ZodType<Prisma.promo_bannersMaxOrderByAggregateInput> = z.object({
...
export default promo_bannersMaxOrderByAggregateInputSchema;
