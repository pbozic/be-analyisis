...
export const driver_history_locationsUpdateManyWithWhereWithoutDelivery_orderInputSchema: z.ZodType<Prisma.driver_history_locationsUpdateManyWithWhereWithoutDelivery_orderInput> = z.object({
  where: z.lazy(() => driver_history_locationsScalarWhereInputSchema),
  data: z.union([ z.lazy(() => driver_history_locationsUpdateManyMutationInputSchema),z.lazy(() => driver_history_locationsUncheckedUpdateManyWithoutDelivery_orderInputSchema) ]),
}).strict();
