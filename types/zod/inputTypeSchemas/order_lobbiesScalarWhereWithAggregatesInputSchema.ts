...
export const order_lobbiesScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.order_lobbiesScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => order_lobbiesScalarWhereWithAggregatesInputSchema),
					z.lazy(() => order_lobbiesScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => order_lobbiesScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
