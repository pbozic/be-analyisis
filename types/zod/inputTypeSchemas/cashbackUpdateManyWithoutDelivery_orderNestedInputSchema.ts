...
export const cashbackUpdateManyWithoutDelivery_orderNestedInputSchema: z.ZodType<Prisma.cashbackUpdateManyWithoutDelivery_orderNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => cashbackUpsertWithWhereUniqueWithoutDelivery_orderInputSchema),
					z.lazy(() => cashbackUpsertWithWhereUniqueWithoutDelivery_orderInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => cashbackUpdateWithWhereUniqueWithoutDelivery_orderInputSchema),
					z.lazy(() => cashbackUpdateWithWhereUniqueWithoutDelivery_orderInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => cashbackUpdateManyWithWhereWithoutDelivery_orderInputSchema),
					z.lazy(() => cashbackUpdateManyWithWhereWithoutDelivery_orderInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default cashbackUpdateManyWithoutDelivery_orderNestedInputSchema;
