...
export const word_buyUpsertWithWhereUniqueWithoutWordInputSchema: z.ZodType<Prisma.word_buyUpsertWithWhereUniqueWithoutWordInput> = z.object({
  where: z.lazy(() => word_buyWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => word_buyUpdateWithoutWordInputSchema),z.lazy(() => word_buyUncheckedUpdateWithoutWordInputSchema) ]),
  create: z.union([ z.lazy(() => word_buyCreateWithoutWordInputSchema),z.lazy(() => word_buyUncheckedCreateWithoutWordInputSchema) ]),
}).strict();
