...
export const user_rolesUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.user_rolesUpdateManyWithoutUserNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => user_rolesUpsertWithWhereUniqueWithoutUserInputSchema),
					z.lazy(() => user_rolesUpsertWithWhereUniqueWithoutUserInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => user_rolesUpdateWithWhereUniqueWithoutUserInputSchema),
					z.lazy(() => user_rolesUpdateWithWhereUniqueWithoutUserInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => user_rolesUpdateManyWithWhereWithoutUserInputSchema),
					z.lazy(() => user_rolesUpdateManyWithWhereWithoutUserInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
					z.lazy(() => user_rolesScalarWhereInputSchema),
					z.lazy(() => user_rolesScalarWhereInputSchema).array(),
				])
				.optional(),
		})
		.strict();

export default user_rolesUpdateManyWithoutUserNestedInputSchema;
