...
export const delivery_ordersUpdateWithWhereUniqueWithoutDelivery_driverInputSchema: z.ZodType<Prisma.delivery_ordersUpdateWithWhereUniqueWithoutDelivery_driverInput> = z.object({
  where: z.lazy(() => delivery_ordersWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => delivery_ordersUpdateWithoutDelivery_driverInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutDelivery_driverInputSchema) ]),
}).strict();
