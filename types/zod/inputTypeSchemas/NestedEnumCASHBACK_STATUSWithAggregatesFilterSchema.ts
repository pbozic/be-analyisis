...
export const NestedEnumCASHBACK_STATUSWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumCASHBACK_STATUSWithAggregatesFilter> = z.object({
  equals: z.lazy(() => CASHBACK_STATUSSchema).optional(),
  in: z.lazy(() => CASHBACK_STATUSSchema).array().optional(),
  notIn: z.lazy(() => CASHBACK_STATUSSchema).array().optional(),
  not: z.union([ z.lazy(() => CASHBACK_STATUSSchema),z.lazy(() => NestedEnumCASHBACK_STATUSWithAggregatesFilterSchema) ]).optional(),
