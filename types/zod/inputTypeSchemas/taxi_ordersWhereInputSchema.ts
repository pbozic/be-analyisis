...
export const taxi_ordersWhereInputSchema: z.ZodType<Prisma.taxi_ordersWhereInput> = z
	.object({
		AND: z
			.union([z.lazy(() => taxi_ordersWhereInputSchema), z.lazy(() => taxi_ordersWhereInputSchema).array()])
			.optional(),
		OR: z
