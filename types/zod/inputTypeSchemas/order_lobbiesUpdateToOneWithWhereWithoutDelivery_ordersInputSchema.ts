...
export const order_lobbiesUpdateToOneWithWhereWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.order_lobbiesUpdateToOneWithWhereWithoutDelivery_ordersInput> = z.object({
  where: z.lazy(() => order_lobbiesWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => order_lobbiesUpdateWithoutDelivery_ordersInputSchema),z.lazy(() => order_lobbiesUncheckedUpdateWithoutDelivery_ordersInputSchema) ]),
}).strict();
