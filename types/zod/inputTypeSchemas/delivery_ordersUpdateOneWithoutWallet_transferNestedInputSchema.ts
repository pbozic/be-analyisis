...
export const delivery_ordersUpdateOneWithoutWallet_transferNestedInputSchema: z.ZodType<Prisma.delivery_ordersUpdateOneWithoutWallet_transferNestedInput> = z.object({
  create: z.union([ z.lazy(() => delivery_ordersCreateWithoutWallet_transferInputSchema),z.lazy(() => delivery_ordersUncheckedCreateWithoutWallet_transferInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => delivery_ordersUpdateToOneWithWhereWithoutWallet_transferInputSchema),z.lazy(() => delivery_ordersUpdateWithoutWallet_transferInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutWallet_transferInputSchema) ]).optional(),
}).strict();
