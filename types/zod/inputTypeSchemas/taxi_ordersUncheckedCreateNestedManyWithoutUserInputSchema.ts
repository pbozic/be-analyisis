...
export const taxi_ordersUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.taxi_ordersUncheckedCreateNestedManyWithoutUserInput> =
	z
		.object({
			create: z
				.union([
...
export default taxi_ordersUncheckedCreateNestedManyWithoutUserInputSchema;
