...
export const businessUncheckedUpdateWithoutDaily_meals_subscribersInputSchema: z.ZodType<Prisma.businessUncheckedUpdateWithoutDaily_meals_subscribersInput> =
	z
		.object({
