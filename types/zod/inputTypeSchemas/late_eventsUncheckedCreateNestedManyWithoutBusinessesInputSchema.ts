...
export const late_eventsUncheckedCreateNestedManyWithoutBusinessesInputSchema: z.ZodType<Prisma.late_eventsUncheckedCreateNestedManyWithoutBusinessesInput> =
	z
		.object({
			create: z
				.union([
