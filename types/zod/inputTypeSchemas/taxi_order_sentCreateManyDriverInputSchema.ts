...
export const taxi_order_sentCreateManyDriverInputSchema: z.ZodType<Prisma.taxi_order_sentCreateManyDriverInput> = z.object({
...
export default taxi_order_sentCreateManyDriverInputSchema;
