...
export const wallet_transfer_historyCreateNestedManyWithoutDelivery_orderInputSchema: z.ZodType<Prisma.wallet_transfer_historyCreateNestedManyWithoutDelivery_orderInput> =
	z
		.object({
			create: z
				.union([
