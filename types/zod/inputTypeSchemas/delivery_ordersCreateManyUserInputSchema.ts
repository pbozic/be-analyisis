...
export const delivery_ordersCreateManyUserInputSchema: z.ZodType<Prisma.delivery_ordersCreateManyUserInput> = z.object({
...
export default delivery_ordersCreateManyUserInputSchema;
