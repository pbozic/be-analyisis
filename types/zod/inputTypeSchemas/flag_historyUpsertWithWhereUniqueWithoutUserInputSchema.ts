...
export const flag_historyUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.flag_historyUpsertWithWhereUniqueWithoutUserInput> =
	z
		.object({
			where: z.lazy(() => flag_historyWhereUniqueInputSchema),
			update: z.union([
				z.lazy(() => flag_historyUpdateWithoutUserInputSchema),
				z.lazy(() => flag_historyUncheckedUpdateWithoutUserInputSchema),
			]),
			create: z.union([
