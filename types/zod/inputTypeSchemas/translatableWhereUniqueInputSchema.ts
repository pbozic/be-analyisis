...
export const translatableWhereUniqueInputSchema: z.ZodType<Prisma.translatableWhereUniqueInput> = z
	.object({
	...
	.and(
		z
			.object({
				...
				AND: z
					.union([
						z.lazy(() => translatableWhereInputSchema),
						z.lazy(() => translatableWhereInputSchema).array(),
					])
					.optional(),
				OR: z
