...
export const vehiclesUpdateManyWithoutDelivery_driverNestedInputSchema: z.ZodType<Prisma.vehiclesUpdateManyWithoutDelivery_driverNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => vehiclesUpsertWithWhereUniqueWithoutDelivery_driverInputSchema),
					z.lazy(() => vehiclesUpsertWithWhereUniqueWithoutDelivery_driverInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => vehiclesUpdateWithWhereUniqueWithoutDelivery_driverInputSchema),
					z.lazy(() => vehiclesUpdateWithWhereUniqueWithoutDelivery_driverInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => vehiclesUpdateManyWithWhereWithoutDelivery_driverInputSchema),
					z.lazy(() => vehiclesUpdateManyWithWhereWithoutDelivery_driverInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
					z.lazy(() => vehiclesScalarWhereInputSchema),
					z.lazy(() => vehiclesScalarWhereInputSchema).array(),
				])
				.optional(),
		})
		.strict();

export default vehiclesUpdateManyWithoutDelivery_driverNestedInputSchema;
