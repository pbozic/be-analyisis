...
export const driversUpdateManyMutationInputSchema: z.ZodType<Prisma.driversUpdateManyMutationInput> = z.object({
...
export default driversUpdateManyMutationInputSchema;
