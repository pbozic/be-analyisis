...
export const business_clientsUpsertWithWhereUniqueWithoutBusinessInputSchema: z.ZodType<Prisma.business_clientsUpsertWithWhereUniqueWithoutBusinessInput> = z.object({
  where: z.lazy(() => business_clientsWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => business_clientsUpdateWithoutBusinessInputSchema),z.lazy(() => business_clientsUncheckedUpdateWithoutBusinessInputSchema) ]),
  create: z.union([ z.lazy(() => business_clientsCreateWithoutBusinessInputSchema),z.lazy(() => business_clientsUncheckedCreateWithoutBusinessInputSchema) ]),
}).strict();
