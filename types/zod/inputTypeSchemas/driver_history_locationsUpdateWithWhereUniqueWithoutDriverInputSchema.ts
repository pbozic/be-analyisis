...
export const driver_history_locationsUpdateWithWhereUniqueWithoutDriverInputSchema: z.ZodType<Prisma.driver_history_locationsUpdateWithWhereUniqueWithoutDriverInput> = z.object({
  where: z.lazy(() => driver_history_locationsWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => driver_history_locationsUpdateWithoutDriverInputSchema),z.lazy(() => driver_history_locationsUncheckedUpdateWithoutDriverInputSchema) ]),
}).strict();
