...
export const menu_categories_categoriesUncheckedUpdateManyWithoutCategoryNestedInputSchema: z.ZodType<Prisma.menu_categories_categoriesUncheckedUpdateManyWithoutCategoryNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => menu_categories_categoriesUpsertWithWhereUniqueWithoutCategoryInputSchema),
					z.lazy(() => menu_categories_categoriesUpsertWithWhereUniqueWithoutCategoryInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => menu_categories_categoriesUpdateWithWhereUniqueWithoutCategoryInputSchema),
					z.lazy(() => menu_categories_categoriesUpdateWithWhereUniqueWithoutCategoryInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => menu_categories_categoriesUpdateManyWithWhereWithoutCategoryInputSchema),
					z.lazy(() => menu_categories_categoriesUpdateManyWithWhereWithoutCategoryInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default menu_categories_categoriesUncheckedUpdateManyWithoutCategoryNestedInputSchema;
