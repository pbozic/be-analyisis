...
export const user_addressUncheckedUpdateManyWithoutUsersNestedInputSchema: z.ZodType<Prisma.user_addressUncheckedUpdateManyWithoutUsersNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => user_addressUpsertWithWhereUniqueWithoutUsersInputSchema),z.lazy(() => user_addressUpsertWithWhereUniqueWithoutUsersInputSchema).array() ]).optional(),
  createMany: z.lazy(() => user_addressCreateManyUsersInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => user_addressWhereUniqueInputSchema),z.lazy(() => user_addressWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => user_addressWhereUniqueInputSchema),z.lazy(() => user_addressWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => user_addressWhereUniqueInputSchema),z.lazy(() => user_addressWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => user_addressWhereUniqueInputSchema),z.lazy(() => user_addressWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => user_addressUpdateWithWhereUniqueWithoutUsersInputSchema),z.lazy(() => user_addressUpdateWithWhereUniqueWithoutUsersInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => user_addressUpdateManyWithWhereWithoutUsersInputSchema),z.lazy(() => user_addressUpdateManyWithWhereWithoutUsersInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => user_addressScalarWhereInputSchema),z.lazy(() => user_addressScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default user_addressUncheckedUpdateManyWithoutUsersNestedInputSchema;
