...
export const promo_sections_buyUncheckedUpdateManyWithoutBought_byNestedInputSchema: z.ZodType<Prisma.promo_sections_buyUncheckedUpdateManyWithoutBought_byNestedInput> =
	z
		.object({
			create: z
				.union([
