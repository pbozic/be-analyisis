...
export const cashbackUpdateManyWithWhereWithoutDelivery_orderInputSchema: z.ZodType<Prisma.cashbackUpdateManyWithWhereWithoutDelivery_orderInput> = z.object({
  where: z.lazy(() => cashbackScalarWhereInputSchema),
  data: z.union([ z.lazy(() => cashbackUpdateManyMutationInputSchema),z.lazy(() => cashbackUncheckedUpdateManyWithoutDelivery_orderInputSchema) ]),
}).strict();
