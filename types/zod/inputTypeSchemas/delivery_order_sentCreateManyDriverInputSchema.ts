...
export const delivery_order_sentCreateManyDriverInputSchema: z.ZodType<Prisma.delivery_order_sentCreateManyDriverInput> = z.object({
...
export default delivery_order_sentCreateManyDriverInputSchema;
