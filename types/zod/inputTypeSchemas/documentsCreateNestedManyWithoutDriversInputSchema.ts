...
export const documentsCreateNestedManyWithoutDriversInputSchema: z.ZodType<Prisma.documentsCreateNestedManyWithoutDriversInput> = z.object({
...
export default documentsCreateNestedManyWithoutDriversInputSchema;
