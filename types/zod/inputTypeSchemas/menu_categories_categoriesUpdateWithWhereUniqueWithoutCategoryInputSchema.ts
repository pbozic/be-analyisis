...
export const menu_categories_categoriesUpdateWithWhereUniqueWithoutCategoryInputSchema: z.ZodType<Prisma.menu_categories_categoriesUpdateWithWhereUniqueWithoutCategoryInput> =
	z
		.object({
			where: z.lazy(() => menu_categories_categoriesWhereUniqueInputSchema),
			data: z.union([
				z.lazy(() => menu_categories_categoriesUpdateWithoutCategoryInputSchema),
				z.lazy(() => menu_categories_categoriesUncheckedUpdateWithoutCategoryInputSchema),
			]),
		})
		.strict();
