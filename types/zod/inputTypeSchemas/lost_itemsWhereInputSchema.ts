...
export const lost_itemsWhereInputSchema: z.ZodType<Prisma.lost_itemsWhereInput> = z.object({
  AND: z.union([ z.lazy(() => lost_itemsWhereInputSchema),z.lazy(() => lost_itemsWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => lost_itemsWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => lost_itemsWhereInputSchema),z.lazy(() => lost_itemsWhereInputSchema).array() ]).optional(),
...
export default lost_itemsWhereInputSchema;
