...
export const business_teamsUncheckedCreateNestedManyWithoutBusinessInputSchema: z.ZodType<Prisma.business_teamsUncheckedCreateNestedManyWithoutBusinessInput> =
	z
		.object({
			create: z
				.union([
...
export default business_teamsUncheckedCreateNestedManyWithoutBusinessInputSchema;
