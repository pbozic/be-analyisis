...
export const user_addressUpdateManyWithoutAddressNestedInputSchema: z.ZodType<Prisma.user_addressUpdateManyWithoutAddressNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => user_addressUpsertWithWhereUniqueWithoutAddressInputSchema),z.lazy(() => user_addressUpsertWithWhereUniqueWithoutAddressInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => user_addressUpdateWithWhereUniqueWithoutAddressInputSchema),z.lazy(() => user_addressUpdateWithWhereUniqueWithoutAddressInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => user_addressUpdateManyWithWhereWithoutAddressInputSchema),z.lazy(() => user_addressUpdateManyWithWhereWithoutAddressInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => user_addressScalarWhereInputSchema),z.lazy(() => user_addressScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default user_addressUpdateManyWithoutAddressNestedInputSchema;
