...
export const menusUpdateOneWithoutCategoriesNestedInputSchema: z.ZodType<Prisma.menusUpdateOneWithoutCategoriesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => menusUpdateToOneWithWhereWithoutCategoriesInputSchema),z.lazy(() => menusUpdateWithoutCategoriesInputSchema),z.lazy(() => menusUncheckedUpdateWithoutCategoriesInputSchema) ]).optional(),
}).strict();
