...
export const taxi_ordersWhereUniqueInputSchema: z.ZodType<Prisma.taxi_ordersWhereUniqueInput> = z
	.object({
			...
			.object({
				...
				AND: z
					.union([
						...
						z.lazy(() => taxi_ordersWhereInputSchema).array(),
					])
					.optional(),
				OR: z
				...
				subtype: z
					.union([z.lazy(() => EnumORDER_SUBTYPEFilterSchema), z.lazy(() => ORDER_SUBTYPESchema)])
					.optional(),
				...
				business_clients: z
					.union([
						z.lazy(() => Business_clientsNullableRelationFilterSchema),
...
export default taxi_ordersWhereUniqueInputSchema;
