...
export const scoring_pointsUpdateManyWithoutDelivery_ordersNestedInputSchema: z.ZodType<Prisma.scoring_pointsUpdateManyWithoutDelivery_ordersNestedInput> = z.object({
  create: z.union([ z.lazy(() => scoring_pointsCreateWithoutDelivery_ordersInputSchema),z.lazy(() => scoring_pointsCreateWithoutDelivery_ordersInputSchema).array(),z.lazy(() => scoring_pointsUncheckedCreateWithoutDelivery_ordersInputSchema),z.lazy(() => scoring_pointsUncheckedCreateWithoutDelivery_ordersInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => scoring_pointsCreateOrConnectWithoutDelivery_ordersInputSchema),z.lazy(() => scoring_pointsCreateOrConnectWithoutDelivery_ordersInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => scoring_pointsUpsertWithWhereUniqueWithoutDelivery_ordersInputSchema),z.lazy(() => scoring_pointsUpsertWithWhereUniqueWithoutDelivery_ordersInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => scoring_pointsUpdateWithWhereUniqueWithoutDelivery_ordersInputSchema),z.lazy(() => scoring_pointsUpdateWithWhereUniqueWithoutDelivery_ordersInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => scoring_pointsUpdateManyWithWhereWithoutDelivery_ordersInputSchema),z.lazy(() => scoring_pointsUpdateManyWithWhereWithoutDelivery_ordersInputSchema).array() ]).optional(),
...
export default scoring_pointsUpdateManyWithoutDelivery_ordersNestedInputSchema;
