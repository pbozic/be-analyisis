...
export const scoring_pointsUpdateManyWithoutDelivery_ordersNestedInputSchema: z.ZodType<Prisma.scoring_pointsUpdateManyWithoutDelivery_ordersNestedInput> =
	z
		.object({
			create: z
				.union([
