...
export const usersUpdateOneWithoutPromo_section_buysNestedInputSchema: z.ZodType<Prisma.usersUpdateOneWithoutPromo_section_buysNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => usersUpdateToOneWithWhereWithoutPromo_section_buysInputSchema),
