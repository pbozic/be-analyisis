...
export const business_clientsMinOrderByAggregateInputSchema: z.ZodType<Prisma.business_clientsMinOrderByAggregateInput> = z.object({
...
export default business_clientsMinOrderByAggregateInputSchema;
