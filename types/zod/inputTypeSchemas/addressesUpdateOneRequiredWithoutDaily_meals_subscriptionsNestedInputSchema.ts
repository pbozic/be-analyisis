...
export const addressesUpdateOneRequiredWithoutDaily_meals_subscriptionsNestedInputSchema: z.ZodType<Prisma.addressesUpdateOneRequiredWithoutDaily_meals_subscriptionsNestedInput> = z.object({
  create: z.union([ z.lazy(() => addressesCreateWithoutDaily_meals_subscriptionsInputSchema),z.lazy(() => addressesUncheckedCreateWithoutDaily_meals_subscriptionsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => addressesCreateOrConnectWithoutDaily_meals_subscriptionsInputSchema).optional(),
  ...
  update: z.union([ z.lazy(() => addressesUpdateToOneWithWhereWithoutDaily_meals_subscriptionsInputSchema),z.lazy(() => addressesUpdateWithoutDaily_meals_subscriptionsInputSchema),z.lazy(() => addressesUncheckedUpdateWithoutDaily_meals_subscriptionsInputSchema) ]).optional(),
}).strict();
