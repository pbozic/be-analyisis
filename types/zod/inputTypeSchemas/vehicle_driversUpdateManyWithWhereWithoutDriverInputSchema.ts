...
export const vehicle_driversUpdateManyWithWhereWithoutDriverInputSchema: z.ZodType<Prisma.vehicle_driversUpdateManyWithWhereWithoutDriverInput> =
	z
		.object({
			where: z.lazy(() => vehicle_driversScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => vehicle_driversUpdateManyMutationInputSchema),
				z.lazy(() => vehicle_driversUncheckedUpdateManyWithoutDriverInputSchema),
			]),
		})
		.strict();
