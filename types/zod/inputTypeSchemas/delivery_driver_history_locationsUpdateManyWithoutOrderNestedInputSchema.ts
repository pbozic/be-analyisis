...
export const delivery_driver_history_locationsUpdateManyWithoutOrderNestedInputSchema: z.ZodType<Prisma.delivery_driver_history_locationsUpdateManyWithoutOrderNestedInput> =
	z
		.object({
			create: z
				.union([
