...
export const word_buyUpdateManyWithoutWordNestedInputSchema: z.ZodType<Prisma.word_buyUpdateManyWithoutWordNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => word_buyUpsertWithWhereUniqueWithoutWordInputSchema),z.lazy(() => word_buyUpsertWithWhereUniqueWithoutWordInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => word_buyUpdateWithWhereUniqueWithoutWordInputSchema),z.lazy(() => word_buyUpdateWithWhereUniqueWithoutWordInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => word_buyUpdateManyWithWhereWithoutWordInputSchema),z.lazy(() => word_buyUpdateManyWithWhereWithoutWordInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => word_buyScalarWhereInputSchema),z.lazy(() => word_buyScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default word_buyUpdateManyWithoutWordNestedInputSchema;
