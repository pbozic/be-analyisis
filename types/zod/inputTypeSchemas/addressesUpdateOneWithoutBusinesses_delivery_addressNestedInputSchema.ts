...
export const addressesUpdateOneWithoutBusinesses_delivery_addressNestedInputSchema: z.ZodType<Prisma.addressesUpdateOneWithoutBusinesses_delivery_addressNestedInput> =
	z
		.object({
			create: z
				.union([
				...
				.optional(),
			connectOrCreate: z
				.lazy(() => addressesCreateOrConnectWithoutBusinesses_delivery_addressInputSchema)
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => addressesUpdateToOneWithWhereWithoutBusinesses_delivery_addressInputSchema),
