...
export const cashbackUncheckedCreateWithoutTaxi_orderInputSchema: z.ZodType<Prisma.cashbackUncheckedCreateWithoutTaxi_orderInput> = z.object({
...
export default cashbackUncheckedCreateWithoutTaxi_orderInputSchema;
