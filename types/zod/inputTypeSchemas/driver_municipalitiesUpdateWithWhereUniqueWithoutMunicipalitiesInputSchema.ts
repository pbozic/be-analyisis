...
export const driver_municipalitiesUpdateWithWhereUniqueWithoutMunicipalitiesInputSchema: z.ZodType<Prisma.driver_municipalitiesUpdateWithWhereUniqueWithoutMunicipalitiesInput> = z.object({
  where: z.lazy(() => driver_municipalitiesWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => driver_municipalitiesUpdateWithoutMunicipalitiesInputSchema),z.lazy(() => driver_municipalitiesUncheckedUpdateWithoutMunicipalitiesInputSchema) ]),
}).strict();
