...
export const cashbackUncheckedCreateWithoutUserInputSchema: z.ZodType<Prisma.cashbackUncheckedCreateWithoutUserInput> = z.object({
...
export default cashbackUncheckedCreateWithoutUserInputSchema;
