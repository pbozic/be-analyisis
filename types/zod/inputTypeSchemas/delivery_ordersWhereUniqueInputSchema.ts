...
export const delivery_ordersWhereUniqueInputSchema: z.ZodType<Prisma.delivery_ordersWhereUniqueInput> = z
	.object({
			...
			.object({
				...
				AND: z
					.union([
						...
						z.lazy(() => delivery_ordersWhereInputSchema).array(),
					])
					.optional(),
				OR: z
				...
				status: z
					.union([
						z.lazy(() => EnumDELIVERY_ORDER_STATUSFilterSchema),
				...
				order_number: z.union([z.lazy(() => IntFilterSchema), z.number().int()]).optional(),
				user: z
				...
				order_lobbies: z
					.union([
						z.lazy(() => Order_lobbiesNullableRelationFilterSchema),
						z.lazy(() => order_lobbiesWhereInputSchema),
					])
					.optional()
					.nullable(),
...
export default delivery_ordersWhereUniqueInputSchema;
