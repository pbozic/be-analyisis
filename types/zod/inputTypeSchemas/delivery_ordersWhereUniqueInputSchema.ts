...
export const delivery_ordersWhereUniqueInputSchema: z.ZodType<Prisma.delivery_ordersWhereUniqueInput> = z.object({
...
.and(z.object({
  ...
  find_drivers_attempts: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
