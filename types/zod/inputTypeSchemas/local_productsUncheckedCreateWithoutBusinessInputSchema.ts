...
export const local_productsUncheckedCreateWithoutBusinessInputSchema: z.ZodType<Prisma.local_productsUncheckedCreateWithoutBusinessInput> = z.object({
...
export default local_productsUncheckedCreateWithoutBusinessInputSchema;
