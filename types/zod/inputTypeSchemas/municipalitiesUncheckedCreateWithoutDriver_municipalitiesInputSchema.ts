...
export const municipalitiesUncheckedCreateWithoutDriver_municipalitiesInputSchema: z.ZodType<Prisma.municipalitiesUncheckedCreateWithoutDriver_municipalitiesInput> =
	z
		.object({
