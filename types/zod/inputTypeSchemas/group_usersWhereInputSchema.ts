...
export const group_usersWhereInputSchema: z.ZodType<Prisma.group_usersWhereInput> = z
	.object({
		AND: z
			.union([z.lazy(() => group_usersWhereInputSchema), z.lazy(() => group_usersWhereInputSchema).array()])
			.optional(),
		OR: z
