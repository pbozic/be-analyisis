...
export const menu_categories_categoriesWhereUniqueInputSchema: z.ZodType<Prisma.menu_categories_categoriesWhereUniqueInput> =
	z
		.object({
			menu_categories_id_categories_id: z.lazy(
				() => menu_categories_categoriesMenu_categories_idCategories_idCompoundUniqueInputSchema
			),
		})
		.and(
			z
				.object({
					menu_categories_id_categories_id: z
						.lazy(() => menu_categories_categoriesMenu_categories_idCategories_idCompoundUniqueInputSchema)
						.optional(),
					AND: z
						.union([
					...
					menu_category: z
						.union([
							z.lazy(() => Menu_categoriesRelationFilterSchema),
