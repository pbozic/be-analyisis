...
export const taxi_ordersUpdateWithoutDriverInputSchema: z.ZodType<Prisma.taxi_ordersUpdateWithoutDriverInput> = z
	.object({
...
export default taxi_ordersUpdateWithoutDriverInputSchema;
