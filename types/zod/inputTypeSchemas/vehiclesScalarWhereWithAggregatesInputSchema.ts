...
export const vehiclesScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.vehiclesScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => vehiclesScalarWhereWithAggregatesInputSchema),z.lazy(() => vehiclesScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => vehiclesScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => vehiclesScalarWhereWithAggregatesInputSchema),z.lazy(() => vehiclesScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  ...
  class: z.union([ z.lazy(() => EnumVEHICLE_CLASSNullableWithAggregatesFilterSchema),z.lazy(() => VEHICLE_CLASSSchema) ]).optional().nullable(),
  category: z.union([ z.lazy(() => EnumVEHICLE_CATEGORYNullableWithAggregatesFilterSchema),z.lazy(() => VEHICLE_CATEGORYSchema) ]).optional().nullable(),
  make: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  ...
  license_plate: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  ...
  vehicle_specification_id: z.union([ z.lazy(() => UuidNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
}).strict();
