...
export const group_usersUpdateWithWhereUniqueWithoutParent_userInputSchema: z.ZodType<Prisma.group_usersUpdateWithWhereUniqueWithoutParent_userInput> = z.object({
  where: z.lazy(() => group_usersWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => group_usersUpdateWithoutParent_userInputSchema),z.lazy(() => group_usersUncheckedUpdateWithoutParent_userInputSchema) ]),
}).strict();
