...
export const menu_categoriesUpsertWithoutMenu_categories_categoriesInputSchema: z.ZodType<Prisma.menu_categoriesUpsertWithoutMenu_categories_categoriesInput> =
	z
		.object({
			update: z.union([
