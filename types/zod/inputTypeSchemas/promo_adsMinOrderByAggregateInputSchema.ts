...
export const promo_adsMinOrderByAggregateInputSchema: z.ZodType<Prisma.promo_adsMinOrderByAggregateInput> = z.object({
...
export default promo_adsMinOrderByAggregateInputSchema;
