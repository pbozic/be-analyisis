...
export const transactionsUpdateOneWithoutDocumentsNestedInputSchema: z.ZodType<Prisma.transactionsUpdateOneWithoutDocumentsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => transactionsUpdateToOneWithWhereWithoutDocumentsInputSchema),
