...
export const daily_meals_subscriptionsUpdateWithoutMenu_categoryInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpdateWithoutMenu_categoryInput> =
	z
		.object({
			...
			address: z
				.lazy(() => addressesUpdateOneRequiredWithoutDaily_meals_subscriptionsNestedInputSchema)
				.optional(),
		})
		.strict();
