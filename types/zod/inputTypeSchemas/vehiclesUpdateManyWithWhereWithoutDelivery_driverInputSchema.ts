...
export const vehiclesUpdateManyWithWhereWithoutDelivery_driverInputSchema: z.ZodType<Prisma.vehiclesUpdateManyWithWhereWithoutDelivery_driverInput> =
	z
		.object({
			where: z.lazy(() => vehiclesScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => vehiclesUpdateManyMutationInputSchema),
				z.lazy(() => vehiclesUncheckedUpdateManyWithoutDelivery_driverInputSchema),
			]),
		})
		.strict();
