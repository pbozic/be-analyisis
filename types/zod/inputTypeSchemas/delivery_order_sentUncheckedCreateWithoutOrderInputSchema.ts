...
export const delivery_order_sentUncheckedCreateWithoutOrderInputSchema: z.ZodType<Prisma.delivery_order_sentUncheckedCreateWithoutOrderInput> = z.object({
...
export default delivery_order_sentUncheckedCreateWithoutOrderInputSchema;
