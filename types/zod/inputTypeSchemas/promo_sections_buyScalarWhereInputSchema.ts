...
export const promo_sections_buyScalarWhereInputSchema: z.ZodType<Prisma.promo_sections_buyScalarWhereInput> = z
	.object({
		AND: z
			.union([
			...
			.optional(),
		OR: z
			.lazy(() => promo_sections_buyScalarWhereInputSchema)
			.array()
			.optional(),
		NOT: z
			.union([
