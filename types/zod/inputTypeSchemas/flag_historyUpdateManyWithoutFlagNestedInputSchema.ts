...
export const flag_historyUpdateManyWithoutFlagNestedInputSchema: z.ZodType<Prisma.flag_historyUpdateManyWithoutFlagNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => flag_historyUpsertWithWhereUniqueWithoutFlagInputSchema),
					z.lazy(() => flag_historyUpsertWithWhereUniqueWithoutFlagInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => flag_historyUpdateWithWhereUniqueWithoutFlagInputSchema),
					z.lazy(() => flag_historyUpdateWithWhereUniqueWithoutFlagInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => flag_historyUpdateManyWithWhereWithoutFlagInputSchema),
					z.lazy(() => flag_historyUpdateManyWithWhereWithoutFlagInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default flag_historyUpdateManyWithoutFlagNestedInputSchema;
