...
export const promo_adsUpdateToOneWithWhereWithoutBannerInputSchema: z.ZodType<Prisma.promo_adsUpdateToOneWithWhereWithoutBannerInput> = z.object({
  where: z.lazy(() => promo_adsWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => promo_adsUpdateWithoutBannerInputSchema),z.lazy(() => promo_adsUncheckedUpdateWithoutBannerInputSchema) ]),
}).strict();
