...
export const usersUpdateToOneWithWhereWithoutLate_eventsInputSchema: z.ZodType<Prisma.usersUpdateToOneWithWhereWithoutLate_eventsInput> = z.object({
  where: z.lazy(() => usersWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => usersUpdateWithoutLate_eventsInputSchema),z.lazy(() => usersUncheckedUpdateWithoutLate_eventsInputSchema) ]),
}).strict();
