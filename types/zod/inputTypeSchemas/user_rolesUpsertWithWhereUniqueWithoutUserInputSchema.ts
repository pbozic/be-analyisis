...
export const user_rolesUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.user_rolesUpsertWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => user_rolesWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => user_rolesUpdateWithoutUserInputSchema),z.lazy(() => user_rolesUncheckedUpdateWithoutUserInputSchema) ]),
  create: z.union([ z.lazy(() => user_rolesCreateWithoutUserInputSchema),z.lazy(() => user_rolesUncheckedCreateWithoutUserInputSchema) ]),
}).strict();
