...
export const addressesUncheckedCreateWithoutDaily_meals_subscriptionsInputSchema: z.ZodType<Prisma.addressesUncheckedCreateWithoutDaily_meals_subscriptionsInput> =
	z
		.object({
