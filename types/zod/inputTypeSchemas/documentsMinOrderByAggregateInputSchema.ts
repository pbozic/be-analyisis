...
export const documentsMinOrderByAggregateInputSchema: z.ZodType<Prisma.documentsMinOrderByAggregateInput> = z
	.object({
...
export default documentsMinOrderByAggregateInputSchema;
