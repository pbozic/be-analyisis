...
import { late_eventsUncheckedCreateNestedManyWithoutBusinessesInputSchema } from './late_eventsUncheckedCreateNestedManyWithoutBusinessesInputSchema';
...
export const businessUncheckedCreateWithoutDelivery_addressInputSchema: z.ZodType<Prisma.businessUncheckedCreateWithoutDelivery_addressInput> = z.object({
  ...
  child_businesses: z.lazy(() => businessUncheckedCreateNestedManyWithoutParent_businessInputSchema).optional(),
  taxi_orders: z.lazy(() => taxi_ordersUncheckedCreateNestedManyWithoutBusinessInputSchema).optional(),
  delivery_orders: z.lazy(() => delivery_ordersUncheckedCreateNestedManyWithoutBusinessInputSchema).optional(),
  menus: z.lazy(() => menusUncheckedCreateNestedManyWithoutBusinessInputSchema).optional(),
  word_buy_stripe_product: z.lazy(() => local_productsUncheckedCreateNestedOneWithoutBusinessInputSchema).optional(),
  ...
  promo_sections: z.lazy(() => promo_sections_buyUncheckedCreateNestedManyWithoutBusinessInputSchema).optional(),
  business_teams: z.lazy(() => business_teamsUncheckedCreateNestedManyWithoutBusinessInputSchema).optional(),
  business_order_lobbies: z.lazy(() => order_lobbiesUncheckedCreateNestedManyWithoutBusinessInputSchema).optional(),
  user_favorite_businesses: z.lazy(() => user_favorite_businessesUncheckedCreateNestedManyWithoutBusinessesInputSchema).optional(),
  scoring_points: z.lazy(() => scoring_pointsUncheckedCreateNestedManyWithoutBusinessesInputSchema).optional(),
  daily_meal_drivers: z.lazy(() => delivery_driversUncheckedCreateNestedManyWithoutDaily_meal_businessInputSchema).optional(),
  late_events: z.lazy(() => late_eventsUncheckedCreateNestedManyWithoutBusinessesInputSchema).optional(),
  daily_meals_subscribers: z.lazy(() => daily_meals_subscriptionsUncheckedCreateNestedManyWithoutBusinessInputSchema).optional(),
  account_actions: z.lazy(() => account_actionsUncheckedCreateNestedManyWithoutBusinessInputSchema).optional(),
  business_clients: z.lazy(() => business_clientsUncheckedCreateNestedManyWithoutBusinessInputSchema).optional()
}).strict();

export default businessUncheckedCreateWithoutDelivery_addressInputSchema;
