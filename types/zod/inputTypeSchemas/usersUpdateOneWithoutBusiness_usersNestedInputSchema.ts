...
export const usersUpdateOneWithoutBusiness_usersNestedInputSchema: z.ZodType<Prisma.usersUpdateOneWithoutBusiness_usersNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => usersUpdateToOneWithWhereWithoutBusiness_usersInputSchema),
