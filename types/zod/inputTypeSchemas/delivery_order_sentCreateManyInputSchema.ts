...
export const delivery_order_sentCreateManyInputSchema: z.ZodType<Prisma.delivery_order_sentCreateManyInput> = z.object({
...
export default delivery_order_sentCreateManyInputSchema;
