...
export const daily_meals_subscriptionsUpdateManyWithWhereWithoutAddressInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpdateManyWithWhereWithoutAddressInput> =
	z
		.object({
			...
			data: z.union([
				...
				z.lazy(() => daily_meals_subscriptionsUncheckedUpdateManyWithoutAddressInputSchema),
			]),
		})
		.strict();
