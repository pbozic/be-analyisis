...
export const municipalitiesUpdateToOneWithWhereWithoutSettlementsInputSchema: z.ZodType<Prisma.municipalitiesUpdateToOneWithWhereWithoutSettlementsInput> =
	z
		.object({
