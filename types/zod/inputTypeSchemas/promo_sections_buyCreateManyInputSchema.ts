...
export const promo_sections_buyCreateManyInputSchema: z.ZodType<Prisma.promo_sections_buyCreateManyInput> = z.object({
...
export default promo_sections_buyCreateManyInputSchema;
