...
export const business_teamsUpdateManyWithoutBusinessNestedInputSchema: z.ZodType<Prisma.business_teamsUpdateManyWithoutBusinessNestedInput> =
	z
		.object({
			create: z
				.union([
					z.lazy(() => business_teamsCreateWithoutBusinessInputSchema),
					z.lazy(() => business_teamsCreateWithoutBusinessInputSchema).array(),
					z.lazy(() => business_teamsUncheckedCreateWithoutBusinessInputSchema),
					z.lazy(() => business_teamsUncheckedCreateWithoutBusinessInputSchema).array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					z.lazy(() => business_teamsCreateOrConnectWithoutBusinessInputSchema),
					z.lazy(() => business_teamsCreateOrConnectWithoutBusinessInputSchema).array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(() => business_teamsUpsertWithWhereUniqueWithoutBusinessInputSchema),
					z.lazy(() => business_teamsUpsertWithWhereUniqueWithoutBusinessInputSchema).array(),
				])
				.optional(),
			createMany: z.lazy(() => business_teamsCreateManyBusinessInputEnvelopeSchema).optional(),
			set: z
				.union([
					z.lazy(() => business_teamsWhereUniqueInputSchema),
					z.lazy(() => business_teamsWhereUniqueInputSchema).array(),
				])
				.optional(),
			disconnect: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => business_teamsUpdateWithWhereUniqueWithoutBusinessInputSchema),
					z.lazy(() => business_teamsUpdateWithWhereUniqueWithoutBusinessInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => business_teamsUpdateManyWithWhereWithoutBusinessInputSchema),
					z.lazy(() => business_teamsUpdateManyWithWhereWithoutBusinessInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
					z.lazy(() => business_teamsScalarWhereInputSchema),
					z.lazy(() => business_teamsScalarWhereInputSchema).array(),
				])
				.optional(),
		})
		.strict();

export default business_teamsUpdateManyWithoutBusinessNestedInputSchema;
