...
export const driversUpsertWithoutReceived_delivery_ordersInputSchema: z.ZodType<Prisma.driversUpsertWithoutReceived_delivery_ordersInput> = z.object({
  update: z.union([ z.lazy(() => driversUpdateWithoutReceived_delivery_ordersInputSchema),z.lazy(() => driversUncheckedUpdateWithoutReceived_delivery_ordersInputSchema) ]),
  create: z.union([ z.lazy(() => driversCreateWithoutReceived_delivery_ordersInputSchema),z.lazy(() => driversUncheckedCreateWithoutReceived_delivery_ordersInputSchema) ]),
