...
export const flag_historyUpdateWithWhereUniqueWithoutFlagInputSchema: z.ZodType<Prisma.flag_historyUpdateWithWhereUniqueWithoutFlagInput> = z.object({
  where: z.lazy(() => flag_historyWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => flag_historyUpdateWithoutFlagInputSchema),z.lazy(() => flag_historyUncheckedUpdateWithoutFlagInputSchema) ]),
}).strict();
