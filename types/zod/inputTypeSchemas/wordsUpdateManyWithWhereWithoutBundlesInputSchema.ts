...
export const wordsUpdateManyWithWhereWithoutBundlesInputSchema: z.ZodType<Prisma.wordsUpdateManyWithWhereWithoutBundlesInput> = z.object({
  where: z.lazy(() => wordsScalarWhereInputSchema),
  data: z.union([ z.lazy(() => wordsUpdateManyMutationInputSchema),z.lazy(() => wordsUncheckedUpdateManyWithoutBundlesInputSchema) ]),
}).strict();
