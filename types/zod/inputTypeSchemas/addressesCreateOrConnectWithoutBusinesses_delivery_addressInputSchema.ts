...
export const addressesCreateOrConnectWithoutBusinesses_delivery_addressInputSchema: z.ZodType<Prisma.addressesCreateOrConnectWithoutBusinesses_delivery_addressInput> =
	z
		.object({
