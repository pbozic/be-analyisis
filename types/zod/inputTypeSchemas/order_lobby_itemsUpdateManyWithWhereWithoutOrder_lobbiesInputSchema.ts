...
export const order_lobby_itemsUpdateManyWithWhereWithoutOrder_lobbiesInputSchema: z.ZodType<Prisma.order_lobby_itemsUpdateManyWithWhereWithoutOrder_lobbiesInput> = z.object({
  where: z.lazy(() => order_lobby_itemsScalarWhereInputSchema),
  data: z.union([ z.lazy(() => order_lobby_itemsUpdateManyMutationInputSchema),z.lazy(() => order_lobby_itemsUncheckedUpdateManyWithoutOrder_lobbiesInputSchema) ]),
}).strict();
