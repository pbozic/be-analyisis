	...
	.and(
		z
			.object({
				...
				user_role: z
					.union([z.lazy(() => EnumUSER_ROLESFilterSchema), z.lazy(() => USER_ROLESSchema)])
					.optional(),
				...
				parent_user: z
					.union([
						z.lazy(() => Group_usersNullableRelationFilterSchema),
				...
				business_teams: z
					.union([
						z.lazy(() => Business_teamsNullableRelationFilterSchema),
