...
export const business_teamsMaxOrderByAggregateInputSchema: z.ZodType<Prisma.business_teamsMaxOrderByAggregateInput> = z.object({
...
export default business_teamsMaxOrderByAggregateInputSchema;
