...
export const order_lobbiesMinOrderByAggregateInputSchema: z.ZodType<Prisma.order_lobbiesMinOrderByAggregateInput> = z.object({
...
export default order_lobbiesMinOrderByAggregateInputSchema;
