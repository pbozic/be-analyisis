...
export const driversUncheckedUpdateOneWithoutCurrent_vehicleNestedInputSchema: z.ZodType<Prisma.driversUncheckedUpdateOneWithoutCurrent_vehicleNestedInput> =
	z
		.object({
			create: z
				.union([
