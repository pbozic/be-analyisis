...
export const group_usersUpsertWithoutChild_userInputSchema: z.ZodType<Prisma.group_usersUpsertWithoutChild_userInput> = z.object({
  update: z.union([ z.lazy(() => group_usersUpdateWithoutChild_userInputSchema),z.lazy(() => group_usersUncheckedUpdateWithoutChild_userInputSchema) ]),
  create: z.union([ z.lazy(() => group_usersCreateWithoutChild_userInputSchema),z.lazy(() => group_usersUncheckedCreateWithoutChild_userInputSchema) ]),
