...
export const promo_bannersUpdateWithWhereUniqueWithoutFilesInputSchema: z.ZodType<Prisma.promo_bannersUpdateWithWhereUniqueWithoutFilesInput> = z.object({
  where: z.lazy(() => promo_bannersWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => promo_bannersUpdateWithoutFilesInputSchema),z.lazy(() => promo_bannersUncheckedUpdateWithoutFilesInputSchema) ]),
}).strict();
