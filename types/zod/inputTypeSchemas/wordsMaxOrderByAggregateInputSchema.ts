...
export const wordsMaxOrderByAggregateInputSchema: z.ZodType<Prisma.wordsMaxOrderByAggregateInput> = z.object({
...
export default wordsMaxOrderByAggregateInputSchema;
