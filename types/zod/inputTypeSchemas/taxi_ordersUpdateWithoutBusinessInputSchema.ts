...
export const taxi_ordersUpdateWithoutBusinessInputSchema: z.ZodType<Prisma.taxi_ordersUpdateWithoutBusinessInput> = z
	.object({
...
export default taxi_ordersUpdateWithoutBusinessInputSchema;
