...
export const word_buyCountOrderByAggregateInputSchema: z.ZodType<Prisma.word_buyCountOrderByAggregateInput> = z.object({
...
export default word_buyCountOrderByAggregateInputSchema;
