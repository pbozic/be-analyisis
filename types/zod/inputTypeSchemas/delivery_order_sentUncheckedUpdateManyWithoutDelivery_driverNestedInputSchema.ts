...
export const delivery_order_sentUncheckedUpdateManyWithoutDelivery_driverNestedInputSchema: z.ZodType<Prisma.delivery_order_sentUncheckedUpdateManyWithoutDelivery_driverNestedInput> =
	z
		.object({
			create: z
				.union([
