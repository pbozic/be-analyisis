...
export const menu_itemsWhereUniqueInputSchema: z.ZodType<Prisma.menu_itemsWhereUniqueInput> = z.object({
...
.and(z.object({
  ...
  menu_category_order_index: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
