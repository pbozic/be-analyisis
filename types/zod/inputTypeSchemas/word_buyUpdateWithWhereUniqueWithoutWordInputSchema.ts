...
export const word_buyUpdateWithWhereUniqueWithoutWordInputSchema: z.ZodType<Prisma.word_buyUpdateWithWhereUniqueWithoutWordInput> = z.object({
  where: z.lazy(() => word_buyWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => word_buyUpdateWithoutWordInputSchema),z.lazy(() => word_buyUncheckedUpdateWithoutWordInputSchema) ]),
}).strict();
