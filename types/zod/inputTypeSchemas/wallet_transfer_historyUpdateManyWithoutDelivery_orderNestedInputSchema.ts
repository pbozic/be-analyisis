...
export const wallet_transfer_historyUpdateManyWithoutDelivery_orderNestedInputSchema: z.ZodType<Prisma.wallet_transfer_historyUpdateManyWithoutDelivery_orderNestedInput> =
	z
		.object({
			create: z
				.union([
