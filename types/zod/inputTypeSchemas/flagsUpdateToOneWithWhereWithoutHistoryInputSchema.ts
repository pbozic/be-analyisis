...
export const flagsUpdateToOneWithWhereWithoutHistoryInputSchema: z.ZodType<Prisma.flagsUpdateToOneWithWhereWithoutHistoryInput> = z.object({
  where: z.lazy(() => flagsWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => flagsUpdateWithoutHistoryInputSchema),z.lazy(() => flagsUncheckedUpdateWithoutHistoryInputSchema) ]),
}).strict();
