...
export const group_usersMaxOrderByAggregateInputSchema: z.ZodType<Prisma.group_usersMaxOrderByAggregateInput> = z.object({
...
export default group_usersMaxOrderByAggregateInputSchema;
