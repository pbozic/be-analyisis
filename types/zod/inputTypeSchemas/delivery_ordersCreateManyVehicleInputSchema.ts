...
export const delivery_ordersCreateManyVehicleInputSchema: z.ZodType<Prisma.delivery_ordersCreateManyVehicleInput> = z.object({
...
export default delivery_ordersCreateManyVehicleInputSchema;
