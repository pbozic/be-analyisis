...
export const delivery_ordersUpdateOneWithoutDriver_history_locationsNestedInputSchema: z.ZodType<Prisma.delivery_ordersUpdateOneWithoutDriver_history_locationsNestedInput> =
	z
		.object({
			create: z
				.union([
				...
				.optional(),
			connectOrCreate: z
				.lazy(() => delivery_ordersCreateOrConnectWithoutDriver_history_locationsInputSchema)
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => delivery_ordersUpdateToOneWithWhereWithoutDriver_history_locationsInputSchema),
