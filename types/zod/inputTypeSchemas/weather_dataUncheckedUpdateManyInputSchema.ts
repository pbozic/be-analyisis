...
export const weather_dataUncheckedUpdateManyInputSchema: z.ZodType<Prisma.weather_dataUncheckedUpdateManyInput> = z.object({
  ...
  municipalities_id: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  settlement_id: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
}).strict();

export default weather_dataUncheckedUpdateManyInputSchema;
