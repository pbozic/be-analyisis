...
export const tokensUncheckedUpdateManyWithoutUsersInputSchema: z.ZodType<Prisma.tokensUncheckedUpdateManyWithoutUsersInput> =
	z
		.object({
			token_id: z.union([z.string().uuid(), z.lazy(() => StringFieldUpdateOperationsInputSchema)]).optional(),
			type: z
				.union([z.lazy(() => TokenTypeSchema), z.lazy(() => EnumTokenTypeFieldUpdateOperationsInputSchema)])
				.optional(),
...
export default tokensUncheckedUpdateManyWithoutUsersInputSchema;
