...
export const businessCreateManyAddressInputSchema: z.ZodType<Prisma.businessCreateManyAddressInput> = z.object({
...
export default businessCreateManyAddressInputSchema;
