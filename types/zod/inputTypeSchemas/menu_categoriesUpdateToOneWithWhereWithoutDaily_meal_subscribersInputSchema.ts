...
export const menu_categoriesUpdateToOneWithWhereWithoutDaily_meal_subscribersInputSchema: z.ZodType<Prisma.menu_categoriesUpdateToOneWithWhereWithoutDaily_meal_subscribersInput> = z.object({
  where: z.lazy(() => menu_categoriesWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => menu_categoriesUpdateWithoutDaily_meal_subscribersInputSchema),z.lazy(() => menu_categoriesUncheckedUpdateWithoutDaily_meal_subscribersInputSchema) ]),
}).strict();
