...
export const delivery_driver_history_locationsUpdateWithoutOrderInputSchema: z.ZodType<Prisma.delivery_driver_history_locationsUpdateWithoutOrderInput> = z.object({
  ...
  delivery_driver: z.lazy(() => delivery_driversUpdateOneWithoutDelivery_driver_history_locationsNestedInputSchema).optional()
}).strict();

export default delivery_driver_history_locationsUpdateWithoutOrderInputSchema;
