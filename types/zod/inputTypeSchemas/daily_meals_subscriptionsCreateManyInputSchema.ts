...
export const daily_meals_subscriptionsCreateManyInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsCreateManyInput> = z.object({
...
export default daily_meals_subscriptionsCreateManyInputSchema;
