...
export const allowancesWhereInputSchema: z.ZodType<Prisma.allowancesWhereInput> = z.object({
  ...
  group_user_id: z.union([ z.lazy(() => UuidNullableFilterSchema),z.string() ]).optional().nullable(),
