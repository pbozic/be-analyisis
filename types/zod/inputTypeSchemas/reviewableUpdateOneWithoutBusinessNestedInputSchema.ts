...
export const reviewableUpdateOneWithoutBusinessNestedInputSchema: z.ZodType<Prisma.reviewableUpdateOneWithoutBusinessNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => reviewableUpdateToOneWithWhereWithoutBusinessInputSchema),
