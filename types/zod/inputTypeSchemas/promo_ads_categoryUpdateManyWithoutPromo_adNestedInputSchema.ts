...
export const promo_ads_categoryUpdateManyWithoutPromo_adNestedInputSchema: z.ZodType<Prisma.promo_ads_categoryUpdateManyWithoutPromo_adNestedInput> = z.object({
  create: z.union([ z.lazy(() => promo_ads_categoryCreateWithoutPromo_adInputSchema),z.lazy(() => promo_ads_categoryCreateWithoutPromo_adInputSchema).array(),z.lazy(() => promo_ads_categoryUncheckedCreateWithoutPromo_adInputSchema),z.lazy(() => promo_ads_categoryUncheckedCreateWithoutPromo_adInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => promo_ads_categoryCreateOrConnectWithoutPromo_adInputSchema),z.lazy(() => promo_ads_categoryCreateOrConnectWithoutPromo_adInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => promo_ads_categoryUpsertWithWhereUniqueWithoutPromo_adInputSchema),z.lazy(() => promo_ads_categoryUpsertWithWhereUniqueWithoutPromo_adInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => promo_ads_categoryUpdateWithWhereUniqueWithoutPromo_adInputSchema),z.lazy(() => promo_ads_categoryUpdateWithWhereUniqueWithoutPromo_adInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => promo_ads_categoryUpdateManyWithWhereWithoutPromo_adInputSchema),z.lazy(() => promo_ads_categoryUpdateManyWithWhereWithoutPromo_adInputSchema).array() ]).optional(),
...
export default promo_ads_categoryUpdateManyWithoutPromo_adNestedInputSchema;
