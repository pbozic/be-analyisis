...
export const categoriesCreateNestedManyWithoutTranslatableInputSchema: z.ZodType<Prisma.categoriesCreateNestedManyWithoutTranslatableInput> =
	z
		.object({
			create: z
				.union([
...
export default categoriesCreateNestedManyWithoutTranslatableInputSchema;
