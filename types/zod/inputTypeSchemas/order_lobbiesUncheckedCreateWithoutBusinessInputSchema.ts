...
export const order_lobbiesUncheckedCreateWithoutBusinessInputSchema: z.ZodType<Prisma.order_lobbiesUncheckedCreateWithoutBusinessInput> =
	z
		.object({
			...
			order_lobby_items: z
				.lazy(() => order_lobby_itemsUncheckedCreateNestedManyWithoutOrder_lobbiesInputSchema)
				.optional(),
			order_lobby_users: z
				.lazy(() => order_lobby_usersUncheckedCreateNestedManyWithoutOrder_lobbiesInputSchema)
				.optional(),
		})
		.strict();

export default order_lobbiesUncheckedCreateWithoutBusinessInputSchema;
