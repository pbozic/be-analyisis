...
export const tokensCreateNestedManyWithoutUsersInputSchema: z.ZodType<Prisma.tokensCreateNestedManyWithoutUsersInput> = z.object({
...
export default tokensCreateNestedManyWithoutUsersInputSchema;
