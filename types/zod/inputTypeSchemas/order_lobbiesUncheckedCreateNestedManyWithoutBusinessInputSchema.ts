...
export const order_lobbiesUncheckedCreateNestedManyWithoutBusinessInputSchema: z.ZodType<Prisma.order_lobbiesUncheckedCreateNestedManyWithoutBusinessInput> =
	z
		.object({
			create: z
				.union([
