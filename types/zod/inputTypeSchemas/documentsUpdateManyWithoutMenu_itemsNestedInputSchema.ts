...
export const documentsUpdateManyWithoutMenu_itemsNestedInputSchema: z.ZodType<Prisma.documentsUpdateManyWithoutMenu_itemsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => documentsUpsertWithWhereUniqueWithoutMenu_itemsInputSchema),
					z.lazy(() => documentsUpsertWithWhereUniqueWithoutMenu_itemsInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => documentsUpdateWithWhereUniqueWithoutMenu_itemsInputSchema),
					z.lazy(() => documentsUpdateWithWhereUniqueWithoutMenu_itemsInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => documentsUpdateManyWithWhereWithoutMenu_itemsInputSchema),
					z.lazy(() => documentsUpdateManyWithWhereWithoutMenu_itemsInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default documentsUpdateManyWithoutMenu_itemsNestedInputSchema;
