...
export const NestedEnumVEHICLE_CLASSWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumVEHICLE_CLASSWithAggregatesFilter> =
	z
		.object({
			...
			not: z
				.union([
					...
					z.lazy(() => NestedEnumVEHICLE_CLASSWithAggregatesFilterSchema),
				])
				.optional(),
