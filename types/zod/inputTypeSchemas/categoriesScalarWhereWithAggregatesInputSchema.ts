...
export const categoriesScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.categoriesScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => categoriesScalarWhereWithAggregatesInputSchema),
					z.lazy(() => categoriesScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => categoriesScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
			...
			icon_file_id: z
				...
				.nullable(),
			category_type: z
				.union([z.lazy(() => EnumCATEGORY_TYPEWithAggregatesFilterSchema), z.lazy(() => CATEGORY_TYPESchema)])
				.optional(),
