...
export const delivery_ordersUpdateManyWithWhereWithoutBusinessInputSchema: z.ZodType<Prisma.delivery_ordersUpdateManyWithWhereWithoutBusinessInput> = z.object({
  where: z.lazy(() => delivery_ordersScalarWhereInputSchema),
  data: z.union([ z.lazy(() => delivery_ordersUpdateManyMutationInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateManyWithoutBusinessInputSchema) ]),
}).strict();
