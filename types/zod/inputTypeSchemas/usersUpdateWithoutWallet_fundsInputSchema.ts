...
export const usersUpdateWithoutWallet_fundsInputSchema: z.ZodType<Prisma.usersUpdateWithoutWallet_fundsInput> = z
	.object({
...
export default usersUpdateWithoutWallet_fundsInputSchema;
