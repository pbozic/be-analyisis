...
export const menu_categories_categoriesCreateNestedManyWithoutMenu_categoryInputSchema: z.ZodType<Prisma.menu_categories_categoriesCreateNestedManyWithoutMenu_categoryInput> =
	z
		.object({
			create: z
				.union([
