...
export const vehicle_driversWhereUniqueInputSchema: z.ZodType<Prisma.vehicle_driversWhereUniqueInput> = z
	.union([
		z.object({
	...
	.and(
		z
			.object({
				...
				vehicle_id_driver_id: z
					.lazy(() => vehicle_driversVehicle_idDriver_idCompoundUniqueInputSchema)
					.optional(),
				AND: z
					.union([
