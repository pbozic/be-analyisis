...
export const wallet_transfer_historyUpdateWithWhereUniqueWithoutDelivery_orderInputSchema: z.ZodType<Prisma.wallet_transfer_historyUpdateWithWhereUniqueWithoutDelivery_orderInput> = z.object({
  where: z.lazy(() => wallet_transfer_historyWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => wallet_transfer_historyUpdateWithoutDelivery_orderInputSchema),z.lazy(() => wallet_transfer_historyUncheckedUpdateWithoutDelivery_orderInputSchema) ]),
}).strict();
