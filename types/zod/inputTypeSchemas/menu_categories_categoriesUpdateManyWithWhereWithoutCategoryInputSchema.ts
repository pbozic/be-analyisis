...
export const menu_categories_categoriesUpdateManyWithWhereWithoutCategoryInputSchema: z.ZodType<Prisma.menu_categories_categoriesUpdateManyWithWhereWithoutCategoryInput> =
	z
		.object({
			...
			data: z.union([
				...
				z.lazy(() => menu_categories_categoriesUncheckedUpdateManyWithoutCategoryInputSchema),
			]),
		})
		.strict();
