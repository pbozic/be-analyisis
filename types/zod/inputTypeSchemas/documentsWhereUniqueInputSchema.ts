...
export const documentsWhereUniqueInputSchema: z.ZodType<Prisma.documentsWhereUniqueInput> = z
	.object({
	...
	.and(
		z
			.object({
				...
				menu_items: z
					.union([
						z.lazy(() => Menu_itemsNullableRelationFilterSchema),
						z.lazy(() => menu_itemsWhereInputSchema),
					])
					.optional()
					.nullable(),
				lost_items: z
					.union([
						z.lazy(() => Lost_itemsNullableRelationFilterSchema),
						z.lazy(() => lost_itemsWhereInputSchema),
					])
					.optional()
					.nullable(),
				transactions: z
					.union([
						z.lazy(() => TransactionsNullableRelationFilterSchema),
