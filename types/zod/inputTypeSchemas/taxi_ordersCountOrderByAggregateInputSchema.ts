...
export const taxi_ordersCountOrderByAggregateInputSchema: z.ZodType<Prisma.taxi_ordersCountOrderByAggregateInput> = z.object({
  ...
  cargo_preferences: z.lazy(() => SortOrderSchema).optional(),
...
export default taxi_ordersCountOrderByAggregateInputSchema;
