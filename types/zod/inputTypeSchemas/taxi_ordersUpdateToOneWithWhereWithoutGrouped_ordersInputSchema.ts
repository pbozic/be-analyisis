...
export const taxi_ordersUpdateToOneWithWhereWithoutGrouped_ordersInputSchema: z.ZodType<Prisma.taxi_ordersUpdateToOneWithWhereWithoutGrouped_ordersInput> = z.object({
  where: z.lazy(() => taxi_ordersWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => taxi_ordersUpdateWithoutGrouped_ordersInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateWithoutGrouped_ordersInputSchema) ]),
}).strict();
