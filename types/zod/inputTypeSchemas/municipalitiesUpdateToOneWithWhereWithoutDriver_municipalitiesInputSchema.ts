...
export const municipalitiesUpdateToOneWithWhereWithoutDriver_municipalitiesInputSchema: z.ZodType<Prisma.municipalitiesUpdateToOneWithWhereWithoutDriver_municipalitiesInput> = z.object({
  where: z.lazy(() => municipalitiesWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => municipalitiesUpdateWithoutDriver_municipalitiesInputSchema),z.lazy(() => municipalitiesUncheckedUpdateWithoutDriver_municipalitiesInputSchema) ]),
}).strict();
