...
export const daily_meals_subscriptionsUncheckedCreateInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUncheckedCreateInput> = z.object({
...
export default daily_meals_subscriptionsUncheckedCreateInputSchema;
