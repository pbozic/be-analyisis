...
export const taxi_ordersUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.taxi_ordersUpdateManyWithWhereWithoutUserInput> = z.object({
  where: z.lazy(() => taxi_ordersScalarWhereInputSchema),
  data: z.union([ z.lazy(() => taxi_ordersUpdateManyMutationInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateManyWithoutUserInputSchema) ]),
}).strict();
