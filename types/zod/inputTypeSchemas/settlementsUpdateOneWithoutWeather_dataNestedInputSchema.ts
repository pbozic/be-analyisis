...
export const settlementsUpdateOneWithoutWeather_dataNestedInputSchema: z.ZodType<Prisma.settlementsUpdateOneWithoutWeather_dataNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => settlementsUpdateToOneWithWhereWithoutWeather_dataInputSchema),
