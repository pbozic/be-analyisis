...
export const allowancesUncheckedUpdateOneWithoutBusiness_userNestedInputSchema: z.ZodType<Prisma.allowancesUncheckedUpdateOneWithoutBusiness_userNestedInput> = z.object({
  create: z.union([ z.lazy(() => allowancesCreateWithoutBusiness_userInputSchema),z.lazy(() => allowancesUncheckedCreateWithoutBusiness_userInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => allowancesUpdateToOneWithWhereWithoutBusiness_userInputSchema),z.lazy(() => allowancesUpdateWithoutBusiness_userInputSchema),z.lazy(() => allowancesUncheckedUpdateWithoutBusiness_userInputSchema) ]).optional(),
}).strict();

export default allowancesUncheckedUpdateOneWithoutBusiness_userNestedInputSchema;
