...
export const order_lobbiesUpdateWithWhereUniqueWithoutBusinessInputSchema: z.ZodType<Prisma.order_lobbiesUpdateWithWhereUniqueWithoutBusinessInput> = z.object({
  where: z.lazy(() => order_lobbiesWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => order_lobbiesUpdateWithoutBusinessInputSchema),z.lazy(() => order_lobbiesUncheckedUpdateWithoutBusinessInputSchema) ]),
}).strict();
