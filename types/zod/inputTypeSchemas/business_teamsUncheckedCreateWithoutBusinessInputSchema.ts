...
export const business_teamsUncheckedCreateWithoutBusinessInputSchema: z.ZodType<Prisma.business_teamsUncheckedCreateWithoutBusinessInput> = z.object({
...
export default business_teamsUncheckedCreateWithoutBusinessInputSchema;
