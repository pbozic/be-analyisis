...
export const delivery_driversCreateNestedOneWithoutReceived_ordersInputSchema: z.ZodType<Prisma.delivery_driversCreateNestedOneWithoutReceived_ordersInput> =
	z
		.object({
			create: z
				.union([
