...
export const wallet_transfer_historyUpdateManyWithWhereWithoutDelivery_orderInputSchema: z.ZodType<Prisma.wallet_transfer_historyUpdateManyWithWhereWithoutDelivery_orderInput> =
	z
		.object({
			where: z.lazy(() => wallet_transfer_historyScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => wallet_transfer_historyUpdateManyMutationInputSchema),
				z.lazy(() => wallet_transfer_historyUncheckedUpdateManyWithoutDelivery_orderInputSchema),
			]),
		})
		.strict();
