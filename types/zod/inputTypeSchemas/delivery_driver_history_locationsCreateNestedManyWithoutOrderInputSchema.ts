...
export const delivery_driver_history_locationsCreateNestedManyWithoutOrderInputSchema: z.ZodType<Prisma.delivery_driver_history_locationsCreateNestedManyWithoutOrderInput> =
	z
		.object({
			create: z
				.union([
