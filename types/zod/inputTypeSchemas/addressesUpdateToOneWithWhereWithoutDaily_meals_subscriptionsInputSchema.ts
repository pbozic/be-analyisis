...
export const addressesUpdateToOneWithWhereWithoutDaily_meals_subscriptionsInputSchema: z.ZodType<Prisma.addressesUpdateToOneWithWhereWithoutDaily_meals_subscriptionsInput> = z.object({
  where: z.lazy(() => addressesWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => addressesUpdateWithoutDaily_meals_subscriptionsInputSchema),z.lazy(() => addressesUncheckedUpdateWithoutDaily_meals_subscriptionsInputSchema) ]),
}).strict();
