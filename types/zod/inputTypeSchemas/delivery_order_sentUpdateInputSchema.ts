...
export const delivery_order_sentUpdateInputSchema: z.ZodType<Prisma.delivery_order_sentUpdateInput> = z.object({
...
export default delivery_order_sentUpdateInputSchema;
