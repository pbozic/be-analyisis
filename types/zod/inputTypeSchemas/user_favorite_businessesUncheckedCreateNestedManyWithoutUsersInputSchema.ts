...
export const user_favorite_businessesUncheckedCreateNestedManyWithoutUsersInputSchema: z.ZodType<Prisma.user_favorite_businessesUncheckedCreateNestedManyWithoutUsersInput> =
	z
		.object({
			create: z
				.union([
