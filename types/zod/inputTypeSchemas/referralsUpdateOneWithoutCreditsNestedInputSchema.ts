...
export const referralsUpdateOneWithoutCreditsNestedInputSchema: z.ZodType<Prisma.referralsUpdateOneWithoutCreditsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => referralsUpdateToOneWithWhereWithoutCreditsInputSchema),
