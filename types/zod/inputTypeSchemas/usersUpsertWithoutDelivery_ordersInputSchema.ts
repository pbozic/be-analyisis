...
export const usersUpsertWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.usersUpsertWithoutDelivery_ordersInput> = z.object({
  update: z.union([ z.lazy(() => usersUpdateWithoutDelivery_ordersInputSchema),z.lazy(() => usersUncheckedUpdateWithoutDelivery_ordersInputSchema) ]),
  create: z.union([ z.lazy(() => usersCreateWithoutDelivery_ordersInputSchema),z.lazy(() => usersUncheckedCreateWithoutDelivery_ordersInputSchema) ]),
