...
export const categoriesUncheckedCreateNestedManyWithoutTranslatableInputSchema: z.ZodType<Prisma.categoriesUncheckedCreateNestedManyWithoutTranslatableInput> =
	z
		.object({
			create: z
				.union([
