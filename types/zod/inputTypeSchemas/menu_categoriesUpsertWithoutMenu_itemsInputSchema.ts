...
export const menu_categoriesUpsertWithoutMenu_itemsInputSchema: z.ZodType<Prisma.menu_categoriesUpsertWithoutMenu_itemsInput> = z.object({
  update: z.union([ z.lazy(() => menu_categoriesUpdateWithoutMenu_itemsInputSchema),z.lazy(() => menu_categoriesUncheckedUpdateWithoutMenu_itemsInputSchema) ]),
  create: z.union([ z.lazy(() => menu_categoriesCreateWithoutMenu_itemsInputSchema),z.lazy(() => menu_categoriesUncheckedCreateWithoutMenu_itemsInputSchema) ]),
