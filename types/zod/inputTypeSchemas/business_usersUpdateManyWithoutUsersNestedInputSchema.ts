...
export const business_usersUpdateManyWithoutUsersNestedInputSchema: z.ZodType<Prisma.business_usersUpdateManyWithoutUsersNestedInput> =
	z
		.object({
			create: z
				.union([
					z.lazy(() => business_usersCreateWithoutUsersInputSchema),
					z.lazy(() => business_usersCreateWithoutUsersInputSchema).array(),
					z.lazy(() => business_usersUncheckedCreateWithoutUsersInputSchema),
					z.lazy(() => business_usersUncheckedCreateWithoutUsersInputSchema).array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					z.lazy(() => business_usersCreateOrConnectWithoutUsersInputSchema),
					z.lazy(() => business_usersCreateOrConnectWithoutUsersInputSchema).array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(() => business_usersUpsertWithWhereUniqueWithoutUsersInputSchema),
					z.lazy(() => business_usersUpsertWithWhereUniqueWithoutUsersInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => business_usersUpdateWithWhereUniqueWithoutUsersInputSchema),
					z.lazy(() => business_usersUpdateWithWhereUniqueWithoutUsersInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => business_usersUpdateManyWithWhereWithoutUsersInputSchema),
					z.lazy(() => business_usersUpdateManyWithWhereWithoutUsersInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default business_usersUpdateManyWithoutUsersNestedInputSchema;
