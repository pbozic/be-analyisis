...
export const daily_meals_subscriptionsUpsertWithWhereUniqueWithoutMenu_categoryInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpsertWithWhereUniqueWithoutMenu_categoryInput> = z.object({
  where: z.lazy(() => daily_meals_subscriptionsWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => daily_meals_subscriptionsUpdateWithoutMenu_categoryInputSchema),z.lazy(() => daily_meals_subscriptionsUncheckedUpdateWithoutMenu_categoryInputSchema) ]),
