...
export const business_usersUncheckedUpdateManyWithoutOperating_addressInputSchema: z.ZodType<Prisma.business_usersUncheckedUpdateManyWithoutOperating_addressInput> =
	z
		.object({
			business_users_id: z
