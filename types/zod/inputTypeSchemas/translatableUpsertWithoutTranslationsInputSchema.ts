...
export const translatableUpsertWithoutTranslationsInputSchema: z.ZodType<Prisma.translatableUpsertWithoutTranslationsInput> = z.object({
  update: z.union([ z.lazy(() => translatableUpdateWithoutTranslationsInputSchema),z.lazy(() => translatableUncheckedUpdateWithoutTranslationsInputSchema) ]),
  create: z.union([ z.lazy(() => translatableCreateWithoutTranslationsInputSchema),z.lazy(() => translatableUncheckedCreateWithoutTranslationsInputSchema) ]),
