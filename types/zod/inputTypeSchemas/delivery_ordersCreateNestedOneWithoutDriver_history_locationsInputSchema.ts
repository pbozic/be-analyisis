...
export const delivery_ordersCreateNestedOneWithoutDriver_history_locationsInputSchema: z.ZodType<Prisma.delivery_ordersCreateNestedOneWithoutDriver_history_locationsInput> =
	z
		.object({
			create: z
				.union([
