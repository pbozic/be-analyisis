...
export const businessCreateOrConnectWithoutWord_buy_stripe_productInputSchema: z.ZodType<Prisma.businessCreateOrConnectWithoutWord_buy_stripe_productInput> =
	z
		.object({
