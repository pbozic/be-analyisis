...
export const documentsUpdateManyWithWhereWithoutMenu_itemsInputSchema: z.ZodType<Prisma.documentsUpdateManyWithWhereWithoutMenu_itemsInput> = z.object({
  where: z.lazy(() => documentsScalarWhereInputSchema),
  data: z.union([ z.lazy(() => documentsUpdateManyMutationInputSchema),z.lazy(() => documentsUncheckedUpdateManyWithoutMenu_itemsInputSchema) ]),
}).strict();
