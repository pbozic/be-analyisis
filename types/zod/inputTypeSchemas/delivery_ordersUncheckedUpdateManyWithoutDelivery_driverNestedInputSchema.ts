...
export const delivery_ordersUncheckedUpdateManyWithoutDelivery_driverNestedInputSchema: z.ZodType<Prisma.delivery_ordersUncheckedUpdateManyWithoutDelivery_driverNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => delivery_ordersUpsertWithWhereUniqueWithoutDelivery_driverInputSchema),
					z.lazy(() => delivery_ordersUpsertWithWhereUniqueWithoutDelivery_driverInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => delivery_ordersUpdateWithWhereUniqueWithoutDelivery_driverInputSchema),
					z.lazy(() => delivery_ordersUpdateWithWhereUniqueWithoutDelivery_driverInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => delivery_ordersUpdateManyWithWhereWithoutDelivery_driverInputSchema),
					z.lazy(() => delivery_ordersUpdateManyWithWhereWithoutDelivery_driverInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default delivery_ordersUncheckedUpdateManyWithoutDelivery_driverNestedInputSchema;
