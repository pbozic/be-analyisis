...
export const user_favorite_businessesUpdateManyWithWhereWithoutBusinessesInputSchema: z.ZodType<Prisma.user_favorite_businessesUpdateManyWithWhereWithoutBusinessesInput> =
	z
		.object({
			where: z.lazy(() => user_favorite_businessesScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => user_favorite_businessesUpdateManyMutationInputSchema),
				z.lazy(() => user_favorite_businessesUncheckedUpdateManyWithoutBusinessesInputSchema),
			]),
		})
		.strict();
