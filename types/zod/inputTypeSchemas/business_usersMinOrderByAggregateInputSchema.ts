...
export const business_usersMinOrderByAggregateInputSchema: z.ZodType<Prisma.business_usersMinOrderByAggregateInput> = z.object({
...
export default business_usersMinOrderByAggregateInputSchema;
