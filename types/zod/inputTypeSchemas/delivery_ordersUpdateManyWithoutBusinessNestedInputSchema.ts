...
export const delivery_ordersUpdateManyWithoutBusinessNestedInputSchema: z.ZodType<Prisma.delivery_ordersUpdateManyWithoutBusinessNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => delivery_ordersUpsertWithWhereUniqueWithoutBusinessInputSchema),
					z.lazy(() => delivery_ordersUpsertWithWhereUniqueWithoutBusinessInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => delivery_ordersUpdateWithWhereUniqueWithoutBusinessInputSchema),
					z.lazy(() => delivery_ordersUpdateWithWhereUniqueWithoutBusinessInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => delivery_ordersUpdateManyWithWhereWithoutBusinessInputSchema),
					z.lazy(() => delivery_ordersUpdateManyWithWhereWithoutBusinessInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default delivery_ordersUpdateManyWithoutBusinessNestedInputSchema;
