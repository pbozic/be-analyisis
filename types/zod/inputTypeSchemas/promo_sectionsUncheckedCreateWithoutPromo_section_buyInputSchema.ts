...
export const promo_sectionsUncheckedCreateWithoutPromo_section_buyInputSchema: z.ZodType<Prisma.promo_sectionsUncheckedCreateWithoutPromo_section_buyInput> =
	z
		.object({
