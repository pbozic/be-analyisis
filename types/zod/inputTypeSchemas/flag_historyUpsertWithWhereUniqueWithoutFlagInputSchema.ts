...
export const flag_historyUpsertWithWhereUniqueWithoutFlagInputSchema: z.ZodType<Prisma.flag_historyUpsertWithWhereUniqueWithoutFlagInput> = z.object({
  where: z.lazy(() => flag_historyWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => flag_historyUpdateWithoutFlagInputSchema),z.lazy(() => flag_historyUncheckedUpdateWithoutFlagInputSchema) ]),
