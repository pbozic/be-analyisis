...
export const wallet_transfer_historyScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.wallet_transfer_historyScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => wallet_transfer_historyScalarWhereWithAggregatesInputSchema),
					z.lazy(() => wallet_transfer_historyScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => wallet_transfer_historyScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
