...
export const order_lobbiesUncheckedUpdateManyWithoutBusinessNestedInputSchema: z.ZodType<Prisma.order_lobbiesUncheckedUpdateManyWithoutBusinessNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => order_lobbiesUpsertWithWhereUniqueWithoutBusinessInputSchema),
					z.lazy(() => order_lobbiesUpsertWithWhereUniqueWithoutBusinessInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => order_lobbiesUpdateWithWhereUniqueWithoutBusinessInputSchema),
					z.lazy(() => order_lobbiesUpdateWithWhereUniqueWithoutBusinessInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => order_lobbiesUpdateManyWithWhereWithoutBusinessInputSchema),
					z.lazy(() => order_lobbiesUpdateManyWithWhereWithoutBusinessInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
					z.lazy(() => order_lobbiesScalarWhereInputSchema),
					z.lazy(() => order_lobbiesScalarWhereInputSchema).array(),
				])
				.optional(),
		})
		.strict();

export default order_lobbiesUncheckedUpdateManyWithoutBusinessNestedInputSchema;
