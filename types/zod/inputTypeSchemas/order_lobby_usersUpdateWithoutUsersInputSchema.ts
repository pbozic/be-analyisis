...
export const order_lobby_usersUpdateWithoutUsersInputSchema: z.ZodType<Prisma.order_lobby_usersUpdateWithoutUsersInput> =
	z
		.object({
			...
			order_lobbies: z
				.lazy(() => order_lobbiesUpdateOneRequiredWithoutOrder_lobby_usersNestedInputSchema)
				.optional(),
		})
		.strict();
