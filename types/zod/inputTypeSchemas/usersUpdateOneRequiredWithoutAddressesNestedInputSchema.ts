...
export const usersUpdateOneRequiredWithoutAddressesNestedInputSchema: z.ZodType<Prisma.usersUpdateOneRequiredWithoutAddressesNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => usersUpdateToOneWithWhereWithoutAddressesInputSchema),
