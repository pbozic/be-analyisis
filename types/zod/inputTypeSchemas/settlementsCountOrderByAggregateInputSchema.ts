...
export const settlementsCountOrderByAggregateInputSchema: z.ZodType<Prisma.settlementsCountOrderByAggregateInput> = z.object({
...
export default settlementsCountOrderByAggregateInputSchema;
