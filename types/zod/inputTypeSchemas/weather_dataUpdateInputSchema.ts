...
import { municipalitiesUpdateOneWithoutWeather_dataNestedInputSchema } from './municipalitiesUpdateOneWithoutWeather_dataNestedInputSchema';
import { settlementsUpdateOneWithoutWeather_dataNestedInputSchema } from './settlementsUpdateOneWithoutWeather_dataNestedInputSchema';

export const weather_dataUpdateInputSchema: z.ZodType<Prisma.weather_dataUpdateInput> = z.object({
  weather_data_id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  municipality: z.lazy(() => municipalitiesUpdateOneWithoutWeather_dataNestedInputSchema).optional(),
  settlement: z.lazy(() => settlementsUpdateOneWithoutWeather_dataNestedInputSchema).optional()
}).strict();

export default weather_dataUpdateInputSchema;
