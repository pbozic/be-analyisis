...
import { driver_municipalitiesUpdateManyWithoutDriversNestedInputSchema } from './driver_municipalitiesUpdateManyWithoutDriversNestedInputSchema';
...
export const driversUpdateWithoutReceived_ordersInputSchema: z.ZodType<Prisma.driversUpdateWithoutReceived_ordersInput> =
	z
		.object({
			...
			received_delivery_orders: z
				.lazy(() => delivery_order_sentUpdateManyWithoutDriverNestedInputSchema)
				.optional(),
			documents: z.lazy(() => documentsUpdateManyWithoutDriversNestedInputSchema).optional(),
			driver_history_locations: z
				.lazy(() => driver_history_locationsUpdateManyWithoutDriverNestedInputSchema)
				.optional(),
			driver_municipalities: z
				.lazy(() => driver_municipalitiesUpdateManyWithoutDriversNestedInputSchema)
				.optional(),
...
export default driversUpdateWithoutReceived_ordersInputSchema;
