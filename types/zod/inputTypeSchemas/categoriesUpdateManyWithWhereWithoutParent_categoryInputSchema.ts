...
export const categoriesUpdateManyWithWhereWithoutParent_categoryInputSchema: z.ZodType<Prisma.categoriesUpdateManyWithWhereWithoutParent_categoryInput> =
	z
		.object({
			where: z.lazy(() => categoriesScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => categoriesUpdateManyMutationInputSchema),
				z.lazy(() => categoriesUncheckedUpdateManyWithoutParent_categoryInputSchema),
			]),
		})
		.strict();
