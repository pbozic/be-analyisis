...
export const NestedEnumSCORING_POINTS_REASONFilterSchema: z.ZodType<Prisma.NestedEnumSCORING_POINTS_REASONFilter> = z
	.object({
		...
		not: z
			.union([
				...
				z.lazy(() => NestedEnumSCORING_POINTS_REASONFilterSchema),
			])
			.optional(),
	})
	.strict();
