...
export const usersUpdateWithWhereUniqueWithoutReviewableInputSchema: z.ZodType<Prisma.usersUpdateWithWhereUniqueWithoutReviewableInput> =
	z
		.object({
			where: z.lazy(() => usersWhereUniqueInputSchema),
			data: z.union([
				z.lazy(() => usersUpdateWithoutReviewableInputSchema),
				z.lazy(() => usersUncheckedUpdateWithoutReviewableInputSchema),
			]),
		})
		.strict();
