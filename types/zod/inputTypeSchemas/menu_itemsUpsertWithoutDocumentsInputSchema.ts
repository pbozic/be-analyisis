...
export const menu_itemsUpsertWithoutDocumentsInputSchema: z.ZodType<Prisma.menu_itemsUpsertWithoutDocumentsInput> = z.object({
  update: z.union([ z.lazy(() => menu_itemsUpdateWithoutDocumentsInputSchema),z.lazy(() => menu_itemsUncheckedUpdateWithoutDocumentsInputSchema) ]),
  create: z.union([ z.lazy(() => menu_itemsCreateWithoutDocumentsInputSchema),z.lazy(() => menu_itemsUncheckedCreateWithoutDocumentsInputSchema) ]),
