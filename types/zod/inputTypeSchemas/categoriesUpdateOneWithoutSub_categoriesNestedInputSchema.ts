...
export const categoriesUpdateOneWithoutSub_categoriesNestedInputSchema: z.ZodType<Prisma.categoriesUpdateOneWithoutSub_categoriesNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => categoriesUpdateToOneWithWhereWithoutSub_categoriesInputSchema),
