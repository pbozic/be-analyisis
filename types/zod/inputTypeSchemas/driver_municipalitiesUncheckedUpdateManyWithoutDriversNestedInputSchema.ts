...
export const driver_municipalitiesUncheckedUpdateManyWithoutDriversNestedInputSchema: z.ZodType<Prisma.driver_municipalitiesUncheckedUpdateManyWithoutDriversNestedInput> =
	z
		.object({
			create: z
				.union([
