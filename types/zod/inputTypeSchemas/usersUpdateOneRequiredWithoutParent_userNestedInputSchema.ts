...
export const usersUpdateOneRequiredWithoutParent_userNestedInputSchema: z.ZodType<Prisma.usersUpdateOneRequiredWithoutParent_userNestedInput> = z.object({
  create: z.union([ z.lazy(() => usersCreateWithoutParent_userInputSchema),z.lazy(() => usersUncheckedCreateWithoutParent_userInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => usersUpdateToOneWithWhereWithoutParent_userInputSchema),z.lazy(() => usersUpdateWithoutParent_userInputSchema),z.lazy(() => usersUncheckedUpdateWithoutParent_userInputSchema) ]).optional(),
}).strict();
