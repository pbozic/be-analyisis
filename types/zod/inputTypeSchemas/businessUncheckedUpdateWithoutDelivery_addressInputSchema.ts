...
import { businessUncheckedUpdateManyWithoutParent_businessNestedInputSchema } from './businessUncheckedUpdateManyWithoutParent_businessNestedInputSchema';
...
export const businessUncheckedUpdateWithoutDelivery_addressInputSchema: z.ZodType<Prisma.businessUncheckedUpdateWithoutDelivery_addressInput> = z.object({
  business_id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  address_id: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  child_businesses: z.lazy(() => businessUncheckedUpdateManyWithoutParent_businessNestedInputSchema).optional(),
  taxi_orders: z.lazy(() => taxi_ordersUncheckedUpdateManyWithoutBusinessNestedInputSchema).optional(),
  delivery_orders: z.lazy(() => delivery_ordersUncheckedUpdateManyWithoutBusinessNestedInputSchema).optional(),
  menus: z.lazy(() => menusUncheckedUpdateManyWithoutBusinessNestedInputSchema).optional(),
  word_buy_stripe_product: z.lazy(() => local_productsUncheckedUpdateOneWithoutBusinessNestedInputSchema).optional(),
  ...
  promo_sections: z.lazy(() => promo_sections_buyUncheckedUpdateManyWithoutBusinessNestedInputSchema).optional(),
  business_teams: z.lazy(() => business_teamsUncheckedUpdateManyWithoutBusinessNestedInputSchema).optional(),
  business_order_lobbies: z.lazy(() => order_lobbiesUncheckedUpdateManyWithoutBusinessNestedInputSchema).optional(),
  user_favorite_businesses: z.lazy(() => user_favorite_businessesUncheckedUpdateManyWithoutBusinessesNestedInputSchema).optional(),
  scoring_points: z.lazy(() => scoring_pointsUncheckedUpdateManyWithoutBusinessesNestedInputSchema).optional(),
  daily_meal_drivers: z.lazy(() => delivery_driversUncheckedUpdateManyWithoutDaily_meal_businessNestedInputSchema).optional(),
  late_events: z.lazy(() => late_eventsUncheckedUpdateManyWithoutBusinessesNestedInputSchema).optional(),
  daily_meals_subscribers: z.lazy(() => daily_meals_subscriptionsUncheckedUpdateManyWithoutBusinessNestedInputSchema).optional(),
  account_actions: z.lazy(() => account_actionsUncheckedUpdateManyWithoutBusinessNestedInputSchema).optional(),
  business_clients: z.lazy(() => business_clientsUncheckedUpdateManyWithoutBusinessNestedInputSchema).optional()
}).strict();

export default businessUncheckedUpdateWithoutDelivery_addressInputSchema;
