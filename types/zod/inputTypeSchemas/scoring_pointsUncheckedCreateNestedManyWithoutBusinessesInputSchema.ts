...
export const scoring_pointsUncheckedCreateNestedManyWithoutBusinessesInputSchema: z.ZodType<Prisma.scoring_pointsUncheckedCreateNestedManyWithoutBusinessesInput> =
	z
		.object({
			create: z
				.union([
