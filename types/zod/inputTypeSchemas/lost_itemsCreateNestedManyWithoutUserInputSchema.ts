...
export const lost_itemsCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.lost_itemsCreateNestedManyWithoutUserInput> = z.object({
...
export default lost_itemsCreateNestedManyWithoutUserInputSchema;
