...
export const usersUpdateOneWithoutCreated_account_actionsNestedInputSchema: z.ZodType<Prisma.usersUpdateOneWithoutCreated_account_actionsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => usersUpdateToOneWithWhereWithoutCreated_account_actionsInputSchema),
					z.lazy(() => usersUpdateWithoutCreated_account_actionsInputSchema),
					z.lazy(() => usersUncheckedUpdateWithoutCreated_account_actionsInputSchema),
				])
				.optional(),
		})
		.strict();
