...
export const categoriesUpsertWithoutMenu_categoriesInputSchema: z.ZodType<Prisma.categoriesUpsertWithoutMenu_categoriesInput> = z.object({
  update: z.union([ z.lazy(() => categoriesUpdateWithoutMenu_categoriesInputSchema),z.lazy(() => categoriesUncheckedUpdateWithoutMenu_categoriesInputSchema) ]),
  create: z.union([ z.lazy(() => categoriesCreateWithoutMenu_categoriesInputSchema),z.lazy(() => categoriesUncheckedCreateWithoutMenu_categoriesInputSchema) ]),
