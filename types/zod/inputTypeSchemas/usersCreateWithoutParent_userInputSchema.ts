...
export const usersCreateWithoutParent_userInputSchema: z.ZodType<Prisma.usersCreateWithoutParent_userInput> = z
	.object({
...
export default usersCreateWithoutParent_userInputSchema;
