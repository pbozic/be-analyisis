...
export const order_lobby_itemsUncheckedCreateNestedManyWithoutOrder_lobbiesInputSchema: z.ZodType<Prisma.order_lobby_itemsUncheckedCreateNestedManyWithoutOrder_lobbiesInput> =
	z
		.object({
			create: z
				.union([
