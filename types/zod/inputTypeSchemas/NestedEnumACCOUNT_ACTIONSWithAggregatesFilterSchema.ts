...
export const NestedEnumACCOUNT_ACTIONSWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumACCOUNT_ACTIONSWithAggregatesFilter> =
	z
		.object({
			equals: z.lazy(() => ACCOUNT_ACTIONSSchema).optional(),
			in: z
				.lazy(() => ACCOUNT_ACTIONSSchema)
				.array()
				.optional(),
			notIn: z
				.lazy(() => ACCOUNT_ACTIONSSchema)
			...
			not: z
				.union([
					...
					z.lazy(() => NestedEnumACCOUNT_ACTIONSWithAggregatesFilterSchema),
				])
				.optional(),
