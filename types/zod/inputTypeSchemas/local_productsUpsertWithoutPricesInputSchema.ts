...
export const local_productsUpsertWithoutPricesInputSchema: z.ZodType<Prisma.local_productsUpsertWithoutPricesInput> = z.object({
  update: z.union([ z.lazy(() => local_productsUpdateWithoutPricesInputSchema),z.lazy(() => local_productsUncheckedUpdateWithoutPricesInputSchema) ]),
