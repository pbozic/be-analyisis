...
export const local_pricesScalarWhereInputSchema: z.ZodType<Prisma.local_pricesScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => local_pricesScalarWhereInputSchema),z.lazy(() => local_pricesScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => local_pricesScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => local_pricesScalarWhereInputSchema),z.lazy(() => local_pricesScalarWhereInputSchema).array() ]).optional(),
