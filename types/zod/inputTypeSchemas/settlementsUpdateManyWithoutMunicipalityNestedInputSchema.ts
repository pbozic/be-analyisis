...
export const settlementsUpdateManyWithoutMunicipalityNestedInputSchema: z.ZodType<Prisma.settlementsUpdateManyWithoutMunicipalityNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => settlementsUpsertWithWhereUniqueWithoutMunicipalityInputSchema),z.lazy(() => settlementsUpsertWithWhereUniqueWithoutMunicipalityInputSchema).array() ]).optional(),
  createMany: z.lazy(() => settlementsCreateManyMunicipalityInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => settlementsWhereUniqueInputSchema),z.lazy(() => settlementsWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => settlementsWhereUniqueInputSchema),z.lazy(() => settlementsWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => settlementsWhereUniqueInputSchema),z.lazy(() => settlementsWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => settlementsWhereUniqueInputSchema),z.lazy(() => settlementsWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => settlementsUpdateWithWhereUniqueWithoutMunicipalityInputSchema),z.lazy(() => settlementsUpdateWithWhereUniqueWithoutMunicipalityInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => settlementsUpdateManyWithWhereWithoutMunicipalityInputSchema),z.lazy(() => settlementsUpdateManyWithWhereWithoutMunicipalityInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => settlementsScalarWhereInputSchema),z.lazy(() => settlementsScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default settlementsUpdateManyWithoutMunicipalityNestedInputSchema;
