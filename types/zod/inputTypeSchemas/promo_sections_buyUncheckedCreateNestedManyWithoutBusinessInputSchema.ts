...
export const promo_sections_buyUncheckedCreateNestedManyWithoutBusinessInputSchema: z.ZodType<Prisma.promo_sections_buyUncheckedCreateNestedManyWithoutBusinessInput> =
	z
		.object({
			create: z
				.union([
