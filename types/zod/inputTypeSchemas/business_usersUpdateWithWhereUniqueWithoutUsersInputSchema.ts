...
export const business_usersUpdateWithWhereUniqueWithoutUsersInputSchema: z.ZodType<Prisma.business_usersUpdateWithWhereUniqueWithoutUsersInput> = z.object({
  where: z.lazy(() => business_usersWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => business_usersUpdateWithoutUsersInputSchema),z.lazy(() => business_usersUncheckedUpdateWithoutUsersInputSchema) ]),
}).strict();
