...
export const translationsUncheckedUpdateManyWithoutTranslatableNestedInputSchema: z.ZodType<Prisma.translationsUncheckedUpdateManyWithoutTranslatableNestedInput> =
	z
		.object({
			create: z
				.union([
