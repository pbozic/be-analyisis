...
export const business_clientsUpsertWithoutTaxi_ordersInputSchema: z.ZodType<Prisma.business_clientsUpsertWithoutTaxi_ordersInput> = z.object({
  update: z.union([ z.lazy(() => business_clientsUpdateWithoutTaxi_ordersInputSchema),z.lazy(() => business_clientsUncheckedUpdateWithoutTaxi_ordersInputSchema) ]),
  create: z.union([ z.lazy(() => business_clientsCreateWithoutTaxi_ordersInputSchema),z.lazy(() => business_clientsUncheckedCreateWithoutTaxi_ordersInputSchema) ]),
