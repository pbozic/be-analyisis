...
export const NestedEnumACTIVITY_TYPEWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumACTIVITY_TYPEWithAggregatesFilter> =
	z
		.object({
			...
			not: z
				.union([
					...
					z.lazy(() => NestedEnumACTIVITY_TYPEWithAggregatesFilterSchema),
				])
				.optional(),
