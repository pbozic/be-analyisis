...
export const taxi_order_sentUpdateManyWithWhereWithoutOrderInputSchema: z.ZodType<Prisma.taxi_order_sentUpdateManyWithWhereWithoutOrderInput> =
	z
		.object({
			where: z.lazy(() => taxi_order_sentScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => taxi_order_sentUpdateManyMutationInputSchema),
				z.lazy(() => taxi_order_sentUncheckedUpdateManyWithoutOrderInputSchema),
			]),
		})
		.strict();
