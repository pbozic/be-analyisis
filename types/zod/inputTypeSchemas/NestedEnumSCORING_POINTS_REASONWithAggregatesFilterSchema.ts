...
export const NestedEnumSCORING_POINTS_REASONWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumSCORING_POINTS_REASONWithAggregatesFilter> =
	z
		.object({
			equals: z.lazy(() => SCORING_POINTS_REASONSchema).optional(),
			in: z
				.lazy(() => SCORING_POINTS_REASONSchema)
				.array()
				.optional(),
			notIn: z
				.lazy(() => SCORING_POINTS_REASONSchema)
			...
			not: z
				.union([
					...
					z.lazy(() => NestedEnumSCORING_POINTS_REASONWithAggregatesFilterSchema),
				])
				.optional(),
