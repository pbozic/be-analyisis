...
export const delivery_ordersUpsertWithoutDelivery_driver_history_locationsInputSchema: z.ZodType<Prisma.delivery_ordersUpsertWithoutDelivery_driver_history_locationsInput> = z.object({
  update: z.union([ z.lazy(() => delivery_ordersUpdateWithoutDelivery_driver_history_locationsInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutDelivery_driver_history_locationsInputSchema) ]),
  create: z.union([ z.lazy(() => delivery_ordersCreateWithoutDelivery_driver_history_locationsInputSchema),z.lazy(() => delivery_ordersUncheckedCreateWithoutDelivery_driver_history_locationsInputSchema) ]),
