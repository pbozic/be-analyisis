...
export const flag_historyCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.flag_historyCreateNestedManyWithoutUserInput> = z.object({
...
export default flag_historyCreateNestedManyWithoutUserInputSchema;
