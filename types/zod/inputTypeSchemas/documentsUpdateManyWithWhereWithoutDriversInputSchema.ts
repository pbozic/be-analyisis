...
export const documentsUpdateManyWithWhereWithoutDriversInputSchema: z.ZodType<Prisma.documentsUpdateManyWithWhereWithoutDriversInput> =
	z
		.object({
			where: z.lazy(() => documentsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => documentsUpdateManyMutationInputSchema),
				z.lazy(() => documentsUncheckedUpdateManyWithoutDriversInputSchema),
			]),
		})
		.strict();
