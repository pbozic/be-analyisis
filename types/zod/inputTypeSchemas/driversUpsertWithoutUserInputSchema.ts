...
export const driversUpsertWithoutUserInputSchema: z.ZodType<Prisma.driversUpsertWithoutUserInput> = z.object({
  update: z.union([ z.lazy(() => driversUpdateWithoutUserInputSchema),z.lazy(() => driversUncheckedUpdateWithoutUserInputSchema) ]),
  create: z.union([ z.lazy(() => driversCreateWithoutUserInputSchema),z.lazy(() => driversUncheckedCreateWithoutUserInputSchema) ]),
