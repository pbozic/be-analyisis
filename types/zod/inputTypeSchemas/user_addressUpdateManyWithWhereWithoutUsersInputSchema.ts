...
export const user_addressUpdateManyWithWhereWithoutUsersInputSchema: z.ZodType<Prisma.user_addressUpdateManyWithWhereWithoutUsersInput> =
	z
		.object({
			where: z.lazy(() => user_addressScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => user_addressUpdateManyMutationInputSchema),
				z.lazy(() => user_addressUncheckedUpdateManyWithoutUsersInputSchema),
			]),
		})
		.strict();
