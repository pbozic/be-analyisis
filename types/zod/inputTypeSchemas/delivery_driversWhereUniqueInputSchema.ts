...
export const delivery_driversWhereUniqueInputSchema: z.ZodType<Prisma.delivery_driversWhereUniqueInput> = z.union([
  z.object({
...
.and(z.object({
  ...
  AND: z.union([ z.lazy(() => delivery_driversWhereInputSchema),z.lazy(() => delivery_driversWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => delivery_driversWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => delivery_driversWhereInputSchema),z.lazy(() => delivery_driversWhereInputSchema).array() ]).optional(),
  ...
  daily_meal_business: z.union([ z.lazy(() => BusinessNullableRelationFilterSchema),z.lazy(() => businessWhereInputSchema) ]).optional().nullable(),
}).strict());
