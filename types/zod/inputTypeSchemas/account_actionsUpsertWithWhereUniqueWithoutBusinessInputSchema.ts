...
export const account_actionsUpsertWithWhereUniqueWithoutBusinessInputSchema: z.ZodType<Prisma.account_actionsUpsertWithWhereUniqueWithoutBusinessInput> =
	z
		.object({
			where: z.lazy(() => account_actionsWhereUniqueInputSchema),
			update: z.union([
				z.lazy(() => account_actionsUpdateWithoutBusinessInputSchema),
				z.lazy(() => account_actionsUncheckedUpdateWithoutBusinessInputSchema),
			]),
			create: z.union([
