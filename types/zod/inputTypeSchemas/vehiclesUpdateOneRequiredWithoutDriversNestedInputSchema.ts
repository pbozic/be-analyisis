...
export const vehiclesUpdateOneRequiredWithoutDriversNestedInputSchema: z.ZodType<Prisma.vehiclesUpdateOneRequiredWithoutDriversNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => vehiclesUpdateToOneWithWhereWithoutDriversInputSchema),z.lazy(() => vehiclesUpdateWithoutDriversInputSchema),z.lazy(() => vehiclesUncheckedUpdateWithoutDriversInputSchema) ]).optional(),
}).strict();
