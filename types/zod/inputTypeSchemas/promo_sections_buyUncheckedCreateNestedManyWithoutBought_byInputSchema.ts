...
export const promo_sections_buyUncheckedCreateNestedManyWithoutBought_byInputSchema: z.ZodType<Prisma.promo_sections_buyUncheckedCreateNestedManyWithoutBought_byInput> =
	z
		.object({
			create: z
				.union([
