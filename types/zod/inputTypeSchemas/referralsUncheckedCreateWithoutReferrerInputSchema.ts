...
export const referralsUncheckedCreateWithoutReferrerInputSchema: z.ZodType<Prisma.referralsUncheckedCreateWithoutReferrerInput> = z.object({
...
export default referralsUncheckedCreateWithoutReferrerInputSchema;
