...
export const filesWhereInputSchema: z.ZodType<Prisma.filesWhereInput> = z
	.object({
		...
		document_id: z
			...
			.nullable(),
		documents: z
			.union([z.lazy(() => DocumentsNullableRelationFilterSchema), z.lazy(() => documentsWhereInputSchema)])
			.optional()
			.nullable(),
