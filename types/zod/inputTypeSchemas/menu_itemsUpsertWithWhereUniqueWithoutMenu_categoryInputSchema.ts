...
export const menu_itemsUpsertWithWhereUniqueWithoutMenu_categoryInputSchema: z.ZodType<Prisma.menu_itemsUpsertWithWhereUniqueWithoutMenu_categoryInput> = z.object({
  where: z.lazy(() => menu_itemsWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => menu_itemsUpdateWithoutMenu_categoryInputSchema),z.lazy(() => menu_itemsUncheckedUpdateWithoutMenu_categoryInputSchema) ]),
  create: z.union([ z.lazy(() => menu_itemsCreateWithoutMenu_categoryInputSchema),z.lazy(() => menu_itemsUncheckedCreateWithoutMenu_categoryInputSchema) ]),
}).strict();
