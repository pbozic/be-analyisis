...
export const delivery_ordersUpsertWithoutLate_eventsInputSchema: z.ZodType<Prisma.delivery_ordersUpsertWithoutLate_eventsInput> = z.object({
  update: z.union([ z.lazy(() => delivery_ordersUpdateWithoutLate_eventsInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutLate_eventsInputSchema) ]),
  create: z.union([ z.lazy(() => delivery_ordersCreateWithoutLate_eventsInputSchema),z.lazy(() => delivery_ordersUncheckedCreateWithoutLate_eventsInputSchema) ]),
