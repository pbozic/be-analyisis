...
export const usersCreateWithoutOrder_lobby_usersInputSchema: z.ZodType<Prisma.usersCreateWithoutOrder_lobby_usersInput> =
	z
		.object({
...
export default usersCreateWithoutOrder_lobby_usersInputSchema;
