...
export const promo_sectionsCreateNestedManyWithoutTranslatableInputSchema: z.ZodType<Prisma.promo_sectionsCreateNestedManyWithoutTranslatableInput> = z.object({
...
export default promo_sectionsCreateNestedManyWithoutTranslatableInputSchema;
