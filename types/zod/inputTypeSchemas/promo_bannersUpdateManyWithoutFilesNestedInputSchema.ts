...
export const promo_bannersUpdateManyWithoutFilesNestedInputSchema: z.ZodType<Prisma.promo_bannersUpdateManyWithoutFilesNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => promo_bannersUpsertWithWhereUniqueWithoutFilesInputSchema),
					z.lazy(() => promo_bannersUpsertWithWhereUniqueWithoutFilesInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => promo_bannersUpdateWithWhereUniqueWithoutFilesInputSchema),
					z.lazy(() => promo_bannersUpdateWithWhereUniqueWithoutFilesInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => promo_bannersUpdateManyWithWhereWithoutFilesInputSchema),
					z.lazy(() => promo_bannersUpdateManyWithWhereWithoutFilesInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default promo_bannersUpdateManyWithoutFilesNestedInputSchema;
