...
export const order_lobby_usersUpdateManyWithoutOrder_lobbiesNestedInputSchema: z.ZodType<Prisma.order_lobby_usersUpdateManyWithoutOrder_lobbiesNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => order_lobby_usersUpsertWithWhereUniqueWithoutOrder_lobbiesInputSchema),
					z.lazy(() => order_lobby_usersUpsertWithWhereUniqueWithoutOrder_lobbiesInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => order_lobby_usersUpdateWithWhereUniqueWithoutOrder_lobbiesInputSchema),
					z.lazy(() => order_lobby_usersUpdateWithWhereUniqueWithoutOrder_lobbiesInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => order_lobby_usersUpdateManyWithWhereWithoutOrder_lobbiesInputSchema),
					z.lazy(() => order_lobby_usersUpdateManyWithWhereWithoutOrder_lobbiesInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default order_lobby_usersUpdateManyWithoutOrder_lobbiesNestedInputSchema;
