...
export const driver_history_locationsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.driver_history_locationsScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => driver_history_locationsScalarWhereWithAggregatesInputSchema),
					z.lazy(() => driver_history_locationsScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => driver_history_locationsScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
