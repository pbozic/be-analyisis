...
export const taxi_ordersUncheckedUpdateManyWithoutBusiness_clientsNestedInputSchema: z.ZodType<Prisma.taxi_ordersUncheckedUpdateManyWithoutBusiness_clientsNestedInput> =
	z
		.object({
			create: z
				.union([
