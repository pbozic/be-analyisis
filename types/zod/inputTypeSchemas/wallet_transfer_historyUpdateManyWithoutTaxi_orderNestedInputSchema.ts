...
export const wallet_transfer_historyUpdateManyWithoutTaxi_orderNestedInputSchema: z.ZodType<Prisma.wallet_transfer_historyUpdateManyWithoutTaxi_orderNestedInput> =
	z
		.object({
			create: z
				.union([
