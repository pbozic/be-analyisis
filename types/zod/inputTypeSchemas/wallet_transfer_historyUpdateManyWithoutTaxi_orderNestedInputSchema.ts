...
export const wallet_transfer_historyUpdateManyWithoutTaxi_orderNestedInputSchema: z.ZodType<Prisma.wallet_transfer_historyUpdateManyWithoutTaxi_orderNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => wallet_transfer_historyUpsertWithWhereUniqueWithoutTaxi_orderInputSchema),z.lazy(() => wallet_transfer_historyUpsertWithWhereUniqueWithoutTaxi_orderInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => wallet_transfer_historyUpdateWithWhereUniqueWithoutTaxi_orderInputSchema),z.lazy(() => wallet_transfer_historyUpdateWithWhereUniqueWithoutTaxi_orderInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => wallet_transfer_historyUpdateManyWithWhereWithoutTaxi_orderInputSchema),z.lazy(() => wallet_transfer_historyUpdateManyWithWhereWithoutTaxi_orderInputSchema).array() ]).optional(),
...
export default wallet_transfer_historyUpdateManyWithoutTaxi_orderNestedInputSchema;
