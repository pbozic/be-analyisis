...
export const promo_bannersUpdateManyWithWhereWithoutFilesInputSchema: z.ZodType<Prisma.promo_bannersUpdateManyWithWhereWithoutFilesInput> = z.object({
  where: z.lazy(() => promo_bannersScalarWhereInputSchema),
  data: z.union([ z.lazy(() => promo_bannersUpdateManyMutationInputSchema),z.lazy(() => promo_bannersUncheckedUpdateManyWithoutFilesInputSchema) ]),
}).strict();
