...
export const businessUpdateOneRequiredWithoutPromo_sectionsNestedInputSchema: z.ZodType<Prisma.businessUpdateOneRequiredWithoutPromo_sectionsNestedInput> = z.object({
  create: z.union([ z.lazy(() => businessCreateWithoutPromo_sectionsInputSchema),z.lazy(() => businessUncheckedCreateWithoutPromo_sectionsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => businessUpdateToOneWithWhereWithoutPromo_sectionsInputSchema),z.lazy(() => businessUpdateWithoutPromo_sectionsInputSchema),z.lazy(() => businessUncheckedUpdateWithoutPromo_sectionsInputSchema) ]).optional(),
}).strict();
