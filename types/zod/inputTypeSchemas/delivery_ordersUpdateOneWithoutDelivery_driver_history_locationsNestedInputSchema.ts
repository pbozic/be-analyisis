...
export const delivery_ordersUpdateOneWithoutDelivery_driver_history_locationsNestedInputSchema: z.ZodType<Prisma.delivery_ordersUpdateOneWithoutDelivery_driver_history_locationsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => delivery_ordersUpdateToOneWithWhereWithoutDelivery_driver_history_locationsInputSchema),z.lazy(() => delivery_ordersUpdateWithoutDelivery_driver_history_locationsInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutDelivery_driver_history_locationsInputSchema) ]).optional(),
}).strict();
