...
export const cashbackCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.cashbackCreateNestedManyWithoutUserInput> = z.object({
...
export default cashbackCreateNestedManyWithoutUserInputSchema;
