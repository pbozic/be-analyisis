...
export const NestedEnumORDER_SUBTYPEWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumORDER_SUBTYPEWithAggregatesFilter> =
	z
		.object({
			...
			not: z
				.union([
					...
					z.lazy(() => NestedEnumORDER_SUBTYPEWithAggregatesFilterSchema),
				])
				.optional(),
