...
export const menu_categoriesUncheckedUpdateManyWithoutMenuNestedInputSchema: z.ZodType<Prisma.menu_categoriesUncheckedUpdateManyWithoutMenuNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => menu_categoriesUpsertWithWhereUniqueWithoutMenuInputSchema),z.lazy(() => menu_categoriesUpsertWithWhereUniqueWithoutMenuInputSchema).array() ]).optional(),
  createMany: z.lazy(() => menu_categoriesCreateManyMenuInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => menu_categoriesWhereUniqueInputSchema),z.lazy(() => menu_categoriesWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => menu_categoriesWhereUniqueInputSchema),z.lazy(() => menu_categoriesWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => menu_categoriesWhereUniqueInputSchema),z.lazy(() => menu_categoriesWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => menu_categoriesWhereUniqueInputSchema),z.lazy(() => menu_categoriesWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => menu_categoriesUpdateWithWhereUniqueWithoutMenuInputSchema),z.lazy(() => menu_categoriesUpdateWithWhereUniqueWithoutMenuInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => menu_categoriesUpdateManyWithWhereWithoutMenuInputSchema),z.lazy(() => menu_categoriesUpdateManyWithWhereWithoutMenuInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => menu_categoriesScalarWhereInputSchema),z.lazy(() => menu_categoriesScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default menu_categoriesUncheckedUpdateManyWithoutMenuNestedInputSchema;
