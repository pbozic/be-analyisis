...
export const wallet_transfer_historyWhereInputSchema: z.ZodType<Prisma.wallet_transfer_historyWhereInput> = z.object({
  AND: z.union([ z.lazy(() => wallet_transfer_historyWhereInputSchema),z.lazy(() => wallet_transfer_historyWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => wallet_transfer_historyWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => wallet_transfer_historyWhereInputSchema),z.lazy(() => wallet_transfer_historyWhereInputSchema).array() ]).optional(),
...
export default wallet_transfer_historyWhereInputSchema;
