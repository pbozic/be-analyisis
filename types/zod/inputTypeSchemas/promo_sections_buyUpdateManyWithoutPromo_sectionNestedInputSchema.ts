...
export const promo_sections_buyUpdateManyWithoutPromo_sectionNestedInputSchema: z.ZodType<Prisma.promo_sections_buyUpdateManyWithoutPromo_sectionNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => promo_sections_buyUpsertWithWhereUniqueWithoutPromo_sectionInputSchema),
					z.lazy(() => promo_sections_buyUpsertWithWhereUniqueWithoutPromo_sectionInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => promo_sections_buyUpdateWithWhereUniqueWithoutPromo_sectionInputSchema),
					z.lazy(() => promo_sections_buyUpdateWithWhereUniqueWithoutPromo_sectionInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => promo_sections_buyUpdateManyWithWhereWithoutPromo_sectionInputSchema),
					z.lazy(() => promo_sections_buyUpdateManyWithWhereWithoutPromo_sectionInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default promo_sections_buyUpdateManyWithoutPromo_sectionNestedInputSchema;
