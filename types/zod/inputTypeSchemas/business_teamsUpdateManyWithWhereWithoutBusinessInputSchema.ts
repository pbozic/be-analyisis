...
export const business_teamsUpdateManyWithWhereWithoutBusinessInputSchema: z.ZodType<Prisma.business_teamsUpdateManyWithWhereWithoutBusinessInput> =
	z
		.object({
			where: z.lazy(() => business_teamsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => business_teamsUpdateManyMutationInputSchema),
				z.lazy(() => business_teamsUncheckedUpdateManyWithoutBusinessInputSchema),
			]),
		})
		.strict();
