...
export const municipalitiesCreateNestedOneWithoutDriver_municipalitiesInputSchema: z.ZodType<Prisma.municipalitiesCreateNestedOneWithoutDriver_municipalitiesInput> =
	z
		.object({
			create: z
				.union([
