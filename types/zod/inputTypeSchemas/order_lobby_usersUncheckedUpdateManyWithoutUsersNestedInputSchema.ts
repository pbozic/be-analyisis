...
export const order_lobby_usersUncheckedUpdateManyWithoutUsersNestedInputSchema: z.ZodType<Prisma.order_lobby_usersUncheckedUpdateManyWithoutUsersNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => order_lobby_usersUpsertWithWhereUniqueWithoutUsersInputSchema),
					z.lazy(() => order_lobby_usersUpsertWithWhereUniqueWithoutUsersInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => order_lobby_usersUpdateWithWhereUniqueWithoutUsersInputSchema),
					z.lazy(() => order_lobby_usersUpdateWithWhereUniqueWithoutUsersInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => order_lobby_usersUpdateManyWithWhereWithoutUsersInputSchema),
					z.lazy(() => order_lobby_usersUpdateManyWithWhereWithoutUsersInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default order_lobby_usersUncheckedUpdateManyWithoutUsersNestedInputSchema;
