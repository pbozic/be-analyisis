...
export const taxi_ordersUncheckedUpdateManyWithoutParent_orderNestedInputSchema: z.ZodType<Prisma.taxi_ordersUncheckedUpdateManyWithoutParent_orderNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => taxi_ordersUpsertWithWhereUniqueWithoutParent_orderInputSchema),
					z.lazy(() => taxi_ordersUpsertWithWhereUniqueWithoutParent_orderInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => taxi_ordersUpdateWithWhereUniqueWithoutParent_orderInputSchema),
					z.lazy(() => taxi_ordersUpdateWithWhereUniqueWithoutParent_orderInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => taxi_ordersUpdateManyWithWhereWithoutParent_orderInputSchema),
					z.lazy(() => taxi_ordersUpdateManyWithWhereWithoutParent_orderInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default taxi_ordersUncheckedUpdateManyWithoutParent_orderNestedInputSchema;
