...
export const promo_sectionsWhereUniqueInputSchema: z.ZodType<Prisma.promo_sectionsWhereUniqueInput> = z.object({
  promo_sections_id: z.string().uuid()
})
.and(z.object({
  promo_sections_id: z.string().uuid().optional(),
  AND: z.union([ z.lazy(() => promo_sectionsWhereInputSchema),z.lazy(() => promo_sectionsWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => promo_sectionsWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => promo_sectionsWhereInputSchema),z.lazy(() => promo_sectionsWhereInputSchema).array() ]).optional(),
  ...
  stripe_product_id: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  canPurchase: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  t1price: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  t2price: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  t3price: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  order: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  service_type: z.union([ z.lazy(() => EnumPROMO_SERVICE_TYPESFilterSchema),z.lazy(() => PROMO_SERVICE_TYPESSchema) ]).optional(),
  promo_duration_days: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  translatable_id: z.union([ z.lazy(() => UuidFilterSchema),z.string() ]).optional(),
  display_cards_per_page: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
...
export default promo_sectionsWhereUniqueInputSchema;
