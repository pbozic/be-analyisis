...
export const promo_sectionsWhereUniqueInputSchema: z.ZodType<Prisma.promo_sectionsWhereUniqueInput> = z
	.object({
	...
	.and(
		z
			.object({
				...
				AND: z
					.union([
						z.lazy(() => promo_sectionsWhereInputSchema),
						z.lazy(() => promo_sectionsWhereInputSchema).array(),
					])
					.optional(),
				OR: z
