...
export const daily_meals_subscriptionsCreateNestedManyWithoutAddressInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsCreateNestedManyWithoutAddressInput> =
	z
		.object({
			create: z
				.union([
