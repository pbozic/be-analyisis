...
export const business_usersWhereUniqueInputSchema: z.ZodType<Prisma.business_usersWhereUniqueInput> = z.union([
  z.object({
...
.and(z.object({
  ...
  AND: z.union([ z.lazy(() => business_usersWhereInputSchema),z.lazy(() => business_usersWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => business_usersWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => business_usersWhereInputSchema),z.lazy(() => business_usersWhereInputSchema).array() ]).optional(),
  ...
  operating_address: z.union([ z.lazy(() => AddressesNullableRelationFilterSchema),z.lazy(() => addressesWhereInputSchema) ]).optional().nullable(),
