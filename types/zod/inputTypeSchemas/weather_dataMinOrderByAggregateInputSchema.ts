...
export const weather_dataMinOrderByAggregateInputSchema: z.ZodType<Prisma.weather_dataMinOrderByAggregateInput> = z.object({
...
export default weather_dataMinOrderByAggregateInputSchema;
