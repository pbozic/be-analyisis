...
export const vehiclesCreateWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.vehiclesCreateWithoutDelivery_ordersInput> =
	z
		.object({
			...
			vehicle_specification: z
				.lazy(() => vehicle_specificationsCreateNestedOneWithoutVehicleInputSchema)
				.optional(),
...
export default vehiclesCreateWithoutDelivery_ordersInputSchema;
