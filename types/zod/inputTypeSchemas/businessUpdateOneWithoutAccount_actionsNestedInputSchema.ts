...
export const businessUpdateOneWithoutAccount_actionsNestedInputSchema: z.ZodType<Prisma.businessUpdateOneWithoutAccount_actionsNestedInput> = z.object({
  create: z.union([ z.lazy(() => businessCreateWithoutAccount_actionsInputSchema),z.lazy(() => businessUncheckedCreateWithoutAccount_actionsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => businessUpdateToOneWithWhereWithoutAccount_actionsInputSchema),z.lazy(() => businessUpdateWithoutAccount_actionsInputSchema),z.lazy(() => businessUncheckedUpdateWithoutAccount_actionsInputSchema) ]).optional(),
}).strict();
