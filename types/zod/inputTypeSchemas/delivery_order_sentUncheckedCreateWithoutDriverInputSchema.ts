...
export const delivery_order_sentUncheckedCreateWithoutDriverInputSchema: z.ZodType<Prisma.delivery_order_sentUncheckedCreateWithoutDriverInput> = z.object({
...
export default delivery_order_sentUncheckedCreateWithoutDriverInputSchema;
