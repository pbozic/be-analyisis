...
export const wallet_fundsUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.wallet_fundsUncheckedUpdateManyWithoutUserNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => wallet_fundsUpsertWithWhereUniqueWithoutUserInputSchema),
					z.lazy(() => wallet_fundsUpsertWithWhereUniqueWithoutUserInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => wallet_fundsUpdateWithWhereUniqueWithoutUserInputSchema),
					z.lazy(() => wallet_fundsUpdateWithWhereUniqueWithoutUserInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => wallet_fundsUpdateManyWithWhereWithoutUserInputSchema),
					z.lazy(() => wallet_fundsUpdateManyWithWhereWithoutUserInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default wallet_fundsUncheckedUpdateManyWithoutUserNestedInputSchema;
