...
export const business_usersUpdateManyWithoutBusinessNestedInputSchema: z.ZodType<Prisma.business_usersUpdateManyWithoutBusinessNestedInput> = z.object({
  create: z.union([ z.lazy(() => business_usersCreateWithoutBusinessInputSchema),z.lazy(() => business_usersCreateWithoutBusinessInputSchema).array(),z.lazy(() => business_usersUncheckedCreateWithoutBusinessInputSchema),z.lazy(() => business_usersUncheckedCreateWithoutBusinessInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => business_usersCreateOrConnectWithoutBusinessInputSchema),z.lazy(() => business_usersCreateOrConnectWithoutBusinessInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => business_usersUpsertWithWhereUniqueWithoutBusinessInputSchema),z.lazy(() => business_usersUpsertWithWhereUniqueWithoutBusinessInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => business_usersUpdateWithWhereUniqueWithoutBusinessInputSchema),z.lazy(() => business_usersUpdateWithWhereUniqueWithoutBusinessInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => business_usersUpdateManyWithWhereWithoutBusinessInputSchema),z.lazy(() => business_usersUpdateManyWithWhereWithoutBusinessInputSchema).array() ]).optional(),
...
export default business_usersUpdateManyWithoutBusinessNestedInputSchema;
