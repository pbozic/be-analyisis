...
export const local_pricesWhereUniqueInputSchema: z.ZodType<Prisma.local_pricesWhereUniqueInput> = z
	.union([
		z.object({
	...
	.and(
		z
			.object({
				...
				AND: z
					.union([
						z.lazy(() => local_pricesWhereInputSchema),
						z.lazy(() => local_pricesWhereInputSchema).array(),
					])
					.optional(),
				OR: z
				...
				product: z
					.union([
						z.lazy(() => Local_productsRelationFilterSchema),
