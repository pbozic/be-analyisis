...
export const referralsCountOrderByAggregateInputSchema: z.ZodType<Prisma.referralsCountOrderByAggregateInput> = z.object({
...
export default referralsCountOrderByAggregateInputSchema;
