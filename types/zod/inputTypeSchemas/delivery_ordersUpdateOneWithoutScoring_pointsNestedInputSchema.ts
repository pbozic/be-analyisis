...
export const delivery_ordersUpdateOneWithoutScoring_pointsNestedInputSchema: z.ZodType<Prisma.delivery_ordersUpdateOneWithoutScoring_pointsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => delivery_ordersUpdateToOneWithWhereWithoutScoring_pointsInputSchema),
