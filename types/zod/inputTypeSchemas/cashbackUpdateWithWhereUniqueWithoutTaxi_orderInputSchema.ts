...
export const cashbackUpdateWithWhereUniqueWithoutTaxi_orderInputSchema: z.ZodType<Prisma.cashbackUpdateWithWhereUniqueWithoutTaxi_orderInput> =
	z
		.object({
			where: z.lazy(() => cashbackWhereUniqueInputSchema),
			data: z.union([
				z.lazy(() => cashbackUpdateWithoutTaxi_orderInputSchema),
				z.lazy(() => cashbackUncheckedUpdateWithoutTaxi_orderInputSchema),
			]),
		})
		.strict();
