...
export const usersUpdateToOneWithWhereWithoutDelivery_driverInputSchema: z.ZodType<Prisma.usersUpdateToOneWithWhereWithoutDelivery_driverInput> = z.object({
  where: z.lazy(() => usersWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => usersUpdateWithoutDelivery_driverInputSchema),z.lazy(() => usersUncheckedUpdateWithoutDelivery_driverInputSchema) ]),
}).strict();
