...
export const local_productsUpdateOneRequiredWithoutPricesNestedInputSchema: z.ZodType<Prisma.local_productsUpdateOneRequiredWithoutPricesNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => local_productsUpdateToOneWithWhereWithoutPricesInputSchema),
