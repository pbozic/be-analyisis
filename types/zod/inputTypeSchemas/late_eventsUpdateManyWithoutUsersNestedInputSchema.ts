...
export const late_eventsUpdateManyWithoutUsersNestedInputSchema: z.ZodType<Prisma.late_eventsUpdateManyWithoutUsersNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => late_eventsUpsertWithWhereUniqueWithoutUsersInputSchema),z.lazy(() => late_eventsUpsertWithWhereUniqueWithoutUsersInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => late_eventsUpdateWithWhereUniqueWithoutUsersInputSchema),z.lazy(() => late_eventsUpdateWithWhereUniqueWithoutUsersInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => late_eventsUpdateManyWithWhereWithoutUsersInputSchema),z.lazy(() => late_eventsUpdateManyWithWhereWithoutUsersInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => late_eventsScalarWhereInputSchema),z.lazy(() => late_eventsScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default late_eventsUpdateManyWithoutUsersNestedInputSchema;
