...
export const taxi_ordersCreateManyUserInputSchema: z.ZodType<Prisma.taxi_ordersCreateManyUserInput> = z.object({
...
export default taxi_ordersCreateManyUserInputSchema;
