...
export const reservationsWhereInputSchema: z.ZodType<Prisma.reservationsWhereInput> = z
	.object({
		AND: z
			.union([z.lazy(() => reservationsWhereInputSchema), z.lazy(() => reservationsWhereInputSchema).array()])
			.optional(),
		OR: z
