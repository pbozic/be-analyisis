...
export const driver_history_locationsScalarWhereInputSchema: z.ZodType<Prisma.driver_history_locationsScalarWhereInput> =
	z
		.object({
			AND: z
				.union([
				...
				.optional(),
			OR: z
				.lazy(() => driver_history_locationsScalarWhereInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
