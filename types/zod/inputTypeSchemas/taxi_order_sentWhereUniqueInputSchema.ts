...
export const taxi_order_sentWhereUniqueInputSchema: z.ZodType<Prisma.taxi_order_sentWhereUniqueInput> = z.union([
  z.object({
    taxi_order_sent_id: z.string().uuid(),
    taxi_order_sent_driver_unique: z.lazy(() => taxi_order_sentTaxi_order_sent_driver_uniqueCompoundUniqueInputSchema)
  }),
  z.object({
    taxi_order_sent_id: z.string().uuid(),
  }),
...
.and(z.object({
  ...
  taxi_order_sent_driver_unique: z.lazy(() => taxi_order_sentTaxi_order_sent_driver_uniqueCompoundUniqueInputSchema).optional(),
  AND: z.union([ z.lazy(() => taxi_order_sentWhereInputSchema),z.lazy(() => taxi_order_sentWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => taxi_order_sentWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => taxi_order_sentWhereInputSchema),z.lazy(() => taxi_order_sentWhereInputSchema).array() ]).optional(),
