...
export const driver_history_locationsUncheckedUpdateInputSchema: z.ZodType<Prisma.driver_history_locationsUncheckedUpdateInput> = z.object({
...
export default driver_history_locationsUncheckedUpdateInputSchema;
