...
export const order_lobby_itemsCountOrderByAggregateInputSchema: z.ZodType<Prisma.order_lobby_itemsCountOrderByAggregateInput> = z.object({
...
export default order_lobby_itemsCountOrderByAggregateInputSchema;
