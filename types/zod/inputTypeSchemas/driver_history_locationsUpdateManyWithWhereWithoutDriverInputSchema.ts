...
export const driver_history_locationsUpdateManyWithWhereWithoutDriverInputSchema: z.ZodType<Prisma.driver_history_locationsUpdateManyWithWhereWithoutDriverInput> = z.object({
  where: z.lazy(() => driver_history_locationsScalarWhereInputSchema),
  data: z.union([ z.lazy(() => driver_history_locationsUpdateManyMutationInputSchema),z.lazy(() => driver_history_locationsUncheckedUpdateManyWithoutDriverInputSchema) ]),
}).strict();
