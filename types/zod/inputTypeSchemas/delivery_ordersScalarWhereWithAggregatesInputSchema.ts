...
export const delivery_ordersScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.delivery_ordersScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => delivery_ordersScalarWhereWithAggregatesInputSchema),
					z.lazy(() => delivery_ordersScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => delivery_ordersScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
			...
			status: z
				.union([
					z.lazy(() => EnumDELIVERY_ORDER_STATUSWithAggregatesFilterSchema),
