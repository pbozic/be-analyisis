...
export const order_lobby_usersUncheckedUpdateManyWithoutOrder_lobbiesNestedInputSchema: z.ZodType<Prisma.order_lobby_usersUncheckedUpdateManyWithoutOrder_lobbiesNestedInput> =
	z
		.object({
			create: z
				.union([
