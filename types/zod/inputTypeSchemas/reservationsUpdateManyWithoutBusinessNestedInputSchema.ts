...
export const reservationsUpdateManyWithoutBusinessNestedInputSchema: z.ZodType<Prisma.reservationsUpdateManyWithoutBusinessNestedInput> = z.object({
  create: z.union([ z.lazy(() => reservationsCreateWithoutBusinessInputSchema),z.lazy(() => reservationsCreateWithoutBusinessInputSchema).array(),z.lazy(() => reservationsUncheckedCreateWithoutBusinessInputSchema),z.lazy(() => reservationsUncheckedCreateWithoutBusinessInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => reservationsCreateOrConnectWithoutBusinessInputSchema),z.lazy(() => reservationsCreateOrConnectWithoutBusinessInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => reservationsUpsertWithWhereUniqueWithoutBusinessInputSchema),z.lazy(() => reservationsUpsertWithWhereUniqueWithoutBusinessInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => reservationsUpdateWithWhereUniqueWithoutBusinessInputSchema),z.lazy(() => reservationsUpdateWithWhereUniqueWithoutBusinessInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => reservationsUpdateManyWithWhereWithoutBusinessInputSchema),z.lazy(() => reservationsUpdateManyWithWhereWithoutBusinessInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => reservationsScalarWhereInputSchema),z.lazy(() => reservationsScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default reservationsUpdateManyWithoutBusinessNestedInputSchema;
