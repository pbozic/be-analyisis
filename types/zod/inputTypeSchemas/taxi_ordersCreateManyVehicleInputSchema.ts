...
export const taxi_ordersCreateManyVehicleInputSchema: z.ZodType<Prisma.taxi_ordersCreateManyVehicleInput> = z.object({
...
export default taxi_ordersCreateManyVehicleInputSchema;
