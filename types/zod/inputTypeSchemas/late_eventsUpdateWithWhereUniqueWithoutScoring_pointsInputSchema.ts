...
export const late_eventsUpdateWithWhereUniqueWithoutScoring_pointsInputSchema: z.ZodType<Prisma.late_eventsUpdateWithWhereUniqueWithoutScoring_pointsInput> =
	z
		.object({
			where: z.lazy(() => late_eventsWhereUniqueInputSchema),
			data: z.union([
				z.lazy(() => late_eventsUpdateWithoutScoring_pointsInputSchema),
				z.lazy(() => late_eventsUncheckedUpdateWithoutScoring_pointsInputSchema),
			]),
		})
		.strict();
