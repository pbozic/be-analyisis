...
export const promo_sections_buyUpdateManyWithWhereWithoutPromo_sectionInputSchema: z.ZodType<Prisma.promo_sections_buyUpdateManyWithWhereWithoutPromo_sectionInput> =
	z
		.object({
			where: z.lazy(() => promo_sections_buyScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => promo_sections_buyUpdateManyMutationInputSchema),
				z.lazy(() => promo_sections_buyUncheckedUpdateManyWithoutPromo_sectionInputSchema),
			]),
		})
		.strict();
