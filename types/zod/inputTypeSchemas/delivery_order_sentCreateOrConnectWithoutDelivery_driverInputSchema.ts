...
export const delivery_order_sentCreateOrConnectWithoutDelivery_driverInputSchema: z.ZodType<Prisma.delivery_order_sentCreateOrConnectWithoutDelivery_driverInput> =
	z
		.object({
