...
export const order_lobby_usersUpdateManyWithWhereWithoutOrder_lobbiesInputSchema: z.ZodType<Prisma.order_lobby_usersUpdateManyWithWhereWithoutOrder_lobbiesInput> =
	z
		.object({
			where: z.lazy(() => order_lobby_usersScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => order_lobby_usersUpdateManyMutationInputSchema),
				z.lazy(() => order_lobby_usersUncheckedUpdateManyWithoutOrder_lobbiesInputSchema),
			]),
		})
		.strict();
