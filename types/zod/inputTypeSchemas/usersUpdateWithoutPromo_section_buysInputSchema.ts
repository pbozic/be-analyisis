...
import { driversUpdateOneWithoutUserNestedInputSchema } from './driversUpdateOneWithoutUserNestedInputSchema';
...
export const usersUpdateWithoutPromo_section_buysInputSchema: z.ZodType<Prisma.usersUpdateWithoutPromo_section_buysInput> =
	z
		.object({
			...
			driver: z.lazy(() => driversUpdateOneWithoutUserNestedInputSchema).optional(),
			...
			user_favorite_businesses: z
				.lazy(() => user_favorite_businessesUpdateManyWithoutUsersNestedInputSchema)
				.optional(),
			scoring_points: z.lazy(() => scoring_pointsUpdateManyWithoutUsersNestedInputSchema).optional(),
			daily_meals_subscriptions: z
				.lazy(() => daily_meals_subscriptionsUpdateManyWithoutUserNestedInputSchema)
				.optional(),
			...
			created_account_actions: z
				.lazy(() => account_actionsUpdateManyWithoutAction_creatorNestedInputSchema)
				.optional(),
		})
		.strict();

export default usersUpdateWithoutPromo_section_buysInputSchema;
