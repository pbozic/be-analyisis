...
export const transactionsMinOrderByAggregateInputSchema: z.ZodType<Prisma.transactionsMinOrderByAggregateInput> = z
	.object({
...
export default transactionsMinOrderByAggregateInputSchema;
