...
export const driversUpdateOneWithoutDelivery_ordersNestedInputSchema: z.ZodType<Prisma.driversUpdateOneWithoutDelivery_ordersNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => driversUpdateToOneWithWhereWithoutDelivery_ordersInputSchema),
