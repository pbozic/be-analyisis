...
export const businessUpdateOneWithoutDocumentsNestedInputSchema: z.ZodType<Prisma.businessUpdateOneWithoutDocumentsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => businessUpdateToOneWithWhereWithoutDocumentsInputSchema),
