...
export const usersCreateWithoutCashbackInputSchema: z.ZodType<Prisma.usersCreateWithoutCashbackInput> = z
	.object({
...
export default usersCreateWithoutCashbackInputSchema;
