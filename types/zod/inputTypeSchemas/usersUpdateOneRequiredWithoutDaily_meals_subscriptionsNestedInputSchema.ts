...
export const usersUpdateOneRequiredWithoutDaily_meals_subscriptionsNestedInputSchema: z.ZodType<Prisma.usersUpdateOneRequiredWithoutDaily_meals_subscriptionsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => usersUpdateToOneWithWhereWithoutDaily_meals_subscriptionsInputSchema),
