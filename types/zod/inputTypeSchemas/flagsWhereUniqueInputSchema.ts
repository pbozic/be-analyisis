...
export const flagsWhereUniqueInputSchema: z.ZodType<Prisma.flagsWhereUniqueInput> = z
	.object({
	...
	.and(
		z
			.object({
				...
				AND: z
					.union([z.lazy(() => flagsWhereInputSchema), z.lazy(() => flagsWhereInputSchema).array()])
					.optional(),
				OR: z
