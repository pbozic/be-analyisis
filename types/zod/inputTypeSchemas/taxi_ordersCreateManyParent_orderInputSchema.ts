...
export const taxi_ordersCreateManyParent_orderInputSchema: z.ZodType<Prisma.taxi_ordersCreateManyParent_orderInput> = z.object({
...
export default taxi_ordersCreateManyParent_orderInputSchema;
