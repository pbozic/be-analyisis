...
export const menu_categoriesUpdateManyWithWhereWithoutMenuInputSchema: z.ZodType<Prisma.menu_categoriesUpdateManyWithWhereWithoutMenuInput> = z.object({
  where: z.lazy(() => menu_categoriesScalarWhereInputSchema),
  data: z.union([ z.lazy(() => menu_categoriesUpdateManyMutationInputSchema),z.lazy(() => menu_categoriesUncheckedUpdateManyWithoutMenuInputSchema) ]),
}).strict();
