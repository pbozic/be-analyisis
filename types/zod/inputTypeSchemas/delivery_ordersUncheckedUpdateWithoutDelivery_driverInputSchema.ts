...
export const delivery_ordersUncheckedUpdateWithoutDelivery_driverInputSchema: z.ZodType<Prisma.delivery_ordersUncheckedUpdateWithoutDelivery_driverInput> = z.object({
  ...
  transactions: z.lazy(() => transactionsUncheckedUpdateManyWithoutDelivery_orderNestedInputSchema).optional(),
  wallet_transfer: z.lazy(() => wallet_transfer_historyUncheckedUpdateManyWithoutDelivery_orderNestedInputSchema).optional(),
  driver_history_locations: z.lazy(() => driver_history_locationsUncheckedUpdateManyWithoutDelivery_orderNestedInputSchema).optional(),
  delivery_driver_history_locations: z.lazy(() => delivery_driver_history_locationsUncheckedUpdateManyWithoutOrderNestedInputSchema).optional(),
  cashback: z.lazy(() => cashbackUncheckedUpdateManyWithoutDelivery_orderNestedInputSchema).optional(),
  order_lobbies: z.lazy(() => order_lobbiesUncheckedUpdateOneWithoutDelivery_ordersNestedInputSchema).optional(),
  scoring_points: z.lazy(() => scoring_pointsUncheckedUpdateManyWithoutDelivery_ordersNestedInputSchema).optional(),
  late_events: z.lazy(() => late_eventsUncheckedUpdateManyWithoutDelivery_ordersNestedInputSchema).optional()
}).strict();

export default delivery_ordersUncheckedUpdateWithoutDelivery_driverInputSchema;
