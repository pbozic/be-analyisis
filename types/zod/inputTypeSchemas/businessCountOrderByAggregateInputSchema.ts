...
export const businessCountOrderByAggregateInputSchema: z.ZodType<Prisma.businessCountOrderByAggregateInput> = z
	.object({
		...
		daily_users_sorted: z.lazy(() => SortOrderSchema).optional(),
...
export default businessCountOrderByAggregateInputSchema;
