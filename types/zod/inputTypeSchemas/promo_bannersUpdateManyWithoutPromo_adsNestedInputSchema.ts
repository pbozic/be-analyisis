...
export const promo_bannersUpdateManyWithoutPromo_adsNestedInputSchema: z.ZodType<Prisma.promo_bannersUpdateManyWithoutPromo_adsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => promo_bannersUpsertWithWhereUniqueWithoutPromo_adsInputSchema),z.lazy(() => promo_bannersUpsertWithWhereUniqueWithoutPromo_adsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => promo_bannersUpdateWithWhereUniqueWithoutPromo_adsInputSchema),z.lazy(() => promo_bannersUpdateWithWhereUniqueWithoutPromo_adsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => promo_bannersUpdateManyWithWhereWithoutPromo_adsInputSchema),z.lazy(() => promo_bannersUpdateManyWithWhereWithoutPromo_adsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => promo_bannersScalarWhereInputSchema),z.lazy(() => promo_bannersScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default promo_bannersUpdateManyWithoutPromo_adsNestedInputSchema;
