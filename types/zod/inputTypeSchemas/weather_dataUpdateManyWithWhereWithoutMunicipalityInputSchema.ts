...
export const weather_dataUpdateManyWithWhereWithoutMunicipalityInputSchema: z.ZodType<Prisma.weather_dataUpdateManyWithWhereWithoutMunicipalityInput> =
	z
		.object({
			where: z.lazy(() => weather_dataScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => weather_dataUpdateManyMutationInputSchema),
				z.lazy(() => weather_dataUncheckedUpdateManyWithoutMunicipalityInputSchema),
			]),
		})
		.strict();
