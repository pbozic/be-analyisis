...
export const delivery_driver_history_locationsCreateWithoutOrderInputSchema: z.ZodType<Prisma.delivery_driver_history_locationsCreateWithoutOrderInput> = z.object({
  ...
  delivery_driver: z.lazy(() => delivery_driversCreateNestedOneWithoutDelivery_driver_history_locationsInputSchema).optional()
}).strict();
