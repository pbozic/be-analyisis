...
export const lost_itemsUncheckedCreateWithoutUserInputSchema: z.ZodType<Prisma.lost_itemsUncheckedCreateWithoutUserInput> = z.object({
...
export default lost_itemsUncheckedCreateWithoutUserInputSchema;
