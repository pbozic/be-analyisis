...
export const driversUpdateWithoutActivity_logsInputSchema: z.ZodType<Prisma.driversUpdateWithoutActivity_logsInput> = z
	.object({
		...
		driver_history_locations: z
			...
			.optional(),
		driver_municipalities: z.lazy(() => driver_municipalitiesUpdateManyWithoutDriversNestedInputSchema).optional(),
		current_vehicle: z.lazy(() => vehiclesUpdateOneWithoutCurrent_driverNestedInputSchema).optional(),
	})
	.strict();

export default driversUpdateWithoutActivity_logsInputSchema;
