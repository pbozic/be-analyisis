...
export const delivery_ordersUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.delivery_ordersUpdateManyWithWhereWithoutUserInput> =
	z
		.object({
			where: z.lazy(() => delivery_ordersScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => delivery_ordersUpdateManyMutationInputSchema),
				z.lazy(() => delivery_ordersUncheckedUpdateManyWithoutUserInputSchema),
			]),
		})
		.strict();
