...
export const promo_adsUpsertWithoutCategoriesInputSchema: z.ZodType<Prisma.promo_adsUpsertWithoutCategoriesInput> = z.object({
  update: z.union([ z.lazy(() => promo_adsUpdateWithoutCategoriesInputSchema),z.lazy(() => promo_adsUncheckedUpdateWithoutCategoriesInputSchema) ]),
  create: z.union([ z.lazy(() => promo_adsCreateWithoutCategoriesInputSchema),z.lazy(() => promo_adsUncheckedCreateWithoutCategoriesInputSchema) ]),
