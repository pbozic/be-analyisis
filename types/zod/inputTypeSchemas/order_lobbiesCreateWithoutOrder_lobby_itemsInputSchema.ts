...
export const order_lobbiesCreateWithoutOrder_lobby_itemsInputSchema: z.ZodType<Prisma.order_lobbiesCreateWithoutOrder_lobby_itemsInput> =
	z
		.object({
			...
			order_lobby_users: z
				.lazy(() => order_lobby_usersCreateNestedManyWithoutOrder_lobbiesInputSchema)
				.optional(),
...
export default order_lobbiesCreateWithoutOrder_lobby_itemsInputSchema;
