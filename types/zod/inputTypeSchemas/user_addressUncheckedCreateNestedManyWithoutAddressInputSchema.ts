...
export const user_addressUncheckedCreateNestedManyWithoutAddressInputSchema: z.ZodType<Prisma.user_addressUncheckedCreateNestedManyWithoutAddressInput> = z.object({
...
export default user_addressUncheckedCreateNestedManyWithoutAddressInputSchema;
