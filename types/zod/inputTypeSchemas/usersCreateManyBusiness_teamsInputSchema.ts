...
export const usersCreateManyBusiness_teamsInputSchema: z.ZodType<Prisma.usersCreateManyBusiness_teamsInput> = z.object({
...
export default usersCreateManyBusiness_teamsInputSchema;
