...
export const businessUpsertWithoutPromo_sectionsInputSchema: z.ZodType<Prisma.businessUpsertWithoutPromo_sectionsInput> = z.object({
  update: z.union([ z.lazy(() => businessUpdateWithoutPromo_sectionsInputSchema),z.lazy(() => businessUncheckedUpdateWithoutPromo_sectionsInputSchema) ]),
  create: z.union([ z.lazy(() => businessCreateWithoutPromo_sectionsInputSchema),z.lazy(() => businessUncheckedCreateWithoutPromo_sectionsInputSchema) ]),
