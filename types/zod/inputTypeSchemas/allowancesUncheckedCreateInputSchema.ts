...
export const allowancesUncheckedCreateInputSchema: z.ZodType<Prisma.allowancesUncheckedCreateInput> = z.object({
...
export default allowancesUncheckedCreateInputSchema;
