...
export const wallet_transfer_historyCreateNestedManyWithoutTaxi_orderInputSchema: z.ZodType<Prisma.wallet_transfer_historyCreateNestedManyWithoutTaxi_orderInput> =
	z
		.object({
			create: z
				.union([
