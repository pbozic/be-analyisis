...
export const categoriesUpdateWithWhereUniqueWithoutParent_categoryInputSchema: z.ZodType<Prisma.categoriesUpdateWithWhereUniqueWithoutParent_categoryInput> = z.object({
  where: z.lazy(() => categoriesWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => categoriesUpdateWithoutParent_categoryInputSchema),z.lazy(() => categoriesUncheckedUpdateWithoutParent_categoryInputSchema) ]),
}).strict();
