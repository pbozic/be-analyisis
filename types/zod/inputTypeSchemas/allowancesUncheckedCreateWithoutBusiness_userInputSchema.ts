...
export const allowancesUncheckedCreateWithoutBusiness_userInputSchema: z.ZodType<Prisma.allowancesUncheckedCreateWithoutBusiness_userInput> = z.object({
...
export default allowancesUncheckedCreateWithoutBusiness_userInputSchema;
