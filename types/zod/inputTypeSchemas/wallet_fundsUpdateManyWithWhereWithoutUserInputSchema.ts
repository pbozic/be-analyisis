...
export const wallet_fundsUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.wallet_fundsUpdateManyWithWhereWithoutUserInput> =
	z
		.object({
			where: z.lazy(() => wallet_fundsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => wallet_fundsUpdateManyMutationInputSchema),
				z.lazy(() => wallet_fundsUncheckedUpdateManyWithoutUserInputSchema),
			]),
		})
		.strict();
