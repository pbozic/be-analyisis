...
export const usersCreateWithoutWallet_fundsInputSchema: z.ZodType<Prisma.usersCreateWithoutWallet_fundsInput> = z
	.object({
...
export default usersCreateWithoutWallet_fundsInputSchema;
