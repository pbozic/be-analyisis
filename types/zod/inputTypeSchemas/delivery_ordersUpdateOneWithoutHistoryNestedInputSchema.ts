...
export const delivery_ordersUpdateOneWithoutHistoryNestedInputSchema: z.ZodType<Prisma.delivery_ordersUpdateOneWithoutHistoryNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => delivery_ordersUpdateToOneWithWhereWithoutHistoryInputSchema),
