...
export const businessUpdateToOneWithWhereWithoutDocumentsInputSchema: z.ZodType<Prisma.businessUpdateToOneWithWhereWithoutDocumentsInput> = z.object({
  where: z.lazy(() => businessWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => businessUpdateWithoutDocumentsInputSchema),z.lazy(() => businessUncheckedUpdateWithoutDocumentsInputSchema) ]),
}).strict();
