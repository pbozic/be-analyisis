...
export const daily_meals_subscriptionsUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUncheckedCreateNestedManyWithoutUserInput> =
	z
		.object({
			create: z
				.union([
