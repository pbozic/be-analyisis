...
export const taxi_ordersUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.taxi_ordersUpsertWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => taxi_ordersWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => taxi_ordersUpdateWithoutUserInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateWithoutUserInputSchema) ]),
  create: z.union([ z.lazy(() => taxi_ordersCreateWithoutUserInputSchema),z.lazy(() => taxi_ordersUncheckedCreateWithoutUserInputSchema) ]),
}).strict();
