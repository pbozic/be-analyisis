...
export const business_usersUpdateManyWithWhereWithoutBusinessInputSchema: z.ZodType<Prisma.business_usersUpdateManyWithWhereWithoutBusinessInput> = z.object({
  where: z.lazy(() => business_usersScalarWhereInputSchema),
  data: z.union([ z.lazy(() => business_usersUpdateManyMutationInputSchema),z.lazy(() => business_usersUncheckedUpdateManyWithoutBusinessInputSchema) ]),
}).strict();
