...
export const delivery_ordersUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.delivery_ordersUpdateManyWithoutUserNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => delivery_ordersUpsertWithWhereUniqueWithoutUserInputSchema),
					z.lazy(() => delivery_ordersUpsertWithWhereUniqueWithoutUserInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => delivery_ordersUpdateWithWhereUniqueWithoutUserInputSchema),
					z.lazy(() => delivery_ordersUpdateWithWhereUniqueWithoutUserInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => delivery_ordersUpdateManyWithWhereWithoutUserInputSchema),
					z.lazy(() => delivery_ordersUpdateManyWithWhereWithoutUserInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default delivery_ordersUpdateManyWithoutUserNestedInputSchema;
