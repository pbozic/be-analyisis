...
export const promo_sectionsUncheckedUpdateManyInputSchema: z.ZodType<Prisma.promo_sectionsUncheckedUpdateManyInput> = z.object({
...
export default promo_sectionsUncheckedUpdateManyInputSchema;
