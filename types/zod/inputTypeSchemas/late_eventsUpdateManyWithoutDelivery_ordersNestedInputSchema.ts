...
export const late_eventsUpdateManyWithoutDelivery_ordersNestedInputSchema: z.ZodType<Prisma.late_eventsUpdateManyWithoutDelivery_ordersNestedInput> =
	z
		.object({
			create: z
				.union([
					z.lazy(() => late_eventsCreateWithoutDelivery_ordersInputSchema),
					z.lazy(() => late_eventsCreateWithoutDelivery_ordersInputSchema).array(),
					z.lazy(() => late_eventsUncheckedCreateWithoutDelivery_ordersInputSchema),
					z.lazy(() => late_eventsUncheckedCreateWithoutDelivery_ordersInputSchema).array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					z.lazy(() => late_eventsCreateOrConnectWithoutDelivery_ordersInputSchema),
					z.lazy(() => late_eventsCreateOrConnectWithoutDelivery_ordersInputSchema).array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(() => late_eventsUpsertWithWhereUniqueWithoutDelivery_ordersInputSchema),
					z.lazy(() => late_eventsUpsertWithWhereUniqueWithoutDelivery_ordersInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => late_eventsUpdateWithWhereUniqueWithoutDelivery_ordersInputSchema),
					z.lazy(() => late_eventsUpdateWithWhereUniqueWithoutDelivery_ordersInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => late_eventsUpdateManyWithWhereWithoutDelivery_ordersInputSchema),
					z.lazy(() => late_eventsUpdateManyWithWhereWithoutDelivery_ordersInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default late_eventsUpdateManyWithoutDelivery_ordersNestedInputSchema;
