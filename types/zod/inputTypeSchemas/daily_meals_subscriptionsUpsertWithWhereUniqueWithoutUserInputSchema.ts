...
export const daily_meals_subscriptionsUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpsertWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => daily_meals_subscriptionsWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => daily_meals_subscriptionsUpdateWithoutUserInputSchema),z.lazy(() => daily_meals_subscriptionsUncheckedUpdateWithoutUserInputSchema) ]),
  create: z.union([ z.lazy(() => daily_meals_subscriptionsCreateWithoutUserInputSchema),z.lazy(() => daily_meals_subscriptionsUncheckedCreateWithoutUserInputSchema) ]),
}).strict();
