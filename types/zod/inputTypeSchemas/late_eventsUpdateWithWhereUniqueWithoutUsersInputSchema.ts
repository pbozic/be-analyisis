...
export const late_eventsUpdateWithWhereUniqueWithoutUsersInputSchema: z.ZodType<Prisma.late_eventsUpdateWithWhereUniqueWithoutUsersInput> = z.object({
  where: z.lazy(() => late_eventsWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => late_eventsUpdateWithoutUsersInputSchema),z.lazy(() => late_eventsUncheckedUpdateWithoutUsersInputSchema) ]),
}).strict();
