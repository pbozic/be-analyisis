...
export const word_buyWhereInputSchema: z.ZodType<Prisma.word_buyWhereInput> = z.object({
  AND: z.union([ z.lazy(() => word_buyWhereInputSchema),z.lazy(() => word_buyWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => word_buyWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => word_buyWhereInputSchema),z.lazy(() => word_buyWhereInputSchema).array() ]).optional(),
  ...
  word: z.union([ z.lazy(() => WordsRelationFilterSchema),z.lazy(() => wordsWhereInputSchema) ]).optional(),
  business: z.union([ z.lazy(() => BusinessRelationFilterSchema),z.lazy(() => businessWhereInputSchema) ]).optional(),
}).strict();

export default word_buyWhereInputSchema;
