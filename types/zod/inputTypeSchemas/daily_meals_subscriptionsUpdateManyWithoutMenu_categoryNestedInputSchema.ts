...
export const daily_meals_subscriptionsUpdateManyWithoutMenu_categoryNestedInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpdateManyWithoutMenu_categoryNestedInput> =
	z
		.object({
			create: z
				.union([
