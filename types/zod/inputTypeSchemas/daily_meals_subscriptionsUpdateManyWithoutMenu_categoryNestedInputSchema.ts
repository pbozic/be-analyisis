...
export const daily_meals_subscriptionsUpdateManyWithoutMenu_categoryNestedInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpdateManyWithoutMenu_categoryNestedInput> = z.object({
  create: z.union([ z.lazy(() => daily_meals_subscriptionsCreateWithoutMenu_categoryInputSchema),z.lazy(() => daily_meals_subscriptionsCreateWithoutMenu_categoryInputSchema).array(),z.lazy(() => daily_meals_subscriptionsUncheckedCreateWithoutMenu_categoryInputSchema),z.lazy(() => daily_meals_subscriptionsUncheckedCreateWithoutMenu_categoryInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => daily_meals_subscriptionsCreateOrConnectWithoutMenu_categoryInputSchema),z.lazy(() => daily_meals_subscriptionsCreateOrConnectWithoutMenu_categoryInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => daily_meals_subscriptionsUpsertWithWhereUniqueWithoutMenu_categoryInputSchema),z.lazy(() => daily_meals_subscriptionsUpsertWithWhereUniqueWithoutMenu_categoryInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => daily_meals_subscriptionsUpdateWithWhereUniqueWithoutMenu_categoryInputSchema),z.lazy(() => daily_meals_subscriptionsUpdateWithWhereUniqueWithoutMenu_categoryInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => daily_meals_subscriptionsUpdateManyWithWhereWithoutMenu_categoryInputSchema),z.lazy(() => daily_meals_subscriptionsUpdateManyWithWhereWithoutMenu_categoryInputSchema).array() ]).optional(),
...
export default daily_meals_subscriptionsUpdateManyWithoutMenu_categoryNestedInputSchema;
