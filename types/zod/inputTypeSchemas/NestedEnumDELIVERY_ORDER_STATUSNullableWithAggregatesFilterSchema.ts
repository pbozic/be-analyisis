...
export const NestedEnumDELIVERY_ORDER_STATUSNullableWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumDELIVERY_ORDER_STATUSNullableWithAggregatesFilter> =
	z
		.object({
			equals: z
