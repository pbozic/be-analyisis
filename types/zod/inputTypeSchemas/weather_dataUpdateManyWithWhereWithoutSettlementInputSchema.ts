...
export const weather_dataUpdateManyWithWhereWithoutSettlementInputSchema: z.ZodType<Prisma.weather_dataUpdateManyWithWhereWithoutSettlementInput> =
	z
		.object({
			where: z.lazy(() => weather_dataScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => weather_dataUpdateManyMutationInputSchema),
				z.lazy(() => weather_dataUncheckedUpdateManyWithoutSettlementInputSchema),
			]),
		})
		.strict();
