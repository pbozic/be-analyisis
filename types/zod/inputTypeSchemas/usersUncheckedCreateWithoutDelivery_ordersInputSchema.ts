...
import { group_usersUncheckedCreateNestedManyWithoutParent_userInputSchema } from './group_usersUncheckedCreateNestedManyWithoutParent_userInputSchema';
...
export const usersUncheckedCreateWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.usersUncheckedCreateWithoutDelivery_ordersInput> = z.object({
  ...
  child_users: z.lazy(() => group_usersUncheckedCreateNestedManyWithoutParent_userInputSchema).optional(),
  ...
  order_lobby_users: z.lazy(() => order_lobby_usersUncheckedCreateNestedManyWithoutUsersInputSchema).optional(),
  promo_section_buys: z.lazy(() => promo_sections_buyUncheckedCreateNestedManyWithoutBought_byInputSchema).optional(),
  user_favorite_businesses: z.lazy(() => user_favorite_businessesUncheckedCreateNestedManyWithoutUsersInputSchema).optional(),
  scoring_points: z.lazy(() => scoring_pointsUncheckedCreateNestedManyWithoutUsersInputSchema).optional(),
  daily_meals_subscriptions: z.lazy(() => daily_meals_subscriptionsUncheckedCreateNestedManyWithoutUserInputSchema).optional(),
  ...
  created_account_actions: z.lazy(() => account_actionsUncheckedCreateNestedManyWithoutAction_creatorInputSchema).optional()
}).strict();

export default usersUncheckedCreateWithoutDelivery_ordersInputSchema;
