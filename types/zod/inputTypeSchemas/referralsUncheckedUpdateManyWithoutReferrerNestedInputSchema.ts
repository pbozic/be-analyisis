...
export const referralsUncheckedUpdateManyWithoutReferrerNestedInputSchema: z.ZodType<Prisma.referralsUncheckedUpdateManyWithoutReferrerNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => referralsUpsertWithWhereUniqueWithoutReferrerInputSchema),z.lazy(() => referralsUpsertWithWhereUniqueWithoutReferrerInputSchema).array() ]).optional(),
  createMany: z.lazy(() => referralsCreateManyReferrerInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => referralsWhereUniqueInputSchema),z.lazy(() => referralsWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => referralsWhereUniqueInputSchema),z.lazy(() => referralsWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => referralsWhereUniqueInputSchema),z.lazy(() => referralsWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => referralsWhereUniqueInputSchema),z.lazy(() => referralsWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => referralsUpdateWithWhereUniqueWithoutReferrerInputSchema),z.lazy(() => referralsUpdateWithWhereUniqueWithoutReferrerInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => referralsUpdateManyWithWhereWithoutReferrerInputSchema),z.lazy(() => referralsUpdateManyWithWhereWithoutReferrerInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => referralsScalarWhereInputSchema),z.lazy(() => referralsScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default referralsUncheckedUpdateManyWithoutReferrerNestedInputSchema;
