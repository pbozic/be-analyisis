...
export const user_favorite_businessesCreateInputSchema: z.ZodType<Prisma.user_favorite_businessesCreateInput> = z.object({
...
export default user_favorite_businessesCreateInputSchema;
