...
export const driver_history_locationsUncheckedUpdateManyWithoutDelivery_orderNestedInputSchema: z.ZodType<Prisma.driver_history_locationsUncheckedUpdateManyWithoutDelivery_orderNestedInput> = z.object({
  create: z.union([ z.lazy(() => driver_history_locationsCreateWithoutDelivery_orderInputSchema),z.lazy(() => driver_history_locationsCreateWithoutDelivery_orderInputSchema).array(),z.lazy(() => driver_history_locationsUncheckedCreateWithoutDelivery_orderInputSchema),z.lazy(() => driver_history_locationsUncheckedCreateWithoutDelivery_orderInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => driver_history_locationsCreateOrConnectWithoutDelivery_orderInputSchema),z.lazy(() => driver_history_locationsCreateOrConnectWithoutDelivery_orderInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => driver_history_locationsUpsertWithWhereUniqueWithoutDelivery_orderInputSchema),z.lazy(() => driver_history_locationsUpsertWithWhereUniqueWithoutDelivery_orderInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => driver_history_locationsUpdateWithWhereUniqueWithoutDelivery_orderInputSchema),z.lazy(() => driver_history_locationsUpdateWithWhereUniqueWithoutDelivery_orderInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => driver_history_locationsUpdateManyWithWhereWithoutDelivery_orderInputSchema),z.lazy(() => driver_history_locationsUpdateManyWithWhereWithoutDelivery_orderInputSchema).array() ]).optional(),
...
export default driver_history_locationsUncheckedUpdateManyWithoutDelivery_orderNestedInputSchema;
