...
export const driver_history_locationsUncheckedUpdateManyWithoutDelivery_orderNestedInputSchema: z.ZodType<Prisma.driver_history_locationsUncheckedUpdateManyWithoutDelivery_orderNestedInput> =
	z
		.object({
			create: z
				.union([
