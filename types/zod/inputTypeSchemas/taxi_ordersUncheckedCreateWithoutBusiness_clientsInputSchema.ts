...
export const taxi_ordersUncheckedCreateWithoutBusiness_clientsInputSchema: z.ZodType<Prisma.taxi_ordersUncheckedCreateWithoutBusiness_clientsInput> =
	z
		.object({
			...
			driver_history_locations: z
				.lazy(() => driver_history_locationsUncheckedCreateNestedManyWithoutOrderInputSchema)
				.optional(),
			wallet_transfer: z
				.lazy(() => wallet_transfer_historyUncheckedCreateNestedManyWithoutTaxi_orderInputSchema)
				.optional(),
			...
			scoring_points: z
				.lazy(() => scoring_pointsUncheckedCreateNestedManyWithoutTaxi_ordersInputSchema)
				.optional(),
			late_events: z.lazy(() => late_eventsUncheckedCreateNestedManyWithoutTaxi_ordersInputSchema).optional(),
		})
		.strict();

export default taxi_ordersUncheckedCreateWithoutBusiness_clientsInputSchema;
