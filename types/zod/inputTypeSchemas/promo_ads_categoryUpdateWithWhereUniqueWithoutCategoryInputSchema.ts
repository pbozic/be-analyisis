...
export const promo_ads_categoryUpdateWithWhereUniqueWithoutCategoryInputSchema: z.ZodType<Prisma.promo_ads_categoryUpdateWithWhereUniqueWithoutCategoryInput> = z.object({
  where: z.lazy(() => promo_ads_categoryWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => promo_ads_categoryUpdateWithoutCategoryInputSchema),z.lazy(() => promo_ads_categoryUncheckedUpdateWithoutCategoryInputSchema) ]),
}).strict();
