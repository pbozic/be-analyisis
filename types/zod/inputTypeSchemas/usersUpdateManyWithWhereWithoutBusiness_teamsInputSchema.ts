...
export const usersUpdateManyWithWhereWithoutBusiness_teamsInputSchema: z.ZodType<Prisma.usersUpdateManyWithWhereWithoutBusiness_teamsInput> =
	z
		.object({
			where: z.lazy(() => usersScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => usersUpdateManyMutationInputSchema),
				z.lazy(() => usersUncheckedUpdateManyWithoutBusiness_teamsInputSchema),
			]),
		})
		.strict();
