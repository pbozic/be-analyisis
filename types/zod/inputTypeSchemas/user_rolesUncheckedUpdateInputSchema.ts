...
export const user_rolesUncheckedUpdateInputSchema: z.ZodType<Prisma.user_rolesUncheckedUpdateInput> = z.object({
...
export default user_rolesUncheckedUpdateInputSchema;
