...
export const late_eventsCreateNestedManyWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.late_eventsCreateNestedManyWithoutDelivery_ordersInput> =
	z
		.object({
			create: z
				.union([
...
export default late_eventsCreateNestedManyWithoutDelivery_ordersInputSchema;
