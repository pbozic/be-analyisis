...
export const local_pricesUpdateWithWhereUniqueWithoutProductInputSchema: z.ZodType<Prisma.local_pricesUpdateWithWhereUniqueWithoutProductInput> = z.object({
  where: z.lazy(() => local_pricesWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => local_pricesUpdateWithoutProductInputSchema),z.lazy(() => local_pricesUncheckedUpdateWithoutProductInputSchema) ]),
}).strict();
