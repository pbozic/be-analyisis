...
export const taxi_order_sentUpdateWithWhereUniqueWithoutDriverInputSchema: z.ZodType<Prisma.taxi_order_sentUpdateWithWhereUniqueWithoutDriverInput> =
	z
		.object({
			where: z.lazy(() => taxi_order_sentWhereUniqueInputSchema),
			data: z.union([
				z.lazy(() => taxi_order_sentUpdateWithoutDriverInputSchema),
				z.lazy(() => taxi_order_sentUncheckedUpdateWithoutDriverInputSchema),
			]),
		})
		.strict();
