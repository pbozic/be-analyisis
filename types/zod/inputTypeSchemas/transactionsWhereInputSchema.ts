...
export const transactionsWhereInputSchema: z.ZodType<Prisma.transactionsWhereInput> = z
	.object({
		AND: z
			.union([z.lazy(() => transactionsWhereInputSchema), z.lazy(() => transactionsWhereInputSchema).array()])
			.optional(),
		OR: z
		...
		wallet_funds: z
			.union([z.lazy(() => Wallet_fundsNullableRelationFilterSchema), z.lazy(() => wallet_fundsWhereInputSchema)])
			.optional()
			.nullable(),
	})
	.strict();

export default transactionsWhereInputSchema;
