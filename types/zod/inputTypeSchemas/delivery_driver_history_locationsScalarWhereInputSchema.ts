...
export const delivery_driver_history_locationsScalarWhereInputSchema: z.ZodType<Prisma.delivery_driver_history_locationsScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => delivery_driver_history_locationsScalarWhereInputSchema),z.lazy(() => delivery_driver_history_locationsScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => delivery_driver_history_locationsScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => delivery_driver_history_locationsScalarWhereInputSchema),z.lazy(() => delivery_driver_history_locationsScalarWhereInputSchema).array() ]).optional(),
