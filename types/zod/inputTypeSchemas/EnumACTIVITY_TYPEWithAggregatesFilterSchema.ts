...
export const EnumACTIVITY_TYPEWithAggregatesFilterSchema: z.ZodType<Prisma.EnumACTIVITY_TYPEWithAggregatesFilter> = z
	.object({
		...
		notIn: z
			...
			.optional(),
		not: z
			.union([z.lazy(() => ACTIVITY_TYPESchema), z.lazy(() => NestedEnumACTIVITY_TYPEWithAggregatesFilterSchema)])
			.optional(),
