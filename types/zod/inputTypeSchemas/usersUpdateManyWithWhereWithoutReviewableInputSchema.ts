...
export const usersUpdateManyWithWhereWithoutReviewableInputSchema: z.ZodType<Prisma.usersUpdateManyWithWhereWithoutReviewableInput> =
	z
		.object({
			where: z.lazy(() => usersScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => usersUpdateManyMutationInputSchema),
				z.lazy(() => usersUncheckedUpdateManyWithoutReviewableInputSchema),
			]),
		})
		.strict();
