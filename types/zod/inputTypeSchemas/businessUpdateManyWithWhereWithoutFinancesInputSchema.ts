...
export const businessUpdateManyWithWhereWithoutFinancesInputSchema: z.ZodType<Prisma.businessUpdateManyWithWhereWithoutFinancesInput> = z.object({
  where: z.lazy(() => businessScalarWhereInputSchema),
  data: z.union([ z.lazy(() => businessUpdateManyMutationInputSchema),z.lazy(() => businessUncheckedUpdateManyWithoutFinancesInputSchema) ]),
}).strict();
