...
export const transactionsCreateNestedManyWithoutDelivery_orderInputSchema: z.ZodType<Prisma.transactionsCreateNestedManyWithoutDelivery_orderInput> =
	z
		.object({
			create: z
				.union([
...
export default transactionsCreateNestedManyWithoutDelivery_orderInputSchema;
