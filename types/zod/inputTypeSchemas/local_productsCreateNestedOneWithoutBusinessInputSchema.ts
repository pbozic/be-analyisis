...
export const local_productsCreateNestedOneWithoutBusinessInputSchema: z.ZodType<Prisma.local_productsCreateNestedOneWithoutBusinessInput> = z.object({
...
export default local_productsCreateNestedOneWithoutBusinessInputSchema;
