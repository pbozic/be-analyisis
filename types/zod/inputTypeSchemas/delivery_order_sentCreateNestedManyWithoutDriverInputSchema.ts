...
export const delivery_order_sentCreateNestedManyWithoutDriverInputSchema: z.ZodType<Prisma.delivery_order_sentCreateNestedManyWithoutDriverInput> = z.object({
...
export default delivery_order_sentCreateNestedManyWithoutDriverInputSchema;
