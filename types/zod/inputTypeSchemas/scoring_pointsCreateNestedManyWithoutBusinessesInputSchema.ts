...
export const scoring_pointsCreateNestedManyWithoutBusinessesInputSchema: z.ZodType<Prisma.scoring_pointsCreateNestedManyWithoutBusinessesInput> = z.object({
...
export default scoring_pointsCreateNestedManyWithoutBusinessesInputSchema;
