...
export const order_lobby_itemsCreateManyInputSchema: z.ZodType<Prisma.order_lobby_itemsCreateManyInput> = z.object({
...
export default order_lobby_itemsCreateManyInputSchema;
