...
export const user_favorite_businessesUser_typed_favoriteCompoundUniqueInputSchema: z.ZodType<Prisma.user_favorite_businessesUser_typed_favoriteCompoundUniqueInput> =
	z
		.object({
			user_id: z.string(),
