...
export const taxi_ordersUncheckedUpdateManyWithoutBusiness_usersNestedInputSchema: z.ZodType<Prisma.taxi_ordersUncheckedUpdateManyWithoutBusiness_usersNestedInput> =
	z
		.object({
			create: z
				.union([
					z.lazy(() => taxi_ordersCreateWithoutBusiness_usersInputSchema),
					z.lazy(() => taxi_ordersCreateWithoutBusiness_usersInputSchema).array(),
					z.lazy(() => taxi_ordersUncheckedCreateWithoutBusiness_usersInputSchema),
					z.lazy(() => taxi_ordersUncheckedCreateWithoutBusiness_usersInputSchema).array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					z.lazy(() => taxi_ordersCreateOrConnectWithoutBusiness_usersInputSchema),
					z.lazy(() => taxi_ordersCreateOrConnectWithoutBusiness_usersInputSchema).array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(() => taxi_ordersUpsertWithWhereUniqueWithoutBusiness_usersInputSchema),
					z.lazy(() => taxi_ordersUpsertWithWhereUniqueWithoutBusiness_usersInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => taxi_ordersUpdateWithWhereUniqueWithoutBusiness_usersInputSchema),
					z.lazy(() => taxi_ordersUpdateWithWhereUniqueWithoutBusiness_usersInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => taxi_ordersUpdateManyWithWhereWithoutBusiness_usersInputSchema),
					z.lazy(() => taxi_ordersUpdateManyWithWhereWithoutBusiness_usersInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default taxi_ordersUncheckedUpdateManyWithoutBusiness_usersNestedInputSchema;
