...
export const delivery_ordersCreateManyInputSchema: z.ZodType<Prisma.delivery_ordersCreateManyInput> = z.object({
...
export default delivery_ordersCreateManyInputSchema;
