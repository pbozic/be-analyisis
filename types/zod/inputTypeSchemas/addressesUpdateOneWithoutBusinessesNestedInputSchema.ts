...
export const addressesUpdateOneWithoutBusinessesNestedInputSchema: z.ZodType<Prisma.addressesUpdateOneWithoutBusinessesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => addressesUpdateToOneWithWhereWithoutBusinessesInputSchema),z.lazy(() => addressesUpdateWithoutBusinessesInputSchema),z.lazy(() => addressesUncheckedUpdateWithoutBusinessesInputSchema) ]).optional(),
}).strict();
