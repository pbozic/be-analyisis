...
export const late_eventsMaxOrderByAggregateInputSchema: z.ZodType<Prisma.late_eventsMaxOrderByAggregateInput> = z.object({
...
export default late_eventsMaxOrderByAggregateInputSchema;
