...
export const businessWhereInputSchema: z.ZodType<Prisma.businessWhereInput> = z
	.object({
		AND: z
			.union([z.lazy(() => businessWhereInputSchema), z.lazy(() => businessWhereInputSchema).array()])
			.optional(),
		OR: z
		...
		delivery_address: z
			...
			.nullable(),
		finances: z
			.union([z.lazy(() => FinancesNullableRelationFilterSchema), z.lazy(() => financesWhereInputSchema)])
			.optional()
			.nullable(),
		...
		reviewable: z
			.union([z.lazy(() => ReviewableNullableRelationFilterSchema), z.lazy(() => reviewableWhereInputSchema)])
			.optional()
			.nullable(),
		word_buy_stripe_product: z
			.union([
				z.lazy(() => Local_productsNullableRelationFilterSchema),
		...
		fiscal_device: z
			.union([
				z.lazy(() => Fiscal_devicesNullableRelationFilterSchema),
				z.lazy(() => fiscal_devicesWhereInputSchema),
			])
			.optional()
			.nullable(),
...
export default businessWhereInputSchema;
