...
export const user_addressUpdateManyWithWhereWithoutAddressInputSchema: z.ZodType<Prisma.user_addressUpdateManyWithWhereWithoutAddressInput> = z.object({
  where: z.lazy(() => user_addressScalarWhereInputSchema),
  data: z.union([ z.lazy(() => user_addressUpdateManyMutationInputSchema),z.lazy(() => user_addressUncheckedUpdateManyWithoutAddressInputSchema) ]),
}).strict();
