...
export const word_buyMinOrderByAggregateInputSchema: z.ZodType<Prisma.word_buyMinOrderByAggregateInput> = z.object({
...
export default word_buyMinOrderByAggregateInputSchema;
