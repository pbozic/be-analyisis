...
export const documentsUpdateManyWithoutTransactionsNestedInputSchema: z.ZodType<Prisma.documentsUpdateManyWithoutTransactionsNestedInput> =
	z
		.object({
			create: z
				.union([
					z.lazy(() => documentsCreateWithoutTransactionsInputSchema),
					z.lazy(() => documentsCreateWithoutTransactionsInputSchema).array(),
					z.lazy(() => documentsUncheckedCreateWithoutTransactionsInputSchema),
					z.lazy(() => documentsUncheckedCreateWithoutTransactionsInputSchema).array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					z.lazy(() => documentsCreateOrConnectWithoutTransactionsInputSchema),
					z.lazy(() => documentsCreateOrConnectWithoutTransactionsInputSchema).array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(() => documentsUpsertWithWhereUniqueWithoutTransactionsInputSchema),
					z.lazy(() => documentsUpsertWithWhereUniqueWithoutTransactionsInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => documentsUpdateWithWhereUniqueWithoutTransactionsInputSchema),
					z.lazy(() => documentsUpdateWithWhereUniqueWithoutTransactionsInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => documentsUpdateManyWithWhereWithoutTransactionsInputSchema),
					z.lazy(() => documentsUpdateManyWithWhereWithoutTransactionsInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default documentsUpdateManyWithoutTransactionsNestedInputSchema;
