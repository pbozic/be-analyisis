...
export const promo_sections_buyMinOrderByAggregateInputSchema: z.ZodType<Prisma.promo_sections_buyMinOrderByAggregateInput> = z.object({
...
export default promo_sections_buyMinOrderByAggregateInputSchema;
