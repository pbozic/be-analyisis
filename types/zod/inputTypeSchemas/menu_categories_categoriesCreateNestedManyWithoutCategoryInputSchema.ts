...
export const menu_categories_categoriesCreateNestedManyWithoutCategoryInputSchema: z.ZodType<Prisma.menu_categories_categoriesCreateNestedManyWithoutCategoryInput> =
	z
		.object({
			create: z
				.union([
