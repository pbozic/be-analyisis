...
export const delivery_driversUncheckedUpdateWithoutDaily_meal_businessInputSchema: z.ZodType<Prisma.delivery_driversUncheckedUpdateWithoutDaily_meal_businessInput> =
	z
		.object({
			...
			received_orders: z
				.lazy(() => delivery_order_sentUncheckedUpdateManyWithoutDelivery_driverNestedInputSchema)
				.optional(),
			...
			delivery_driver_history_locations: z
				.lazy(() => delivery_driver_history_locationsUncheckedUpdateManyWithoutDelivery_driverNestedInputSchema)
				.optional(),
		})
		.strict();

export default delivery_driversUncheckedUpdateWithoutDaily_meal_businessInputSchema;
