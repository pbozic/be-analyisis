...
export const wallet_fundsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.wallet_fundsScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => wallet_fundsScalarWhereWithAggregatesInputSchema),
					z.lazy(() => wallet_fundsScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => wallet_fundsScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
			...
			expires_at: z
				...
				.nullable(),
			type: z
				.union([z.lazy(() => EnumFUNDS_TYPEWithAggregatesFilterSchema), z.lazy(() => FUNDS_TYPESchema)])
				.optional(),
			status: z
				.union([
					z.lazy(() => EnumCREDIT_STATUSNullableWithAggregatesFilterSchema),
