...
export const documentsUpdateManyWithWhereWithoutDelivery_driverInputSchema: z.ZodType<Prisma.documentsUpdateManyWithWhereWithoutDelivery_driverInput> =
	z
		.object({
			where: z.lazy(() => documentsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => documentsUpdateManyMutationInputSchema),
				z.lazy(() => documentsUncheckedUpdateManyWithoutDelivery_driverInputSchema),
			]),
		})
		.strict();
