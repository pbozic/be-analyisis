...
export const menusUpsertWithoutDaily_meal_subscribersInputSchema: z.ZodType<Prisma.menusUpsertWithoutDaily_meal_subscribersInput> = z.object({
  update: z.union([ z.lazy(() => menusUpdateWithoutDaily_meal_subscribersInputSchema),z.lazy(() => menusUncheckedUpdateWithoutDaily_meal_subscribersInputSchema) ]),
  create: z.union([ z.lazy(() => menusCreateWithoutDaily_meal_subscribersInputSchema),z.lazy(() => menusUncheckedCreateWithoutDaily_meal_subscribersInputSchema) ]),
