...
export const addressesUpsertWithoutBusiness_usersInputSchema: z.ZodType<Prisma.addressesUpsertWithoutBusiness_usersInput> = z.object({
  update: z.union([ z.lazy(() => addressesUpdateWithoutBusiness_usersInputSchema),z.lazy(() => addressesUncheckedUpdateWithoutBusiness_usersInputSchema) ]),
  create: z.union([ z.lazy(() => addressesCreateWithoutBusiness_usersInputSchema),z.lazy(() => addressesUncheckedCreateWithoutBusiness_usersInputSchema) ]),
