...
export const late_eventsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.late_eventsScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => late_eventsScalarWhereWithAggregatesInputSchema),
					z.lazy(() => late_eventsScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => late_eventsScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
