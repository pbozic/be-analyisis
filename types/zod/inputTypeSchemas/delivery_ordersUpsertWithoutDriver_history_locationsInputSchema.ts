...
export const delivery_ordersUpsertWithoutDriver_history_locationsInputSchema: z.ZodType<Prisma.delivery_ordersUpsertWithoutDriver_history_locationsInput> = z.object({
  update: z.union([ z.lazy(() => delivery_ordersUpdateWithoutDriver_history_locationsInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutDriver_history_locationsInputSchema) ]),
