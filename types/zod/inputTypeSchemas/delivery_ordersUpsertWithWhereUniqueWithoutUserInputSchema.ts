...
export const delivery_ordersUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.delivery_ordersUpsertWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => delivery_ordersWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => delivery_ordersUpdateWithoutUserInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutUserInputSchema) ]),
  create: z.union([ z.lazy(() => delivery_ordersCreateWithoutUserInputSchema),z.lazy(() => delivery_ordersUncheckedCreateWithoutUserInputSchema) ]),
}).strict();
