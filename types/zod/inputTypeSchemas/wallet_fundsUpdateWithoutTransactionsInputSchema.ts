...
export const wallet_fundsUpdateWithoutTransactionsInputSchema: z.ZodType<Prisma.wallet_fundsUpdateWithoutTransactionsInput> = z.object({
...
export default wallet_fundsUpdateWithoutTransactionsInputSchema;
