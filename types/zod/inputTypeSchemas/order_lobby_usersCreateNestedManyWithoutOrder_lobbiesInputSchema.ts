...
export const order_lobby_usersCreateNestedManyWithoutOrder_lobbiesInputSchema: z.ZodType<Prisma.order_lobby_usersCreateNestedManyWithoutOrder_lobbiesInput> =
	z
		.object({
			create: z
				.union([
