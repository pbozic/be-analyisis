...
export const promo_sectionsUncheckedUpdateWithoutTranslatableInputSchema: z.ZodType<Prisma.promo_sectionsUncheckedUpdateWithoutTranslatableInput> =
	z
		.object({
			promo_sections_id: z
			...
			display_cards_per_page: z
				...
				.nullable(),
			promo_section_buy: z
				.lazy(() => promo_sections_buyUncheckedUpdateManyWithoutPromo_sectionNestedInputSchema)
				.optional(),
		})
		.strict();
