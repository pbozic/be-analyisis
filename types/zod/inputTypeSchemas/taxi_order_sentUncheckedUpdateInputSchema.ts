...
export const taxi_order_sentUncheckedUpdateInputSchema: z.ZodType<Prisma.taxi_order_sentUncheckedUpdateInput> = z.object({
...
export default taxi_order_sentUncheckedUpdateInputSchema;
