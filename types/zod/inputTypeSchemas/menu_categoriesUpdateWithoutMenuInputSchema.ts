...
import { menu_itemsUpdateManyWithoutMenu_categoryNestedInputSchema } from './menu_itemsUpdateManyWithoutMenu_categoryNestedInputSchema';
...
export const menu_categoriesUpdateWithoutMenuInputSchema: z.ZodType<Prisma.menu_categoriesUpdateWithoutMenuInput> = z
	.object({
		...
		menu_order_index: z
			...
			.optional()
			.nullable(),
		menu_items: z.lazy(() => menu_itemsUpdateManyWithoutMenu_categoryNestedInputSchema).optional(),
		menu_categories_categories: z
			.lazy(() => menu_categories_categoriesUpdateManyWithoutMenu_categoryNestedInputSchema)
			.optional(),
		daily_meal_subscribers: z
			.lazy(() => daily_meals_subscriptionsUpdateManyWithoutMenu_categoryNestedInputSchema)
			.optional(),
	})
	.strict();

export default menu_categoriesUpdateWithoutMenuInputSchema;
