...
export const businessUpdateManyWithoutFiscal_deviceNestedInputSchema: z.ZodType<Prisma.businessUpdateManyWithoutFiscal_deviceNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => businessUpsertWithWhereUniqueWithoutFiscal_deviceInputSchema),z.lazy(() => businessUpsertWithWhereUniqueWithoutFiscal_deviceInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => businessUpdateWithWhereUniqueWithoutFiscal_deviceInputSchema),z.lazy(() => businessUpdateWithWhereUniqueWithoutFiscal_deviceInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => businessUpdateManyWithWhereWithoutFiscal_deviceInputSchema),z.lazy(() => businessUpdateManyWithWhereWithoutFiscal_deviceInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => businessScalarWhereInputSchema),z.lazy(() => businessScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default businessUpdateManyWithoutFiscal_deviceNestedInputSchema;
