...
import { delivery_ordersCreateNestedManyWithoutDriverInputSchema } from './delivery_ordersCreateNestedManyWithoutDriverInputSchema';
...
export const driversCreateWithoutCurrent_vehicleInputSchema: z.ZodType<Prisma.driversCreateWithoutCurrent_vehicleInput> = z.object({
  ...
  delivery_orders: z.lazy(() => delivery_ordersCreateNestedManyWithoutDriverInputSchema).optional(),
  received_delivery_orders: z.lazy(() => delivery_order_sentCreateNestedManyWithoutDriverInputSchema).optional(),
  documents: z.lazy(() => documentsCreateNestedManyWithoutDriversInputSchema).optional(),
  driver_history_locations: z.lazy(() => driver_history_locationsCreateNestedManyWithoutDriverInputSchema).optional(),
  driver_municipalities: z.lazy(() => driver_municipalitiesCreateNestedManyWithoutDriversInputSchema).optional(),
  activity_logs: z.lazy(() => driver_activity_logsCreateNestedManyWithoutDriverInputSchema).optional()
}).strict();

export default driversCreateWithoutCurrent_vehicleInputSchema;
