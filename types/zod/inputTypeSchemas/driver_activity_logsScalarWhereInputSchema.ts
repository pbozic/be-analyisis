...
export const driver_activity_logsScalarWhereInputSchema: z.ZodType<Prisma.driver_activity_logsScalarWhereInput> = z
	.object({
		AND: z
			.union([
			...
			.optional(),
		OR: z
			.lazy(() => driver_activity_logsScalarWhereInputSchema)
			.array()
			.optional(),
		NOT: z
			.union([
