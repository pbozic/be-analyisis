...
export const reviewsUncheckedUpdateManyWithoutAuthorNestedInputSchema: z.ZodType<Prisma.reviewsUncheckedUpdateManyWithoutAuthorNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => reviewsUpsertWithWhereUniqueWithoutAuthorInputSchema),
					z.lazy(() => reviewsUpsertWithWhereUniqueWithoutAuthorInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => reviewsUpdateWithWhereUniqueWithoutAuthorInputSchema),
					z.lazy(() => reviewsUpdateWithWhereUniqueWithoutAuthorInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => reviewsUpdateManyWithWhereWithoutAuthorInputSchema),
					z.lazy(() => reviewsUpdateManyWithWhereWithoutAuthorInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default reviewsUncheckedUpdateManyWithoutAuthorNestedInputSchema;
