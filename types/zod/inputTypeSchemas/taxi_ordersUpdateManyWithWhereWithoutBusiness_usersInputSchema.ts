...
export const taxi_ordersUpdateManyWithWhereWithoutBusiness_usersInputSchema: z.ZodType<Prisma.taxi_ordersUpdateManyWithWhereWithoutBusiness_usersInput> = z.object({
  where: z.lazy(() => taxi_ordersScalarWhereInputSchema),
  data: z.union([ z.lazy(() => taxi_ordersUpdateManyMutationInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateManyWithoutBusiness_usersInputSchema) ]),
}).strict();
