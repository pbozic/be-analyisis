...
export const delivery_ordersCreateOrConnectWithoutDriver_history_locationsInputSchema: z.ZodType<Prisma.delivery_ordersCreateOrConnectWithoutDriver_history_locationsInput> =
	z
		.object({
