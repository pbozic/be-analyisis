...
export const late_eventsUpdateManyWithWhereWithoutBusinessesInputSchema: z.ZodType<Prisma.late_eventsUpdateManyWithWhereWithoutBusinessesInput> =
	z
		.object({
			where: z.lazy(() => late_eventsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => late_eventsUpdateManyMutationInputSchema),
				z.lazy(() => late_eventsUncheckedUpdateManyWithoutBusinessesInputSchema),
			]),
		})
		.strict();
