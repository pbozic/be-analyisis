...
export const driver_municipalitiesCreateNestedManyWithoutMunicipalitiesInputSchema: z.ZodType<Prisma.driver_municipalitiesCreateNestedManyWithoutMunicipalitiesInput> =
	z
		.object({
			create: z
				.union([
