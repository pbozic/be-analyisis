...
export const menu_itemsOrderByWithAggregationInputSchema: z.ZodType<Prisma.menu_itemsOrderByWithAggregationInput> = z.object({
  ...
  menu_category_order_index: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
