...
export const group_usersUpdateOneWithoutChild_userNestedInputSchema: z.ZodType<Prisma.group_usersUpdateOneWithoutChild_userNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => group_usersUpdateToOneWithWhereWithoutChild_userInputSchema),z.lazy(() => group_usersUpdateWithoutChild_userInputSchema),z.lazy(() => group_usersUncheckedUpdateWithoutChild_userInputSchema) ]).optional(),
}).strict();

export default group_usersUpdateOneWithoutChild_userNestedInputSchema;
