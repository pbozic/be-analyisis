...
export const usersUpdateOneRequiredWithoutReviewsNestedInputSchema: z.ZodType<Prisma.usersUpdateOneRequiredWithoutReviewsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => usersUpdateToOneWithWhereWithoutReviewsInputSchema),
