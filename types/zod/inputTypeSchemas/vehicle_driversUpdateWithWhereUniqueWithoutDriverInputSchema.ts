...
export const vehicle_driversUpdateWithWhereUniqueWithoutDriverInputSchema: z.ZodType<Prisma.vehicle_driversUpdateWithWhereUniqueWithoutDriverInput> =
	z
		.object({
			where: z.lazy(() => vehicle_driversWhereUniqueInputSchema),
			data: z.union([
				z.lazy(() => vehicle_driversUpdateWithoutDriverInputSchema),
				z.lazy(() => vehicle_driversUncheckedUpdateWithoutDriverInputSchema),
			]),
		})
		.strict();
