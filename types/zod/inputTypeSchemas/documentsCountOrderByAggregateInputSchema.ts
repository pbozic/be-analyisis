...
export const documentsCountOrderByAggregateInputSchema: z.ZodType<Prisma.documentsCountOrderByAggregateInput> = z
	.object({
		...
		additional_info: z.lazy(() => SortOrderSchema).optional(),
...
export default documentsCountOrderByAggregateInputSchema;
