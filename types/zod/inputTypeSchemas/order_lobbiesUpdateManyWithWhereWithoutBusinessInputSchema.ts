...
export const order_lobbiesUpdateManyWithWhereWithoutBusinessInputSchema: z.ZodType<Prisma.order_lobbiesUpdateManyWithWhereWithoutBusinessInput> =
	z
		.object({
			where: z.lazy(() => order_lobbiesScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => order_lobbiesUpdateManyMutationInputSchema),
				z.lazy(() => order_lobbiesUncheckedUpdateManyWithoutBusinessInputSchema),
			]),
		})
		.strict();
