...
export const wallet_fundsUncheckedCreateInputSchema: z.ZodType<Prisma.wallet_fundsUncheckedCreateInput> = z.object({
...
export default wallet_fundsUncheckedCreateInputSchema;
