...
export const reservationsMaxOrderByAggregateInputSchema: z.ZodType<Prisma.reservationsMaxOrderByAggregateInput> = z
	.object({
...
export default reservationsMaxOrderByAggregateInputSchema;
