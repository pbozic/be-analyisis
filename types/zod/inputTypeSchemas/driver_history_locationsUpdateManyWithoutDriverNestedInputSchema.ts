...
export const driver_history_locationsUpdateManyWithoutDriverNestedInputSchema: z.ZodType<Prisma.driver_history_locationsUpdateManyWithoutDriverNestedInput> =
	z
		.object({
			create: z
				.union([
