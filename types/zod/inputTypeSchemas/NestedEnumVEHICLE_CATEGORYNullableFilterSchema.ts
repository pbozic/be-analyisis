...
export const NestedEnumVEHICLE_CATEGORYNullableFilterSchema: z.ZodType<Prisma.NestedEnumVEHICLE_CATEGORYNullableFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => VEHICLE_CATEGORYSchema),z.lazy(() => NestedEnumVEHICLE_CATEGORYNullableFilterSchema) ]).optional().nullable(),
}).strict();
