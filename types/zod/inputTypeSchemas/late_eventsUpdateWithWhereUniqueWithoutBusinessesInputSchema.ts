...
export const late_eventsUpdateWithWhereUniqueWithoutBusinessesInputSchema: z.ZodType<Prisma.late_eventsUpdateWithWhereUniqueWithoutBusinessesInput> = z.object({
  where: z.lazy(() => late_eventsWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => late_eventsUpdateWithoutBusinessesInputSchema),z.lazy(() => late_eventsUncheckedUpdateWithoutBusinessesInputSchema) ]),
}).strict();
