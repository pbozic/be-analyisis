...
export const business_clientsScalarWhereInputSchema: z.ZodType<Prisma.business_clientsScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => business_clientsScalarWhereInputSchema),z.lazy(() => business_clientsScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => business_clientsScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => business_clientsScalarWhereInputSchema),z.lazy(() => business_clientsScalarWhereInputSchema).array() ]).optional(),
