...
export const delivery_ordersUpdateOneWithoutTransactionsNestedInputSchema: z.ZodType<Prisma.delivery_ordersUpdateOneWithoutTransactionsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => delivery_ordersUpdateToOneWithWhereWithoutTransactionsInputSchema),z.lazy(() => delivery_ordersUpdateWithoutTransactionsInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutTransactionsInputSchema) ]).optional(),
}).strict();
