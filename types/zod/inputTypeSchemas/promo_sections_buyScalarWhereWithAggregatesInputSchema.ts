...
export const promo_sections_buyScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.promo_sections_buyScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => promo_sections_buyScalarWhereWithAggregatesInputSchema),
					z.lazy(() => promo_sections_buyScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => promo_sections_buyScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
