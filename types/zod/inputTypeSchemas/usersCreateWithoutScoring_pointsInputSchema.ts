...
export const usersCreateWithoutScoring_pointsInputSchema: z.ZodType<Prisma.usersCreateWithoutScoring_pointsInput> = z
	.object({
...
export default usersCreateWithoutScoring_pointsInputSchema;
