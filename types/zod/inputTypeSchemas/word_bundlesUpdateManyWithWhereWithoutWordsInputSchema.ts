...
export const word_bundlesUpdateManyWithWhereWithoutWordsInputSchema: z.ZodType<Prisma.word_bundlesUpdateManyWithWhereWithoutWordsInput> =
	z
		.object({
			where: z.lazy(() => word_bundlesScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => word_bundlesUpdateManyMutationInputSchema),
				z.lazy(() => word_bundlesUncheckedUpdateManyWithoutWordsInputSchema),
			]),
		})
		.strict();
