...
export const promo_sectionsAvgOrderByAggregateInputSchema: z.ZodType<Prisma.promo_sectionsAvgOrderByAggregateInput> = z.object({
...
export default promo_sectionsAvgOrderByAggregateInputSchema;
