...
import { financesCreateNestedOneWithoutBusinessInputSchema } from './financesCreateNestedOneWithoutBusinessInputSchema';
...
export const businessCreateWithoutWord_buy_stripe_productInputSchema: z.ZodType<Prisma.businessCreateWithoutWord_buy_stripe_productInput> =
	z
		.object({
			...
			delivery_address: z
				.lazy(() => addressesCreateNestedOneWithoutBusinesses_delivery_addressInputSchema)
				.optional(),
			finances: z.lazy(() => financesCreateNestedOneWithoutBusinessInputSchema).optional(),
			...
			user_favorite_businesses: z
				.lazy(() => user_favorite_businessesCreateNestedManyWithoutBusinessesInputSchema)
				.optional(),
			scoring_points: z.lazy(() => scoring_pointsCreateNestedManyWithoutBusinessesInputSchema).optional(),
			daily_meal_drivers: z
				.lazy(() => delivery_driversCreateNestedManyWithoutDaily_meal_businessInputSchema)
				.optional(),
			...
			daily_meals_subscribers: z
				.lazy(() => daily_meals_subscriptionsCreateNestedManyWithoutBusinessInputSchema)
				.optional(),
...
export default businessCreateWithoutWord_buy_stripe_productInputSchema;
