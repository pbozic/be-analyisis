...
export const vehiclesUpdateWithWhereUniqueWithoutDelivery_driverInputSchema: z.ZodType<Prisma.vehiclesUpdateWithWhereUniqueWithoutDelivery_driverInput> = z.object({
  where: z.lazy(() => vehiclesWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => vehiclesUpdateWithoutDelivery_driverInputSchema),z.lazy(() => vehiclesUncheckedUpdateWithoutDelivery_driverInputSchema) ]),
}).strict();
