...
export const delivery_ordersUncheckedUpdateManyWithoutDriverNestedInputSchema: z.ZodType<Prisma.delivery_ordersUncheckedUpdateManyWithoutDriverNestedInput> =
	z
		.object({
			create: z
				.union([
