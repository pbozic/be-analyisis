...
export const delivery_driver_history_locationsUncheckedCreateInputSchema: z.ZodType<Prisma.delivery_driver_history_locationsUncheckedCreateInput> = z.object({
...
export default delivery_driver_history_locationsUncheckedCreateInputSchema;
