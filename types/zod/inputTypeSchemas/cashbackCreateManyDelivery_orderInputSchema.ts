...
export const cashbackCreateManyDelivery_orderInputSchema: z.ZodType<Prisma.cashbackCreateManyDelivery_orderInput> = z.object({
...
export default cashbackCreateManyDelivery_orderInputSchema;
