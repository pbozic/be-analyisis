...
export const businessUncheckedCreateWithoutWord_buy_stripe_productInputSchema: z.ZodType<Prisma.businessUncheckedCreateWithoutWord_buy_stripe_productInput> =
	z
		.object({
