...
export const taxi_ordersUpdateOneWithoutCashbackNestedInputSchema: z.ZodType<Prisma.taxi_ordersUpdateOneWithoutCashbackNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => taxi_ordersUpdateToOneWithWhereWithoutCashbackInputSchema),z.lazy(() => taxi_ordersUpdateWithoutCashbackInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateWithoutCashbackInputSchema) ]).optional(),
}).strict();
