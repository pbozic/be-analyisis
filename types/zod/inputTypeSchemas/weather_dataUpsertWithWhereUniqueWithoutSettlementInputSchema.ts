...
export const weather_dataUpsertWithWhereUniqueWithoutSettlementInputSchema: z.ZodType<Prisma.weather_dataUpsertWithWhereUniqueWithoutSettlementInput> = z.object({
  where: z.lazy(() => weather_dataWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => weather_dataUpdateWithoutSettlementInputSchema),z.lazy(() => weather_dataUncheckedUpdateWithoutSettlementInputSchema) ]),
