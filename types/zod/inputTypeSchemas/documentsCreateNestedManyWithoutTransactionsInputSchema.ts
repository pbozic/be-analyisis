...
export const documentsCreateNestedManyWithoutTransactionsInputSchema: z.ZodType<Prisma.documentsCreateNestedManyWithoutTransactionsInput> =
	z
		.object({
			create: z
				.union([
...
export default documentsCreateNestedManyWithoutTransactionsInputSchema;
