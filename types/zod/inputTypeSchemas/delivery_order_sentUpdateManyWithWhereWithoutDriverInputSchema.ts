...
export const delivery_order_sentUpdateManyWithWhereWithoutDriverInputSchema: z.ZodType<Prisma.delivery_order_sentUpdateManyWithWhereWithoutDriverInput> =
	z
		.object({
			where: z.lazy(() => delivery_order_sentScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => delivery_order_sentUpdateManyMutationInputSchema),
				z.lazy(() => delivery_order_sentUncheckedUpdateManyWithoutDriverInputSchema),
			]),
		})
		.strict();
