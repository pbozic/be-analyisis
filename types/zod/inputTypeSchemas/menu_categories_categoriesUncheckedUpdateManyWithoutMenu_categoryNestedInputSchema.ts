...
export const menu_categories_categoriesUncheckedUpdateManyWithoutMenu_categoryNestedInputSchema: z.ZodType<Prisma.menu_categories_categoriesUncheckedUpdateManyWithoutMenu_categoryNestedInput> =
	z
		.object({
			create: z
				.union([
