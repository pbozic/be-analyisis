...
export const late_eventsWhereInputSchema: z.ZodType<Prisma.late_eventsWhereInput> = z.object({
  AND: z.union([ z.lazy(() => late_eventsWhereInputSchema),z.lazy(() => late_eventsWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => late_eventsWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => late_eventsWhereInputSchema),z.lazy(() => late_eventsWhereInputSchema).array() ]).optional(),
  ...
  scoring_points: z.union([ z.lazy(() => Scoring_pointsNullableRelationFilterSchema),z.lazy(() => scoring_pointsWhereInputSchema) ]).optional().nullable(),
}).strict();

export default late_eventsWhereInputSchema;
