...
export const late_eventsWhereInputSchema: z.ZodType<Prisma.late_eventsWhereInput> = z
	.object({
		AND: z
			.union([z.lazy(() => late_eventsWhereInputSchema), z.lazy(() => late_eventsWhereInputSchema).array()])
			.optional(),
		OR: z
