...
export const NestedEnumDELIVERY_ORDER_STATUSFilterSchema: z.ZodType<Prisma.NestedEnumDELIVERY_ORDER_STATUSFilter> = z
	.object({
		...
		not: z
			.union([
				...
				z.lazy(() => NestedEnumDELIVERY_ORDER_STATUSFilterSchema),
			])
			.optional(),
	})
	.strict();
