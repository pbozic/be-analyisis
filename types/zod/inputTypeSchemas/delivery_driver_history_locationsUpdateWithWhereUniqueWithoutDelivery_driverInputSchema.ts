...
export const delivery_driver_history_locationsUpdateWithWhereUniqueWithoutDelivery_driverInputSchema: z.ZodType<Prisma.delivery_driver_history_locationsUpdateWithWhereUniqueWithoutDelivery_driverInput> =
	z
		.object({
			where: z.lazy(() => delivery_driver_history_locationsWhereUniqueInputSchema),
			data: z.union([
				z.lazy(() => delivery_driver_history_locationsUpdateWithoutDelivery_driverInputSchema),
				z.lazy(() => delivery_driver_history_locationsUncheckedUpdateWithoutDelivery_driverInputSchema),
			]),
		})
		.strict();
