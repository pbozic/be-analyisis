...
export const account_actionsUncheckedUpdateManyWithoutAction_creatorNestedInputSchema: z.ZodType<Prisma.account_actionsUncheckedUpdateManyWithoutAction_creatorNestedInput> =
	z
		.object({
			create: z
				.union([
