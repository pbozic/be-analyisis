...
export const businessUncheckedCreateWithoutDaily_meals_subscribersInputSchema: z.ZodType<Prisma.businessUncheckedCreateWithoutDaily_meals_subscribersInput> =
	z
		.object({
