...
export const delivery_order_sentCreateWithoutDriverInputSchema: z.ZodType<Prisma.delivery_order_sentCreateWithoutDriverInput> = z.object({
...
export default delivery_order_sentCreateWithoutDriverInputSchema;
