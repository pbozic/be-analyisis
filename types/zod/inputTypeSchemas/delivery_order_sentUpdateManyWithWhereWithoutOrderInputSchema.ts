...
export const delivery_order_sentUpdateManyWithWhereWithoutOrderInputSchema: z.ZodType<Prisma.delivery_order_sentUpdateManyWithWhereWithoutOrderInput> =
	z
		.object({
			where: z.lazy(() => delivery_order_sentScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => delivery_order_sentUpdateManyMutationInputSchema),
				z.lazy(() => delivery_order_sentUncheckedUpdateManyWithoutOrderInputSchema),
			]),
		})
		.strict();
