...
export const usersUpdateOneWithoutDelivery_driverNestedInputSchema: z.ZodType<Prisma.usersUpdateOneWithoutDelivery_driverNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => usersUpdateToOneWithWhereWithoutDelivery_driverInputSchema),
