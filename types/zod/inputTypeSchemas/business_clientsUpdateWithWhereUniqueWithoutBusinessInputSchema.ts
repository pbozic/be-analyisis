...
export const business_clientsUpdateWithWhereUniqueWithoutBusinessInputSchema: z.ZodType<Prisma.business_clientsUpdateWithWhereUniqueWithoutBusinessInput> = z.object({
  where: z.lazy(() => business_clientsWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => business_clientsUpdateWithoutBusinessInputSchema),z.lazy(() => business_clientsUncheckedUpdateWithoutBusinessInputSchema) ]),
}).strict();
