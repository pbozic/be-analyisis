...
export const documentsUpdateWithWhereUniqueWithoutMenu_itemsInputSchema: z.ZodType<Prisma.documentsUpdateWithWhereUniqueWithoutMenu_itemsInput> = z.object({
  where: z.lazy(() => documentsWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => documentsUpdateWithoutMenu_itemsInputSchema),z.lazy(() => documentsUncheckedUpdateWithoutMenu_itemsInputSchema) ]),
}).strict();
