...
export const categoriesUncheckedUpdateInputSchema: z.ZodType<Prisma.categoriesUncheckedUpdateInput> = z
	.object({
...
export default categoriesUncheckedUpdateInputSchema;
