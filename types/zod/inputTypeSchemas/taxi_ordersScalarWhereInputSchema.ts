...
export const taxi_ordersScalarWhereInputSchema: z.ZodType<Prisma.taxi_ordersScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => taxi_ordersScalarWhereInputSchema),z.lazy(() => taxi_ordersScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => taxi_ordersScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => taxi_ordersScalarWhereInputSchema),z.lazy(() => taxi_ordersScalarWhereInputSchema).array() ]).optional(),
