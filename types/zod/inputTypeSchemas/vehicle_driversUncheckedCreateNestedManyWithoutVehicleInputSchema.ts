...
export const vehicle_driversUncheckedCreateNestedManyWithoutVehicleInputSchema: z.ZodType<Prisma.vehicle_driversUncheckedCreateNestedManyWithoutVehicleInput> =
	z
		.object({
			create: z
				.union([
