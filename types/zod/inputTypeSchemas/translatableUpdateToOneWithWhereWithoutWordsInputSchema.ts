...
export const translatableUpdateToOneWithWhereWithoutWordsInputSchema: z.ZodType<Prisma.translatableUpdateToOneWithWhereWithoutWordsInput> = z.object({
  where: z.lazy(() => translatableWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => translatableUpdateWithoutWordsInputSchema),z.lazy(() => translatableUncheckedUpdateWithoutWordsInputSchema) ]),
}).strict();
