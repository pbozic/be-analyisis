...
export const group_usersUncheckedUpdateManyWithoutParent_userNestedInputSchema: z.ZodType<Prisma.group_usersUncheckedUpdateManyWithoutParent_userNestedInput> =
	z
		.object({
			create: z
				.union([
