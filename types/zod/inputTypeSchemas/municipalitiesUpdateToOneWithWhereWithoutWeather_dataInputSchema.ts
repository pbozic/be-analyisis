...
export const municipalitiesUpdateToOneWithWhereWithoutWeather_dataInputSchema: z.ZodType<Prisma.municipalitiesUpdateToOneWithWhereWithoutWeather_dataInput> =
	z
		.object({
