...
export const word_buyUpdateManyWithWhereWithoutBusinessInputSchema: z.ZodType<Prisma.word_buyUpdateManyWithWhereWithoutBusinessInput> =
	z
		.object({
			where: z.lazy(() => word_buyScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => word_buyUpdateManyMutationInputSchema),
				z.lazy(() => word_buyUncheckedUpdateManyWithoutBusinessInputSchema),
			]),
		})
		.strict();
