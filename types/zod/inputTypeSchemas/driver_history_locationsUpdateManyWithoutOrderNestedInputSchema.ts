...
export const driver_history_locationsUpdateManyWithoutOrderNestedInputSchema: z.ZodType<Prisma.driver_history_locationsUpdateManyWithoutOrderNestedInput> = z.object({
  create: z.union([ z.lazy(() => driver_history_locationsCreateWithoutOrderInputSchema),z.lazy(() => driver_history_locationsCreateWithoutOrderInputSchema).array(),z.lazy(() => driver_history_locationsUncheckedCreateWithoutOrderInputSchema),z.lazy(() => driver_history_locationsUncheckedCreateWithoutOrderInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => driver_history_locationsCreateOrConnectWithoutOrderInputSchema),z.lazy(() => driver_history_locationsCreateOrConnectWithoutOrderInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => driver_history_locationsUpsertWithWhereUniqueWithoutOrderInputSchema),z.lazy(() => driver_history_locationsUpsertWithWhereUniqueWithoutOrderInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => driver_history_locationsUpdateWithWhereUniqueWithoutOrderInputSchema),z.lazy(() => driver_history_locationsUpdateWithWhereUniqueWithoutOrderInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => driver_history_locationsUpdateManyWithWhereWithoutOrderInputSchema),z.lazy(() => driver_history_locationsUpdateManyWithWhereWithoutOrderInputSchema).array() ]).optional(),
...
export default driver_history_locationsUpdateManyWithoutOrderNestedInputSchema;
