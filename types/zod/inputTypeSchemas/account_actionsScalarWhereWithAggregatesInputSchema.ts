...
export const account_actionsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.account_actionsScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => account_actionsScalarWhereWithAggregatesInputSchema),z.lazy(() => account_actionsScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => account_actionsScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => account_actionsScalarWhereWithAggregatesInputSchema),z.lazy(() => account_actionsScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  ...
  reason: z.union([ z.lazy(() => EnumACCOUNT_ACTIONS_REASONWithAggregatesFilterSchema),z.lazy(() => ACCOUNT_ACTIONS_REASONSchema) ]).optional(),
  action: z.union([ z.lazy(() => EnumACCOUNT_ACTIONSWithAggregatesFilterSchema),z.lazy(() => ACCOUNT_ACTIONSSchema) ]).optional(),
}).strict();
