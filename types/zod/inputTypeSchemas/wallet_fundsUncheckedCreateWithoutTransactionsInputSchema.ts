...
export const wallet_fundsUncheckedCreateWithoutTransactionsInputSchema: z.ZodType<Prisma.wallet_fundsUncheckedCreateWithoutTransactionsInput> = z.object({
...
export default wallet_fundsUncheckedCreateWithoutTransactionsInputSchema;
