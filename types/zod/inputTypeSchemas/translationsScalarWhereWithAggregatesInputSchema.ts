...
export const translationsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.translationsScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => translationsScalarWhereWithAggregatesInputSchema),
					z.lazy(() => translationsScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => translationsScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
