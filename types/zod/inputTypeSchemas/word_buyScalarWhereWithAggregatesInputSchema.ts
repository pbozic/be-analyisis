...
export const word_buyScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.word_buyScalarWhereWithAggregatesInput> = z
	.object({
		AND: z
			.union([
				z.lazy(() => word_buyScalarWhereWithAggregatesInputSchema),
				z.lazy(() => word_buyScalarWhereWithAggregatesInputSchema).array(),
			])
			.optional(),
		OR: z
			.lazy(() => word_buyScalarWhereWithAggregatesInputSchema)
			.array()
			.optional(),
		NOT: z
			.union([
