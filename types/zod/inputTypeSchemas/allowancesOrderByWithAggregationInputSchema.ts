...
export const allowancesOrderByWithAggregationInputSchema: z.ZodType<Prisma.allowancesOrderByWithAggregationInput> = z.object({
  ...
  amount_taxi_purchase_order: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  amount_transfer_purchase_order: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  amount_delivery_purchase_order: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  amount_any_purchase_order: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
