...
export const delivery_driversUpdateOneWithoutUserNestedInputSchema: z.ZodType<Prisma.delivery_driversUpdateOneWithoutUserNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => delivery_driversUpdateToOneWithWhereWithoutUserInputSchema),
...
export default delivery_driversUpdateOneWithoutUserNestedInputSchema;
