...
export const daily_meals_subscriptionsUpdateManyWithoutBusinessNestedInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpdateManyWithoutBusinessNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => daily_meals_subscriptionsUpsertWithWhereUniqueWithoutBusinessInputSchema),
					z.lazy(() => daily_meals_subscriptionsUpsertWithWhereUniqueWithoutBusinessInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => daily_meals_subscriptionsUpdateWithWhereUniqueWithoutBusinessInputSchema),
					z.lazy(() => daily_meals_subscriptionsUpdateWithWhereUniqueWithoutBusinessInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => daily_meals_subscriptionsUpdateManyWithWhereWithoutBusinessInputSchema),
					z.lazy(() => daily_meals_subscriptionsUpdateManyWithWhereWithoutBusinessInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default daily_meals_subscriptionsUpdateManyWithoutBusinessNestedInputSchema;
