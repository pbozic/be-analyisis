...
export const delivery_driversUpdateManyWithWhereWithoutDaily_meal_businessInputSchema: z.ZodType<Prisma.delivery_driversUpdateManyWithWhereWithoutDaily_meal_businessInput> =
	z
		.object({
			where: z.lazy(() => delivery_driversScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => delivery_driversUpdateManyMutationInputSchema),
				z.lazy(() => delivery_driversUncheckedUpdateManyWithoutDaily_meal_businessInputSchema),
			]),
		})
		.strict();
