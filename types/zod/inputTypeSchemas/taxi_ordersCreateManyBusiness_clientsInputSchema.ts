...
export const taxi_ordersCreateManyBusiness_clientsInputSchema: z.ZodType<Prisma.taxi_ordersCreateManyBusiness_clientsInput> = z.object({
...
export default taxi_ordersCreateManyBusiness_clientsInputSchema;
