...
export const delivery_driver_history_locationsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.delivery_driver_history_locationsScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => delivery_driver_history_locationsScalarWhereWithAggregatesInputSchema),
					z.lazy(() => delivery_driver_history_locationsScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => delivery_driver_history_locationsScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
			...
			status: z
				.union([
					z.lazy(() => EnumDELIVERY_ORDER_STATUSNullableWithAggregatesFilterSchema),
