...
export const taxi_ordersUpdateWithWhereUniqueWithoutParent_orderInputSchema: z.ZodType<Prisma.taxi_ordersUpdateWithWhereUniqueWithoutParent_orderInput> = z.object({
  where: z.lazy(() => taxi_ordersWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => taxi_ordersUpdateWithoutParent_orderInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateWithoutParent_orderInputSchema) ]),
}).strict();
