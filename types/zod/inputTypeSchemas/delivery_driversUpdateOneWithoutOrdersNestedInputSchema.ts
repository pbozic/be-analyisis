...
export const delivery_driversUpdateOneWithoutOrdersNestedInputSchema: z.ZodType<Prisma.delivery_driversUpdateOneWithoutOrdersNestedInput> = z.object({
  create: z.union([ z.lazy(() => delivery_driversCreateWithoutOrdersInputSchema),z.lazy(() => delivery_driversUncheckedCreateWithoutOrdersInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => delivery_driversUpdateToOneWithWhereWithoutOrdersInputSchema),z.lazy(() => delivery_driversUpdateWithoutOrdersInputSchema),z.lazy(() => delivery_driversUncheckedUpdateWithoutOrdersInputSchema) ]).optional(),
}).strict();
