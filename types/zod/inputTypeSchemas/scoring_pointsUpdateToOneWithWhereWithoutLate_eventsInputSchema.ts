...
export const scoring_pointsUpdateToOneWithWhereWithoutLate_eventsInputSchema: z.ZodType<Prisma.scoring_pointsUpdateToOneWithWhereWithoutLate_eventsInput> = z.object({
  where: z.lazy(() => scoring_pointsWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => scoring_pointsUpdateWithoutLate_eventsInputSchema),z.lazy(() => scoring_pointsUncheckedUpdateWithoutLate_eventsInputSchema) ]),
}).strict();
