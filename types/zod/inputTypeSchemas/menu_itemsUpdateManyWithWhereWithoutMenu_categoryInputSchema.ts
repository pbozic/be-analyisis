...
export const menu_itemsUpdateManyWithWhereWithoutMenu_categoryInputSchema: z.ZodType<Prisma.menu_itemsUpdateManyWithWhereWithoutMenu_categoryInput> =
	z
		.object({
			where: z.lazy(() => menu_itemsScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => menu_itemsUpdateManyMutationInputSchema),
				z.lazy(() => menu_itemsUncheckedUpdateManyWithoutMenu_categoryInputSchema),
			]),
		})
		.strict();
