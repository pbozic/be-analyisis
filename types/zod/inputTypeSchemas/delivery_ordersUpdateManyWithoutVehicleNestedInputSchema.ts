...
export const delivery_ordersUpdateManyWithoutVehicleNestedInputSchema: z.ZodType<Prisma.delivery_ordersUpdateManyWithoutVehicleNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => delivery_ordersUpsertWithWhereUniqueWithoutVehicleInputSchema),z.lazy(() => delivery_ordersUpsertWithWhereUniqueWithoutVehicleInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => delivery_ordersUpdateWithWhereUniqueWithoutVehicleInputSchema),z.lazy(() => delivery_ordersUpdateWithWhereUniqueWithoutVehicleInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => delivery_ordersUpdateManyWithWhereWithoutVehicleInputSchema),z.lazy(() => delivery_ordersUpdateManyWithWhereWithoutVehicleInputSchema).array() ]).optional(),
...
export default delivery_ordersUpdateManyWithoutVehicleNestedInputSchema;
