...
export const delivery_driversScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.delivery_driversScalarWhereWithAggregatesInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => delivery_driversScalarWhereWithAggregatesInputSchema),
					z.lazy(() => delivery_driversScalarWhereWithAggregatesInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => delivery_driversScalarWhereWithAggregatesInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
