...
export const vehiclesUpdateOneWithoutDocumentsNestedInputSchema: z.ZodType<Prisma.vehiclesUpdateOneWithoutDocumentsNestedInput> = z.object({
  create: z.union([ z.lazy(() => vehiclesCreateWithoutDocumentsInputSchema),z.lazy(() => vehiclesUncheckedCreateWithoutDocumentsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => vehiclesUpdateToOneWithWhereWithoutDocumentsInputSchema),z.lazy(() => vehiclesUpdateWithoutDocumentsInputSchema),z.lazy(() => vehiclesUncheckedUpdateWithoutDocumentsInputSchema) ]).optional(),
}).strict();
