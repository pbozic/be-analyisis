...
import { z } from 'zod';
import { weather_dataTime_epoch_settlement_idCompoundUniqueInputSchema } from './weather_dataTime_epoch_settlement_idCompoundUniqueInputSchema';
...
export const weather_dataWhereUniqueInputSchema: z.ZodType<Prisma.weather_dataWhereUniqueInput> = z.union([
  z.object({
    weather_data_id: z.string().uuid(),
    time_epoch_settlement_id: z.lazy(() => weather_dataTime_epoch_settlement_idCompoundUniqueInputSchema)
  }),
  z.object({
    weather_data_id: z.string().uuid(),
  }),
...
.and(z.object({
  ...
  time_epoch_settlement_id: z.lazy(() => weather_dataTime_epoch_settlement_idCompoundUniqueInputSchema).optional(),
  AND: z.union([ z.lazy(() => weather_dataWhereInputSchema),z.lazy(() => weather_dataWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => weather_dataWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => weather_dataWhereInputSchema),z.lazy(() => weather_dataWhereInputSchema).array() ]).optional(),
  ...
  condition_code: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  wind_kph: z.union([ z.lazy(() => FloatFilterSchema),z.number() ]).optional(),
  wind_degree: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  ...
  humidity: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  cloud: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  ...
  chance_of_rain: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  will_it_snow: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  chance_of_snow: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  ...
  municipalities_id: z.union([ z.lazy(() => UuidNullableFilterSchema),z.string() ]).optional().nullable(),
  settlement_id: z.union([ z.lazy(() => UuidNullableFilterSchema),z.string() ]).optional().nullable(),
  municipality: z.union([ z.lazy(() => MunicipalitiesNullableRelationFilterSchema),z.lazy(() => municipalitiesWhereInputSchema) ]).optional().nullable(),
  settlement: z.union([ z.lazy(() => SettlementsNullableRelationFilterSchema),z.lazy(() => settlementsWhereInputSchema) ]).optional().nullable(),
}).strict());

export default weather_dataWhereUniqueInputSchema;
