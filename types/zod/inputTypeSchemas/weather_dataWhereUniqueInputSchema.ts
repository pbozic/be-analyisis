...
export const weather_dataWhereUniqueInputSchema: z.ZodType<Prisma.weather_dataWhereUniqueInput> = z
	.union([
		z.object({
	...
	.and(
		z
			.object({
				...
				time_epoch_settlement_id: z
					.lazy(() => weather_dataTime_epoch_settlement_idCompoundUniqueInputSchema)
					.optional(),
				AND: z
					.union([
						z.lazy(() => weather_dataWhereInputSchema),
						z.lazy(() => weather_dataWhereInputSchema).array(),
					])
					.optional(),
				OR: z
				...
				settlement: z
					.union([
						z.lazy(() => SettlementsNullableRelationFilterSchema),
						z.lazy(() => settlementsWhereInputSchema),
					])
					.optional()
					.nullable(),
			})
