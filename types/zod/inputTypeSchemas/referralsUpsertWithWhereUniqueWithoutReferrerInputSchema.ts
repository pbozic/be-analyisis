...
export const referralsUpsertWithWhereUniqueWithoutReferrerInputSchema: z.ZodType<Prisma.referralsUpsertWithWhereUniqueWithoutReferrerInput> = z.object({
  where: z.lazy(() => referralsWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => referralsUpdateWithoutReferrerInputSchema),z.lazy(() => referralsUncheckedUpdateWithoutReferrerInputSchema) ]),
  create: z.union([ z.lazy(() => referralsCreateWithoutReferrerInputSchema),z.lazy(() => referralsUncheckedCreateWithoutReferrerInputSchema) ]),
}).strict();
