...
export const businessUpdateOneRequiredWithoutUser_favorite_businessesNestedInputSchema: z.ZodType<Prisma.businessUpdateOneRequiredWithoutUser_favorite_businessesNestedInput> = z.object({
  create: z.union([ z.lazy(() => businessCreateWithoutUser_favorite_businessesInputSchema),z.lazy(() => businessUncheckedCreateWithoutUser_favorite_businessesInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => businessUpdateToOneWithWhereWithoutUser_favorite_businessesInputSchema),z.lazy(() => businessUpdateWithoutUser_favorite_businessesInputSchema),z.lazy(() => businessUncheckedUpdateWithoutUser_favorite_businessesInputSchema) ]).optional(),
}).strict();
