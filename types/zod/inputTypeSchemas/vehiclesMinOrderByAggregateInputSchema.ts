...
export const vehiclesMinOrderByAggregateInputSchema: z.ZodType<Prisma.vehiclesMinOrderByAggregateInput> = z.object({
...
export default vehiclesMinOrderByAggregateInputSchema;
