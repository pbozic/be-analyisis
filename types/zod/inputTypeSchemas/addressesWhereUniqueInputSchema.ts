...
export const addressesWhereUniqueInputSchema: z.ZodType<Prisma.addressesWhereUniqueInput> = z.union([
  z.object({
...
.and(z.object({
  ...
  uniqueAddressIdentifier: z.lazy(() => addressesUniqueAddressIdentifierCompoundUniqueInputSchema).optional(),
