...
export const order_lobby_usersWhereUniqueInputSchema: z.ZodType<Prisma.order_lobby_usersWhereUniqueInput> = z
	.union([
		z.object({
	...
	.and(
		z
			.object({
				...
				user_id_order_lobbies_id: z
					.lazy(() => order_lobby_usersUser_idOrder_lobbies_idCompoundUniqueInputSchema)
					.optional(),
				AND: z
					.union([
