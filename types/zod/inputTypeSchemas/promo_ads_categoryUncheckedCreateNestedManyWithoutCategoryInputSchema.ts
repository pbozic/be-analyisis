...
export const promo_ads_categoryUncheckedCreateNestedManyWithoutCategoryInputSchema: z.ZodType<Prisma.promo_ads_categoryUncheckedCreateNestedManyWithoutCategoryInput> =
	z
		.object({
			create: z
				.union([
