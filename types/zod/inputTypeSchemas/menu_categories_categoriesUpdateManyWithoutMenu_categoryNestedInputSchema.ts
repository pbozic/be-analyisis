...
export const menu_categories_categoriesUpdateManyWithoutMenu_categoryNestedInputSchema: z.ZodType<Prisma.menu_categories_categoriesUpdateManyWithoutMenu_categoryNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => menu_categories_categoriesUpsertWithWhereUniqueWithoutMenu_categoryInputSchema),
					z
						.lazy(() => menu_categories_categoriesUpsertWithWhereUniqueWithoutMenu_categoryInputSchema)
						.array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => menu_categories_categoriesUpdateWithWhereUniqueWithoutMenu_categoryInputSchema),
					z
						.lazy(() => menu_categories_categoriesUpdateWithWhereUniqueWithoutMenu_categoryInputSchema)
						.array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => menu_categories_categoriesUpdateManyWithWhereWithoutMenu_categoryInputSchema),
					z.lazy(() => menu_categories_categoriesUpdateManyWithWhereWithoutMenu_categoryInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
					z.lazy(() => menu_categories_categoriesScalarWhereInputSchema),
					z.lazy(() => menu_categories_categoriesScalarWhereInputSchema).array(),
				])
				.optional(),
		})
		.strict();

export default menu_categories_categoriesUpdateManyWithoutMenu_categoryNestedInputSchema;
