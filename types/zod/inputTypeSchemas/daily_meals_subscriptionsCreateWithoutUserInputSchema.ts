...
export const daily_meals_subscriptionsCreateWithoutUserInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsCreateWithoutUserInput> = z.object({
...
export default daily_meals_subscriptionsCreateWithoutUserInputSchema;
