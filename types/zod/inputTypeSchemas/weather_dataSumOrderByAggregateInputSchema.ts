...
export const weather_dataSumOrderByAggregateInputSchema: z.ZodType<Prisma.weather_dataSumOrderByAggregateInput> = z.object({
...
export default weather_dataSumOrderByAggregateInputSchema;
