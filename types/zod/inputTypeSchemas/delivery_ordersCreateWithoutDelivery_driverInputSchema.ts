...
import { delivery_order_sentCreateNestedManyWithoutOrderInputSchema } from './delivery_order_sentCreateNestedManyWithoutOrderInputSchema';
...
export const delivery_ordersCreateWithoutDelivery_driverInputSchema: z.ZodType<Prisma.delivery_ordersCreateWithoutDelivery_driverInput> =
	z
		.object({
			...
			history: z.lazy(() => delivery_order_sentCreateNestedManyWithoutOrderInputSchema).optional(),
			...
			wallet_transfer: z
				.lazy(() => wallet_transfer_historyCreateNestedManyWithoutDelivery_orderInputSchema)
				.optional(),
			driver_history_locations: z
				.lazy(() => driver_history_locationsCreateNestedManyWithoutDelivery_orderInputSchema)
				.optional(),
			delivery_driver_history_locations: z
				.lazy(() => delivery_driver_history_locationsCreateNestedManyWithoutOrderInputSchema)
				.optional(),
...
export default delivery_ordersCreateWithoutDelivery_driverInputSchema;
