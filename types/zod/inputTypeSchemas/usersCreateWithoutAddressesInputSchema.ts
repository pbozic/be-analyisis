...
export const usersCreateWithoutAddressesInputSchema: z.ZodType<Prisma.usersCreateWithoutAddressesInput> = z
	.object({
...
export default usersCreateWithoutAddressesInputSchema;
