...
export const promo_sectionsUncheckedCreateNestedManyWithoutTranslatableInputSchema: z.ZodType<Prisma.promo_sectionsUncheckedCreateNestedManyWithoutTranslatableInput> =
	z
		.object({
			create: z
				.union([
