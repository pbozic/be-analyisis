...
export const taxi_order_sentCreateManyOrderInputSchema: z.ZodType<Prisma.taxi_order_sentCreateManyOrderInput> = z.object({
...
export default taxi_order_sentCreateManyOrderInputSchema;
