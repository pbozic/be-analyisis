...
export const taxi_ordersUpdateOneWithoutWallet_transferNestedInputSchema: z.ZodType<Prisma.taxi_ordersUpdateOneWithoutWallet_transferNestedInput> = z.object({
  create: z.union([ z.lazy(() => taxi_ordersCreateWithoutWallet_transferInputSchema),z.lazy(() => taxi_ordersUncheckedCreateWithoutWallet_transferInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => taxi_ordersUpdateToOneWithWhereWithoutWallet_transferInputSchema),z.lazy(() => taxi_ordersUpdateWithoutWallet_transferInputSchema),z.lazy(() => taxi_ordersUncheckedUpdateWithoutWallet_transferInputSchema) ]).optional(),
}).strict();
