...
export const transactionsCreateWithoutTaxi_orderInputSchema: z.ZodType<Prisma.transactionsCreateWithoutTaxi_orderInput> = z.object({
...
export default transactionsCreateWithoutTaxi_orderInputSchema;
