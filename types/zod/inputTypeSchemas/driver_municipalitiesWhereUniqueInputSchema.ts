...
export const driver_municipalitiesWhereUniqueInputSchema: z.ZodType<Prisma.driver_municipalitiesWhereUniqueInput> = z.union([
  z.object({
    driver_municipalities_id: z.string().uuid(),
    driver_id_municipalities_id: z.lazy(() => driver_municipalitiesDriver_idMunicipalities_idCompoundUniqueInputSchema)
  }),
  z.object({
    driver_municipalities_id: z.string().uuid(),
  }),
...
.and(z.object({
  ...
  driver_id_municipalities_id: z.lazy(() => driver_municipalitiesDriver_idMunicipalities_idCompoundUniqueInputSchema).optional(),
