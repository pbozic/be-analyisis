...
export const transactionsCreateWithoutUserInputSchema: z.ZodType<Prisma.transactionsCreateWithoutUserInput> = z
	.object({
...
export default transactionsCreateWithoutUserInputSchema;
