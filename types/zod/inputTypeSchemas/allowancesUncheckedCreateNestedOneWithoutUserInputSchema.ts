...
export const allowancesUncheckedCreateNestedOneWithoutUserInputSchema: z.ZodType<Prisma.allowancesUncheckedCreateNestedOneWithoutUserInput> = z.object({
...
export default allowancesUncheckedCreateNestedOneWithoutUserInputSchema;
