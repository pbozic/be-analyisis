...
export const delivery_driversUpsertWithoutDelivery_driver_history_locationsInputSchema: z.ZodType<Prisma.delivery_driversUpsertWithoutDelivery_driver_history_locationsInput> =
	z
		.object({
			update: z.union([
