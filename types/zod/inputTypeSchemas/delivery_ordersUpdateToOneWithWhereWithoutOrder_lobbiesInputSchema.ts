...
export const delivery_ordersUpdateToOneWithWhereWithoutOrder_lobbiesInputSchema: z.ZodType<Prisma.delivery_ordersUpdateToOneWithWhereWithoutOrder_lobbiesInput> = z.object({
  where: z.lazy(() => delivery_ordersWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => delivery_ordersUpdateWithoutOrder_lobbiesInputSchema),z.lazy(() => delivery_ordersUncheckedUpdateWithoutOrder_lobbiesInputSchema) ]),
}).strict();
