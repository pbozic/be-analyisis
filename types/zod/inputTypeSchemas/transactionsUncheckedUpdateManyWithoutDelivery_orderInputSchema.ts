...
export const transactionsUncheckedUpdateManyWithoutDelivery_orderInputSchema: z.ZodType<Prisma.transactionsUncheckedUpdateManyWithoutDelivery_orderInput> =
	z
		.object({
			transaction_id: z
