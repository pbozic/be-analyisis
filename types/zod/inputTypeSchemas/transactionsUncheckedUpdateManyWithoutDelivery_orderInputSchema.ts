...
export const transactionsUncheckedUpdateManyWithoutDelivery_orderInputSchema: z.ZodType<Prisma.transactionsUncheckedUpdateManyWithoutDelivery_orderInput> = z.object({
  ...
  wallet_fund_id: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
}).strict();

export default transactionsUncheckedUpdateManyWithoutDelivery_orderInputSchema;
