...
export const wallet_fundsCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.wallet_fundsCreateNestedManyWithoutUserInput> = z.object({
...
export default wallet_fundsCreateNestedManyWithoutUserInputSchema;
