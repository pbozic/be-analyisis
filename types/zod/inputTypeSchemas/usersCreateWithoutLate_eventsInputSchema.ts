...
export const usersCreateWithoutLate_eventsInputSchema: z.ZodType<Prisma.usersCreateWithoutLate_eventsInput> = z
	.object({
...
export default usersCreateWithoutLate_eventsInputSchema;
