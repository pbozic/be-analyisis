...
export const businessUpdateToOneWithWhereWithoutChild_businessesInputSchema: z.ZodType<Prisma.businessUpdateToOneWithWhereWithoutChild_businessesInput> = z.object({
  where: z.lazy(() => businessWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => businessUpdateWithoutChild_businessesInputSchema),z.lazy(() => businessUncheckedUpdateWithoutChild_businessesInputSchema) ]),
}).strict();
