...
export const delivery_driversUncheckedCreateNestedManyWithoutDaily_meal_businessInputSchema: z.ZodType<Prisma.delivery_driversUncheckedCreateNestedManyWithoutDaily_meal_businessInput> =
	z
		.object({
			create: z
				.union([
