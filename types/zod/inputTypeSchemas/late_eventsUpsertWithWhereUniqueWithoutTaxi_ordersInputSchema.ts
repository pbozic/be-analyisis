...
export const late_eventsUpsertWithWhereUniqueWithoutTaxi_ordersInputSchema: z.ZodType<Prisma.late_eventsUpsertWithWhereUniqueWithoutTaxi_ordersInput> = z.object({
  where: z.lazy(() => late_eventsWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => late_eventsUpdateWithoutTaxi_ordersInputSchema),z.lazy(() => late_eventsUncheckedUpdateWithoutTaxi_ordersInputSchema) ]),
  create: z.union([ z.lazy(() => late_eventsCreateWithoutTaxi_ordersInputSchema),z.lazy(() => late_eventsUncheckedCreateWithoutTaxi_ordersInputSchema) ]),
}).strict();
