...
export const menusUpdateManyWithWhereWithoutBusinessInputSchema: z.ZodType<Prisma.menusUpdateManyWithWhereWithoutBusinessInput> =
	z
		.object({
			where: z.lazy(() => menusScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => menusUpdateManyMutationInputSchema),
				z.lazy(() => menusUncheckedUpdateManyWithoutBusinessInputSchema),
			]),
		})
		.strict();
