...
export const word_buyScalarWhereInputSchema: z.ZodType<Prisma.word_buyScalarWhereInput> = z
	.object({
		AND: z
			.union([z.lazy(() => word_buyScalarWhereInputSchema), z.lazy(() => word_buyScalarWhereInputSchema).array()])
			.optional(),
		OR: z
			.lazy(() => word_buyScalarWhereInputSchema)
			.array()
			.optional(),
		NOT: z
			.union([z.lazy(() => word_buyScalarWhereInputSchema), z.lazy(() => word_buyScalarWhereInputSchema).array()])
