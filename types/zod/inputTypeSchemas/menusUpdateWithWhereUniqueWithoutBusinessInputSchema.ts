...
export const menusUpdateWithWhereUniqueWithoutBusinessInputSchema: z.ZodType<Prisma.menusUpdateWithWhereUniqueWithoutBusinessInput> = z.object({
  where: z.lazy(() => menusWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => menusUpdateWithoutBusinessInputSchema),z.lazy(() => menusUncheckedUpdateWithoutBusinessInputSchema) ]),
}).strict();
