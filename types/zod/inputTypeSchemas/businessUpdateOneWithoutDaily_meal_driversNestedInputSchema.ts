...
export const businessUpdateOneWithoutDaily_meal_driversNestedInputSchema: z.ZodType<Prisma.businessUpdateOneWithoutDaily_meal_driversNestedInput> = z.object({
  create: z.union([ z.lazy(() => businessCreateWithoutDaily_meal_driversInputSchema),z.lazy(() => businessUncheckedCreateWithoutDaily_meal_driversInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => businessUpdateToOneWithWhereWithoutDaily_meal_driversInputSchema),z.lazy(() => businessUpdateWithoutDaily_meal_driversInputSchema),z.lazy(() => businessUncheckedUpdateWithoutDaily_meal_driversInputSchema) ]).optional(),
}).strict();
