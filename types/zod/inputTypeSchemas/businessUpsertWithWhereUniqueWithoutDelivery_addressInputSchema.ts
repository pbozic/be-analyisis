...
export const businessUpsertWithWhereUniqueWithoutDelivery_addressInputSchema: z.ZodType<Prisma.businessUpsertWithWhereUniqueWithoutDelivery_addressInput> =
	z
		.object({
			where: z.lazy(() => businessWhereUniqueInputSchema),
			update: z.union([
				z.lazy(() => businessUpdateWithoutDelivery_addressInputSchema),
				z.lazy(() => businessUncheckedUpdateWithoutDelivery_addressInputSchema),
			]),
			create: z.union([
