...
export const referralsScalarWhereInputSchema: z.ZodType<Prisma.referralsScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => referralsScalarWhereInputSchema),z.lazy(() => referralsScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => referralsScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => referralsScalarWhereInputSchema),z.lazy(() => referralsScalarWhereInputSchema).array() ]).optional(),
