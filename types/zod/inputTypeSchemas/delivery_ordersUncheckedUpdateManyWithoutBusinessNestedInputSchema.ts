...
export const delivery_ordersUncheckedUpdateManyWithoutBusinessNestedInputSchema: z.ZodType<Prisma.delivery_ordersUncheckedUpdateManyWithoutBusinessNestedInput> =
	z
		.object({
			create: z
				.union([
