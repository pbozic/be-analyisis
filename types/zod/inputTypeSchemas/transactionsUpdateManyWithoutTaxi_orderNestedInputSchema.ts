...
export const transactionsUpdateManyWithoutTaxi_orderNestedInputSchema: z.ZodType<Prisma.transactionsUpdateManyWithoutTaxi_orderNestedInput> = z.object({
  create: z.union([ z.lazy(() => transactionsCreateWithoutTaxi_orderInputSchema),z.lazy(() => transactionsCreateWithoutTaxi_orderInputSchema).array(),z.lazy(() => transactionsUncheckedCreateWithoutTaxi_orderInputSchema),z.lazy(() => transactionsUncheckedCreateWithoutTaxi_orderInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => transactionsCreateOrConnectWithoutTaxi_orderInputSchema),z.lazy(() => transactionsCreateOrConnectWithoutTaxi_orderInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => transactionsUpsertWithWhereUniqueWithoutTaxi_orderInputSchema),z.lazy(() => transactionsUpsertWithWhereUniqueWithoutTaxi_orderInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => transactionsUpdateWithWhereUniqueWithoutTaxi_orderInputSchema),z.lazy(() => transactionsUpdateWithWhereUniqueWithoutTaxi_orderInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => transactionsUpdateManyWithWhereWithoutTaxi_orderInputSchema),z.lazy(() => transactionsUpdateManyWithWhereWithoutTaxi_orderInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => transactionsScalarWhereInputSchema),z.lazy(() => transactionsScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default transactionsUpdateManyWithoutTaxi_orderNestedInputSchema;
