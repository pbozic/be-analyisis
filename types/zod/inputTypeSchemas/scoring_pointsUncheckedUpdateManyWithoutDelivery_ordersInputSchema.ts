...
export const scoring_pointsUncheckedUpdateManyWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.scoring_pointsUncheckedUpdateManyWithoutDelivery_ordersInput> =
	z
		.object({
			scoring_points_id: z
