...
export const usersUpdateOneRequiredWithoutWallet_fundsNestedInputSchema: z.ZodType<Prisma.usersUpdateOneRequiredWithoutWallet_fundsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => usersUpdateToOneWithWhereWithoutWallet_fundsInputSchema),z.lazy(() => usersUpdateWithoutWallet_fundsInputSchema),z.lazy(() => usersUncheckedUpdateWithoutWallet_fundsInputSchema) ]).optional(),
}).strict();
