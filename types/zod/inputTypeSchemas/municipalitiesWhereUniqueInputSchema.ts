...
export const municipalitiesWhereUniqueInputSchema: z.ZodType<Prisma.municipalitiesWhereUniqueInput> = z
	.object({
			...
			.object({
				...
				AND: z
					.union([
						...
						z.lazy(() => municipalitiesWhereInputSchema).array(),
					])
					.optional(),
				OR: z
					.lazy(() => municipalitiesWhereInputSchema)
					.array()
					.optional(),
				NOT: z
					.union([
...
export default municipalitiesWhereUniqueInputSchema;
