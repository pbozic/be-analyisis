...
export const scoring_pointsUpdateOneWithoutLate_eventsNestedInputSchema: z.ZodType<Prisma.scoring_pointsUpdateOneWithoutLate_eventsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => scoring_pointsUpdateToOneWithWhereWithoutLate_eventsInputSchema),
