...
export const menu_categoriesUncheckedUpdateWithoutDaily_meal_subscribersInputSchema: z.ZodType<Prisma.menu_categoriesUncheckedUpdateWithoutDaily_meal_subscribersInput> =
	z
		.object({
			menu_category_id: z
