...
export const reservationsMinOrderByAggregateInputSchema: z.ZodType<Prisma.reservationsMinOrderByAggregateInput> = z
	.object({
...
export default reservationsMinOrderByAggregateInputSchema;
