...
export const businessUpdateToOneWithWhereWithoutUser_favorite_businessesInputSchema: z.ZodType<Prisma.businessUpdateToOneWithWhereWithoutUser_favorite_businessesInput> = z.object({
  where: z.lazy(() => businessWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => businessUpdateWithoutUser_favorite_businessesInputSchema),z.lazy(() => businessUncheckedUpdateWithoutUser_favorite_businessesInputSchema) ]),
}).strict();
