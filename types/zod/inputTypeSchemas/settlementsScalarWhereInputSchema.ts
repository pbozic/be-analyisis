...
export const settlementsScalarWhereInputSchema: z.ZodType<Prisma.settlementsScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => settlementsScalarWhereInputSchema),z.lazy(() => settlementsScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => settlementsScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => settlementsScalarWhereInputSchema),z.lazy(() => settlementsScalarWhereInputSchema).array() ]).optional(),
