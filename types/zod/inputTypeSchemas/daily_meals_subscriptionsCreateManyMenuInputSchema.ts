...
export const daily_meals_subscriptionsCreateManyMenuInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsCreateManyMenuInput> = z.object({
...
export default daily_meals_subscriptionsCreateManyMenuInputSchema;
