...
export const promo_sectionsUpdateManyMutationInputSchema: z.ZodType<Prisma.promo_sectionsUpdateManyMutationInput> = z.object({
...
export default promo_sectionsUpdateManyMutationInputSchema;
