...
export const wordsUpdateManyWithoutCategoryNestedInputSchema: z.ZodType<Prisma.wordsUpdateManyWithoutCategoryNestedInput> =
	z
		.object({
			create: z
				.union([
					z.lazy(() => wordsCreateWithoutCategoryInputSchema),
					z.lazy(() => wordsCreateWithoutCategoryInputSchema).array(),
					z.lazy(() => wordsUncheckedCreateWithoutCategoryInputSchema),
					z.lazy(() => wordsUncheckedCreateWithoutCategoryInputSchema).array(),
				])
				.optional(),
			connectOrCreate: z
				.union([
					z.lazy(() => wordsCreateOrConnectWithoutCategoryInputSchema),
					z.lazy(() => wordsCreateOrConnectWithoutCategoryInputSchema).array(),
				])
				.optional(),
			upsert: z
				.union([
					z.lazy(() => wordsUpsertWithWhereUniqueWithoutCategoryInputSchema),
					z.lazy(() => wordsUpsertWithWhereUniqueWithoutCategoryInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => wordsUpdateWithWhereUniqueWithoutCategoryInputSchema),
					z.lazy(() => wordsUpdateWithWhereUniqueWithoutCategoryInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => wordsUpdateManyWithWhereWithoutCategoryInputSchema),
					z.lazy(() => wordsUpdateManyWithWhereWithoutCategoryInputSchema).array(),
				])
				.optional(),
			deleteMany: z
...
export default wordsUpdateManyWithoutCategoryNestedInputSchema;
