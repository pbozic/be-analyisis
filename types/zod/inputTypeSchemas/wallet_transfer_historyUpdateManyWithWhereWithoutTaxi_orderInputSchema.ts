...
export const wallet_transfer_historyUpdateManyWithWhereWithoutTaxi_orderInputSchema: z.ZodType<Prisma.wallet_transfer_historyUpdateManyWithWhereWithoutTaxi_orderInput> =
	z
		.object({
			where: z.lazy(() => wallet_transfer_historyScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => wallet_transfer_historyUpdateManyMutationInputSchema),
				z.lazy(() => wallet_transfer_historyUncheckedUpdateManyWithoutTaxi_orderInputSchema),
			]),
		})
		.strict();
