...
export const driver_municipalitiesUpdateManyWithWhereWithoutDriversInputSchema: z.ZodType<Prisma.driver_municipalitiesUpdateManyWithWhereWithoutDriversInput> =
	z
		.object({
			where: z.lazy(() => driver_municipalitiesScalarWhereInputSchema),
			data: z.union([
				z.lazy(() => driver_municipalitiesUpdateManyMutationInputSchema),
				z.lazy(() => driver_municipalitiesUncheckedUpdateManyWithoutDriversInputSchema),
			]),
		})
		.strict();
