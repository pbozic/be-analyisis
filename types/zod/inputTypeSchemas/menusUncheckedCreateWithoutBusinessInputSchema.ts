...
export const menusUncheckedCreateWithoutBusinessInputSchema: z.ZodType<Prisma.menusUncheckedCreateWithoutBusinessInput> = z.object({
...
export default menusUncheckedCreateWithoutBusinessInputSchema;
