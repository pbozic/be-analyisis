...
export const cashbackCreateNestedManyWithoutTaxi_orderInputSchema: z.ZodType<Prisma.cashbackCreateNestedManyWithoutTaxi_orderInput> = z.object({
...
export default cashbackCreateNestedManyWithoutTaxi_orderInputSchema;
