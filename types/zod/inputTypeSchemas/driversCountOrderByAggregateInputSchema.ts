...
export const driversCountOrderByAggregateInputSchema: z.ZodType<Prisma.driversCountOrderByAggregateInput> = z.object({
  ...
  working_hours: z.lazy(() => SortOrderSchema).optional(),
  ride_requirements: z.lazy(() => SortOrderSchema).optional(),
  ...
  delivery_timeline: z.lazy(() => SortOrderSchema).optional(),
  last_ping_at: z.lazy(() => SortOrderSchema).optional(),
  is_inactive: z.lazy(() => SortOrderSchema).optional(),
  transfer_requirements: z.lazy(() => SortOrderSchema).optional(),
...
export default driversCountOrderByAggregateInputSchema;
