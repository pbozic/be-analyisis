...
export const wallet_transfer_historyUpsertWithWhereUniqueWithoutTaxi_orderInputSchema: z.ZodType<Prisma.wallet_transfer_historyUpsertWithWhereUniqueWithoutTaxi_orderInput> =
	z
		.object({
			where: z.lazy(() => wallet_transfer_historyWhereUniqueInputSchema),
			update: z.union([
				z.lazy(() => wallet_transfer_historyUpdateWithoutTaxi_orderInputSchema),
				z.lazy(() => wallet_transfer_historyUncheckedUpdateWithoutTaxi_orderInputSchema),
			]),
			create: z.union([
