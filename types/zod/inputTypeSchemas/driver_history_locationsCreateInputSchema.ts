...
export const driver_history_locationsCreateInputSchema: z.ZodType<Prisma.driver_history_locationsCreateInput> = z
	.object({
...
export default driver_history_locationsCreateInputSchema;
