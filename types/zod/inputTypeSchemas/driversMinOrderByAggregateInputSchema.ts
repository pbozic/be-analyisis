...
export const driversMinOrderByAggregateInputSchema: z.ZodType<Prisma.driversMinOrderByAggregateInput> = z.object({
...
export default driversMinOrderByAggregateInputSchema;
