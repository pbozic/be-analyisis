...
export const daily_meals_subscriptionsUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.daily_meals_subscriptionsUpdateManyWithWhereWithoutUserInput> = z.object({
  where: z.lazy(() => daily_meals_subscriptionsScalarWhereInputSchema),
  data: z.union([ z.lazy(() => daily_meals_subscriptionsUpdateManyMutationInputSchema),z.lazy(() => daily_meals_subscriptionsUncheckedUpdateManyWithoutUserInputSchema) ]),
}).strict();
