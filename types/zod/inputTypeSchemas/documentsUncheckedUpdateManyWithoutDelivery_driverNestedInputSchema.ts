...
export const documentsUncheckedUpdateManyWithoutDelivery_driverNestedInputSchema: z.ZodType<Prisma.documentsUncheckedUpdateManyWithoutDelivery_driverNestedInput> =
	z
		.object({
			create: z
				.union([
