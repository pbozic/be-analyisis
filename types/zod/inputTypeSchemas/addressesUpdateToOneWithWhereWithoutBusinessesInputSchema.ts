...
export const addressesUpdateToOneWithWhereWithoutBusinessesInputSchema: z.ZodType<Prisma.addressesUpdateToOneWithWhereWithoutBusinessesInput> = z.object({
  where: z.lazy(() => addressesWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => addressesUpdateWithoutBusinessesInputSchema),z.lazy(() => addressesUncheckedUpdateWithoutBusinessesInputSchema) ]),
}).strict();
