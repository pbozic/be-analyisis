...
export const driver_activity_logsUncheckedCreateNestedManyWithoutDriverInputSchema: z.ZodType<Prisma.driver_activity_logsUncheckedCreateNestedManyWithoutDriverInput> =
	z
		.object({
			create: z
				.union([
...
export default driver_activity_logsUncheckedCreateNestedManyWithoutDriverInputSchema;
