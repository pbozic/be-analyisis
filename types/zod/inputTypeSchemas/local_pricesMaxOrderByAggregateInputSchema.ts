...
export const local_pricesMaxOrderByAggregateInputSchema: z.ZodType<Prisma.local_pricesMaxOrderByAggregateInput> = z.object({
...
export default local_pricesMaxOrderByAggregateInputSchema;
