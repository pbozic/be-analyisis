...
export const order_lobby_itemsCreateNestedManyWithoutOrder_lobbiesInputSchema: z.ZodType<Prisma.order_lobby_itemsCreateNestedManyWithoutOrder_lobbiesInput> =
	z
		.object({
			create: z
				.union([
