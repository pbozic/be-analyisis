...
export const delivery_driver_history_locationsWhereInputSchema: z.ZodType<Prisma.delivery_driver_history_locationsWhereInput> =
	z
		.object({
			AND: z
				.union([
					z.lazy(() => delivery_driver_history_locationsWhereInputSchema),
					z.lazy(() => delivery_driver_history_locationsWhereInputSchema).array(),
				])
				.optional(),
			OR: z
				.lazy(() => delivery_driver_history_locationsWhereInputSchema)
				.array()
				.optional(),
			NOT: z
				.union([
...
export default delivery_driver_history_locationsWhereInputSchema;
