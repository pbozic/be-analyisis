...
export const taxi_ordersUpsertWithWhereUniqueWithoutDriverInputSchema: z.ZodType<Prisma.taxi_ordersUpsertWithWhereUniqueWithoutDriverInput> =
	z
		.object({
			where: z.lazy(() => taxi_ordersWhereUniqueInputSchema),
			update: z.union([
				z.lazy(() => taxi_ordersUpdateWithoutDriverInputSchema),
				z.lazy(() => taxi_ordersUncheckedUpdateWithoutDriverInputSchema),
			]),
			create: z.union([
