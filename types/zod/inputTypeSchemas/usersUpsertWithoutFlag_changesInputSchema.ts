...
export const usersUpsertWithoutFlag_changesInputSchema: z.ZodType<Prisma.usersUpsertWithoutFlag_changesInput> = z.object({
  update: z.union([ z.lazy(() => usersUpdateWithoutFlag_changesInputSchema),z.lazy(() => usersUncheckedUpdateWithoutFlag_changesInputSchema) ]),
  create: z.union([ z.lazy(() => usersCreateWithoutFlag_changesInputSchema),z.lazy(() => usersUncheckedCreateWithoutFlag_changesInputSchema) ]),
