...
export const delivery_driver_history_locationsCreateNestedManyWithoutDelivery_driverInputSchema: z.ZodType<Prisma.delivery_driver_history_locationsCreateNestedManyWithoutDelivery_driverInput> =
	z
		.object({
			create: z
				.union([
