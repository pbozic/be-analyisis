...
export const businessUpdateWithoutFinancesInputSchema: z.ZodType<Prisma.businessUpdateWithoutFinancesInput> = z.object({
...
export default businessUpdateWithoutFinancesInputSchema;
