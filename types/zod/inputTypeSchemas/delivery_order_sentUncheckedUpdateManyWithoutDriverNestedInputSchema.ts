...
export const delivery_order_sentUncheckedUpdateManyWithoutDriverNestedInputSchema: z.ZodType<Prisma.delivery_order_sentUncheckedUpdateManyWithoutDriverNestedInput> =
	z
		.object({
			create: z
				.union([
