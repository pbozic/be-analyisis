...
export const businessUncheckedUpdateWithoutWord_buy_stripe_productInputSchema: z.ZodType<Prisma.businessUncheckedUpdateWithoutWord_buy_stripe_productInput> =
	z
		.object({
