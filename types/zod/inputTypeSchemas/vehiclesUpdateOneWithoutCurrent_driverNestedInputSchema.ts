...
export const vehiclesUpdateOneWithoutCurrent_driverNestedInputSchema: z.ZodType<Prisma.vehiclesUpdateOneWithoutCurrent_driverNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => vehiclesUpdateToOneWithWhereWithoutCurrent_driverInputSchema),
