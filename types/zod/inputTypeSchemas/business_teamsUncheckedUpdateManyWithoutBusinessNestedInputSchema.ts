...
export const business_teamsUncheckedUpdateManyWithoutBusinessNestedInputSchema: z.ZodType<Prisma.business_teamsUncheckedUpdateManyWithoutBusinessNestedInput> =
	z
		.object({
			create: z
				.union([
