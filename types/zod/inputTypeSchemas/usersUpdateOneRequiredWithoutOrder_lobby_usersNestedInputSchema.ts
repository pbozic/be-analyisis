...
export const usersUpdateOneRequiredWithoutOrder_lobby_usersNestedInputSchema: z.ZodType<Prisma.usersUpdateOneRequiredWithoutOrder_lobby_usersNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => usersUpdateToOneWithWhereWithoutOrder_lobby_usersInputSchema),
