...
export const translationsUncheckedCreateNestedManyWithoutTranslatableInputSchema: z.ZodType<Prisma.translationsUncheckedCreateNestedManyWithoutTranslatableInput> =
	z
		.object({
			create: z
				.union([
...
export default translationsUncheckedCreateNestedManyWithoutTranslatableInputSchema;
