...
export const businessScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.businessScalarWhereWithAggregatesInput> = z
	.object({
		AND: z
			.union([
				z.lazy(() => businessScalarWhereWithAggregatesInputSchema),
				z.lazy(() => businessScalarWhereWithAggregatesInputSchema).array(),
			])
			.optional(),
		OR: z
			.lazy(() => businessScalarWhereWithAggregatesInputSchema)
			.array()
			.optional(),
		NOT: z
			.union([
		...
		finance_id: z
			...
			.nullable(),
		type: z
			.union([z.lazy(() => EnumBUSINESS_TYPEWithAggregatesFilterSchema), z.lazy(() => BUSINESS_TYPESchema)])
			.optional(),
		...
		daily_users_sorting_type: z
			.union([z.lazy(() => EnumSORTING_TYPEWithAggregatesFilterSchema), z.lazy(() => SORTING_TYPESchema)])
			.optional(),
