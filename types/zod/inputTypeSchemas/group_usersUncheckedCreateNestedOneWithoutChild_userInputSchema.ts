...
export const group_usersUncheckedCreateNestedOneWithoutChild_userInputSchema: z.ZodType<Prisma.group_usersUncheckedCreateNestedOneWithoutChild_userInput> =
	z
		.object({
			create: z
				.union([
