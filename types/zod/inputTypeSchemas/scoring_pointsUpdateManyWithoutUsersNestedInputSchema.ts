...
export const scoring_pointsUpdateManyWithoutUsersNestedInputSchema: z.ZodType<Prisma.scoring_pointsUpdateManyWithoutUsersNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => scoring_pointsUpsertWithWhereUniqueWithoutUsersInputSchema),
					z.lazy(() => scoring_pointsUpsertWithWhereUniqueWithoutUsersInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => scoring_pointsUpdateWithWhereUniqueWithoutUsersInputSchema),
					z.lazy(() => scoring_pointsUpdateWithWhereUniqueWithoutUsersInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => scoring_pointsUpdateManyWithWhereWithoutUsersInputSchema),
					z.lazy(() => scoring_pointsUpdateManyWithWhereWithoutUsersInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default scoring_pointsUpdateManyWithoutUsersNestedInputSchema;
