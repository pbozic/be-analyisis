...
export const businessCreateNestedOneWithoutDaily_meals_subscribersInputSchema: z.ZodType<Prisma.businessCreateNestedOneWithoutDaily_meals_subscribersInput> =
	z
		.object({
			create: z
				.union([
