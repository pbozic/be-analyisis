...
export const driversUpdateOneWithoutDriver_history_locationsNestedInputSchema: z.ZodType<Prisma.driversUpdateOneWithoutDriver_history_locationsNestedInput> = z.object({
  create: z.union([ z.lazy(() => driversCreateWithoutDriver_history_locationsInputSchema),z.lazy(() => driversUncheckedCreateWithoutDriver_history_locationsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => driversUpdateToOneWithWhereWithoutDriver_history_locationsInputSchema),z.lazy(() => driversUpdateWithoutDriver_history_locationsInputSchema),z.lazy(() => driversUncheckedUpdateWithoutDriver_history_locationsInputSchema) ]).optional(),
}).strict();
