...
export const promo_sectionsUpdateOneRequiredWithoutPromo_section_buyNestedInputSchema: z.ZodType<Prisma.promo_sectionsUpdateOneRequiredWithoutPromo_section_buyNestedInput> = z.object({
  create: z.union([ z.lazy(() => promo_sectionsCreateWithoutPromo_section_buyInputSchema),z.lazy(() => promo_sectionsUncheckedCreateWithoutPromo_section_buyInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => promo_sectionsUpdateToOneWithWhereWithoutPromo_section_buyInputSchema),z.lazy(() => promo_sectionsUpdateWithoutPromo_section_buyInputSchema),z.lazy(() => promo_sectionsUncheckedUpdateWithoutPromo_section_buyInputSchema) ]).optional(),
}).strict();
