...
export const flag_historyWhereUniqueInputSchema: z.ZodType<Prisma.flag_historyWhereUniqueInput> = z.object({
  flag_history_id: z.string().uuid()
})
.and(z.object({
  flag_history_id: z.string().uuid().optional(),
  AND: z.union([ z.lazy(() => flag_historyWhereInputSchema),z.lazy(() => flag_historyWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => flag_historyWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => flag_historyWhereInputSchema),z.lazy(() => flag_historyWhereInputSchema).array() ]).optional(),
