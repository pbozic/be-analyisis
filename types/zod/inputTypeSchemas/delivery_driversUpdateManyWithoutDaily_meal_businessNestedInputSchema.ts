...
export const delivery_driversUpdateManyWithoutDaily_meal_businessNestedInputSchema: z.ZodType<Prisma.delivery_driversUpdateManyWithoutDaily_meal_businessNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => delivery_driversUpsertWithWhereUniqueWithoutDaily_meal_businessInputSchema),z.lazy(() => delivery_driversUpsertWithWhereUniqueWithoutDaily_meal_businessInputSchema).array() ]).optional(),
  createMany: z.lazy(() => delivery_driversCreateManyDaily_meal_businessInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => delivery_driversWhereUniqueInputSchema),z.lazy(() => delivery_driversWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => delivery_driversWhereUniqueInputSchema),z.lazy(() => delivery_driversWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => delivery_driversWhereUniqueInputSchema),z.lazy(() => delivery_driversWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => delivery_driversUpdateWithWhereUniqueWithoutDaily_meal_businessInputSchema),z.lazy(() => delivery_driversUpdateWithWhereUniqueWithoutDaily_meal_businessInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => delivery_driversUpdateManyWithWhereWithoutDaily_meal_businessInputSchema),z.lazy(() => delivery_driversUpdateManyWithWhereWithoutDaily_meal_businessInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => delivery_driversScalarWhereInputSchema),z.lazy(() => delivery_driversScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default delivery_driversUpdateManyWithoutDaily_meal_businessNestedInputSchema;
