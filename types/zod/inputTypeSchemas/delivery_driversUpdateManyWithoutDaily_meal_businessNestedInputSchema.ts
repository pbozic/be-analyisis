...
export const delivery_driversUpdateManyWithoutDaily_meal_businessNestedInputSchema: z.ZodType<Prisma.delivery_driversUpdateManyWithoutDaily_meal_businessNestedInput> =
	z
		.object({
			create: z
				.union([
