...
export const delivery_order_sentScalarWhereInputSchema: z.ZodType<Prisma.delivery_order_sentScalarWhereInput> = z
	.object({
		AND: z
			.union([
			...
			.optional(),
		OR: z
			.lazy(() => delivery_order_sentScalarWhereInputSchema)
			.array()
			.optional(),
		NOT: z
			.union([
