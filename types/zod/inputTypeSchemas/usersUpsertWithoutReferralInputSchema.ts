...
export const usersUpsertWithoutReferralInputSchema: z.ZodType<Prisma.usersUpsertWithoutReferralInput> = z.object({
  update: z.union([ z.lazy(() => usersUpdateWithoutReferralInputSchema),z.lazy(() => usersUncheckedUpdateWithoutReferralInputSchema) ]),
  create: z.union([ z.lazy(() => usersCreateWithoutReferralInputSchema),z.lazy(() => usersUncheckedCreateWithoutReferralInputSchema) ]),
