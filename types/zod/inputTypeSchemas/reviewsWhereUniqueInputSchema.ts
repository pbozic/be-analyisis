...
export const reviewsWhereUniqueInputSchema: z.ZodType<Prisma.reviewsWhereUniqueInput> = z
	.object({
	...
	.and(
		z
			.object({
				...
				AND: z
					.union([z.lazy(() => reviewsWhereInputSchema), z.lazy(() => reviewsWhereInputSchema).array()])
					.optional(),
				OR: z
...
export default reviewsWhereUniqueInputSchema;
