...
export const user_favorite_businessesUpdateWithWhereUniqueWithoutBusinessesInputSchema: z.ZodType<Prisma.user_favorite_businessesUpdateWithWhereUniqueWithoutBusinessesInput> = z.object({
  where: z.lazy(() => user_favorite_businessesWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => user_favorite_businessesUpdateWithoutBusinessesInputSchema),z.lazy(() => user_favorite_businessesUncheckedUpdateWithoutBusinessesInputSchema) ]),
}).strict();
