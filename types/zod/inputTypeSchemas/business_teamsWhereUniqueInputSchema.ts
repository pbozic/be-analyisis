...
export const business_teamsWhereUniqueInputSchema: z.ZodType<Prisma.business_teamsWhereUniqueInput> = z.union([
  z.object({
...
.and(z.object({
  ...
  AND: z.union([ z.lazy(() => business_teamsWhereInputSchema),z.lazy(() => business_teamsWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => business_teamsWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => business_teamsWhereInputSchema),z.lazy(() => business_teamsWhereInputSchema).array() ]).optional(),
