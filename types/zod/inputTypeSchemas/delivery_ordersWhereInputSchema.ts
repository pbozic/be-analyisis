...
export const delivery_ordersWhereInputSchema: z.ZodType<Prisma.delivery_ordersWhereInput> = z
	.object({
		AND: z
			.union([
		...
		status: z
			.union([z.lazy(() => EnumDELIVERY_ORDER_STATUSFilterSchema), z.lazy(() => DELIVERY_ORDER_STATUSSchema)])
			.optional(),
		last_sent_at: z
