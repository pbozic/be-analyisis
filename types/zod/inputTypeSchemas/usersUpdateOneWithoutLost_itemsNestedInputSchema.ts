...
export const usersUpdateOneWithoutLost_itemsNestedInputSchema: z.ZodType<Prisma.usersUpdateOneWithoutLost_itemsNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => usersUpdateToOneWithWhereWithoutLost_itemsInputSchema),
