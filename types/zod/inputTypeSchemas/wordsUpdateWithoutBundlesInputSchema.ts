...
export const wordsUpdateWithoutBundlesInputSchema: z.ZodType<Prisma.wordsUpdateWithoutBundlesInput> = z.object({
...
export default wordsUpdateWithoutBundlesInputSchema;
