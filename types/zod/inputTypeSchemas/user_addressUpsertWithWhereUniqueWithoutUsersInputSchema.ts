...
export const user_addressUpsertWithWhereUniqueWithoutUsersInputSchema: z.ZodType<Prisma.user_addressUpsertWithWhereUniqueWithoutUsersInput> = z.object({
  where: z.lazy(() => user_addressWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => user_addressUpdateWithoutUsersInputSchema),z.lazy(() => user_addressUncheckedUpdateWithoutUsersInputSchema) ]),
  create: z.union([ z.lazy(() => user_addressCreateWithoutUsersInputSchema),z.lazy(() => user_addressUncheckedCreateWithoutUsersInputSchema) ]),
}).strict();
