...
export const transactionsUncheckedCreateNestedManyWithoutTaxi_orderInputSchema: z.ZodType<Prisma.transactionsUncheckedCreateNestedManyWithoutTaxi_orderInput> =
	z
		.object({
			create: z
				.union([
