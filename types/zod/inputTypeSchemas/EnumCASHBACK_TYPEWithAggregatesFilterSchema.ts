...
export const EnumCASHBACK_TYPEWithAggregatesFilterSchema: z.ZodType<Prisma.EnumCASHBACK_TYPEWithAggregatesFilter> = z
	.object({
		...
		notIn: z
			...
			.optional(),
		not: z
			.union([z.lazy(() => CASHBACK_TYPESchema), z.lazy(() => NestedEnumCASHBACK_TYPEWithAggregatesFilterSchema)])
			.optional(),
