...
export const businessUpdateOneRequiredWithoutReservationsNestedInputSchema: z.ZodType<Prisma.businessUpdateOneRequiredWithoutReservationsNestedInput> = z.object({
  create: z.union([ z.lazy(() => businessCreateWithoutReservationsInputSchema),z.lazy(() => businessUncheckedCreateWithoutReservationsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => businessUpdateToOneWithWhereWithoutReservationsInputSchema),z.lazy(() => businessUpdateWithoutReservationsInputSchema),z.lazy(() => businessUncheckedUpdateWithoutReservationsInputSchema) ]).optional(),
}).strict();
