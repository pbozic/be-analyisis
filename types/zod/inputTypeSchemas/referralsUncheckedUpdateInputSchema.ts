...
export const referralsUncheckedUpdateInputSchema: z.ZodType<Prisma.referralsUncheckedUpdateInput> = z.object({
...
export default referralsUncheckedUpdateInputSchema;
