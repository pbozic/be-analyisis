...
export const documentsUpdateManyWithoutVehiclesNestedInputSchema: z.ZodType<Prisma.documentsUpdateManyWithoutVehiclesNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => documentsUpsertWithWhereUniqueWithoutVehiclesInputSchema),z.lazy(() => documentsUpsertWithWhereUniqueWithoutVehiclesInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => documentsUpdateWithWhereUniqueWithoutVehiclesInputSchema),z.lazy(() => documentsUpdateWithWhereUniqueWithoutVehiclesInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => documentsUpdateManyWithWhereWithoutVehiclesInputSchema),z.lazy(() => documentsUpdateManyWithWhereWithoutVehiclesInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => documentsScalarWhereInputSchema),z.lazy(() => documentsScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default documentsUpdateManyWithoutVehiclesNestedInputSchema;
