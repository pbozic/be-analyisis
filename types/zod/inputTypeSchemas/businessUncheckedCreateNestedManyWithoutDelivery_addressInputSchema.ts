...
export const businessUncheckedCreateNestedManyWithoutDelivery_addressInputSchema: z.ZodType<Prisma.businessUncheckedCreateNestedManyWithoutDelivery_addressInput> =
	z
		.object({
			create: z
				.union([
