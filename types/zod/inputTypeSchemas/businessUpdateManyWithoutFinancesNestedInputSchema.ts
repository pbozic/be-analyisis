...
export const businessUpdateManyWithoutFinancesNestedInputSchema: z.ZodType<Prisma.businessUpdateManyWithoutFinancesNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			upsert: z
				.union([
					z.lazy(() => businessUpsertWithWhereUniqueWithoutFinancesInputSchema),
					z.lazy(() => businessUpsertWithWhereUniqueWithoutFinancesInputSchema).array(),
				])
				.optional(),
			...
			update: z
				.union([
					z.lazy(() => businessUpdateWithWhereUniqueWithoutFinancesInputSchema),
					z.lazy(() => businessUpdateWithWhereUniqueWithoutFinancesInputSchema).array(),
				])
				.optional(),
			updateMany: z
				.union([
					z.lazy(() => businessUpdateManyWithWhereWithoutFinancesInputSchema),
					z.lazy(() => businessUpdateManyWithWhereWithoutFinancesInputSchema).array(),
				])
				.optional(),
			deleteMany: z
				.union([
...
export default businessUpdateManyWithoutFinancesNestedInputSchema;
