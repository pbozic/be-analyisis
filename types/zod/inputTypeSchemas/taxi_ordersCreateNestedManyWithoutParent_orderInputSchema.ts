...
export const taxi_ordersCreateNestedManyWithoutParent_orderInputSchema: z.ZodType<Prisma.taxi_ordersCreateNestedManyWithoutParent_orderInput> = z.object({
...
export default taxi_ordersCreateNestedManyWithoutParent_orderInputSchema;
