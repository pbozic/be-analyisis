...
export const business_clientsCreateNestedManyWithoutBusinessInputSchema: z.ZodType<Prisma.business_clientsCreateNestedManyWithoutBusinessInput> = z.object({
...
export default business_clientsCreateNestedManyWithoutBusinessInputSchema;
