...
export const scoring_pointsCreateNestedManyWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.scoring_pointsCreateNestedManyWithoutDelivery_ordersInput> =
	z
		.object({
			create: z
				.union([
