...
export const user_favorite_businessesUpdateWithoutUsersInputSchema: z.ZodType<Prisma.user_favorite_businessesUpdateWithoutUsersInput> =
	z
		.object({
			...
			businesses: z
				.lazy(() => businessUpdateOneRequiredWithoutUser_favorite_businessesNestedInputSchema)
				.optional(),
		})
		.strict();

export default user_favorite_businessesUpdateWithoutUsersInputSchema;
