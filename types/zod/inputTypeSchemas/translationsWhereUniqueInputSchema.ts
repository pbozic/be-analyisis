...
export const translationsWhereUniqueInputSchema: z.ZodType<Prisma.translationsWhereUniqueInput> = z.union([
  z.object({
...
.and(z.object({
  ...
  AND: z.union([ z.lazy(() => translationsWhereInputSchema),z.lazy(() => translationsWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => translationsWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => translationsWhereInputSchema),z.lazy(() => translationsWhereInputSchema).array() ]).optional(),
