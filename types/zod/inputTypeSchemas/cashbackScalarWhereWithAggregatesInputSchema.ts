...
export const cashbackScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.cashbackScalarWhereWithAggregatesInput> = z
	.object({
		AND: z
			.union([
				z.lazy(() => cashbackScalarWhereWithAggregatesInputSchema),
				z.lazy(() => cashbackScalarWhereWithAggregatesInputSchema).array(),
			])
			.optional(),
		OR: z
			.lazy(() => cashbackScalarWhereWithAggregatesInputSchema)
			.array()
			.optional(),
		NOT: z
			.union([
		...
		type: z
			.union([z.lazy(() => EnumCASHBACK_TYPEWithAggregatesFilterSchema), z.lazy(() => CASHBACK_TYPESchema)])
			.optional(),
		source: z
			.union([z.lazy(() => EnumCASHBACK_SOURCEWithAggregatesFilterSchema), z.lazy(() => CASHBACK_SOURCESchema)])
			.optional(),
		status: z
			.union([z.lazy(() => EnumCASHBACK_STATUSWithAggregatesFilterSchema), z.lazy(() => CASHBACK_STATUSSchema)])
			.optional(),
		description: z
