...
export const delivery_ordersUncheckedCreateInputSchema: z.ZodType<Prisma.delivery_ordersUncheckedCreateInput> = z.object({
...
export default delivery_ordersUncheckedCreateInputSchema;
