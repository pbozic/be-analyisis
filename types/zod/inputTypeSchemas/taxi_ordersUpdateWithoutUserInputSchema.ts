...
export const taxi_ordersUpdateWithoutUserInputSchema: z.ZodType<Prisma.taxi_ordersUpdateWithoutUserInput> = z
	.object({
...
export default taxi_ordersUpdateWithoutUserInputSchema;
