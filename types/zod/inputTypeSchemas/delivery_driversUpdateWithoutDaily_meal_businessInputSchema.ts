...
export const delivery_driversUpdateWithoutDaily_meal_businessInputSchema: z.ZodType<Prisma.delivery_driversUpdateWithoutDaily_meal_businessInput> =
	z
		.object({
			...
			received_orders: z
				.lazy(() => delivery_order_sentUpdateManyWithoutDelivery_driverNestedInputSchema)
				.optional(),
			documents: z.lazy(() => documentsUpdateManyWithoutDelivery_driverNestedInputSchema).optional(),
			delivery_driver_history_locations: z
				.lazy(() => delivery_driver_history_locationsUpdateManyWithoutDelivery_driverNestedInputSchema)
				.optional(),
		})
		.strict();

export default delivery_driversUpdateWithoutDaily_meal_businessInputSchema;
