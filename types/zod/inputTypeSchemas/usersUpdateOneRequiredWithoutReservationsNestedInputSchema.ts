...
export const usersUpdateOneRequiredWithoutReservationsNestedInputSchema: z.ZodType<Prisma.usersUpdateOneRequiredWithoutReservationsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => usersUpdateToOneWithWhereWithoutReservationsInputSchema),z.lazy(() => usersUpdateWithoutReservationsInputSchema),z.lazy(() => usersUncheckedUpdateWithoutReservationsInputSchema) ]).optional(),
}).strict();
