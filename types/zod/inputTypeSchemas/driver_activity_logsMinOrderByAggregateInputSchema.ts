...
export const driver_activity_logsMinOrderByAggregateInputSchema: z.ZodType<Prisma.driver_activity_logsMinOrderByAggregateInput> = z.object({
...
export default driver_activity_logsMinOrderByAggregateInputSchema;
