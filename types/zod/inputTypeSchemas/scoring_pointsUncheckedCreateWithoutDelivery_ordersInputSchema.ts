...
export const scoring_pointsUncheckedCreateWithoutDelivery_ordersInputSchema: z.ZodType<Prisma.scoring_pointsUncheckedCreateWithoutDelivery_ordersInput> = z.object({
...
export default scoring_pointsUncheckedCreateWithoutDelivery_ordersInputSchema;
