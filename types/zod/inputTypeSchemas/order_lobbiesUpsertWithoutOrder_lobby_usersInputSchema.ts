...
export const order_lobbiesUpsertWithoutOrder_lobby_usersInputSchema: z.ZodType<Prisma.order_lobbiesUpsertWithoutOrder_lobby_usersInput> = z.object({
  update: z.union([ z.lazy(() => order_lobbiesUpdateWithoutOrder_lobby_usersInputSchema),z.lazy(() => order_lobbiesUncheckedUpdateWithoutOrder_lobby_usersInputSchema) ]),
