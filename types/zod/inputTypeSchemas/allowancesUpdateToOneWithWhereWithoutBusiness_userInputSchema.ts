...
export const allowancesUpdateToOneWithWhereWithoutBusiness_userInputSchema: z.ZodType<Prisma.allowancesUpdateToOneWithWhereWithoutBusiness_userInput> = z.object({
  where: z.lazy(() => allowancesWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => allowancesUpdateWithoutBusiness_userInputSchema),z.lazy(() => allowancesUncheckedUpdateWithoutBusiness_userInputSchema) ]),
}).strict();
