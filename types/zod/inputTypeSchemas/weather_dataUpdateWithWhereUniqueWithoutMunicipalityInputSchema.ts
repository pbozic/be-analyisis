...
export const weather_dataUpdateWithWhereUniqueWithoutMunicipalityInputSchema: z.ZodType<Prisma.weather_dataUpdateWithWhereUniqueWithoutMunicipalityInput> = z.object({
  where: z.lazy(() => weather_dataWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => weather_dataUpdateWithoutMunicipalityInputSchema),z.lazy(() => weather_dataUncheckedUpdateWithoutMunicipalityInputSchema) ]),
}).strict();
