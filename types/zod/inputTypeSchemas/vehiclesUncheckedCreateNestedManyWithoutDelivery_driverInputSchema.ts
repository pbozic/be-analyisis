...
export const vehiclesUncheckedCreateNestedManyWithoutDelivery_driverInputSchema: z.ZodType<Prisma.vehiclesUncheckedCreateNestedManyWithoutDelivery_driverInput> =
	z
		.object({
			create: z
				.union([
