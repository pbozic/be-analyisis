...
export const transactionsUncheckedUpdateManyWithoutDelivery_orderNestedInputSchema: z.ZodType<Prisma.transactionsUncheckedUpdateManyWithoutDelivery_orderNestedInput> =
	z
		.object({
			create: z
				.union([
