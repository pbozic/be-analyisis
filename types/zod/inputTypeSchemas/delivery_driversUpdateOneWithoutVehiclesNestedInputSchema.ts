...
export const delivery_driversUpdateOneWithoutVehiclesNestedInputSchema: z.ZodType<Prisma.delivery_driversUpdateOneWithoutVehiclesNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			update: z
				.union([
					z.lazy(() => delivery_driversUpdateToOneWithWhereWithoutVehiclesInputSchema),
