...
export const taxi_ordersCreateManyBusiness_usersInputSchema: z.ZodType<Prisma.taxi_ordersCreateManyBusiness_usersInput> = z.object({
...
export default taxi_ordersCreateManyBusiness_usersInputSchema;
