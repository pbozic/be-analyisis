...
export const delivery_driversUpdateToOneWithWhereWithoutDelivery_driver_history_locationsInputSchema: z.ZodType<Prisma.delivery_driversUpdateToOneWithWhereWithoutDelivery_driver_history_locationsInput> = z.object({
  where: z.lazy(() => delivery_driversWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => delivery_driversUpdateWithoutDelivery_driver_history_locationsInputSchema),z.lazy(() => delivery_driversUncheckedUpdateWithoutDelivery_driver_history_locationsInputSchema) ]),
}).strict();
