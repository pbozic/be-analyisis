...
export const order_lobby_itemsWhereUniqueInputSchema: z.ZodType<Prisma.order_lobby_itemsWhereUniqueInput> = z
	.object({
	...
	.and(
		z
			.object({
				...
				AND: z
					.union([
						z.lazy(() => order_lobby_itemsWhereInputSchema),
						z.lazy(() => order_lobby_itemsWhereInputSchema).array(),
					])
					.optional(),
				OR: z
					.lazy(() => order_lobby_itemsWhereInputSchema)
					.array()
					.optional(),
				NOT: z
					.union([
				...
				order_lobbies: z
					.union([
						z.lazy(() => Order_lobbiesRelationFilterSchema),
