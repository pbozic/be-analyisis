...
export const promo_sectionsUncheckedCreateInputSchema: z.ZodType<Prisma.promo_sectionsUncheckedCreateInput> = z.object({
  ...
  promo_section_buy: z.lazy(() => promo_sections_buyUncheckedCreateNestedManyWithoutPromo_sectionInputSchema).optional()
}).strict();

export default promo_sectionsUncheckedCreateInputSchema;
