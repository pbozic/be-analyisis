...
export const businessUpdateToOneWithWhereWithoutScoring_pointsInputSchema: z.ZodType<Prisma.businessUpdateToOneWithWhereWithoutScoring_pointsInput> = z.object({
  where: z.lazy(() => businessWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => businessUpdateWithoutScoring_pointsInputSchema),z.lazy(() => businessUncheckedUpdateWithoutScoring_pointsInputSchema) ]),
}).strict();
