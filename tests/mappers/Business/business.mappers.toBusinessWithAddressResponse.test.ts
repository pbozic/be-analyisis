 ...
 *
 * Source: schemas/dto/Business/business.mappers.ts:234
 */

import { describe, it, expect } from '@jest/globals';
import { toBusinessWithAddressResponse } from '../../../schemas/dto/Business/business.mappers.js';
...
describe('Business Mapper - toBusinessWithAddressResponse', () => {
	it('should map Prisma data to DTO and validate against schema', () => {
		// Get mock data - use businessbyid which has address
