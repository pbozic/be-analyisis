...
import { toUserWithAddressesResponse } from '../../../schemas/dto/User/user.mappers.js';
import { UserWithAddressesResponseSchema } from '../../../schemas/dto/User/index.js';
import { mockPrismaData } from '../../integration/mock-prisma.js';
import { UserAddressesPrisma } from '../../../prisma/includes/user.js';
