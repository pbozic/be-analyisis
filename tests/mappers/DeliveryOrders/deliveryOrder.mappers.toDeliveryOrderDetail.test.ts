...
import { toDeliveryOrderDetail } from '../../../schemas/dto/DeliveryOrders/deliveryOrder.mappers.js';
import { DeliveryOrderDetailSchema } from '../../../schemas/dto/DeliveryOrders/index.js';
...
describe('DeliveryOrders Mapper - toDeliveryOrderDetail', () => {
	it('should map Prisma data to DTO and validate against schema', () => {
		...
		const result = toDeliveryOrderDetail(mockData);
