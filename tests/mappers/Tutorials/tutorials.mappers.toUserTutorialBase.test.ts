...
import { toUserTutorialBase } from '../../../schemas/dto/Tutorials/tutorials.mappers.js';
import { UserTutorialBaseSchema } from '../../../schemas/dto/Tutorials/index.js';
import { mockPrismaData } from '../../integration/mock-prisma.js';

describe('Tutorials Mapper - toUserTutorialBase', () => {
	it('should map Prisma data to DTO and validate against schema', () => {
		// Get mock data
		const mockData = mockPrismaData.userTutorial;

		if (!mockData) {
			console.warn('⚠️  Mock data for "userTutorial" not found');
		...
		const result = toUserTutorialBase(mockData);
