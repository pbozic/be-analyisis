...
router.post('/order/confirm_wallet', TaxiOrderController.confirmWalletPayment);
router.post('/order/:order_id/signature', TaxiOrderController.uploadTaxiOrderSignature);
router.post('/order/:order_id/photo', TaxiOrderController.uploadTaxiOrderPhoto);
