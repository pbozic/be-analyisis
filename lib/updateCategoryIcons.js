...
import { upsertFileOnS3Helper } from './s3.js';
...
let CATEGORIES_FULL = {
	...
	vegetarian: {
		key: 'vegetarian',
		tag: 'vegetarian',
		source: '../prisma/seeders/icons/vegetarian.png',
		name: 'Vegetarian',
	},
	...
	sandwiches: {
		key: 'sandwiches',
		tag: 'sandwiches',
		source: '../prisma/seeders/icons/sandwich.png',
		name: 'Sandwiches',
	},
	...
	japanese: {
		key: 'japanese',
		tag: 'japanese',
		source: '../prisma/seeders/icons/japanese-food.png',
		name: 'Japanese',
	},
	...
	breakfast: {
		key: 'breakfast',
		tag: 'breakfast',
		source: '../prisma/seeders/icons/breakfast.png',
		name: 'Breakfast',
	},
	...
	gourmetCuisine: {
		key: 'gourmetCuisine',
		tag: 'gourmet-cuisine',
		source: '../prisma/seeders/icons/fine-dining.png',
		name: 'Fine dining',
	},
	traditional: {
		key: 'traditional',
		tag: 'traditional',
		source: '../prisma/seeders/icons/traditional.png',
		name: 'Traditional',
	},
	...
	snacksExtras: {
		key: 'snacksExtras',
		tag: 'extras',
		source: '../prisma/seeders/icons/snacks_extras.png',
		name: 'Snacks & extras',
	},
	...
	hotDrinks: {
		key: 'hotDrinks',
		tag: 'hot-drinks',
		source: '../prisma/seeders/icons/hot-drinks.png',
		name: 'Coffee & Tea',
	},
	...
	kidsMeals: {
		key: 'kidsMeals',
		tag: 'kids-meals',
		source: '../prisma/seeders/icons/kids-meals.png',
		name: 'Kids meals',
	},
};
const DIETARY_OPTIONS = [
	{ title: 'Gallbladder', tag: 'gallbladder', source: '../prisma/seeders/icons/liver_icon.png' },
	{
		...
		tag: 'gluten-free',
		key: 'glutenFree',
		source: '../prisma/seeders/icons/gluten-free_icon.png',
	},
	...
	{ title: 'Vegan', tag: 'vegan', source: '../prisma/seeders/icons/vegan.png' },
	{
		...
		tag: 'dietary-plan',
		key: 'dietaryPlan',
		source: '../prisma/seeders/icons/diet1_icon.png',
	},
];
/**
 * Recreate and upload icon files for categories and dietary options using local seed images.
 * Disconnects old icons, deletes previous files and upserts new S3-backed files per category.
...
async function fixCategoryIcons() {
	...
	for (const category of categories) {
		...
		if (catObj || diet) {
			...
			if (category.icon && category.icon.file_id) {
				...
				console.log(newCat);
				await upsertFileOnS3Helper(
					null,
					newCat.icon,
					iconFileData.file_type,
					iconFileData.mime_type,
					iconFileData.base64
				);
			}
		}
