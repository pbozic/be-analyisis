import { default as default$0 } from '@turf/centroid';

import weatherApi from './weatherApi.js';
import prisma from '../prisma/prisma.js';
const centroid = { default: default$0 }.default;
/**
 * Fetch and upsert hourly weather forecasts for all settlements.
 * Uses the settlement geojson centroid to query the weather API and stores data in weather_data.
...
export { getSettlementsWeatherForecast };
export default {
