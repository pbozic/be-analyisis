...
async function handleSendOrderNotifications(order, status) {
	const notifications = {
		PENDING: {
	...
	if (order.user_id && notifications[status].user !== null) {
...
module.exports = {
	sendOrderNotifications: handleSendOrderNotifications
};