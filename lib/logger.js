...
/**
 * Create a simple logger wrapper that injects async context and supports common levels.
 *
 * @param {object} logger - Pino logger instance.
 * @returns {object} Wrapper with info, error, warn, debug methods.
 */
...
/**
 * Log a message at a specific level, merging async context and sanitizing metadata.
 *
 * @param {string} level - Log level: info|error|warn|debug.
 * @param {string} msg - Message to log.
 * @param {object[]} meta - Additional metadata arguments.
 * @param {object} logger - Pino logger instance.
 * @returns {void}
 */
...
/**
 * Sanitize metadata by removing circular references; returns a string in dev for readability.
 *
 * @param {object} meta - Metadata payload to sanitize.
 * @returns {object|string} Sanitized meta or stringified form in dev.
 */
...
export { sanitizeCircularReferences };
export default {
	logger,
	asyncLocalStorage,
	log,
