...
const verifyOrderCosts = async (orderData) => {
	...
	console.info('Comparing Total:', discountTotal + orderTotal, orderData.details.total_price);
	if (orderData.details.total_price.toFixed(2) !== (discountTotal + orderTotal).toFixed(2)) return false;
	return true;
};
