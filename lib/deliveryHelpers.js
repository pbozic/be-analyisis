...
function CalculateOrderDetails(provider, cartItems, selectedAddress, paymentType = 'cash', orderData) {
	let orderTotal = 0;
	let discountTotal = 0;
	...
	// Delivery Cost
	let delivery_cost = calculateOrderDeliveryCost(orderData, student_meal);
