...
dotenv.config();
/**
 * Generate a self-signed PKCS#12 (.p12) certificate for PDF signing.
 *
 * @param {object} commonName
 * @returns {Buffer} The PKCS#12 certificate as a Buffer.
 */
...
/**
 * Get or generate the PDF signing certificate as a Buffer.
 *
 * @returns {Promise<Buffer>} The PKCS#12 certificate as a Buffer.
 */
