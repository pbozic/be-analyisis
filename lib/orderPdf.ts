 ...
 */
async function generatePDFFromPug(templateName: string, locals: Record<string, any> = {}) {
 ...
 */
async function signPdfBuffer(pdfBuffer: Buffer): Promise<Buffer> {
 ...
 */
async function getOrderAndPDF(order_id: string): Promise<Buffer | undefined> {
