...
async function createSplitPayment(customer_acc, restaurant_acc, order_id, payment_method,total_price, merchant_cut, return_url){//transfer_prices, transfer_destinations){
    try{
        const paymentIntent = await stripe.paymentIntents.create({
