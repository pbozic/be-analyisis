...
const FoodByCuisine = {
	Italian: {
		...
		categories_ids: ["69b8c85b-a521-4dad-a84c-8c331d39f8d0", "c81e1bfd-b6ea-4d22-bb7d-c90ad1893530"],
	},
	Mexican: {
		dishes: ["Tacos", "Quesadilla", "Enchiladas", "Burrito"],
		categories: ["mexican", "fastFood", "healthy", "traditional"],
		categories_ids: ["4268efbd-a614-4de0-8ddb-b507be684a45", "6af407c3-3d80-4d43-8d7a-d2adddbce106"],
	},
	American: {
		dishes: ["Burger", "Sandwich"],
		categories: ["burger", "fastFood", "bbq", "steak", "chicken", "breakfast"],
		categories_ids: ["0328cdfe-ce0c-4373-a5fb-86c84fb204b1", "4b3628c7-64e4-436e-8079-d8f1572a184c"],
	},
	Japanese: {
		dishes: ["Ramen", "Tempura", "Teriyaki"],
		categories: ["japanese", "sushi", "bowl", "seafood", "gourmetCuisine"],
		categories_ids: ["9e4fa6ed-0357-496a-b29d-cf1401db142e", "b2d51e1b-a3a3-411a-997a-eb87743af783"],
	},
	Indian: {
		dishes: ["Curry", "Biryani", "Tikka Masala", "Korma"],
		categories: ["indian", "spicy", "healthy", "halal", "kosher"],
		categories_ids: ["955b6d0f-b924-4ad8-afc5-746d9ce57aee"],
	},
	Chinese: {
		dishes: ["Noodles", "Dumplings", "Fried Rice", "Spring Rolls"],
		categories: ["chinese", "asian", "vegan", "vegetarian", "traditional"],
		categories_ids: ["852cd19f-87a5-4d69-ac44-86c47d9f5b13"],
	},
	"Middle Eastern": {
		dishes: ["Kebab", "Shawarma"],
		categories: ["kebab", "arabic", "kosher", "halal", "healthy"],
		categories_ids: ["f708122f-282f-4fa7-820c-8365395ddbb3", "da0050f6-78a6-42a5-bce0-5b4660fb411f"],
	},
	French: {
		dishes: ["Omelette", "Coq au Vin", "Quiche", "Cassoulet"],
		categories: ["gourmetCuisine", "french", "bakery", "desserts", "wine"],
		categories_ids: ["16d80b6e-6e00-4242-86c8-6faa4666877a", "46d8bc4b-d416-4149-8334-535a5a40da13"],
	},
	General: {
		dishes: ["Soup", "Stew", "Salad"],
		categories: ["soups", "salads", "healthy", "vegan", "vegetarian"],
		categories_ids: ["51b4373b-2f09-463d-b443-5b435075cb7f", "b8138785-db57-4ae6-8836-575c70235ea7", "c27a14a0-dc9a-4abb-aed1-ea98160dc86b"],
	},
};
...
const dishImages = {
	"Shawarma": "https://images.pexels.com/photos/18177331/pexels-photo-18177331/free-photo-of-arabic-food-served-on-a-tray.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
	"Coq au Vin": "https://www.recipetineats.com/tachyon/2016/09/Coq-au-Vin_00.jpg?resize=900%2C1260&zoom=0.72",
	"Teriyaki": "https://images.pexels.com/photos/11787138/pexels-photo-11787138.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
	"Cassoulet": "https://diethood.com/wp-content/uploads/2021/12/chicken-cassoulet-5.jpg",
	"Fried Rice": "https://www.seriouseats.com/thmb/tuMCogfAOy2zNdVqE7ydUwuru9Q=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/easy-vegetable-fried-rice-recipe-hero-2-fed2a62b8bce4c51b945d9c24c2edb68.jpg",
	"Spring Rolls": "https://cdn.apartmenttherapy.info/image/upload/f_auto,q_auto:eco,c_fill,g_auto,w_728,h_546/k%2FPhoto%2FRecipe%20Ramp%20Up%2F2022-01-Spring-Rolls%2FVegetarian_Spring_Rolls-2"
}
...
async function getFoodImage(food_type) {
	...
	const response = await axios.get(
		`https://api.pexels.com/v1/search?query=${encodeURI(food_type)}&per_page=1`,
		{
			headers: {
...
async function generateBusiness() {
	...
	for (let cuisine of categoryNames) {
		...
		for (let j = 0; j < itemCount; j++) {
			await new Promise((resolve) => setTimeout(resolve, 1000));
			let item = await generateMenuItem(axiosC, category, menu, cuisine, business.business.business_id, userB.user_id);
		}
	}
