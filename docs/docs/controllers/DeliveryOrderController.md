...
<!-- DOCGEN:START convertAddressToLocation -->
...
<!-- DOCGEN:END convertAddressToLocation -->



<!-- DOCGEN:START getRouteDuration -->
### getRouteDuration
...
<!-- DOCGEN:START sendPdfDeliveryOrder -->
...
<!-- DOCGEN:END sendPdfDeliveryOrder -->
...
<!-- DOCGEN:START processOrderReady -->
### processOrderReady
...
<!-- DOCGEN:END processOrderReady -->



<!-- DOCGEN:START handleOrderProcessingFailure -->
...
<!-- DOCGEN:END handleOrderProcessingFailure -->
...
<!-- DOCGEN:START getMenuItemStockChange -->
### getMenuItemStockChange
...
<!-- DOCGEN:END getMenuItemStockChange -->



<!-- DOCGEN:START handleStockSync -->
### handleStockSync
...
<!-- DOCGEN:END handleStockSync -->



<!-- DOCGEN:START removeOrderStockChange -->
### removeOrderStockChange
...
<!-- DOCGEN:END removeOrderStockChange -->
