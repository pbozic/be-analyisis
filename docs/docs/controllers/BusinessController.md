...
<!-- DOCGEN:END sumRevenue -->



<!-- DOCGEN:START getPeriodsFromBody -->
### getPeriodsFromBody
...
<!-- DOCGEN:END getPeriodsFromBody -->



<!-- DOCGEN:START buildPromoBuckets -->
### buildPromoBuckets
