...
**Responses:**
- 200 - Successful operation, returns a list of online drivers
- 400 - Error occurred while obtaining the online driver list
...
**Responses:**
- 201 - Driver history locations fetched successfully
- 400 - Error fetching history locations for a particular driver
