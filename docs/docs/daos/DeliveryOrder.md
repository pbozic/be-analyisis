...
<!-- DOCGEN:START getDailyMealsSubscriptionByBusinessId -->
### getDailyMealsSubscriptionByBusinessId

<!-- DOCGEN:END getDailyMealsSubscriptionByBusinessId -->

<!-- DOCGEN:START getDailyMealsSubscriptionByUserId -->
### getDailyMealsSubscriptionByUserId

<!-- DOCGEN:END getDailyMealsSubscriptionByUserId -->
