...
<!-- DOCGEN:END getDailyMealCategoryById -->
...
<!-- DOCGEN:START getActiveDailyMealCategoriesForBusiness -->
### getActiveDailyMealCategoriesForBusiness

<!-- DOCGEN:END getActiveDailyMealCategoriesForBusiness -->
...
<!-- DOCGEN:START getDailyMealCategoryPriceForDate -->
